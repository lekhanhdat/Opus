    ...
    public class HtmlAttributeCollection : IList<HtmlAttribute>
    {
        ...
        public HtmlAttribute this[string name]
        {
            get
            {
                ...
                return Hashitems.ContainsKey(name.ToLower(System.Globalization.CultureInfo.InvariantCulture)) ? Hashitems[name.ToLower(System.Globalization.CultureInfo.InvariantCulture)] : null;
            }
            set { Append(value); }
        }
        ...
        public bool Contains(string name)
        {
            ...
            {
                if (items[i].Name.Equals(name.ToLower(System.Globalization.CultureInfo.InvariantCulture)))
                    return true;
            }
            return false;
        }
        ...
        public void Remove(string name)
        {
            ...
            string lname = name.ToLower(System.Globalization.CultureInfo.InvariantCulture);
            for (int i = 0; i < items.Count; i++)
            {
