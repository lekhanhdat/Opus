...
namespace AvePoint.Media.Storage.FTP.Wrapper.Extensions
{
    ...
    public static class ChecksumExtension
    {
        ...
        public static FtpHash GetChecksum(this WrapperFtpClient client, string path)
        {
        ...
        public static IAsyncResult BeginGetChecksum(this WrapperFtpClient client, string path, AsyncCallback callback, object state)
        {
