...
namespace AvePoint.GCommon.Contract.Server.Common.Monitor.Object
{
    ...
    public class RibbonModel : INotifyPropertyChanged
    {
        ...
        /// 当有选择job时进行隐藏
        /// </summary>
        public bool HideIfSelected
        {
            get
            {
                return (Options & RibbonOption.HideIfSelected) == RibbonOption.HideIfSelected;
            }
        }
        ...
        //public bool Unsustainable
        //{
        //    get
        //    {
        //        return (Options & RibbonOption.Unsustainable) == RibbonOption.Unsustainable;
        //    }
        //    set
        //    {
        //        if (value)
        //        {
        //            Options |= RibbonOption.Unsustainable;
        //        }
        //        else
        //        {
        //            Options = ~RibbonOption.Unsustainable & Options;
        //        }
        //    }
        //}
        ...
        public bool VisibleIfSelected
        {
            get 
            {
                return ((Options & RibbonOption.SelectVisible) == RibbonOption.SelectVisible);
            }
        }
        public bool DisableIfSelectAny
        {
            get { return (Options & RibbonOption.SelectDisable) == RibbonOption.SelectDisable; }
        }
    ...
    public enum JobMonitorRibbonType
    {
        ...
        [EnumMember]
        ViewLastAccessedTime = 45,
        [EnumMember]
        ViewSharePointAlerts = 46,
        [EnumMember]
        DownloadResult = 51,
        [EnumMember]
        ExportForEditing = 52,
        ...
        [EnumMember]
        DeleteJobAndRelatedTempDatabase = 112,
        [EnumMember]
        CollectJobsReport = 47,
        [EnumMember]
        Resync = 48,
        [EnumMember]
        JobPruning = 49,
        [EnumMember]
        JobPerformanceAlert = 50,

        [EnumMember]
        DownloadJobDetail = 70,
        [EnumMember]
        DownloadJobSPCAF = 701,
        [EnumMember]
        DownloadJobLog = 71,

        [EnumMember]
        ViewO365ActivityReport = 72,

        [EnumMember]
        ViewFileShareServerReport = 73,

        [EnumMember]
        Rerun = 721,

        [EnumMember]
        RerunWithDebugLogging = 722,

        [EnumMember]
        RerunMenu = 726,

        [EnumMember]
        ViewInformationManagementPolicies = 2000,
        
        [EnumMember]
        ViewUpcomingContentExpiration = 2001,
