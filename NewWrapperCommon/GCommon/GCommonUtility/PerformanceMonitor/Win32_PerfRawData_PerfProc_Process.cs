...
namespace AvePoint.GCommon.Utility
{
    ...
    internal class PerfRawData_PerfProc_Process : System.ComponentModel.Component
    {
        private static string CreatedWmiNamespace = "root\\CimV2";
        private static string CreatedClassName = "win32_PerfRawData_PerfProc_Process";
        ...
        public PerfRawData_PerfProc_Process()
        {
            this.InitializeObject(null, null, null);
        }

        public PerfRawData_PerfProc_Process(string keyName)
        {
            this.InitializeObject(null, new System.Management.ManagementPath(PerfRawData_PerfProc_Process.ConstructPath(keyName)), null);
        }

        public PerfRawData_PerfProc_Process(System.Management.ManagementScope mgmtScope, string keyName)
        {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(PerfRawData_PerfProc_Process.ConstructPath(keyName)), null);
        }

        public PerfRawData_PerfProc_Process(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(null, path, getOptions);
        }

        public PerfRawData_PerfProc_Process(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path)
        {
            this.InitializeObject(mgmtScope, path, null);
        }

        public PerfRawData_PerfProc_Process(System.Management.ManagementPath path)
        {
            this.InitializeObject(null, path, null);
        }

        public PerfRawData_PerfProc_Process(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions)
        {
            this.InitializeObject(mgmtScope, path, getOptions);
        }

        public PerfRawData_PerfProc_Process(System.Management.ManagementObject theObject)
        {
            Initialize();
        ...
        public PerfRawData_PerfProc_Process(System.Management.ManagementBaseObject theObject)
        {
            Initialize();
            if ((CheckIfProperClass(theObject) == true))
            {
        ...
        {
            string strPath = "root\\CimV2:win32_PerfRawData_PerfProc_Process";
        ...
        public static PerfRawData_PerfProc_ProcessCollection GetInstances()
        {
            return GetInstances(null, null, null);
        }

        public static PerfRawData_PerfProc_ProcessCollection GetInstances(string condition)
        {
            return GetInstances(null, condition, null);
        }

        public static PerfRawData_PerfProc_ProcessCollection GetInstances(System.String[] selectedProperties)
        {
            return GetInstances(null, null, selectedProperties);
        }

        public static PerfRawData_PerfProc_ProcessCollection GetInstances(string condition, System.String[] selectedProperties)
        {
            return GetInstances(null, condition, selectedProperties);
        }

        public static PerfRawData_PerfProc_ProcessCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions)
        {
            if ((mgmtScope == null))
            {
            ...
            pathObj.ClassName = "win32_PerfRawData_PerfProc_Process";
            ...
            return new PerfRawData_PerfProc_ProcessCollection(clsObject.GetInstances(enumOptions));
        }

        public static PerfRawData_PerfProc_ProcessCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition)
        {
            return GetInstances(mgmtScope, condition, null);
        }

        public static PerfRawData_PerfProc_ProcessCollection GetInstances(System.Management.ManagementScope mgmtScope, System.String[] selectedProperties)
        {
            return GetInstances(mgmtScope, null, selectedProperties);
        }

        public static PerfRawData_PerfProc_ProcessCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, System.String[] selectedProperties)
        {
            if ((mgmtScope == null))
            {
                if ((statMgmtScope == null))
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("win32_PerfRawData_PerfProc_Process", condition, selectedProperties));
            System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new PerfRawData_PerfProc_ProcessCollection(ObjectSearcher.Get());
        }

        [Browsable(true)]
        public static PerfRawData_PerfProc_Process CreateInstance()
        {
            ...
            return new PerfRawData_PerfProc_Process(tmpMgmtClass.CreateInstance());
        }
        ...
        public class PerfRawData_PerfProc_ProcessCollection : object, ICollection
        {

            private ManagementObjectCollection privColObj;

            public PerfRawData_PerfProc_ProcessCollection(ManagementObjectCollection objCollection)
            {
            ...
            public virtual void CopyTo(System.Array array, int index)
            {
                ...
                {
                    array.SetValue(new PerfRawData_PerfProc_Process(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }

            public virtual System.Collections.IEnumerator GetEnumerator()
            {
                return new PerfRawData_PerfProc_ProcessEnumerator(privColObj.GetEnumerator());
            }

            public class PerfRawData_PerfProc_ProcessEnumerator : object, System.Collections.IEnumerator
            {

                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;

                public PerfRawData_PerfProc_ProcessEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum)
                {
                    privObjEnum = objEnum;
                }
                ...
                public virtual object Current
                {
                    get
                    {
                        return new PerfRawData_PerfProc_Process(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
