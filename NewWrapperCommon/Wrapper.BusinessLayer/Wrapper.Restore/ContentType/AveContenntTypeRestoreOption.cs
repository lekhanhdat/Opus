...
//    public class AveSchemaDependencyNotFoundException : AveException
//    {
...
//            : base("Cannot find the {1} schema dependency '{0}'.", name, type)
//        {
//            SchemaDependencyName = name;
//        }
//    }

//    public class AveSchemaDependencyConflictException : AveException
//    {
//        public string SchemaDependencyName = string.Empty;
//        public string SchemaDependencyType = string.Empty;

//        public AveSchemaDependencyConflictException(string name, string type)
//            : base("There is a conflict {1} schema dependency '{0}' exist in the destination.", name, type)
//        {
//            SchemaDependencyName = name;
//        }
//    }
