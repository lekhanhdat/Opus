...
namespace AvePoint.GCommon.Contract.Server.Common
{
    ...
    public class AveResourceManager : ResourceManager
    {
        ...
        [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "i18nMessageDic is unmodifiable as the cause of being referenced.")]
        ...
        public string GetString(string name, string culture)
        {
            ...
            {
                return I18NMessageDic[name].Value;
            }
            return null;
        }
    }
