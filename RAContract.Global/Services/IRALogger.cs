...
namespace AvePoint.RA.Contract.Services
{
    ...
    {
        /// <summary>
        /// Convert sensitive value to base64 string for log
        /// </summary>
        /// <param name="strVal"></param>
        /// <returns>empty or [value]</returns>
        public static string LogBase64(this string strVal)
        {
            if (string.IsNullOrEmpty(strVal))
            {
                return strVal;
            }
            string base64 = System.Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes(strVal));
            return $"[{base64}]";
        }
    }
}
