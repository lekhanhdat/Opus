...
namespace AvePoint.RA.SharePoint.Common.CAMLHelper.CAML
{
    ...
    public sealed class CAMLManager
    {
        ...
        private bool mIsUnclassificationQuery;
        ...
        /// <summary>
        /// Get or set the IsUnclassificationQuery flag of this CAML query.
        /// </summary>
        public bool IsUnclassificationQuery
        {
            get { return mIsUnclassificationQuery; }
            set { mIsUnclassificationQuery = value; }
        }
