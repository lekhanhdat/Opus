...
namespace AvePoint.ObjectModel.Common
{
    class AveViewFieldCollection : AveAbstractCommonCollection<string>, IAveViewFieldCollection
    {
        ...
        public AveViewFieldCollection(IAveRequest request, IAveList parentList, AveView view, IDictionary<string, object> prop)
        {
            mRequest = request;
        ...
        private void InitSchemaXml(ref IDictionary<string,object> viewFieldCollectionProperty)
        {
