...
//                                if (term == null)
//                                {
//                                    term = termSet.CreateTerm(dtInfo.Term.TermName, lcid, Guid.NewGuid());
...
//                    report.AddDetail(new AveWrapperReportDto("Tag", "Tag", AveReportObjectType.DocumentTag, AveStatus.Skipped, "You don't have permission to restore document tag. " + ex.Message));
//                }
//                catch (Exception ex)
//                {
