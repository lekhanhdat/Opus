...
{
    public class GoogleTreeFilterDriveQueryBuilder : BaseArrayFilterBuilder
    {
        ...
        {
            return filterOption.SPNodes.Where(n => n.Level == (int)NodeLevel.GoogleMyDrive || n.Level == (int)NodeLevel.GoogleSharedDrive).Select(n => n.Id).ToList();
        }
    }
}
