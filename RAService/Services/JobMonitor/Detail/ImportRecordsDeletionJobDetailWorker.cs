...
{
    public class ImportRecordsDeletionJobDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_ITEMS_DELETION_IMPORTPHYSICALRECORDS, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_ITEMS_DELETION_IMPORTPHYSICALRECORDS, TABLE_NAME);
        }
    }
}
