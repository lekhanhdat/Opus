...
namespace AvePoint.GCommon.Contract.PermissionExpander
{
    ...
    public class ModulePermission
    {
        ...
        public ModulePermission()
        {
            ...
            dictionary.Add(ModuleContract.DocAvePlatform.DataProtection.PlatformBackupForSMSP.Name, new List<PermissionType> { PermissionType.Read, PermissionType.Write, PermissionType.Control });
