...
namespace AvePoint.ObjectModel.Common
{
    class AveEventReceiverDefinition : AveClientObject, IAveEventReceiverDefinition
    {
        ...
        public AveEventReceiverDefinition(AveWeb web, AveList list, AveEventReceiverDefinitionCollection eventReceiverDefinitionCol, IAveRequest request, string erdSource, IDictionary<string, object> eventReceiverDefProperties)
        {
            mWeb = web;
            mList = list;
            mRequest = request;
