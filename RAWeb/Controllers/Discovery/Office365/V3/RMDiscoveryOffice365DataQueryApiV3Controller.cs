...
namespace AvePoint.RA.Web.Controllers.Discovery.Office365.V3
{
    ...
    public class RMDiscoveryOffice365DataQueryApiV3Controller : BaseApiController
    {
        ...
        {
            return s_discoveryDataQueryService.QueryInactiveV3SummaryNodesAsync(queryParameter);
        }
        ...
        {
            return s_discoveryDataQueryService.QueryInactiveV3SummaryNodeTotalAggregateInfoAsync(queryParameter);
        }
    }
}
