...
namespace AvePoint.Media.Service.DomainModel
{
        ...
        , IRetentionInfo
    {
        ...
        public ArchiverRetentionInfo(ArchiverPruningJob info)
        {
            ...
            this.IsSystemStorage = info.IsSystemStorage;
            this.DeleteStatus = info.DeleteStatus;
        }
    ...
    public class ExchangeArchiverRetentionInfo : ArchiverRetentionInfo
    {
        public ExchangeArchiverRetentionInfo(ArchiverPruningJob info)
        {
            this.IsSimulateJob = info.IsSimulateJob;
            this.FarmName = info.FarmName;
            this.JobId = info.JobId;
            ...
            this.DestinationDevice = info.DestinationDevice;
            this.RetentionTimeSpanSeconds = info.RetentionTimeSpanSeconds;
            var volumeGenerator = this.VolumeGeneratorFactory.GetVolumeGenerator(ProductModule.ExchangeBackup);
            var volumeParam = new VolumeParameter(this);
            volumeParam.EmailAddress = volumeParam.SiteCollectionUrl;
            this.DataVolume = volumeGenerator.GenerateDataVolume(volumeParam);
            this.IndexVolume = volumeGenerator.GenerateIndexVolume(volumeParam);
            this.CacheSetting = info.CacheSettings;
            this.DestinationStoreInArchiverTier = info.NeedStoreInArchiverTier;
    ...
    public class TeamsArchiverRetentionInfo : ArchiverRetentionInfo
    {
        public TeamsArchiverRetentionInfo(ArchiverPruningJob info)
        {
            this.FarmName = info.FarmName;
            this.JobId = info.JobId;
            this.SiteUrl = info.SiteUrl;
            ...
            this.DestinationDevice = info.DestinationDevice;
            this.RetentionTimeSpanSeconds = info.RetentionTimeSpanSeconds;
            var volumeGenerator = this.VolumeGeneratorFactory.GetVolumeGenerator(ProductModule.TeamsArchiverBackup);
            var volumeParam = new VolumeParameter(this);
            this.DataVolume = volumeGenerator.GenerateDataVolume(volumeParam);
            this.IndexVolume = volumeGenerator.GenerateIndexVolume(volumeParam);
            this.CacheSetting = info.CacheSettings;
    ...
    public class GoogleArchiverRetentionInfo : ArchiverRetentionInfo
    {
        public GoogleArchiverRetentionInfo(ArchiverPruningJob info)
        {
            this.FarmName = info.FarmName;
            this.JobId = info.JobId;
            this.SiteUrl = info.SiteUrl;
            ...
            this.DestinationDevice = info.DestinationDevice;
            this.RetentionTimeSpanSeconds = info.RetentionTimeSpanSeconds;
            var volumeGenerator = this.VolumeGeneratorFactory.GetVolumeGenerator(ProductModule.GDriveArchiverBackup);
            var volumeParam = new VolumeParameter(this);
            this.DataVolume = volumeGenerator.GenerateDataVolume(volumeParam);
            this.IndexVolume = volumeGenerator.GenerateIndexVolume(volumeParam);
            this.CacheSetting = info.CacheSettings;
    ...
    public class ArchiverLifecycleRetentionInfo : ArchiverRetentionInfo
    {
        public ArchiverLifecycleRetentionInfo(ArchiverPruningJob info) : base(info)
        {
        ...
        public bool IsOneDriveSite { set; get; }

        public bool IsTeams { set; get; }

        public bool IsGoogleDrive { set; get; }
        public ArchiverMessage ArchiverMessage { set; get; }
        public Dictionary<int, Rule> Rules { set; get; }
        public int JobType { get; set; }
        public string ExplorerDBInfo { set; get; }
    }
}