...
{
    public sealed class DestoryActivity : NativeActivity
    {
        ...
        protected override void Execute(NativeActivityContext context)
        {
            try
            {
                ...
                ManualApprovalService.SetWorkflowIsComplete(runningRequest.InstanceId, SOApproveDBStatus.Approved);
                logger.Info($"Destory record. request id : {requestInfo.RequestId}, instance id : {context.WorkflowInstanceId}");
