...
public static class IdcrlErrorCodes
{
    ...
    public const int PPCRL_REQUEST_E_STRONG_PASSWORD_APPLIED = -2147207980;
    ...
    private static Dictionary<int, string> s_errorMap = new Dictionary<int, string>
    {
        ...
        {
            PPCRL_REQUEST_E_STRONG_PASSWORD_APPLIED,
            "The Multi-Factor Authentication is enabled for this account, please use the other account without MFA or use the app password to try again."
        }
    };
