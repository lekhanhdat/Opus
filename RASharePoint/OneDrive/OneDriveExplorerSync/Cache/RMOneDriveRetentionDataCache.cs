...
{
    public class RMOneDriveRetentionDataCache : IDisposable
    {
        ...
        static RMOneDriveRetentionDataCache _instance;
        ...
        public static RMOneDriveRetentionDataCache Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (locker)
                    {
                        if (_instance == null)
                        {
                            _instance = new RMOneDriveRetentionDataCache();
                            _instance.Init();
                        }
                    }
                }
        ...
        public RMOneDriveRetentionDataCache()
        {
            Init();
        }
        ...
        public async System.Threading.Tasks.Task AddLabelHistoryAsync()
        {
            try
            {
                ...
                var previousUsedLabels = RMLabelDao.GetLabelByStatusAndType((int)Contract.TaxonomyModel.RMRetentionLabelStatus.Previous, (int)Contract.TaxonomyModel.RMRetentionSourceType.OneDrive);
                ...
                else
                {
                    ...
                    RMEXOLabel newLabel = new RMEXOLabel()
                    {
                        ...
                        Type = (int)Contract.TaxonomyModel.RMRetentionSourceType.OneDrive,
        ...
        private void CacheLabelSetting()
        {
            ...
            if (labels.Any(l => l.Status == (int)RMRetentionLabelStatus.FromGUI))
            {
            ...
            string previoisNames = prevLabels != null && prevLabels.Count > 0 ? string.Join(",", prevLabels) : string.Empty;
            logger.Info($"cache label retention setting, PreviousLable:{previoisNames}, ProcessLabel:{currentLabel?.Name}.");
        }
