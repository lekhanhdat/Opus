...
namespace AvePoint.RA.Service.Services.Discovery.Office365.Work.Analyzer.V3.General.Inactive
{
    public class RMDiscoveryOffice365SiteInactiveDataAnalyzer
    {
        ...
        public async Task<(bool analysisSucceed, List<RMDiscoveryOffice365SiteInactiveData> dataList)> AnalysisAsync()
        {
            try
            {
                ...
                await _dataDao.AddSiteInactiveDataListAsync(_o365TenantId, dataList.ToArray());
