...
namespace AvePoint.GCommon.Contract.AveModuleContract
{
    ...
    public class DocAvePlatform : AveModuleContainer
    {
        ...
        private readonly CloudAppAdministration caa = new CloudAppAdministration();

        public CloudAppAdministration CloudAppAdministration
        {
            get { return caa; }
        } 
        ...
        public override List<AveModule> getSubModules()
        {
            ...
            result.Add(this.CloudAppAdministration);
            //please keep control panel the last one.
