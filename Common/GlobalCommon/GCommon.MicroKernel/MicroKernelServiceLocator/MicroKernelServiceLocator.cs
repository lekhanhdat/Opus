...
namespace AvePoint.GCommon.MicroKernel
{
    ...
    {
        static IIocContainerAnalyzer iocContainerAnalyzer = IocContainerAnalyzerFactory.GetContainerAnalyzer(AppDomain.CurrentDomain.GetData(MicroKernelConstant.CoreIocContainerIdentifier));
        ...
        {
            return (T)(String.IsNullOrEmpty(serviceId) ? iocContainerAnalyzer.ResolveByType(typeof(T)) : iocContainerAnalyzer.ResolveById(serviceId, (Type)null));
        }
