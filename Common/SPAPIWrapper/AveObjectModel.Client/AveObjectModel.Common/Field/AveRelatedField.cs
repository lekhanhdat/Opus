...
namespace AvePoint.ObjectModel.Common
{
    class AveRelatedField : AveClientObject, IAveRelatedField
    {
        ...
        public AveRelatedField(IAveRequest m_Request, AveList m_AveList, AveRelatedFieldCollection aveRelatedFieldCollection, IDictionary<string, object> relatedFieldProperties)
        {
