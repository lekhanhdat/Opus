    ...
    class AveMetadataServiceApplication : AveIisWebServiceApplication, IAveMetadataServiceApplication
    {
        ...
        public Uri GetContentTypeSyndicationHubLocal()
        {
            ...
            using (AvePerformanceScope pc = new AvePerformanceScope("Server.AveMetadataServiceApplication.GetContentTypeSyndicationHubLocal"))
            {
                ...
                return GetContentTypeSyndicationHubLocal(this.DefaultPartitionId);
        ...
        public Uri GetContentTypeSyndicationHubLocal(Guid defaultPartitionId)
        {
            ...
            using (AvePerformanceScope pc = new AvePerformanceScope("Server.AveMetadataServiceApplication.GetContentTypeSyndicationHubLocal"))
            {
                ...
                Type applicationType = typeof(TaxonomySession).Assembly.GetType("Microsoft.SharePoint.Taxonomy.MetadataWebServiceApplication");
                object TaxonomyDatabaseMapper = applicationType.InvokeMember("DatabaseMapper", BindingFlags.GetProperty | BindingFlags.NonPublic | BindingFlags.Instance, null, this.mServiceApplication, null, System.Globalization.CultureInfo.InvariantCulture);
                return (Uri)AveAssemblyUtility.InvokeMethod(TaxonomyDatabaseMapper, "GetContentTypeSyndicationHubLocal", new object[] { defaultPartitionId });
        ...
        public bool IsMetadataPartition(AveServiceApplication app)
        {
            ...
            using (AvePerformanceScope pc = new AvePerformanceScope("Server.AveMetadataServiceApplication.IsMetadataPartition"))
            {
                ...
                Type type = Assembly.Load("Microsoft.Office.Server, Version=16.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c")
