...
{
    internal class DO2SOCustomPropertyNumberBase<T> : DO2SOFilterConverterBase
        where T : PolicyRuleBase, new()
    {
        ...
        public DO2SOCustomPropertyNumberBase(string value1, int startSequenceNo, NumberConditionType condition, string extraValue)
        {
            this.mValue1 = value1;
