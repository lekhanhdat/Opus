...
namespace AvePoint.ObjectModel.Common
{
    ...
    internal class AveRoleAssignmentsSerializer : IAveRoleAssignmentsSerializer
    {
        private AveWeb m_Web;

        public AveRoleAssignmentsSerializer(AveWeb web)
        {
            m_Web = web;
        }

        public List<AveRoleAssignmentInfo> GetObjectData(Guid siteId, Guid scopeId)
        {
            List<AveRoleAssignmentInfo> roleAssignmentsInfo = new List<AveRoleAssignmentInfo>();
            foreach (AveRoleAssignment roleAssignment in m_Web.RoleAssignments)
            {
        ...
        public List<AveRoleAssignmentInfo> GetObjectData()
        {
