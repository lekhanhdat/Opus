...
namespace AvePoint.RA.SharePoint.Archiver.CAMLHelper
{
    ...
    public class QueryCondition
    {
        ...
        public QueryCondition(Types.JoinTypes joinType, Types.FieldRefTypes fieldRefType, string field, Types.FieldTypes fieldType, Types.QueryTypes queryType)
            : this(joinType)
        {
            _query = new Query(field, fieldRefType, fieldType, queryType);
        }
