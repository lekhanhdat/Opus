...
{
    public class PermissionSyncFailedInfoGenerator : TelemetryGenerator
    {
        public override TelemetryModule Module => TelemetryModule.PermissionSync;
        ...
        protected override Dictionary<TelemetryEventType, Func<IList<object>, CloudRecordsCommonRecord>> EventTypeGenerateMapping =>
            ...
            {
                { TelemetryEventType.PermissionSyncFailedInfo, GetPermissionSyncFailedInfo },
            };

        public CloudRecordsCommonRecord GetPermissionSyncFailedInfo(IList<object> args)
        {
