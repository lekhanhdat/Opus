...
namespace AvePoint.Hybrid.Utility
{
    ...
    public class AveTuple<TA> : ITuple
    {
        readonly TA itemA;

        public TA ItemA { get { return this.itemA; } }

        public AveTuple(TA item)
        {
            this.itemA = item;
        }
    ...
    public class AveTuple<TA, TB> : AveTuple<TA>, ITuple
    {
        readonly TB itemB;

        public TB ItemB { get { return this.itemB; } }

        public AveTuple(TA itemA, TB itemB)
            : base(itemA)
        {
            this.itemB = itemB;
        }
    ...
    public class AveTuple<TA, TB, TC> : AveTuple<TA, TB>, ITuple
    {
        readonly TC itemC;

        public TC ItemC { get { return this.itemC; } }

        public AveTuple(TA itemA, TB itemB, TC itemC)
            : base(itemA, itemB)
        {
            this.itemC = itemC;
        }
    ...
    public class AveTuple<TA, TB, TC, TD> : AveTuple<TA, TB, TC>, ITuple
    {
        readonly TD itemD;

        public TD ItemD { get { return this.itemD; } }

        public AveTuple(TA itemA, TB itemB, TC itemC, TD itemD)
    ...
    public class AveTuple<TA, TB, TC, TD, TE> : AveTuple<TA, TB, TC, TD>, ITuple
    {
        readonly TE itemE;

        public TE ItemE { get { return this.itemE; } }

        public AveTuple(TA itemA, TB itemB, TC itemC, TD itemD, TE itemE)
    ...
    public class AveTuple<TA, TB, TC, TD, TE, TF> : AveTuple<TA, TB, TC, TD, TE>, ITuple
    {
        readonly TF itemF;

        public TF ItemF { get { return this.itemF; } }

        public AveTuple(TA itemA, TB itemB, TC itemC, TD itemD, TE itemE, TF itemF)
    ...
    public class AveTuple<TA, TB, TC, TD, TE, TF, TG> : AveTuple<TA, TB, TC, TD, TE, TF>, ITuple
    {
        readonly TG itemG;

        public TG ItemG { get { return this.itemG; } }

        public AveTuple(TA itemA, TB itemB, TC itemC, TD itemD, TE itemE, TF itemF, TG itemG)
    ...
    public class AveTuple<TA, TB, TC, TD, TE, TF, TG, TH> : AveTuple<TA, TB, TC, TD, TE, TF, TG>, ITuple
    {
        readonly TH itemH;

        public TH ItemH { get { return this.itemH; } }

        public AveTuple(TA itemA, TB itemB, TC itemC, TD itemD, TE itemE, TF itemF, TG itemG, TH itemH)
