...
{
    public class ArrayListFilesWrapper : AbstractArrayListWrapper
    {
        ...
        public ArrayListFilesWrapper(IChangeArrayListResultsListener arrayListResultsListener)
        {
            this.arrayListResultsListener = arrayListResultsListener;
            this.count = arrayListResultsListener.GetFilesResultsCount();
        }
        ...
        {
            ar.Clear();
            ar = arrayListResultsListener.GetNextFilesResults(responseInfo, queryParams, urlWithoutQueryParms
