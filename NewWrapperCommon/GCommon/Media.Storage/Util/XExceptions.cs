...
namespace AvePoint.Media.Storage.Util
{
    ...
    {
        public XIOException(string msg) : base(msg) { }
    }
    ...
    {
        public DeleteSrcFileFailedException(string message) : base(message) { }

        public DeleteSrcFileFailedException(string message, Exception innerException) : base(message, innerException) { }
    }

    public class ProhibitDeleteException : XException
    {
        public ProhibitDeleteException(string message) : base(message) { }

        public ProhibitDeleteException(string message, Exception innerException) : base(message, innerException) { }
    }

    public class FailoverModeException : XException
    {
        public FailoverModeException(string message) : base(message) { }

        public FailoverModeException(string message, Exception innerException) : base(message, innerException) { }
    }
    ...
    public class IDNullException : XException
    {
        ...
        public IDNullException(string message, Exception innerException) : base(message, innerException) { }
    }
    ...
    public class GatewayTimeoutException : XException
    {
    ...
    //Connector CloudAdapter中多线程写流导致冲突时抛出的异常
    public class WriteStreamConflictException : XException
    {
        public WriteStreamConflictException(String message) : base(message) { }

        public WriteStreamConflictException(String message, Exception innerException) : base(message, innerException) { }
    }

    /// <summary>
    /// For box token not found
    /// </summary>
    public class TokenNotFoundException : XException
    {
