...
namespace AvePoint.GCommon.Contract.Server.GUI
{
    public class AUIModuleUtility
    {
        ...
        private static Dictionary<GUIModuleType, ModuleInfo> moduleCollection = new Dictionary<GUIModuleType, ModuleInfo>()
        {
            ...
            { GUIModuleType.StorageOptimization, new ModuleInfo(){ Module="ControlGUIStorageOptimization", Feature="AvePoint.StorageOptimization.Gui.Xaml.SOBasePage"}},
            { GUIModuleType.DBManager, new ModuleInfo(){ Module="ControlGUIDBManager", Feature="AvePoint.DBManager.Gui.Xaml.DBManagerHome"}},
			{ GUIModuleType.DataManager, new ModuleInfo(){ Module="ControlGUIDataManager", Feature="AvePoint.DataManager.Gui.DataManagerHome"}},
            ...
            { GUIModuleType.SQLServerDataManager, new ModuleInfo(){ Module="ControlGUISSDM", Feature="AvePoint.SQLRecoveryManager.Gui.Xaml.ProjectObj.SQLServerDataManager"}},
            { GUIModuleType.HighAvailability, new ModuleInfo(){ Module="ControlGUIHighAvailability", Feature="AvePoint.HighAvailability.Gui.Xaml.ProjectObj.HighAvailabilityContainer"}},
            { GUIModuleType.VM, new ModuleInfo(){ Module="ControlGUIVM", Feature="AvePoint.VMRecovery.Gui.Xaml.ProjectObj.VMRecoveryContainer"}},
        };
    }
