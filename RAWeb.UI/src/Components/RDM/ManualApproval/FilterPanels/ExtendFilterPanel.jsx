...
const ExtendFilterPanel = ({ show, onFilter, onHide, defaultFilterDefinitions, filterAvailableOptions ,SpecialEnableReviewDefinitions, approvalCommentQuickReasons,SpeciallEnableReviewOnlyOneLocationDefinitions, customColumns}) => {
...
export default ExtendFilterPanel;