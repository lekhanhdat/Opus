...
{
    class NumberDataFormat : BaseDataFormat
    {
        private static AveLogger log = AveLogger.GetInstance(typeof(NumberDataFormat));

        public NumberDataFormat(AveXmlField xmlField, IAveField destField, AveSPItem mItem) :
