...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldUrl : AveField, IAveFieldUrl
    {
        ...
        public AveFieldUrl(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, Dictionary<string, object> contentTypeProp, Dictionary<string, object> prop)
        ...
        public AveUrlFieldFormatType DisplayFormat
        {
            get
            {
                return base.DataCache.GetProperty<AveUrlFieldFormatType>("DisplayFormat");
            }
            set
            {
        ...
        {
            return new AveFieldUrlValue(value);
        }
        ...
        public override object DefaultValueTyped
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(base.GetFieldAttributeValue("DefaultURLDesc")))
                {
                    return new AveFieldUrlValue(this.DefaultValue);
                }
                return new AveFieldUrlValue { Url = this.DefaultValue, Description = base.GetFieldAttributeValue("DefaultURLDesc") };
            }
        }
    }
}
