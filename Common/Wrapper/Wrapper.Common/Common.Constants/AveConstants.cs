...
namespace AvePoint.Wrapper.Common
{
    public class AveConstants
    {
        ...
        public const char TYPE_PROJECT = 'J';
        ...
        public static Guid Workflows = new Guid("0af5989a-3aea-4519-8ab0-85d91abe39ff");//Workflows feature
        public static Guid ExpirationWorkflow = new Guid("c85e5759-f323-4efb-b548-443d2216efb5");//Disposition Approval Workflow feature
        public static Guid IssueTrackingWorkflow = new Guid("fde5d850-671e-4143-950a-87b473922dc7");//Three State Workflow feature
        #endregion

        #region workflow type for sp2010
        public const string Three_State = "C6964BFF-BF8D-41AC-AD5E-B61EC111731A";//Three-state SP2010
        public const string Disposition_Approval = "DD19A800-37C1-43C0-816D-F8EB5F4A4145";//Disposition Approval SP2010
        public const string APPROVAL_BASEID = "8AD4D8F0-93A7-4941-9657-CF3706F00409";          //Approval SP2010
        public const string COLLECT_FEEDBACK_BASEID = "3BFB07CB-5C6A-4266-849B-8D6711700409";  //Collect Feedback SP2010  
        public const string COLLECT_SIGNATURE_BASEID = "77C71F43-F403-484B-BCB2-303710E00409"; //Collect signature SP2010
        public const string PUBLISHING_APPROVAL_BASEID = "E43856D2-1BB4-40EF-B08B-016D89A00409";//Publishing Approval SP2010
        #endregion

        public const string FOLDER_NAME_RECORDINGS = "Recordings";
    }
}
