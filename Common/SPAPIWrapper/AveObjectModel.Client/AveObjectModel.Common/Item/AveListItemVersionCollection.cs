...
namespace AvePoint.ObjectModel.Common
{
    class AveListItemVersionCollection : AveAbstractCommonCollection<IAveListItemVersion>, IAveListItemVersionCollection
    {
        ...
        public AveListItemVersionCollection(AveListItem listItem, IAveRequest request, IDictionary<string, object> listItemVerColProperites)
        {
            mListItem = listItem;
            mRequest = request;
        ...
        {
            var listItemVerPropertiesList = base.DataCache.GetChildren();
            mListData = new List<IAveListItemVersion>(listItemVerPropertiesList.Count);
            foreach (var listItemVerProperites in listItemVerPropertiesList)
            {
        ...
        public IAveListItemVersion GetLastVersion()
        {
            return GetVersionFromID(mListData.Max(ver => ver.VersionId));
        }
