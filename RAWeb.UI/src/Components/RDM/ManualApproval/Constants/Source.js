...
export const SourceI18Ns = new Map([
    ...
    [Source.Box, RMResx.RM_JS_SPS_TabLabel_Box],
    [Source.GoogleDrive, RMResx.RM_JS_SPS_TabLabel_GoogleDrive],
...
export const SourceIcons = new Map([
    ...
    [Source.Box, "fia-box-blue-b"],
    [Source.GoogleDrive, "fia-google-drive-f"],
