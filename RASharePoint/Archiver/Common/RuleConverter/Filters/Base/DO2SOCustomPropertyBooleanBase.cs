...
namespace AvePoint.RA.SharePoint.Archiver.Common.RuleConverter.Filters.Base
{
    internal class DO2SOCustomPropertyBooleanBase<T> : DO2SOFilterConverterBase
        where T : PolicyRuleBase, new()
    {
        private readonly string mValue1;
        private readonly int mStartSequenceNo;
        private readonly BooleanConditionType mCondition;
        ...
        public DO2SOCustomPropertyBooleanBase(string value1, int startSequenceNo, BooleanConditionType condition, string extraValue)
        {
            this.mValue1 = value1;
        ...
        public override List<SOFilterPolicy> Convert()
        {
            ...
            T rule = new T { Value1 = this.mFilterName };
            ...
            {
                BooleanConditionType.Equals => PolicyCondition.Equals,
                BooleanConditionType.DoesNotEqual => PolicyCondition.DoesNotEquals,
