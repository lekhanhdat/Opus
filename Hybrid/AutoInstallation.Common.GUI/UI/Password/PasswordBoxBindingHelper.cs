    ...
    public class PasswordBoxBindingHelper
    {
            ...
            DependencyPropertyChangedEventArgs e)
        {
            ...
            if (passwordBox != null)
            {
                ...
                if ((bool) e.NewValue) passwordBox.PasswordChanged += PasswordBoxPasswordChanged;
            }
        }
            ...
            DependencyPropertyChangedEventArgs e)
        {
            try
            {
                ...
                if (password != null) password.PasswordChanged -= PasswordBoxPasswordChanged;

                if (!string.IsNullOrEmpty(e.NewValue?.ToString()))
                {
                    if (!_updating) password.Password = e.NewValue?.ToString();
                }
                else
                {
            ...
            {
                logger.Error($"error occured when set password,error:{ex}");
            }
        }
