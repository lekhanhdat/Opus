...
namespace AvePoint.Media.Service.ArchiverBackup
{
    ...
    {
        //List<ArchiverBasicIndex> Search(ArchiverRestoreFilter filter, ArchiverBrowseInfo restoreParam);
        ...
        List<ArchiverBasicIndex> SearchForExportAllItem();
        List<ArchiverBasicIndex> SearchForExportAllItemOnSpecificTimeRange(ArchiverBrowseInfo info);
