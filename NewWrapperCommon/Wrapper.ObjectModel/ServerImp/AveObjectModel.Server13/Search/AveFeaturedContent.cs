...
namespace AvePoint.ObjectModel.Server13
{
    class AveFeaturedContent : IAveFeaturedContent
    {
        ...
        private Server13.Search.AveContextCollection mContexts;
        ...
        {
            mFeaturedContent.AttachContext((cx as Server13.Search.AveContext).Context);
        }

        public void DetachContext(Wrapper.Common.Search.IAveContext cx)
        {
            mFeaturedContent.DetachContext((cx as Server13.Search.AveContext).Context);
        }
