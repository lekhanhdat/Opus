...
namespace AvePoint.Wrapper.Restore
{
    class UserFieldDataFormat : BaseDataFormat
    {
        ...
        public UserFieldDataFormat(AveXmlField xmlField, IAveField destField, AveSPItem mItem) :
        ...
        private System.Tuple<int, string> GetDesUserIdAndLoginName(int oldUserId)
        {
            ...
            IAvePrincipal user = mItem.ParentList.ParentWeb.ParentSite.SPMembers.FindMember(oldUserId, false, true);
            if (user != null)
            {
