...
import { AvaiableOptions, FilterI18Ns, FilterOptions } from "../Constants/index";
...
const RelatedRecordsFilterPanel = ({ show, onFilter, onHide, defaultFilterDefinitions, filterAvailableOptions, customColumns }) => {
...
export default RelatedRecordsFilterPanel;