...
{
    public class ScopeIdQueryBuilder : BaseFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && !string.IsNullOrEmpty(filterOption.ScopeId);
        }
