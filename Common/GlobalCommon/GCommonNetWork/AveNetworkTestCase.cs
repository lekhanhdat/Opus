...
//    {
//        public static void Test(string ip, int port, string testSendFile, bool enableSSL, string sslThumbprint = null, string testReceiveFilePath = null)
//        {
//            try
//            {
//                IAveNetwork network = AveNetwork.Connect(ip, port, enableSSL, sslThumbprint);
