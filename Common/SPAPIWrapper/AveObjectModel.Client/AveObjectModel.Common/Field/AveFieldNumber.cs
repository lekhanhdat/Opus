...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldNumber : AveField, IAveFieldNumber
    {
        ...
        public AveFieldNumber(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
