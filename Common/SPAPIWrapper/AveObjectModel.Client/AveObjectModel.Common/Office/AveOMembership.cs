...
namespace AvePoint.ObjectModel.Common.Office
{
    class AveOMembership:AveClientObject,IAveOMembership
    {
        ...
        public AveOMembership(IAveRequest request,AveOUserProfile profile,IDictionary<string,object>membershipProp)
        {
            mRequest = request;
            mProfile = profile;
        ...
        public IAveOMemberGroup MembershipGroup 
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("MembershipGroup"))
                {
                    ...
                    base.DataCache.AddProperty("MembershipGroup",memberGroup);
                }
