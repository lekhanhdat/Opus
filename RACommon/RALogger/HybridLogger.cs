...
namespace AvePoint.RA.Common.HybridLogger
{
    public class HybridLogger : ILogger
    {
        protected static readonly RALogger logger = RALogger.GetInstance(typeof(HybridLogger));
        ...
        class HybridProvider : ILoggerProvider
        {
            ...
            {
                return new HybridLogger(categoryName);
        ...
        public HybridLogger(string categortName) 
        {
