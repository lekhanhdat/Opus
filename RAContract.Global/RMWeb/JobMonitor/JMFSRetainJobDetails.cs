...
{
    public class JMFSRetainJobDetails : JMJobDetails
    {
    ...
    public class JMFSRetainDashboardDetails : JMFSRetainJobDetails
    {
        public JMFSRetainDashboardDetails(JMFSRetainJobDetails baseObject)
        {
