...
namespace AvePoint.Wrapper.Common
{
    ...
    {
        public const string FORMAT_CAML_QUERY_ID =
            "<View Scope=\"RecursiveAll\">" +
                "<QueryOptions><QueryThrottleMode>Override</QueryThrottleMode></QueryOptions>" +
                "<Query><OrderBy Override=\"TRUE\"><FieldRef Name=\"ID\" /></OrderBy></Query>" +
                "<RowLimit>{0}</RowLimit>" +
            "</View>";

        public const string FORMAT_CAML_QUERY_VALUE_INT = "<Value Type=\"Integer\">{0}</Value>";
        public const string FORMAT_CAML_QUERY_ITEM =
            ...
            "</View>";
        public const string FORMAT_CAML_QUERY_ITEM_With_RowLimit =
            "<View Scope=\"RecursiveAll\"><QueryOptions><QueryThrottleMode>Override</QueryThrottleMode></QueryOptions>" +
                "<Query><Where><In>" +
                    "<FieldRef Name=\"ID\"/><Values>{0}</Values>" +
                "</In></Where><OrderBy Override=\"TRUE\"><FieldRef Name=\"ID\" /></OrderBy></Query>" +
            ...
            "</View>";
        /// <summary>
        /// Values下，一次query最多500个item或者Folder
        /// </summary>
        public static int QUERY_VALUES_LIMITE_ITEM = 500;

        /// <summary>
        /// Values下，一次qeury最多60个File
        /// </summary>
        public static int QUERY_VALUES_LIMITE_FILE = 60;

        private bool mdatesInUtc;
        private string mfolderServerRelativeUrl;
        private AveItemCollectionPosition mlistItemCollectionPosition;
        private string mviewXml;
        private string mviewFieldsXml;
        private string mqueryXml;
        private string mqueryOptionXml;
        private bool mLoadAllItems = true;

        public bool LoadAllItems
        {
            get { return mLoadAllItems; }
            set { mLoadAllItems = value; }
        }
        ...
        public AveItemCollectionPosition ListItemCollectionPosition
        {
            get
            {
        ...
        public static AveCamlQuery CreateAllItemsQuery(int rowLimit, string[] viewFields, string scope = "Recursive")
        {
            AveCamlQuery camlQuery = new AveCamlQuery();
            if (rowLimit <= 0)
            {
        ...
        public string[] ToStringArray()
        {
            ...
            returnInfo[7] = this.mLoadAllItems.ToString();
            return returnInfo;
        }
    }

    public class AveItemCollectionPosition
    {
