...
namespace AvePoint.Wrapper.Common
{
    ...
    public class AveWebSettingInfo
    {
        ...
        [DataMember]
        public AveRestorableProperty<bool> AllowAutomaticASPXPageIndexing;
        [DataMember]
        ...
        [DataMember]
        public AveRestorableProperty<string> ProjectPolicyContentTypeId;
        [DataMember]
        public AveRestorableProperty<DateTime> ProjectExpirationDate;
        [DataMember]
        public AveRestorableProperty<DateTime> SiteClosedTime;
        [DataMember]
        public AveRestorableProperty<bool> IsSiteClosed;
        [DataMember]
        public AveRestorableProperty<string> ProjectPolicyName;
        ...
        [DataMember]
        public AveRestorableProperty<string> ThemedTitle;// add by adrian
        [DataMember]
        ...
        [DataMember]
        public AveRestorableProperty<bool> HideSiteContentsLink;
        [DataMember]
        public List<AveTermStoreInfo> MetaDataNavigationRelativeTerm;
        
        #region User Resource, Add in 6.4
        //need to add AveRestorableProperty?
        [DataMember]
    ...
    /// <summary>
    /// Create Web后提供外围Action所需info信息
    /// </summary>
    public class AveWebRestoreBasicInfo
    {
        public RestoreObjectResult Status { get; set; }
    }

    public enum RestoreObjectResult
    {
        None=0,
        Exist=1,
        NewCreated=2,
