...
using AvePoint.GCommon.Utility.Exceptions.Configuration;
using System;
...
namespace AvePoint.RA.Contract.RMWeb.FSMasterIndex
{
    public interface IFSMasterIndexService
    {
        ...
        public void DeleteFSMasterIndex(FSMasterIndexContract connection);
    }
}
