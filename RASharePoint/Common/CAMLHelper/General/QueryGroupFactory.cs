...
namespace AvePoint.RA.SharePoint.Common.CAMLHelper.General
{
    ...
    {
        public RMRuleItemCollection CheckerCollections { get; set; }
    ...
    public class QueryGroupFactory
    {
        ...
        private RMRuleItemCollection mCheckerCollections;
            ...
            bool mAddCond4TimePoint = true)
        {
            ...
            this.mWssId = wssId;
            this.mAddCond4TimePoint = mAddCond4TimePoint;
        }
        ...
        public QueryGroup GetQueryGroupByRuleCheckerCollection(bool includeRecord = true)
        {
            ...
            if (!mCheckerCollections.HasUnCamlQueryableCondition)
            {
                ...
                foreach (var checker in mCheckerCollections.Rules)
                {
                    ...
                    {
                        if (filter.RuleType == ArchiverFilterRuleType.LastAccessedTime || filter.RuleType == ArchiverFilterRuleType.LastActiveTime || filter.RuleType == ArchiverFilterRuleType.OrphanedFolderRule)
                        {
        ...
        private void AddCommonQueryCondition()
        {
            if (mWssId == 0)
            {
                mCamlGroup.Conditions.Add(QueryConditionFactory.GetTaxonomyQueryCondition(mRMColumnName, Types.JoinTypes.And));
            }
            else
            {
        ...
        private void ProcessFilterCondition(ArchiverRuleFilter filter, ref Query query)
        {
            ...
            switch (filter.Condition)
            {
                ...
                case ArchiverFilterCondition.ListIn:
                    ...
                    query.StrValues = filter.Value1.Split(";", StringSplitOptions.RemoveEmptyEntries);
                    break;
