...
{
    [DataContract]
    public class SOBlobProviderTreeMessage : AveTreeMessage
    {
        [DataMember]
        public List<SOBlobProviderTreeNodeDto> NodeList { get; set; }

        [DataMember]
        public SOBlobProviderTreeNodeDto Node { get; set; }
