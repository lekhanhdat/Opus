...
{
    public class RowKeyConnectorBuildInColumn : IConnectorBuildInColumn
    {
        public Guid ColumnId => CustomizeConnectorBuildColumnIds.RowKey;

        public void ApplyRecordValue(Record record, Dictionary<string, CustomColumn> customColumnDic)
        {
            record.RowKey = customColumnDic[ColumnId.ToString()].Value;
