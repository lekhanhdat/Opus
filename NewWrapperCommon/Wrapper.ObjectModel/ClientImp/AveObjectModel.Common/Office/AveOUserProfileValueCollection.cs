...
namespace AvePoint.ObjectModel.Common.Office
{
    class AveOUserProfileValueCollection :AveClientObject , IAveOUserProfileValueCollection
    {
        ...
        {   
            ...
            if (base.DataCache.IsPropertyAvailable("Value"))
            {
                values = base.DataCache.GetProperty<List<object>>("Value");
            }
        }
        ...
        public IAveOProperty Property
        {
            get 
            {
                if (base.DataCache.IsPropertyNotLoaded("Property"))
                {
                    ...
                    base.DataCache.PropertiesCache["Property"] = property;
                }
        ...
        public object this[int index]
        {
            get
            {
                if (base.DataCache.IsPropertyAvailable("Value"))
                {
                    //AvePoint.ObjectModel.WebService.UserProfileService.ValueData[] values = base.DataCache.GetProperty<AvePoint.ObjectModel.WebService.UserProfileService.ValueData[]>("Value");
                    return values[index];
                }
                return null;
                ...
                //    base.DataCache.PropertiesCache["Value" + index.ToString()] = timeZone;
                //}
