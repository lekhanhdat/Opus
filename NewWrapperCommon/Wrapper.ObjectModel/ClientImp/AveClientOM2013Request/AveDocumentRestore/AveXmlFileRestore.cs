...
{
    // 增加XML文件处理类，目前只有更新逻辑不同，以后可能需要添加替换XML content的逻辑。
    class AveXmlFileRestore : AveOrdinaryFileRestore
    {
        public AveXmlFileRestore(AveClientContext context, AveClientOM2013Request request, object authentication, AveDocumentInfo docInfo, Stream fileStream) : 
