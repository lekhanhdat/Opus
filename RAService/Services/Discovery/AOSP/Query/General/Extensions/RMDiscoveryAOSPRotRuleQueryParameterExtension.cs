...
{
    public static class RMDiscoveryAOSPRotRuleQueryParameterExtension
    {
        public static bool TryGetSqlDefinition(this RMDiscoveryAOSPROTRuleQueryParameter parameter, string dbSchemaName, string dataTableAlias, out RMDiscoverySqlDefinition sqlDefinition)
        {
            sqlDefinition = new();
