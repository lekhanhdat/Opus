...
namespace AvePoint.GCommon.Contract.Tree.Object
{
    ...
    public abstract class AveTreeNodeDto<T> : IAveTreeNodeDto where T : AveTreeNodeDto<T>
    {
        ...
        public string TextNode(string prefix, bool isLastChild)
        {
            ...
            // not log file name, use ID instead
            var nameStr = Level == NodeLevel.Document 
                || Level == NodeLevel.Item 
                || Level == NodeLevel.ItemVersion 
                ? ID : Name;
            textBuilder.Append(prefix + (isLastChild ? "└" : "├") + (CheckNumber == 1 ? "√" : " ") + nameStr + " " + (SelectAll == SelectAllState.Checked ? "SelectAll" : "") + " " + (IncludeNew == IncludeNewState.Checked ? "IncludeNew" : "") + " " + this.Offset + " " + this.StartIndex + " " + this.ChildrenCount + "\r\n");
            if (Children != null)
            {
    ...
    public enum NodeLevel
    {
        ...
        [EnumMember]
        ExchangeOnlineO365GroupGroup = 5030, // 仅用于Mailbox表存储, 不用于Tree节点
        [EnumMember]
        ExchangeOnlineO365Group = 5040, // 仅用于Mailbox表存储, 不用于Tree节点
        ...
        [EnumMember]
        Office365Planner = 6065,

        [EnumMember]
        Office365PlannerPlan = 6066,

        [EnumMember]
        Office365PlannerTask = 6067,

        [EnumMember]
        TeamChannels = 6068,

        [EnumMember]
        YammerGroupContainer = 6070,

        [EnumMember]
        YammerGroup = 6071,

        [EnumMember]
        YammerConversations = 6072,

        [EnumMember]
        YammerConversationItem = 6073,

        [EnumMember]
        Office365UserContainer = 6080,
        ...
        [EnumMember]
        PersonalChatMessage = 6083,

        [EnumMember]
        Office365PowerBIContainer = 6090,

        [EnumMember]
        PowerBIWorkspace = 6091,

        [EnumMember]
        PowerBIReport = 6092,

        [EnumMember]
        PowerAutomateContainer = 6093,

        [EnumMember]
        PowerAutomate = 6094,

        [EnumMember]
        PowerAppsContainer = 6095,
    ...
    public enum NodeType
    {
        ...
        EOO365Group = 922,
        [EnumMember]
        EOItemAttachment = 923,
        [EnumMember]
        EOCalendarEvent = 924,
        //[EnumMember]
        //EOO365FilesFolder = 923,
        //[EnumMember]
        //EOO365MembersFolder = 924,
        //[EnumMember]
        //EOO365OtherFoldersFolder = 925,
        //[EnumMember]
        //EOO365MemberItem = 926,
        ...
        [EnumMember]
        TeamConversations = 932,

        [EnumMember]
        TeamConversation = 933,
        ...
        [EnumMember]
        ChannelConversations = 936,

        [EnumMember]
        ChannelConversation = 937,
        ...
        [EnumMember]
        ChannelReplyMessage = 946,

        #endregion

        #region Chat
        [EnumMember]
        ChatUserContainer = 950,
        [EnumMember]
        ChatUser = 951,
        [EnumMember]
        Chat = 952,
        ...
        [EnumMember]
        PrivateChannelSitesGroup = 1003,
        #endregion

        #region sitecollection type
        [EnumMember]
        ...
        O365GroupSites = 1012,
        [EnumMember]
        PrivateChannelSites = 1013,
        [EnumMember]
        O365TeamSites = 1014,
        #endregion

        [EnumMember]
        Office365GroupEntire = 1100,

        [EnumMember]
        TeamPrivateChannel = 1110,

        [EnumMember]
        TeamSharedChannel = 1111,

        [EnumMember]
        TeamIncomingChannel = 1112,

        EnterpriseProject = 1200,

        [EnumMember]
        SharePointTaskProject = 1201,

        [EnumMember]
        SharedChannelSites = 1203,

        [EnumMember]
        StandardChannelSites = 1204,
        ...
        #region google
        GoogleContainer = 1300,
        GoogleDrive = 1301,
        GoogleMyDrive = 1302,
        GoogleSharedDrive = 1303,
        #endregion
