...
[module: SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Scope = "member", Target = "AvePoint.Media.Storage.XFactory.#CreateXri(System.String,System.Int32,System.String,System.String,System.String,System.String,System.String)", MessageId = "privatekeysecret")]
[module: SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Scope = "member", Target = "AvePoint.Media.Storage.XFactory.#CreateXri(System.String,System.Int32,System.String,System.String,System.String,System.String,System.String)", MessageId = "sftp")]
[module: SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Scope = "member", Target = "AvePoint.Media.Storage.XFactory.#CreateXri(System.String,System.Int32,System.String,System.String,System.String,System.String,System.String)", MessageId = "sftprootfolder")]
[module: SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Scope = "member", Target = "AvePoint.Media.Storage.XFactory.#CreateXri(System.String,System.Int32,System.String,System.String,System.String,System.String,System.String)", MessageId = "privatekeypasswordsecret")]
...
namespace AvePoint.Media.Storage
{
    ...
    {
        static StorageLogger logger = StorageLogger.GetInstance(typeof(XFactory));
        ...
        public static IXSystem InstanceSystem(string xriString)
        {
            xriString = ChangeObjectXRI(xriString);
            XRI xri = XRI.ValueOf(xriString);
            IVIM vim = LoadVIM(xri.VIM);
            IXSystem sys = vim.CreateSystem(xriString, null);
            return sys;
        }

        public static XLibrary InstanceLibrary(List<string> xris)
        {
            XLibrary lib = new XLibrary();
            XRI xri;
            IVIM vim;
            string tmpXri;
            foreach (string xriStr in xris)
            {
                tmpXri = ChangeObjectXRI(xriStr);
                xri = XRI.ValueOf(tmpXri);
                vim = LoadVIM(xri.VIM);
                lib.AddVIM(tmpXri, vim);
            }
            lib.Open();
            return lib;
        }
        ...
        public static string CreateXri(int deviceType, string location, string username, string password, int port, params string[] parameters)
        {
            ...
            {
                case 0://FS
                    xri = string.Format(XConst.MEDIASTORAGE_PROTOCOL + "fs_vim?location={0}&name={1}&secret={2}&" + "IS".ToLower(CultureInfo.InvariantCulture) + "validate=false&creation=true", XRI.ValueEncode(location), XRI.ValueEncode(username), XRI.ValueEncode(password));
                    break;
                //case 1://centera
                //    xri = string.Format(XConst.DOCAVE + "-xam://centera_vim?address={0}&authType=n/sAuth&name={1}&secret={2}", location, username, XRI.ValueEncode(password));
                //    break;
                //case 2://tsm
                //    xri = string.Format(XConst.DOCAVE + "-xam://tsm_vim?commMethod=tcpip&address={0}&port={1}&node={2}&secret={3}", location, port, username, XRI.ValueEncode(SecretUtil.EncryptPassword(password)));
                //    break;
                case 3://ftp
                    xri = string.Format(XConst.MEDIASTORAGE_PROTOCOL + "ftp_vim?host={0}&port={1}&name={2}&secret={3}", XRI.ValueEncode(location), port, XRI.ValueEncode(username), XRI.ValueEncode(password));
                    break;
                //case 4:
                //    break;
                //case 5:
                ...
                //    break;
                default:
                    throw new NotSupportedException("Unknown device type:" + deviceType);
            }
        ...
        public static string CreateXri(string host, int port, string rootFolder, string username, string password, string privateKey, string privateKeyPassword)
        {
            ...
            xri = string.Format(XConst.MEDIASTORAGE_PROTOCOL + "sftp_vim?host={0}&port={1}&name={2}", XRI.ValueEncode(host), port, XRI.ValueEncode(username));
            if (!String.IsNullOrEmpty(password))
            {
                xri = xri + "&secret=" + XRI.ValueEncode(password);
            }
            if (!String.IsNullOrEmpty(rootFolder))
            {
                xri = xri + "&sftprootfolder=" + XRI.ValueEncode(rootFolder);
            }
            else
            {
            ...
            {
                xri = xri + "&privatekeysecret=" + XRI.ValueEncode(privateKey);
            }
            if (!String.IsNullOrEmpty(privateKeyPassword))
            {
                xri = xri + "&privatekeypasswordsecret=" + XRI.ValueEncode(privateKeyPassword);
            }
            return xri;
        }
        
        private static string ChangeObjectXRI(string xri)
        {
            string result = xri;
            if (xri.Contains("StorageType=object".ToLower(CultureInfo.InvariantCulture)))
            {
                result = xri.Replace("atmos_vim", "objectatmos_vim");
            }
            return result;
        }
        ...
        public static string CreateXri(params string[] parameters)
        {
            ...
            switch (deviceType)
            {
                ...
                case 3://centera
                    ...
                    break;
                case 13://NFS
                    xri = string.Format(XConst.MEDIASTORAGE_PROTOCOL + "nfs_vim?location={0}", parameters[2]);
                    break;
                case 5://dell
                ...
                case 405://att
                    ...
                    break;
                case 410://s3compatible
                    xri = string.Format(XConst.MEDIASTORAGE_PROTOCOL + "s3compatible_vim?" + "C".ToLower(CultureInfo.InvariantCulture) + "type={0}&BUCKETNAME={1}&name={2}&secret={3}&endpoint={4}".ToLower(CultureInfo.InvariantCulture), parameters[2], parameters[3], parameters[4], parameters[5], parameters[6]);
                    break;
                default:
                    throw new NotSupportedException("Unknown device type:" + deviceType);
            }
        ...
        #region 快速实例
        public static XLibrary InstanceDemoLibrary()
        {
        ...
        public static XLibrary InstanceDemoLibrary(int deviceType)
        {
            List<string> xris = new List<string>();
            switch (deviceType)
            {
        ...
        public static IXSystem InstanceDemoSystem()
        {
            return null;// InstanceSystem(@"docave-xam://fs_vim?location=\\10.2.6.37\1&name=storage\administrator&secret=" + XRI.ValueEncode(SecretUtil.EncryptPassword("1qaz2wsxE")));
        }

        public static IXSystem InstanceDemoSystem(int deviceType)
        {
            switch (deviceType)
            {
                case 0://fs
        ...
        public class CaseInsensitiveSortMode : IComparer<IXFeature>
        {
            // Calls CaseInsensitiveComparer.Compare with the parameters reversed.
            int IComparer<IXFeature>.Compare(IXFeature x, IXFeature y)
            {
                List<string> jumpQueueList = new List<string> { "FS", "FTP" };
                ...
                return ((new CaseInsensitiveComparer(CultureInfo.InvariantCulture)).Compare(x.Type.Display, y.Type.Display));
            }
        }
        ...
        private static IVIM LoadVIM(string vimName)
        {
            ...
            lock (locker)
            {
                ...
                if (info == null)
                {
                    throw new VIMLoadException("Can not find vim info in Storage.config : " + vimName);
                }
                if ("AvePoint.Media.Storage.NetApp.NetAppVIM".Equals(info.Type, StringComparison.OrdinalIgnoreCase))
                {
                    Assembly ass = XFactory.GetAssembly("netapp_cifs_vim");
                    vim = (IVIM)ass.CreateInstance(info.Type);
                }
                else if ("StorageOptimization.Connector.CloudAdapter.CloudAdapterVIM".Equals(info.Type, StringComparison.OrdinalIgnoreCase))
                {
                    Assembly ass = XFactory.GetAssembly("CloudAdapter_vim".ToLowerInvariant());
                    vim = (IVIM)ass.CreateInstance(info.Type);
                }
                else
                {
                    vim = Activator.CreateInstance(Type.GetType(info.Type)) as IVIM;
                }
                return vim;
            }
        }
        ...
        private static int[] typesSOArchiverSupported;
        private static int[] typesSOExtenderSupported;
        private static int[] typesDPPlatformBackupSupported;
        private static int[] typesDPGranularBackupSupported;
        private static int[] typesComplianceEDiscoverySupported;
        private static int[] typesDPPlatformBackupForSMSPSupported;

        public static int[] GetSupportTypesByJob(JobType job)
        {
            int[] SupportTypesByJob;
            switch (job)
            {
                case JobType.SOArchiver:
                    SupportTypesByJob = TypesSOArchiverSupported;
                    break;
                case JobType.SOExtender:
                    SupportTypesByJob = TypesSOExtenderSupported;
                    break;
                case JobType.DPGranularBackup:
                    SupportTypesByJob = TypesDPGranularBackupSupported;
                    break;
                case JobType.DPPlatformBackup:
                    SupportTypesByJob = TypesDPPlatformBackupSupported;
                    break;
                case JobType.ComplianceEDiscovery:
                    SupportTypesByJob = TypesComplianceEDiscoverySupported;
                    break;
                case JobType.DPPlatformBackupForSMSP:
                    SupportTypesByJob = TypesDPPlatformBackupForSMSPSupported;
                    break;
                default:
                    throw new NotSupportedException("Unknown job type");
            }
            return SupportTypesByJob;
        }
        internal static int[] TypesSOArchiverSupported
        {
            get
            {
                if (typesSOArchiverSupported == null)
                {
                    typesSOArchiverSupported = new int[]{ 
                        (int)DeviceIndex.FS, 
                        (int)DeviceIndex.IBMStorwizeFamily,
                        (int)DeviceIndex.FTP, 
                        (int)DeviceIndex.TSM, 
                        (int)DeviceIndex.EMCCentera, 
                        (int)DeviceIndex.Cloud, 
                        (int)DeviceIndex.Amazon, 
                        (int)DeviceIndex.Rackspace, 
                        (int)DeviceIndex.Azure, 
                        (int)DeviceIndex.Atmos, 
                        (int)DeviceIndex.Att, 
                        (int)DeviceIndex.HDS, 
                        (int)DeviceIndex.Dropbox,
                        (int)DeviceIndex.DELLDXStorage, 
                        (int)DeviceIndex.NetApp, 
                        (int)DeviceIndex.LUN, 
                        (int)DeviceIndex.CIFS, 
                        (int)DeviceIndex.CARINGOStorage, 
                        (int)DeviceIndex.Box, 
                        (int)DeviceIndex.GoogleDrive, 
                        (int)DeviceIndex.SkyDrive,
                        (int)DeviceIndex.IBMElasticStorage,
                        (int)DeviceIndex.S3Compatible
                        };
                }
                return typesSOArchiverSupported;
            }
        }

        internal static int[] TypesSOExtenderSupported
        {
            get
            {
                if (typesSOExtenderSupported == null)
                {
                    ...
                    typesSOExtenderSupported = new int[] { 
                            (int)DeviceIndex.FS, 
                            (int)DeviceIndex.IBMStorwizeFamily,
                            (int)DeviceIndex.EMCCentera, 
                            (int)DeviceIndex.Cloud, 
        ...
        internal static int[] TypesDPPlatformBackupSupported
        {
            get
            {
                if (typesDPPlatformBackupSupported == null)
                {
                    typesDPPlatformBackupSupported = new int[] { 
                            (int)DeviceIndex.FS, 
                            (int)DeviceIndex.IBMStorwizeFamily,
                            (int)DeviceIndex.FTP, 
                            (int)DeviceIndex.TSM, 
                ...
                return typesDPPlatformBackupSupported;
            }
        }

        internal static int[] TypesDPPlatformBackupForSMSPSupported
        {
            get
            {
                if (typesDPPlatformBackupForSMSPSupported == null)
                {
                    typesDPPlatformBackupForSMSPSupported = new int[] { 
                            (int)DeviceIndex.NetApp, 
                            (int)DeviceIndex.LUN, 
                            (int)DeviceIndex.CIFS, 
                        };
                }
                return typesDPPlatformBackupForSMSPSupported;
            }
        }

        internal static int[] TypesDPGranularBackupSupported
        {
            get
            {
                if (typesDPGranularBackupSupported == null)
                {
                    typesDPGranularBackupSupported = new int[] { 
                            (int)DeviceIndex.FS, 
                            (int)DeviceIndex.IBMStorwizeFamily,
                            (int)DeviceIndex.FTP, 
                            (int)DeviceIndex.TSM, 
                ...
                return typesDPGranularBackupSupported;
            }
        }

        internal static int[] TypesComplianceEDiscoverySupported
        {
            get
            {
                if (typesComplianceEDiscoverySupported == null)
                {
                    typesComplianceEDiscoverySupported = new int[] { 
                            (int)DeviceIndex.FS, 
                            (int)DeviceIndex.IBMStorwizeFamily,
                            (int)DeviceIndex.EMCCentera, 
                            (int)DeviceIndex.DELLDXStorage, 
                ...
                return typesComplianceEDiscoverySupported;
            }
        }
    ...
    public interface IResourceProvider<T, TK> // TODO 看代码中只有centera使用了这个接口，应该可以去掉
    {
    ...
    public class ResourceTag<T> // TODO 看代码中只有centera使用了这个接口，应该可以去掉
    {
        private T resource;
        private bool inUse;
