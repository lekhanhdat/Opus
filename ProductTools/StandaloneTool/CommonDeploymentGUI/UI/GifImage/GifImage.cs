...
namespace AvePoint.Deployment.CommonGUI
{
    ...
    public class GifImage : System.Windows.Controls.UserControl
    {
        ...
        public static readonly DependencyProperty ForceGifAnimationProperty = DependencyProperty.Register("ForceGifAnimation", typeof(bool), typeof(GifImage), new FrameworkPropertyMetadata(false));
        public bool ForceGifAnimation
        {
            get
            {
                return (bool)this.GetValue(ForceGifAnimationProperty);
            }
            set
            {
                this.SetValue(ForceGifAnimationProperty, value);
            }
        }
