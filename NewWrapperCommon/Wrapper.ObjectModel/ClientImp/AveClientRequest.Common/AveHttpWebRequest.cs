...
namespace AveClientRequest.Common
{
    ...
    public class AveHttpWebRequest : WebRequest
    {
        ...
        public AveHttpWebRequest(HttpWebRequest webRequest, DataMonitor dataMonitor)
        {
            ...
            m_HttpWebRequest.Timeout = WrapperConfiguration.BPOS_S.HttpWebRequestTimeout;
            m_HttpWebRequest.ReadWriteTimeout = WrapperConfiguration.BPOS_S.HttpWebRequestReadWriteTimeout;
        ...
        public bool AllowAutoRedirect
        {
            get 
            {
                return this.m_HttpWebRequest.AllowAutoRedirect;
            }
            set
            {
                this.m_HttpWebRequest.AllowAutoRedirect = value;
            }
        }
    }
}
