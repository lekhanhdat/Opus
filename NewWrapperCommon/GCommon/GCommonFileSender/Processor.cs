...
namespace AvePoint.GCommon.FileTransfer
{
    ...
    internal class Processor : IGeneralOutputStream
    {
        ...
        IGeneralOutputStream topStream;
        ...
        private readonly AveDataBlockQueue dataBlockInputQueue;
        private readonly BlockSender dataBlockSender;
        private AveDataBlock sendingBlock;
        ...
        public void Start(string jobId = "")
        {
            ...
            processThread = new Thread(Process) { IsBackground = true, Name = currentThreadId + "_Processor" };
        ...
        private void Process(object o = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                logger.Error(CommonResources.ProcessorProcessErrorOccurred, ex.ToString());
        ...
        protected void RealWrite(byte[] buf, int offset, int length, AveDataBlockType currentBlockType)
        {
            ...
            if (length > 0)
            {
                if (sendingBlock != null) sendingBlock.AppendBuffer(buf, offset, length);
            }
        }
