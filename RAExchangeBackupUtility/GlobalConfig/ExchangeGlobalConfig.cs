...
namespace ExchangeUtility
{
    public class ExchangeGlobalConfig
    {
        static ExchangeGlobalConfig()
        {
            try
            {
                ProductVersion = ServiceVersionHelper.GetVersion(true).ProductVersion;
            }
        ...
        //WARN: enable trace log will write log to RALogger
        public static bool EnableTraceLog { get; set; }
