...
{
    public class HoldByQueryBuilder : BaseArrayFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && filterOption.HoldBy != null && filterOption.HoldBy.Count > 0;
        }
        ...
        {
            return Contract.TemplateManagement.QueryCloumnIds.HoldBy;
        }

        protected override string GetFilterColumnName()
        {
            return CosmosConst.C_HoldBy;
        }

        protected override object GetFilterValue(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption.HoldBy.Select(o => o.UserPrincipalName).ToList();
        }
    }
}
