...
namespace AvePoint.Item.Restore
{
    ...
    public class AveItemRestoreReport : IAveRestoreReport, IDisposable
    {
        #region Properties
        private readonly AveLogger log = AveLogger.GetInstance(typeof(AveItemRestoreReport));
        ...
        public void Init(ItemRestoreConfig config)
        {
            //Config = config;
