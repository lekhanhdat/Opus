...
{
    class AveProjectStageCustomField : AveClientObject, IAveProjectStageCustomField
    {
        private IAveRequest mRequest;

        public AveProjectStageCustomField(IAveRequest request, Dictionary<string, object> prop)
        {
