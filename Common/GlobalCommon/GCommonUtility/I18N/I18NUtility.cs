...
namespace AvePoint.GCommon.Utility.I18N
{
    ...
    public class I18NUtility
    {
        ...
        public static string curCulture
        {
            get
            {
                if (string.IsNullOrEmpty(TenantThreadLocalValue.CurrentCulture))
                {
                    TenantThreadLocalValue.CurrentCulture = "en-US";
                    if (systemOptionService != null)
                    {
                        TenantThreadLocalValue.CurrentCulture = systemOptionService.GetCurrentLanguageCulture();
                    }
                }
                return TenantThreadLocalValue.CurrentCulture;
            }
        }
