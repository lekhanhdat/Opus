...
{
    [DataContract]
    public class RMDiscoveryAOSPSizeRangeQueryParameter
    {
        [DataMember]
        [JsonProperty("queryMode")]
        public RMDiscoveryAOSPSizeRangeQueryMode QueryMode { get; set; }
        [DataMember]
    ...
    [DataContract]
    public enum RMDiscoveryAOSPSizeRangeQueryMode
    {
        [EnumMember]
        None = 0,
        [EnumMember]
