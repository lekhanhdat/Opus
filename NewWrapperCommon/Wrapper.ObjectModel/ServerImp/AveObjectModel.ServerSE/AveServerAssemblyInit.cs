...
namespace AvePoint.ObjectModel.ServerSE
{
    class AveServerAssemblyInit
    {
        ...
        private const string mAveTypeNamePro = "AvePoint.ObjectModel.ServerSE.Ave";
        private const string mAveOffcieTypeNamePro = "AvePoint.ObjectModel.ServerSE.Office.Ave";
