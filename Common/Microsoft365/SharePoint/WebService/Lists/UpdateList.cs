...
namespace Microsoft365.SharePoint.WebService.Lists
{
    ...
    public class UpdateList : ISoapHttpRequest
    {
        ...
        [XmlElement(ElementName = "listProperties")]
        public XmlNode ListProperties { get; set; }
        ...
        [XmlIgnore]
        public string SoapAction => "http://schemas.microsoft.com/sharepoint/soap/UpdateList";
