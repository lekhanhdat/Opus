...
{
    public class RMEXOApplySettingFullJob : RMEXOApplySettingBase
    {
        public RMEXOApplySettingFullJob(RMExchangeOnlineSetting setting, ExchangeOnlineTreeNodeDto treeNode, JobManagement jobManagement) : base(setting, treeNode, jobManagement)
        {
        }
        ...
        {
            //Full job need to set syncstate to string.empty
            return GetSubItemsAsync(folder, string.Empty).GetConsumingEnumerable();
        }
    }
}
