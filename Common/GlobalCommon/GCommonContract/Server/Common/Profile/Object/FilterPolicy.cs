        ...
        public override bool Equals(object obj)
        {
            ...
            else
            {
                ...
                if (this.Condition == _TimeFilter.Condition && this.EndTime == _TimeFilter.EndTime && this.BeginTime == _TimeFilter.BeginTime
                    && ((this.TimeSpan == _TimeFilter.TimeSpan) || Math.Abs(this.TimeSpan - _TimeFilter.TimeSpan) < 1E-06) && this.Unit == _TimeFilter.Unit && this.Include ==_TimeFilter.Include 
    ...
    public class NumberFilter : BaseFilter
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            else
            {
                ...
                if (this.Condition == _NumberFilter.Condition && ((this.Criteria == _NumberFilter.Criteria) || Math.Abs(this.Criteria - _NumberFilter.Criteria) < 1E-06) && this.Unit == _NumberFilter.Unit
