...
namespace AvePoint.ObjectModel.Common
{
    ...
    public partial class AveSiteService : AveSoapHttpClientProtocol
    {
        ...
        protected override System.Net.WebRequest GetWebRequest(Uri uri)
        {
            ...
            {
                webrequest = new Wrapper.Common.ReconnectableHttpWebRequest(webrequest as HttpWebRequest);
            }
        ...
        public string GetUpdatedFormDigestInformation(string url)
        {
            object[] results = this.Invoke("GetUpdatedFormDigestInformation", new object[]{url});
            return ((string)(results[0]));
        }
    }
}
