...
{
    public interface IMMPlatformEncryptionService
    {
        String GetEncryptionInfo(PlatformRestoreRequest request);

        String GetEncryptionInfoExtender(PlatformBackupRequest request);
    }
}
