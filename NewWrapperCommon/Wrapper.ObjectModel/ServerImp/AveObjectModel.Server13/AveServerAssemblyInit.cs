...
namespace AvePoint.ObjectModel.Server13
{
    class AveServerAssemblyInit
    {
        ...
        private const string mAveOffcieTypeNamePro = "AvePoint.ObjectModel.Server13.Office.Ave";

        public static void LoadAssembly()
        {
            AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.SharePoint, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
            AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.SharePoint.Search, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
            AveAssemblyUtility.AddTypeSearchAssembly(Assembly.LoadFile(System.Environment.GetEnvironmentVariable("CommonProgramFiles") + @"\Microsoft Shared\Web Server Extensions\15\CONFIG\BIN\Microsoft.SharePoint.ApplicationPages.dll"));
            //由于2013 Foundation中也添加了Search Service，所以需要Load该Dll，07和10均无需Load。
            AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.Office.Server.Search, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
            if (WrapperRuntime.CurrentContext.IsMoss)
            {
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.SharePoint.Portal, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.SharePoint.Taxonomy, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.SharePoint.Publishing, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.Office.InfoPath.Server, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.Office.DocumentManagement, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.Office.Server, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.Office.Policy, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.Office.Server.UserProfiles, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
                AveAssemblyUtility.AddTypeSearchAssembly(Assembly.Load("Microsoft.SharePoint.WorkflowServices, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c"));
