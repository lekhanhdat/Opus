...
namespace AvePoint.GCommon.MicroKernel
{
    ...
    {
        static readonly IIocContainerAnalyzer containerAnalyzer;
        ...
        public override T Discover<T>(String requestObjectId)
        {
            ...
            return (T)containerAnalyzer.ResolveById(requestObjectId);
        }
        ...
        public override Object Discover(String requestObjectId)
        {
            ...
            return containerAnalyzer.ResolveById(requestObjectId);
        }
