...
const AnalysisConfigurationRotComponent = ({ info, hasJob, onChange }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        onValidate: () => {
            ...
            if (info.enable) {
                if (
                    info.redundantRules.every((i) => !i.isEnable) &&
                    info.obsoleteRules.every((i) => !i.isEnable) &&
                    info.trivialRules.every((i) => !i.isEnable)
                ) {
    ...
    return (
        <div className="reco-analysis-configurator-rot-definition">
            ...
            <div style={{ display: info.enable ? "block" : "none" }}>
                ...
                >
                    <R.TabPanel
                        tab={RMResx.RM_FA_Discovery_ROTConfig_RedundantTab}
                        aria-label={
                            RMResx.RM_FA_Discovery_ROTConfig_RedundantTab
                        }
                    >
                        <RuleCategoryInfoesManager
                            supportAnalyseMethods={[
                                AnalyseMethodConstants.type.FSDocument,
                            ]}
                            ruleCategoryInfoes={info.redundantRules}
                            onChange={(value) =>
                    ...
                    <R.TabPanel
                        tab={RMResx.RM_FA_Discovery_ROTConfig_ObsoleteTab}
                        aria-label={
                            RMResx.RM_FA_Discovery_ROTConfig_ObsoleteTab
                        }
                    >
                        <RuleCategoryInfoesManager
                            supportAnalyseMethods={[
                            ...
                            ruleCategoryInfoes={info.obsoleteRules}
                            onChange={(value) =>
                                onRuleCategoryInfoesChange(
                                    "obsoleteRules",
                                    value
                    ...
                    <R.TabPanel
                        tab={RMResx.RM_FA_Discovery_ROTConfig_TrivialTab}
                        aria-label={RMResx.RM_FA_Discovery_ROTConfig_TrivialTab}
                    >
                        <RuleCategoryInfoesManager
                            supportAnalyseMethods={[
                                AnalyseMethodConstants.type.FSDocument,
                            ]}
                            ruleCategoryInfoes={info.trivialRules}
                            onChange={(value) =>
                                onRuleCategoryInfoesChange(
                                    "trivialRules",
                                    value
