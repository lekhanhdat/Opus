...
namespace AvePoint.Media.Service.DomainModel
{
    ...
    using GCommon.Contract.Server.ControlPanel.Cryptography.Wrapper;
    using Newtonsoft.Json;
    using System;
    using System.Runtime.Serialization;
    #endregion

    public abstract class RestoreJobBase
        : IRestoreJob
    {
        ...
        public bool IsAdvancedRestore => JobType == JobType.StubArchiverRestore || JobType == JobType.M365InPlaceArchiverRestore;
    }
}