...
{
    internal class CollectionOperationGeneratorRemoveValue : CollectionOperationGenerator
    {

        public CollectionOperationGeneratorRemoveValue(CollectionAvailableOperation availableOperation) : base(availableOperation)
        {
            ClassName = "#CollectionOperationItemRemoveByValue";
            InputCollectionDescription = "The collection variable to remove items from.";
            OutputCollectionDescription = "Collection variable to store the collection with the items removed.";
            ActionName = "Remove Value from Collection";
        }
        ...
        public override Image CreateImage()
        {
            return new Image
            {
                Src = "ext/workflowDesigner/Img/icons/NW2013_Action_IconMap.png?noCache=1469150084681",
                ClassName = "#CollectionOperationItemRemoveByValue",
                x49x49 = 196,
                y49x49 = 474,
                x30x30 = 196,
        ...
        public override List<Property> GenerateProperties(NintexWFActionProcessor nintexWorkflowActionProcessor, NWActionConfig config)
        {
            ...
            {
                ID = "CollectionOperationItemRemoveByValue",
