...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldCalculated : AveField, IAveFieldCalculated
    {
        ...
        public AveFieldCalculated(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, Dictionary<string, object> contentTypeProp, Dictionary<string, object> prop)
        ...
        public AveDateTimeFieldFormatType DateFormat
        {
            get
            {
                return base.DataCache.GetProperty<AveDateTimeFieldFormatType>("DateFormat");
            }
            set
            {
                base.DataCache.AddChangedProperty("DateFormat", (int)value);
            }
        }
        ...
        public AveFieldType OutputType
        {
            get
            {
                return base.DataCache.GetProperty<AveFieldType>("OutputType");
            }
            set
            {
                base.DataCache.AddChangedProperty("OutputType", (int)value);
            }
        }
        ...
        public int CurrencyLocaleId
        {
            get
            {
                return base.DataCache.GetProperty<int>("CurrencyLocaleId");
            }
            set
            {
                base.DataCache.AddChangedProperty("CurrencyLocaleId", value);
            }
        }
        ...
        public string FieldRefsXml
        {
            get
            {
                return base.DataCache.GetProperty<String>("FieldRefsXml");
            }
            set
            {
                base.DataCache.AddChangedProperty("FieldRefsXml", value);
            }
        }
