...
{
    [DataContract]
    public class RMDiscoveryGoogleConfigurationInfo
    {
        [DataMember]
        [JsonProperty("scopeInfo")]
        public RMDiscoveryGoogleScopeInfo ScopeInfo { get; set; } = new();
        ...
        public RMDiscoveryGoogleRotDefinition RotDefinition { get; set; } = new();
    }
}
