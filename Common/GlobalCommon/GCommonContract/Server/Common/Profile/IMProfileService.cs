...
namespace AvePoint.GCommon.Contract.Server.Common.Profile
{
    ...
    public interface IMProfileService
    {
        ...
        [OperationContract]
        List<ProfileDto> GetByTypeOnSystem(ProfileType type);
        [OperationContract]
        ...
        [OperationContract]
        ProfileDto GetByProfileNameOnSystem(string profileName, ProfileType type);
        [OperationContract]
        bool IsNameExistByParentId(String parentId, String name);
        [OperationContract]
        bool IsNameExist(int type, string name);
        [OperationContract]
        bool IsNameExistOnSystem(int type, string name);
        [OperationContract]
        bool IsNameExist(int type, string name, string excludeId);
        [OperationContract]
        T GetProfileExtensionByType<T>(int type);
    }
}
