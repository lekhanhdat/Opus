...
namespace AvePoint.ObjectModel.Common
{
    ...
    {
        internal AveChange(IDictionary<string, object> changeProperties)
        {
        ...
        public IAveChangeToken ChangeToken
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("ChangeToken") && base.DataCache.IsPropertyAvailable("ChangeToken" + AveObjectModelConstant.ObjectPropertySuffix))
                {
                    string stringValue = base.DataCache.GetPropertyWithoutChange("ChangeToken" + AveObjectModelConstant.ObjectPropertySuffix).ToString();
                    base.DataCache.AddProperty("ChangeToken",new AveChangeToken(stringValue));
                }
                return base.DataCache.GetProperty<IAveChangeToken>("ChangeToken");
            }
        }
