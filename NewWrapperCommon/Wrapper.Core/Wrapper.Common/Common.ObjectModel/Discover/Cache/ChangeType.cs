...
namespace AvePoint.Wrapper.Common
{
    ...
    internal static class NativeChangeTypeExtension
    {
        /// <summary>
        /// If the project contains this method is upgraded to .Net 4.0+, remove this method and use the following:
        /// https://msdn.microsoft.com/en-us/library/system.enum.hasflag(v=vs.100).aspx
        /// </summary>
        /// <param name="self"></param>
        /// <param name="flag"></param>
        /// <returns></returns>
        public static bool HasFlag(this NativeChangeType self, NativeChangeType flag)
        {
            return (self & flag) != 0;
        }
    }
