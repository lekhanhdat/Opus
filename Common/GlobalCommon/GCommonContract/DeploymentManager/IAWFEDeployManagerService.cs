...
namespace AvePoint.GCommon.Contract.DeploymentManager
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IAWFEDeployManagerService
    {
        /// <summary>
        ...
        /// <returns></returns>
        [OperationContract]
        ReturnResult ProcessMessage(WFEDMMessage message);
        ...
        [OperationContract]
        ReturnResult ProcessMessageFromPrimaryAgent(WFEDMMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult HandleMessageFromServerForMonitorJob(WFEDMMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult HandleMessageFromAgentForMonitorJob(WFEDMMessage message);
    }
