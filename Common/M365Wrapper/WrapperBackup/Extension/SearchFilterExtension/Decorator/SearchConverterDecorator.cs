...
{
    internal abstract class SearchConverterDecorator : ISearchConverter
    {
        protected readonly ISearchConverter _inner;

        protected SearchConverterDecorator(ISearchConverter inner)
        {
            _inner = inner;
        }
