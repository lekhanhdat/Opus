...
namespace AvePoint.GCommon.Contract.Server.GranularRestore.Object
{
    ...
    public class BackupDataFilterDto
    {
        /// <summary>
        /// Key:FarmName, Value:PlanId的集合。注释：需要根据Farm和PlanId过滤记录情况下使用。
        /// </summary>
        [DataMember]
        public Dictionary<string, List<string>> FarmAndPlanIds { get; set; }
        ...
        [DataMember]
        public List<BackupLevel> BackupLevels { get; set; }
