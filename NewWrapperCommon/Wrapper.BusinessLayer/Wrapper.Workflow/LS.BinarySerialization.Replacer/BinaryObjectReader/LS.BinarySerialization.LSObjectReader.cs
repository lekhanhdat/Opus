...
{
    public sealed class LSObjectReader
    {
        ...
        internal Object TopObject
        {
            ...
            set
            {
                ...
                if (m_objectManager != null)
                {
                    ...
                    LSInvoker.SetProperty(m_objectManager, "TopObject", value);
                    //
                }
            }
        }
        ...
        public LSObjectReader(Stream stream, ISurrogateSelector selector, StreamingContext context, InternalFE formatterEnums, SerializationBinder binder)
        {
            if (stream == null)
            {
                throw new ArgumentNullException("stream", LSEnvironment.GetResourceString("ArgumentNull_Stream"));
            }
            ...
            if (m_binder != null)
            {
                TypeLimitingDeserializationBinder tldBinder = m_binder as TypeLimitingDeserializationBinder;
                if (tldBinder != null)
        ...
        internal ObjectManager CallSecondCstr(ISurrogateSelector selector, StreamingContext context, bool checkSecurity, bool isCrossAppDomain)
        {
            BindingFlags flags = BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic;
            ConstructorInfo[] cstrs = typeof(ObjectManager).GetConstructors(flags);
            ...
            return (ObjectManager)cstr.Invoke(new object[] { selector, context, checkSecurity, isCrossAppDomain });

        }

        internal Object Deserialize(HeaderHandler handler, LSBinaryParser serParser, bool fCheck, bool isCrossAppDomain, IMethodCallMessage methodCallMessage)
        {
#if _DEBUG 
            ...
            if (serParser == null)
                throw new ArgumentNullException("serParser", String.Format(CultureInfo.CurrentCulture, LSEnvironment.GetResourceString("ArgumentNull_WithParamName"), serParser));
            ...
            if (fCheck)
            {
                try
                {
                    ...
                    Type typeofCodeAccessPermission = Type.GetType("System.Security.CodeAccessPermission");
                    Type typeofPermissionType = Type.GetType("System.Security.PermissionType");
                    object typeofPermissionTypeValue = Enum.ToObject(typeofPermissionType, (int)PermissionType.SecuritySerialization);
                    LSInvoker.CallStaticMethod(typeofCodeAccessPermission, "DemandInternal", new Type[] { typeofPermissionType }, new object[] { typeofPermissionTypeValue });
                    //
                }
                catch (Exception e)
                {
                    log.Log(AveLogLevel.DEBUG, "An error occurred while de-serializing, error message: {0}", e);
            ...
            if (bFullDeserialization)
            {
                ...
                m_objectManager = CallSecondCstr(m_surrogates, m_context, false, bIsCrossAppDomain);
                //
            ...
            {
                if (TopObject == null)
                    throw new SerializationException(LSEnvironment.GetResourceString("Serialization_TopObject"));
            ...
            //ls.SerTrace.Log(this, "Deserialize Exit ", TopObject);
            ...
            if (bMethodCall)
            {
                ...
                //ls.TopObject = binaryMethodCall.ReadArray(methodCallArray, handlerObject);
            }
            else if (bMethodReturn)
            {
                Object[] methodReturnArray = TopObject as Object[];
                //ls.TopObject = binaryMethodReturn.ReadArray(methodReturnArray, methodCallMessage, handlerObject);
            }
            */
            #endregion
        ...
        private void CheckSerializable(Type t)
        {
            if (!t.IsSerializable && !HasSurrogate(t))
                throw new SerializationException(String.Format(CultureInfo.InvariantCulture, LSEnvironment.GetResourceString("Serialization_NonSerType"),
        ...
        {
            //ls.BCLDebug.Assert((index < crossAppDomainArray.Length),
        ...
        //internal object CreateReadObjectInfo(Type objectType)
        //{

        //    object objectInfo = LSInvoker.CallStaticMethod(Type.GetType("System.Runtime.Serialization.Formatters.Binary.ReadObjectInfo"), "Create",
        //        new Type[] { typeof(Type), typeof(ISurrogateSelector), typeof(StreamingContext), typeof(ObjectManager), serObjectInfoInit.ParentType, typeof(IFormatterConverter), typeof(bool) },
        //        new object[] { objectType, m_surrogates, m_context, m_objectManager, serObjectInfoInit.parentObject, m_formatterConverter, bSimpleAssembly });
        //    return objectInfo;
        //}

        //internal object CreateReadObjectInfo(Type objectType, string[] memberNames, Type[] memberTypes)
        //{
        //    //Type typeofReadObjectInfo = Type.GetType("System.Runtime.Serialization.Formatters.Binary.ReadObjectInfo");
        //    object objectInfo = LSInvoker.CallStaticMethod(Type.GetType("System.Runtime.Serialization.Formatters.Binary.ReadObjectInfo"), "Create",
        //        new Type[] { typeof(Type), typeof(string[]), typeof(Type[]), typeof(ISurrogateSelector), typeof(StreamingContext), typeof(ObjectManager), serObjectInfoInit.ParentType, typeof(IFormatterConverter), typeof(bool) },
        //        new object[] { objectType, memberNames, memberTypes, m_surrogates, m_context, m_objectManager, serObjectInfoInit, m_formatterConverter, bSimpleAssembly });
        //    return objectInfo;
        //}
        ...
        internal void Parse(ParseRecord pr)
        {
            ...
            pr.Dump();
                ...
                switch (pr.PRparseTypeEnum)
                {
                    ...
                    default:
                        throw new SerializationException(String.Format(CultureInfo.CurrentCulture, LSEnvironment.GetResourceString("Serialization_XMLElement"), pr.PRname));

                }
            }
            catch (Exception e)
            {
                log.Log(AveLogLevel.DEBUG, WrapperWorkflowResource.FindEnumTypeFaild, e.ToString());
...
#endif
            throw new SerializationException(String.Format(CultureInfo.CurrentCulture, LSEnvironment.GetResourceString("Serialization_ParseError"), onStack.PRname + " " + ((Enum)onStack.PRparseTypeEnum) + " " + processing.PRname + " " + ((Enum)processing.PRparseTypeEnum)));
        }
        ...
        [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "Serialization_MBRAsMBV is a key")]
            ...
            if (t != null)
            {
                if (IsRemoting)
                {
                    if (typeof(MarshalByRefObject).IsAssignableFrom(t))
                        throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, LSEnvironment.GetResourceString("Serialization_MBRAsMBV"), t.FullName));
        ...
        private void ParseObject(ParseRecord pr)
        {
            ...
            if (pr.PRnewObj == null)
                throw new SerializationException(String.Format(CultureInfo.CurrentCulture, LSEnvironment.GetResourceString("Serialization_TopObjectInstantiate"), pr.PRdtType));
            ...
            if (pr.PRobjectInfo == null)
                pr.PRobjectInfo = CreateReadObjectInfo(pr.PRdtType);
            CheckSecurity(pr);
        ...
        {
            //ls.SerTrace.Log(this, "ParseArray Entry");

            long genId = pr.PRobjectId;

            if (pr.PRarrayTypeEnum == InternalArrayTypeE.Base64)
            {
                //ls.SerTrace.Log(this, "ParseArray bin.base64 ", pr.PRvalue.Length, " ", pr.PRvalue);
                // ByteArray 
                ...
                if (stack.Peek() == pr)
                {
                    //ls.SerTrace.Log(this, "ParseArray, bin.base64 has been stacked");
                    stack.Pop();
                }
                if (pr.PRobjectPositionEnum == InternalObjectPositionE.Top)
                {
                ...
                //ls.SerTrace.Log(this, "ParseArray  RegisterObject ", pr.PRobjectId, " ", pr.PRnewObj.GetType());
            ...
            else if ((pr.PRarrayTypeEnum == InternalArrayTypeE.Jagged) || (pr.PRarrayTypeEnum == InternalArrayTypeE.Single))
            {
                ...
                //ls.SerTrace.Log(this, "ParseArray Before Jagged,Simple create ", pr.PRarrayElementType, " ", pr.PRlengthA[0]);
                ...
                //ls.SerTrace.Log(this, "ParseArray Jagged,Simple Array ", pr.PRnewObj.GetType());

                // For binary, headers comes in as an array of header objects 
                if (pr.PRobjectPositionEnum == InternalObjectPositionE.Headers)
                {
                    //ls.SerTrace.Log(this, "ParseArray header array");
            ...
            else if (pr.PRarrayTypeEnum == InternalArrayTypeE.Rectangular)
            {
                ...
                //ls.SerTrace.Log(this, "ParseArray Rectangle Array ", pr.PRnewObj.GetType(), " lower Bound ", pr.PRisLowerBound);
                ...
                throw new SerializationException(String.Format(CultureInfo.CurrentCulture, LSEnvironment.GetResourceString("Serialization_ArrayType"), ((Enum)pr.PRarrayTypeEnum)));

            CheckSecurity(pr);
            //ls.SerTrace.Log(this, "ParseArray Exit");
        }
        ...
        {
            //ls.SerTrace.Log(this, "ParseArrayMember Entry");
            ParseRecord objectPr = (ParseRecord)stack.Peek();
            ...
            if (pr.PRmemberValueEnum == InternalMemberValueE.Reference)
            {
                ...
                if (refObj == null)
                {
                    ...
                    //ls.SerTrace.Log(this, "ParseArrayMember RecordArrayElementFixup objectId ", objectPr.PRobjectId, " idRef ", pr.PRidRef);
            ...
            else if (pr.PRmemberValueEnum == InternalMemberValueE.Nested)
            {
                ...
                //ls.SerTrace.Log(this, "ParseArrayMember Nested ");
                if (pr.PRdtType == null)
                {
            ...
            else if (pr.PRmemberValueEnum == InternalMemberValueE.InlineValue)
            {
                ...
                else if (objectPr.PRisArrayVariant)
                {
                    ...
                    if (pr.PRkeyDt == null)
                        throw new SerializationException(LSEnvironment.GetResourceString("Serialization_ArrayTypeObject"));
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //ls.SerTrace.Log(this, "ParseArrayMember SetValue Primitive pr.PRvalue " + var, " elementTypeCode ", ((Enum)objectPr.PRdtTypeCode));
                        ...
                        if (objectPr.PRobjectA != null)
                        {
                            //ls.SerTrace.Log(this, "ParseArrayMember SetValue Primitive predefined array " + objectPr.PRobjectA.GetType());
                            objectPr.PRobjectA[objectPr.PRindexMap[0]] = var;
                        }
                        else
                            ((Array)objectPr.PRnewObj).SetValue(var, objectPr.PRindexMap); // Primitive type 
                        //ls.SerTrace.Log(this, "ParseArrayMember SetValue Primitive after");
                    }
                }
            }
            else if (pr.PRmemberValueEnum == InternalMemberValueE.Null)
            {
                //ls.SerTrace.Log("ParseArrayMember Null item ", pr.PRmemberIndex, " nullCount ", pr.PRnullCount);
            ...
            //ls.SerTrace.Log("ParseArrayMember Exit");
        }

        private void ParseArrayMemberEnd(ParseRecord pr)
        {
            //ls.SerTrace.Log(this, "ParseArrayMemberEnd");
        ...
        {
            //ls.SerTrace.Log(this, "ParseMember Entry ");
            ...
            {
                //ls.SerTrace.Log(this, "ParseMember pr.PRdtType null and not isSi");
            ...
            {
                // Value is Null 
                //ls.SerTrace.Log(this, "ParseMember null member: ", pr.PRname);
                //ls.SerTrace.Log(this, "AddValue 1");
                objectPr.PRobjectInfo.AddValue(pr.PRname, null, ref objectPr.PRsi, ref objectPr.PRmemberData);
            }
            else if (pr.PRmemberValueEnum == InternalMemberValueE.Nested)
            {
                //ls.SerTrace.Log(this, "ParseMember Nested Type member: ", pr.PRname, " objectPr.PRnewObj ", objectPr.PRnewObj);
                ParseObject(pr);
                stack.Push(pr);
                //ls.SerTrace.Log(this, "AddValue 2 ", pr.PRnewObj, " is value type ", pr.PRnewObj.GetType().IsValueType);

                if ((pr.PRobjectInfo != null) && (pr.PRobjectInfo.objectType != null) && (pr.PRobjectInfo.objectType.IsValueType))
                {
                    //ls.SerTrace.Log("ParseMember ValueType ObjectPr ", objectPr.PRnewObj, " memberName  ", pr.PRname, " nested object ", pr.PRnewObj);
                    pr.PRisValueTypeFixup = true; //Valuefixup
                    ValueFixupStack.Push(new ValueFixup(objectPr.PRnewObj, pr.PRname, objectPr.PRobjectInfo));//valuefixup
                }
                else
                {
                    //ls.SerTrace.Log(this, "AddValue 2A ");
            ...
            {
                //ls.SerTrace.Log(this, "ParseMember Reference Type member: ", pr.PRname);
                // See if object has already been instantiated 
                Object refObj = m_objectManager.GetObject(pr.PRidRef);
                if (refObj == null)
                {
                    //ls.SerTrace.Log(this, "ParseMember RecordFixup: ", pr.PRname);
                    //ls.SerTrace.Log(this, "AddValue 3");
                    objectPr.PRobjectInfo.AddValue(pr.PRname, null, ref objectPr.PRsi, ref objectPr.PRmemberData);
                    objectPr.PRobjectInfo.RecordFixup(objectPr.PRobjectId, pr.PRname, pr.PRidRef); // Object not instantiated
                }
                else
                {
                    //ls.SerTrace.Log(this, "ParseMember Referenced Object Known ", pr.PRname, " ", refObj);
                    //ls.SerTrace.Log(this, "AddValue 5");
            ...
            else if (pr.PRmemberValueEnum == InternalMemberValueE.InlineValue)
            {
                ...
                //ls.SerTrace.Log(this, "ParseMember primitive or String member: ", pr.PRname);

                if (pr.PRdtType == Converter.typeofString)
                {
                    ParseString(pr, objectPr);
                    //ls.SerTrace.Log(this, "AddValue 6");
                ...
                else if (pr.PRdtTypeCode == InternalPrimitiveTypeE.Invalid)
                {
                    ...
                    if (pr.PRarrayTypeEnum == InternalArrayTypeE.Base64)
                    {
                        //ls.SerTrace.Log(this, "AddValue 7");
                        ...
                        throw new SerializationException(String.Format(CultureInfo.CurrentCulture, LSEnvironment.GetResourceString("Serialization_TypeMissing"), pr.PRname));
                    else
                    {
                        //ls.SerTrace.Log(this, "Object Class with no memberInfo data  Member " + pr.PRname + " type " + pr.PRdtType);
                        ...
                        {
                            //ls.SerTrace.Log(this, "AddValue 9");
                        ...
                        else if (objectPr.PRobjectInfo.isSi)
                        {
                            ...
                            //ls.SerTrace.Log(this, "AddValue 10");
                            objectPr.PRobjectInfo.AddValue(pr.PRname, pr.PRvalue, ref objectPr.PRsi, ref objectPr.PRmemberData);
                        }
                    }
                }
        ...
        {
            //ls.SerTrace.Log(this, "ParseMemberEnd");
            switch (pr.PRmemberTypeEnum)
            {
                case InternalMemberTypeE.Item:
        ...
        {
            //ls.SerTrace.Log(this, "ParseString Entry ", pr.PRobjectId, " ", pr.PRvalue, " ", pr.PRisRegistered);
            // Process String class
            if ((!pr.PRisRegistered) && (pr.PRobjectId > 0))
            {
                //ls.SerTrace.Log(this, "ParseString  RegisterObject ", pr.PRvalue, " ", pr.PRobjectId);
        ...
        private void RegisterObject(Object obj, ParseRecord pr, ParseRecord objectPr, bool bIsString)
        {
            if (!pr.PRisRegistered)
            {
                ...
                //ls.SerTrace.Log(this, "RegisterObject 0bj ", obj, " objectId ", pr.PRobjectId, " si ", si, " parentId ", parentId, " memberInfo ", memberInfo, " indexMap " + indexMap);
                if (bIsString)
        ...
        private void IndexTraceMessage(String message, int[] index)
        {
            ...
            sb.Append("]");
            //ls.SerTrace.Log(this, message, " ", sb.ToString());
        }
            ...
            if (entry == null || entry.assemblyName != assemblyName)
            {
                ...
                if (bSimpleAssembly)
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            assm = LSAssembly.LoadWithPartialNameInternal(assemblyName, null, ref stackMark);
                            if (assm == null && assemblyName != null)
                                assm = LSAssembly.LoadWithPartialNameInternal(new AssemblyName(assemblyName).Name, null, ref stackMark);
                        }
                        finally
                        {
                    ...
                    catch (Exception e)
                    {
                        ...
                        //need not to handle exception or log.
                    }
                }
                else
                {
                    ...
                    {
                        log.Log(AveLogLevel.DEBUG, WrapperWorkflowResource.LoadAssemblyError, e.ToString());//need not to handle exception or log.
                    }
                }
                if (assm == null)
                    return null;
                ...
                if (type == null && bSimpleAssembly)
                {
                    try
                    {
                        ...
                        try
                        {
                            type = TypeName.GetType(assm, typeName);
                        }
                        finally
                        {
                            CodeAccessPermission.RevertAssert();
