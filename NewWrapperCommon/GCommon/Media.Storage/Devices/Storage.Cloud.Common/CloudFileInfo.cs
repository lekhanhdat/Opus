...
namespace AvePoint.Media.Storage.Cloud.Common
{
    ...
    class CloudFileInfo : XFileInfo
    {
        ...
        public CloudFileInfo(string highName, string lowName, long fileSize, string modified, string creation)
            : this(highName, lowName)
        {
            if (!string.IsNullOrEmpty(modified))
            {
    ...
    class CloudDirectoryInfo : XDirectoryInfo
    {
        bool isExists ; 
        ...
        public CloudDirectoryInfo(string highName, string lowName, string modified, string creation)
        {
            HighName = highName;
            name = lowName;
            LowName = lowName;
