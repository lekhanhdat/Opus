...
namespace AvePoint.Office365.Api.AIR.IPC
{
    ...
    public static class SafeNativeMethods
    {
        ...
        public static APIMode IpcInitialize()
        {
            ...
            {
                throw new AveWrapperOffice365ApiException(AveWrapperErrorCode.AIRMSIPCClientNotFound, AveInternalResourceKey.Wrapper_Exception_Common_AIRMSIPCClientNotFound);
            }
            ...
            {
                throw new AveWrapperOffice365ApiException(AveWrapperErrorCode.AIRMSIPCClientLoadFailed, AveInternalResourceKey.Wrapper_Exception_Common_AIRMSIPCClientLoadFailed);
            }
            else
            {
                //Call a quick MSIPC method to load all the MSIPC.dll function pointers
                return IpcGetAPIMode();
            }
        }
