...
namespace AvePoint.Wrapper.Restore
{
    public class AvePPSScoreCard : AvePPSBase
    {
        ...
        {
            foreach (XmlElement configuredView in element)
            {
        ...
        {
            foreach (XmlElement configuredViewChild in configuredView)
            {
        ...
        {
            foreach (XmlElement gridViewDefinitionChild in gridViewDefinition)
            {
        ...
        {         
            foreach (XmlElement headerChild in header)
            {
        ...
        {
            foreach (XmlElement childNode in headerChild)
            {
        ...
        private void ReplaceGridHeaderItem(XmlElement gridHeaderItem)
        {
            ...
            foreach (XmlElement gridHeaderItemChild in gridHeaderItem)
            {
