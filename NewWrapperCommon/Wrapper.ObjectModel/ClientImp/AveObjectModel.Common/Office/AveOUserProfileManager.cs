...
namespace AvePoint.ObjectModel.Common.Office
{
    class AveOUserProfileManager : AveAbstractCommonCollection<IAveOUserProfile>, IAveOUserProfileManager
    {
        ...
        public AveOUserProfileManager(AveServiceContext serviceContext, AveSite site)//(string siteUrl,AveUserAccountInfo userAccountInfo)//
        {
            ...
            isOnlineSite = site.IsOnlineSite;
        ...
        {
            List<Dictionary<string, object>> userProfileList = base.DataCache.GetProperty<List<Dictionary<string, object>>>(AveObjectModelConstant.ChildrenProperties) ?? new List<Dictionary<string, object>>();
            mListData = new List<IAveOUserProfile>(userProfileList.Count);
            foreach(Dictionary<string,object>userProfileProp in userProfileList )
            {
        ...
        {
            Dictionary<string, object> userProfileProp = this.mRequest.GetUserProfileByName(strAccountName,isOnlineSite);
            if (userProfileProp.Count > 0)
            {
                if (!base.DataCache.IsPropertyAvailable("DefaultProfileSubtypeProperties"))
                {
                    ...
                    List<Dictionary<string, object>> childrenProperties = new List<Dictionary<string, object>>();
                    ...
                    valueNames.Add(AveObjectModelConstant.ChildrenProperties, childrenProperties);
        ...
        public IAveOProfileSubtypePropertyManager DefaultProfileSubtypeProperties
        {
            get 
            {
                if (base.DataCache.IsPropertyNotLoaded("DefaultProfileSubtypeProperties"))
                {
                    ...
                    base.DataCache.PropertiesCache["DefaultProfileSubtypeProperties"] = profileSubtypePropertyManager;
                }
        ...
        public IAveOPropertyCollection Properties
        {
            ...
            { 
                if(base.DataCache.IsPropertyNotLoaded("Properties") )
                {
                    ...
                    base.DataCache.PropertiesCache["Properties"]=propertyCol;
                }
        ...
        public IAveOPropertyCollection PropertiesWithSection
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("PropertiesWithSection"))
                {
                    ...
                    AveOPropertyCollection propertyCol = propertyColProp == null ? null : new AveOPropertyCollection(this.mRequest, propertyColProp);
                    base.DataCache.PropertiesCache["PropertiesWithSection"] = propertyCol;
                }
        ...
        public bool IsPersonalSiteMultipleLanguage
        {
            get
            {
                //client API cannot get this property
                return false;
            }
            set
            {
