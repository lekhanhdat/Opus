...
const FilterOption = FilterOptions.MLEscalatedFrom;

const EscalatedFromFilter = ({onFilterChange, onRemoveFilterChange, filterDefinitions}) => {
...
export default EscalatedFromFilter;