...
namespace Media.Common.ClassicStorageApi
{
    ...
    { 
        ...
        {
            return connectionString.Replace("wasabi_vim?", "s3compatible_vim?");
        }
        ...
        {
            connectionStrings = connectionStrings.Select(NormalizeConnectionString).ToList();
            ...
            {
                modernXLibrary = Storage.XFactory.InstanceLibrary(modernConnectionStrings);
            }
