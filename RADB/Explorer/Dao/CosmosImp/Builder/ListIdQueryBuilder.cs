...
{
    public class ListIdQueryBuilder: BaseFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && !string.IsNullOrEmpty(filterOption.ListId);
        }
