    ...
    internal class AveSiteSettingSerializer : IAveSiteSettingSerializer
    {
        ...
        public AveSiteSettingInfo GetObjectData()
        {
            ...
            if (((AveWebSettingTypes)this.mSettingTypes & AveWebSettingTypes.SiteAuditSettings) == AveWebSettingTypes.SiteAuditSettings)
            {
                ...
                if (m_Site.DataCache.IsPropertyAvailable("AuditLogTrimmingRetention"))
                {
                    siteSettingInfo.AuditLogTrimmingRetention = m_Site.AuditLogTrimmingRetention;
                }
                if (m_Site.DataCache.IsPropertyAvailable("TrimAuditLog"))
                {
            ...
            #region SharePoint Designer
            //Sharepoint designer settings.
            if (((AveWebSettingTypes)this.mSettingTypes & AveWebSettingTypes.SiteSharePointDesignerSettings) == AveWebSettingTypes.SiteSharePointDesignerSettings)
            {
            ...
            if (((AveWebSettingTypes)this.mSettingTypes & AveWebSettingTypes.SiteOtherSettings) == AveWebSettingTypes.SiteOtherSettings)
            {
                ...
                if (m_Site.RootWeb != null)
                {
                    ...
                    siteSettingInfo.UserConfiguredEnableAutoSpawn = m_Site.VariationsSettings.UserConfiguredEnableAutoSpawn;
                    siteSettingInfo.StopAutoSpawnAfterDelete = m_Site.VariationsSettings.StopAutoSpawnAfterDelete;
                    siteSettingInfo.UpdateWebParts = m_Site.VariationsSettings.UpdateWebParts;
                    siteSettingInfo.SendNotificationEmail = m_Site.VariationsSettings.SendNotificationEmail;
                }
                ...
                {
                    Logger.Warn("Cannot find SolutionCatalog in the site,exception {0}", ex.ToString());
                }
