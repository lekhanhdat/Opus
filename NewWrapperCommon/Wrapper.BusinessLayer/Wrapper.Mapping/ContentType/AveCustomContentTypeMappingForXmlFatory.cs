...
namespace AvePoint.Wrapper.Mapping
{
    ...
    public class AveCustomContentTypeMappingForXmlFatory : IAveCustomContentTypeMappingFactory
    {
        ...
        {
            Dictionary<string, AveCustomContentTypeForXmlInfo> listCustomContentTypeMappings = new Dictionary<string, AveCustomContentTypeForXmlInfo>(StringComparer.OrdinalIgnoreCase);
