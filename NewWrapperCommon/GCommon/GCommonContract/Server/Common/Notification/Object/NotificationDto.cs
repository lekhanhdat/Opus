...
namespace AvePoint.GCommon.Contract.Server.Common
{
    ...
    public class NotificationDto : IProfileContent
    {
        ...
        /// <summary>
        ///只为Audit调用UpdateNotificationMessageOnGroup方法时区分是create还是edit使用不需要存入数据库。
        /// </summary>
        ...
        /// <summary>
        /// 用来标识Job Report Format（CSV ,TXT or XLS）
        /// </summary>
        [DataMember]
        public ReportFileType JobReportFormat { get; set; }
        /// <summary>
        /// 发送提醒的对象
        /// </summary>
        [DataMember]
