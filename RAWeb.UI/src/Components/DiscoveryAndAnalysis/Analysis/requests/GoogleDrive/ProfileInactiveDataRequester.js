...
class ProfileInactiveDataRequester {
    ...
    static queryAggregateInfo = (queryParameter) => {
        ...
        queryParameter.organizationId === "00000000-0000-0000-0000-000000000000" || 
        ...
        return ExceptionHandler.handleAsync(
            async () => {
                const res = await CacheUtil.WindowCacheUtil.tryGetValueAsync(
                    ...
                    async () => {
                        const requestOption = {
                            url: "/api/RMDiscoveryGoogleProfileDataQueryApi/queryInactiveAggregateInfo",
                            method: "POST",
                            data: queryParameter,
                        };
        ...
        return ExceptionHandler.handleAsync(
            async () => {
                const res = await CacheUtil.WindowCacheUtil.tryGetValueAsync(
                    ...
                    async () => {
                        const requestOption = {
                            url: "/api/RMDiscoveryGoogleProfileDataQueryApi/queryInactiveOptimizationNodeTotalAggregateInfo",
                            method: "POST",
        ...
        return ExceptionHandler.handleAsync(
            async () => {
                const res = await CacheUtil.WindowCacheUtil.tryGetValueAsync(
                    ...
                    async () => {
                        const requestOption = {
                            url: "/api/RMDiscoveryGoogleProfileDataQueryApi/queryInactiveOptimizationNodesData",
                            method: "POST",
                            data: queryParameter,
                        };
                        return await fetchUtility(requestOption);
