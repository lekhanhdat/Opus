...
namespace AvePoint.Wrapper.Backup
{
    public class AveTaxonomyGroup
    {
        ...
        {
            output.WriteMetadata(AveMetadataType.MetadataGroup, GetGroupInfo(groupId));
        }

        private AveMetadataGroupInfo GetGroupInfo(Guid groupId)
        {
            this.TaxonomyGroup = groupId;
            return this.ServiceApplication.GetGroup(groupId);
        }
    }
}