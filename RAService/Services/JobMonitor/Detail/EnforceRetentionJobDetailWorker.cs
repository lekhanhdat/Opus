...
namespace AvePoint.RA.Service.Services.JobMonitor.Detail
{
    ...
    public class EnforceRetentionJobDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_ENFORCE_RETENTION, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_ENFORCE_RETENTION, TABLE_NAME);
        }
    }
}
