...
namespace AvePoint.RA.SharePoint.Teams.EnforceRetention.Cache
{
    public class TeamsRetentionDataCache : IDisposable
    {
        ...
        static TeamsRetentionDataCache _instance;
        ...
        public static TeamsRetentionDataCache Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (locker)
                    {
                        if (_instance == null)
                        {
                            _instance = new TeamsRetentionDataCache();
                            _instance.Init();
                        }
                    }
                }
        ...
        private RMRetentionSourceType _sourceType = RMRetentionSourceType.Teams;

        public TeamsRetentionDataCache()
        {
            Init();
        }
        ...
        private void CacheLabelSetting()
        {
            ...
            logger.Info($"cache label retention setting, PreviousLabel:{string.Join(",", prevLabels)}, ProcessLabel:{currentLabel?.Name}.");
        }
