    ...
    public class AveItemCache : AveDiscoverCache
    {
        ...
        public Dictionary<int, List<AveSecurityObject>> GetChangeSecuritys()
        {
            if (ItemId.HasValue)
            {
                ...
                return Query.QueryItemSecurityForIB(this.SiteId, this.WebId, this.ListId, ItemId.Value);
            }
            else
            {
        ...
        public void GetAttachments(String listRootFolderUrl,AveItemObject itemObject)
        {
            Query.QueryAttachmentByItemObj(this.SiteId, listRootFolderUrl, itemObject,this.AveWeb,this.ListId);
        }

        public void GetVersions(AveItemObject itemObject)
        {
            Query.QueryVersionsByItemObj(this, itemObject);
        }
        #endregion
    }
}
