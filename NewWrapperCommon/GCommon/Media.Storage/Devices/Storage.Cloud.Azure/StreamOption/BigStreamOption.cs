...
{
    class BigDBOption : AbstractStreamOption, IChangeStream
    {
        ...
        public HttpWebRequest ChangeHttpUploadStream(long beginLength, long endLength, int rangeType)
        {
            ...
            string range1 = "bytes=" + beginLength.ToString() + "-" + endLength.ToString();
    ...
    class BlockBlobOption : AbstractStreamOption
    {
