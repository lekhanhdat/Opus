...
{
    public class TeamsTreeFilterTeamQueryBuilder : BaseArrayFilterBuilder
    {
        ...
        {
            return CosmosConst.C_TeamsId;
        }

        protected override object GetFilterValue(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption.SPNodes.Where(n => n.Level == (int)NodeLevel.Office365GroupEntire).Select(n => n.Id).ToList();
        }
    }
}
