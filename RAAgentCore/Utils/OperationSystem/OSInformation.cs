...
namespace AvePoint.Hybrid.Utility.OperationSystem
{
    ...
    public static class OSInformation
    {
        ...
        static OperatingSystemInfo osInfo;
        ...
        /// </remarks>
        /// </summary>
        public static Int32 CPUUsage { get { return Convert.ToInt32(cpuPerformanceCounter.NextValue(), NumberFormatInfo.InvariantInfo); } }
        ...
        static Int64 GetFreePhysicalMemory()
        {
        ...
        {
            return new Hybrid.Utility.OperationSystem.Windows.Win32.WindowsOperatingSystem().GetLeftMemoryEx();
        }
