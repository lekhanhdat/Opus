...
{
    public class GoogleObjectBackup : IDisposable
    {
        protected IRALogger _logger = RALogger.GetInstance(typeof(DeleteOnlyController));
        public GoogleConfiguration Configuration { get; set; }
        public GoogleExportBeforeArcInfo GoogleExportBeforeArcInfo { get; set; }
