...
namespace AvePoint.GCommon.Contract.GranularBackup.Object
{
    ...
    public class SiteMasterIndexDto
    {
        [DataMember]
        ...
        [DataMember]
        public SiteMasterIndexExtension IndexExtension { get; set; }
        ...
        /// </summary>
        [DataMember]
        public List<SiteMasterIndexSubDto> subInfos { get; set; }
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class SiteMasterIndexSubDto
    {
        [DataMember]
        public string Id { get; set; }
        ...
        [DataMember]
        public string SkyDriveUserName { get; set; }
    }

    [DataContract(Namespace = ContractConstants.Namespace)]
    public enum BackupIndexJobType : int
    {
        [EnumMember]
        Granular = 0,
        [EnumMember]
