    ...
    const summaryData = [
        {
            ...
            value: UnitConvertsionUtil.DynamicConvert(dataInfo.DataTotalSize),
    ...
    const summaryFiles = [
        {
            ...
            value: UnitConvertsionUtil.DynamicConvert(dataInfo.FileTotalSize),
