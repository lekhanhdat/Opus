export default class AddCorrelateConnectionTable extends R.Component {
    idAttr = true;
    componentCreate() {
        this.state = {
            page: 1,
        ...
        return (
            <div>
                <R.Table
                    ...
                    rowTemplate={AddCorrelateConnectionTableRowTemplate}
...
class AddCorrelateConnectionTableRowTemplate extends R.TableRow {
    constructor(props) {
        super(props);
        this.state = {};
    }
