...
{
    public class FileVEOParameters
    {
        ...
        public FileVEOParameters(string Title, string FileID, string ParentVEOID, string CreatedTime, string ModifiedTime, string Author, string Editor)
        {
            this.VTitle = Title;
            this.VFileID = FileID;
