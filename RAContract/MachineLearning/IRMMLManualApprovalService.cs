...
{
    public interface IRMMLManualApprovalService
    {
        ...
        RAReturnMessage ChangeTerm(RealTimeAction action, ChangeTermDto changeTermInfo);
        Task<string> RealRunChangeTermJobAsync(string param, JobType jobType);
        Task<string> RealRunApproveJobAsync(string param, JobType jobType);
    }
}
