...
namespace AvePoint.GCommon.Contract.CentralAdmin.Object.SecurityCenter
{
    ...
    public class CASecurityViewTemporaryPermissionOperation : CASecurityUsersOperation
    { 
        [DataMember]
        public string ExpiredTime { get; set; }
        [DataMember]
        public List<NodeLevel> FilterLevel { get; set; }
        [DataMember]
        public string UrlContains { get; set; }    
        [DataMember]
        public List<CAGrantTemporaryPermissionGroupInfo> ViewGroups { get; set; }
        [DataMember]
