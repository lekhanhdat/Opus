...
namespace AvePoint.ObjectModel.Common
{
    class AveTaxonomySession : AveClientObject, IAveTaxonomySession
    {
        ...
        internal AveTaxonomySession AdminTaxonomySession { get; set; }
        ...
        public IAveTermStoreCollection TermStores
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("TermStores"))
                {
                    ...
                    base.DataCache.PropertiesCache["TermStores"] = TermStores;
                }
        ...
        public IAveTermStore DefaultSiteCollectionTermStore
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("DefaultSiteCollectionTermStore") && base.DataCache.IsPropertyAvailable("DefaultSiteCollectionTermStore" + AveObjectModelConstant.ObjectPropertySuffix))
                {
                    AveTermStore DefaultSiteCollectionTermStore = new AveTermStore(this, m_Request, null, base.DataCache.PropertiesCache["DefaultSiteCollectionTermStore" + AveObjectModelConstant.ObjectPropertySuffix] as Dictionary<string, object>);
                    base.DataCache.PropertiesCache["DefaultSiteCollectionTermStore"] = DefaultSiteCollectionTermStore;
                }
                //return base.DataCache.GetProperty<IAveTermStore>("DefaultSiteCollectionTermStore");
                IAveTermStore termStore = base.DataCache.GetProperty<IAveTermStore>("DefaultSiteCollectionTermStore");
                if (termStore == null) 
                {
                    return null;
                }
                return this.TermStores[termStore.ID] != null ? TermStores[termStore.ID] : termStore;
            }
        }
        ...
        public IAveTermStore DefaultKeywordsTermStore
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("DefaultKeywordsTermStore") && base.DataCache.IsPropertyAvailable("DefaultKeywordsTermStore" + AveObjectModelConstant.ObjectPropertySuffix))
                {
                    AveTermStore DefaultSiteCollectionTermStore = new AveTermStore(this, m_Request, null, base.DataCache.PropertiesCache["DefaultKeywordsTermStore" + AveObjectModelConstant.ObjectPropertySuffix] as Dictionary<string, object>);
                    base.DataCache.PropertiesCache["DefaultKeywordsTermStore"] = DefaultSiteCollectionTermStore;
                }
                return base.DataCache.GetProperty<IAveTermStore>("DefaultKeywordsTermStore");
                //IAveTermStore termStore = base.DataCache.GetProperty<IAveTermStore>("DefaultKeywordsTermStore");
        ...
        {
            Dictionary<string, object> termProp = m_Request.GetTerm(Guid.Empty, guid);
            if (termProp.ContainsKey("Group"))
            {
                Dictionary<string, object> groupProperties = termProp["Group"] as Dictionary<string, object>;
        ...
        {
            Dictionary<string, object> termsProperties = m_Request.GetTerms(new Guid(), new Guid(), termLabel, trimUnavailable);
            AveTermCollection terms = new AveTermCollection(m_Request, null, termsProperties);
            return terms;
        }
        ...
        {
            AdminTaxonomySession = new AveTaxonomySession(site);
        }
