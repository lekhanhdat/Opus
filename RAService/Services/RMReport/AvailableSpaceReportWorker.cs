...
{
    public class AvailableSpaceReportWorker : AbstractReportWorker
    {
        public AvailableSpaceReportWorker()
        {
        ...
        public void InitCreateTableSQLString()
        {
            ...
            CREATE_TABLE_SQL = string.Format(ReportConstants.CREATE_TABLE_PRM_AVAILABLE_SPACE_REPORT, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(ReportConstants.INSERT_DATA_PRM_AVAILABLE_SPACE_REPORT, TABLE_NAME);
        }
