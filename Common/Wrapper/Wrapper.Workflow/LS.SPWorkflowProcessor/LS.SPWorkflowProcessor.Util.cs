...
namespace LS.SPWorkflowProcessor
{
    ...
    public class Environment
    {
        public static SharePointVersion SharePointVersion
        {
            get
            {
                if (SPWorkflowProcessorRuntime.ObjectModelFactory.ContextKind == AveContextKind.Server07ObjectModel)
                {
                    return SharePointVersion.SharePoint2007;
                }
                else if (SPWorkflowProcessorRuntime.ObjectModelFactory.ContextKind == AveContextKind.ServerObjectModel)
