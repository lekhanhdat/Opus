...
import SFDataTypeChart from "../../Salesforce/SFDataTypeChart";
...
import { SFBasicDataRequester, SFInactiveDataRequester } from "../../../../requests";
...
const  SFDataAnalysis = (props,ref)=> {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await SFBasicDataRequester.getObjects(defaultQueryParameter);
            setObjects(res);
        };
        fetchData();
    }, []);
                ...
                <div>
                    ...
                    >
                        <SFDataTypeChart
                            ...
                            queryParameter={queryParameter}
                            queryData={
                                SFInactiveDataRequester.queryFigureDataInfo
                            }
                        />
                    </div>
                </div>
...
export default forwardRef(SFDataAnalysis);
