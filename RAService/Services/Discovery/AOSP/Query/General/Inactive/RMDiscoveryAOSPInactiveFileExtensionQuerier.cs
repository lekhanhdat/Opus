...
{
    public class RMDiscoveryAOSPInactiveFileExtensionQuerier : RMDiscoveryAOSPInactiveDataQuerier<List<RMDiscoveryFileExtensionDataInfo>>
    {
        public RMDiscoveryAOSPInactiveFileExtensionQuerier(RMDiscoveryAOSPQueryParameter queryParameter) : base(queryParameter)
        {
        }
...
JOIN [{_schemaName}].[RMAOSPFileExtensions] AS fileType ON data.FileExtension = fileType.Id ";
