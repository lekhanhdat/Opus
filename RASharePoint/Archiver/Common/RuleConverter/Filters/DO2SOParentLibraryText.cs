...
{
    internal class DO2SOParentLibraryText : DO2SOFilterConverterBase
    {
        ...
        public DO2SOParentLibraryText(string value1, int startSequenceNo, TextConditionType condition, string extraValue)
        {
            this.mValue1 = value1;
        ...
        public override List<SOFilterPolicy> Convert()
        {
            ...
            ParentLibraryTextRule rule = new ParentLibraryTextRule { Value1 = this.mFilterName };
