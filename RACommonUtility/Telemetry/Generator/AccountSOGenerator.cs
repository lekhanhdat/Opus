...
{
    public class AccountSOGenerator : TelemetryGenerator
    {
        public override TelemetryModule Module => TelemetryModule.Account;
        ...
        protected override Dictionary<TelemetryEventType, Func<IList<object>, CloudRecordsCommonRecord>> EventTypeGenerateMapping =>
            ...
            {
                { TelemetryEventType.SOCustomer, GetSOCustomer },
            };

        public CloudRecordsCommonRecord GetSOCustomer(IList<object> args)
        {
            var record = new CloudRecordsCommonRecord();
            return record;
        }
    }
}
