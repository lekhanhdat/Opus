...
namespace AvePoint.Wrapper.Common
{
    ...
    public interface IAveReportCenterQueryService : IAveQueryService
    {
        ...
        IAveQueryDataReader GetBlobRawDataSP2010Attachments(Guid siteId, Guid parentId);
        ...
        IAveQueryDataReader BlobInventorySP2010GetSOInfoInList(Guid aveSiteId, Guid rootFolderId);
        ...
        IAveQueryDataReader GetUserStorageAttachment(Guid site, Guid parentId);
