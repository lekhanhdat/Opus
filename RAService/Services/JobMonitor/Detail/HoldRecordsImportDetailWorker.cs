...
{
    public class HoldRecordsImportDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_HOLD_RECORDS_IMPORT, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_HOLD_RECORDS_IMPORT, TABLE_NAME);
        }
    }
}
