...
namespace AvePoint.Media.Storage.Cloud.Dropbox
{
    ...
    class DropboxFileInfo : XFileInfo
    {
        public Boolean IsExists { set; get; }

        public DropboxFileInfo(String highName, String lowName,Int64 length, String modifyTime)
        {
            ...
            this.FileSize = this.Length = length;
        }

        public DropboxFileInfo(String highName, String lowName)
        {
            this.HighName = highName;
            this.LowName = lowName;
        }
