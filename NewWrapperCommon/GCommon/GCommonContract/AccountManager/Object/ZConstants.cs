...
{
    public class ZSystemRoleConstants
    {
        public const string GROUP_SAAS_USERS = "SaaS Users";
        public const string GROUP_ADMINISTRATORS = "Administrators";
        public const string GROUP_MANAGERS = "Managers";
        public const string GROUP_OPERATORS = "Operators";
        ...
        public const string PERMISSION_NO_ACCESS = "No Access";
    ...
    public class ZResultMessage
    {
        ...
        public ZResultMessage()
        {
            AccountDtos  =new List<AccountDto>();
            ResultType = Result.Successful;
            DictionaryGroupContainPermLevel = new Dictionary<string, List<GroupDto>>();
        }
    }

    [DataContract(Namespace = ContractConstants.Namespace)]
    public enum ZPermissionScope
    {
        [EnumMember]
        None = 0,
        [EnumMember]
    ...
    public enum ZGroupType : int
    {
        ...
        ActiveDirectory = 1 << 1,
        [EnumMember]
        [Obsolete("6.3 version don't use")]
        SecurityTrimming = 1 << 2,//add tenant group
        [EnumMember]
        Local = 1 << 3,//add system group
        [EnumMember]
        DedicatedTenantGroup = 1 << 4,//Site Collection type
        [EnumMember]
        Operators = 1 << 5,//add system group
    }

    [DataContract(Namespace = ContractConstants.Namespace)]
    public enum ZCheckADResultType
    {
        [EnumMember]
    ...
    public class ZAccountManagerEnumUtil
    {
        public static string ToString(GroupType type)
        {
            switch (type)
            {
                ...
                case GroupType.DedicatedTenantGroup:
