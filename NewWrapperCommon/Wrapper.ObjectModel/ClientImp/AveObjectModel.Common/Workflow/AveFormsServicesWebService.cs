...
{
    class AveFormsServicesWebService : IAveFormsServicesWebService
    {
        private IAveRequest mRequest = null;
        public AveFormsServicesWebService(IAveWeb web)
        {
        ...
        {
            mRequest.BrowserEnableUserFormTemplate(formTemplateUrl);
        }
    }
}
