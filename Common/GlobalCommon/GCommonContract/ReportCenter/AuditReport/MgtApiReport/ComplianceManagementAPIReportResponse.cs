...
namespace AvePoint.GCommon.Contract.ReportCenter.AuditReport.MgtApiReport
{
    ...
    public class ComplianceManagementAPIReportResponse
    {
        public ComplianceManagementAPIReportResponse()
        {
            Data = new List<O365AuditDataInfo>();
        }

        [DataMember]
        public List<O365AuditDataInfo> Data { get; set; }
        ...
        [DataMember]
        public string DependProfileId { get; set; }
    }
}
