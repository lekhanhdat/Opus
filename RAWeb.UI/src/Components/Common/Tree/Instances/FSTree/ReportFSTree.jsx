...
import FSDestinationTreeNodeContent from '../../NodeContents/RC/FSNodeContent';
    ...
    initTreeContext() {
        ...
        this.treeContext = {
            ...
            transToTreeNodeObject(oitem) {
                ...
                let pagedByServer = oitem.Level < NodeLevel.SiteCollections && !oitem.IsNotInitItem; //Edit 回显是为前台分页
                let isHasMixedStatus = mainComponent.hasMixStatusNodeLevel.includes(oitem.Level);
                let children = oitem.Children ? oitem.Children : [];
                let pageSize = 10;
                return {
                    origin: oitem,
                    nodeKey: oitem.Id,
            ...
            onLoadNodes(parentItem, funcSuccess, funcFail) {
                let browseUrl = "/api/FSSettingApi/FSBrowseTreeByPager";
