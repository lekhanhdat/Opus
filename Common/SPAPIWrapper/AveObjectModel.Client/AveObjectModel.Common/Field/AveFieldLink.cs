...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldLink : AveClientObject, IAveFieldLink
    {
        ...
        public AveFieldLink(AveField field)
        {
            ...
            fieldLinkProperties.Add("FieldInternalName", field.InternalName);
            fieldLinkProperties.Add("FieldTypeAsString", field.TypeAsString);
            base.DataCache.AddProperty("Id",field.ID);
        ...
        public AveFieldLink(AveContentType contentType, AveFieldLinkCollection fieldLinkCollection, IAveRequest request, IDictionary<string, object> fieldLinkProperties)
        {
            ...
            existFieldLinkProperties.Add("FieldInternalName", this.Name);
        ...
        public void Delete()
        {
            if (!this.mContentType.DataCache.ChangedProperties.ContainsKey("DeleteFieldLink"))
            {
                ...
                this.mContentType.DataCache.AddChangedProperty("DeleteFieldLink", deleteIds);
            }
            else
            {
