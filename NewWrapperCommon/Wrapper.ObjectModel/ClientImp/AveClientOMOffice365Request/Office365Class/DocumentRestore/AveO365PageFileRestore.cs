...
{
    class AveO365PageFileRestore : AveO365BaseDocumentRestore
    {
        
        public AveO365PageFileRestore(AveClientContext context, AveClientOMOffice365Request request, FederationToken tokenProvider, AveDocumentInfo docInfo, Stream fileStream)
        ...
        private PageType GetPageType()
        {
            ...
            else if (DocInfo.FieldsInfo.Fields.ContainsKey("HTML_x0020_File_x0020_Type") &&
            ...
            {
                if (!DocInfo.HasStream || (!string.IsNullOrEmpty(DocInfo.SetupPath) &&
