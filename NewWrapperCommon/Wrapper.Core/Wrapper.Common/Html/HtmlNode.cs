    ...
    public class HtmlNode : IXPathNavigable
    {
        ...
        public string Name
        {
            get
            {
                ...
                return _name != null ? _name.ToLower(System.Globalization.CultureInfo.InvariantCulture) : string.Empty;
            }
            set { _name = value; }
        }
        ...
        public static bool CanOverlapElement(string name)
        {
            ...
            object flag = ElementsFlags[name.ToLower(System.Globalization.CultureInfo.InvariantCulture)];
            if (flag == null)
            {
                return false;
            }
        ...
        [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "The word 'newChildrend' is an exception message.")]
        ...
        [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "The word 'xpath' is an exception message.")]
        ...
        public void WriteTo(XmlWriter writer)
        {
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Element:
                    string name = _ownerdocument.OptionOutputUpperCase ? Name.ToUpper(System.Globalization.CultureInfo.InvariantCulture) : Name;
        ...
        internal void WriteAttribute(TextWriter outText, HtmlAttribute att)
        {
            ...
            if (_ownerdocument.OptionOutputAsXml)
            {
                if (_ownerdocument.OptionOutputUpperCase)
                {
                    name = att.XmlName.ToUpper(System.Globalization.CultureInfo.InvariantCulture);
                }
                else
                {
                    name = att.XmlName;
            ...
            else
            {
                if (_ownerdocument.OptionOutputUpperCase)
                {
                    name = att.Name.ToUpper(System.Globalization.CultureInfo.InvariantCulture);
                }
                else
                {
                    name = att.Name;
