...
{
    public class RMDiscoveryGoogleRotNodeTotalAggregateDataQuerier : RMDiscoveryGoogleRotDataQuerier<Dictionary<string, object>>
    {
        public RMDiscoveryGoogleRotNodeTotalAggregateDataQuerier(RMDiscoveryGoogleQueryParameter queryParameter) : base(queryParameter)
        {
        }
        ...
        public override async Task<Dictionary<string, object>> QueryAsync()
        {
            ...
            {
                tableName = "RMGoogleBasicRuleLevelRotData";
            }
