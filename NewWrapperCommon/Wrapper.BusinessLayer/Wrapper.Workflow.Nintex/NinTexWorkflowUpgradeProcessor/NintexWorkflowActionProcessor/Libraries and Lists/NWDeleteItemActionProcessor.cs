...
{
    internal class NWDeleteItemActionProcessor : NWLibariesAndListsActionProcessor
    {
        public NWDeleteItemActionProcessor(NintexWFActionProcessor workflowActionProcessor)
