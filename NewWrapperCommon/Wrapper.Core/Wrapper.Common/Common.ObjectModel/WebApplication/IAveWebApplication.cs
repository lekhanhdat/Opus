...
namespace AvePoint.Wrapper.Common
{
    public interface IAveWebApplication : IAvePersistedUpgradableObject
    {
        ...
        IAveWebConfigModificationCollection WebConfigModifications { get; }

        #region add for SP2013
        bool SelfServiceCreateIndividualSite { get; set; }
        string SelfServiceCreationParentSiteUrl { get; set; }
        string SelfServiceCreationQuotaTemplate { get; set; }
        string SelfServiceSiteCustomFormUrl { get; set; }
        bool ShowStartASiteMenuItem { get; set; }
        IAveUserSettingsProvider UserSettingsProvider { get; set; }
        bool AllowAnalyticsCookieForAnonymousUsers { get; set; }
        #endregion
    }
}