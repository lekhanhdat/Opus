...
namespace AvePoint.GCommon.Utility
{
    public class AvePerformanceLogging
    {
        class LoggingEntry
        {
            ...
            public readonly object EntryLock = new object();
        ...
        readonly static object entriesLock = new object();
        ...
        private static void OutputThread(object obj)
        {
            ...
            while (true)
            {
                ...
                lock (loggingEntry.EntryLock)
                {
                    if (loggingEntry.LogObjects.Count == 0)
                    {
                        Thread.Sleep(3000);
                        continue;
                    }
                ...
                string logFileFullPath = SecurityUtils.SafeCombinePath(outputDirectory, loggingEntry.LoggingTypeName + ".txt");
