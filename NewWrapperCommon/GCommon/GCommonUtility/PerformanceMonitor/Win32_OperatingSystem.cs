...
namespace AvePoint.GCommon.Utility
{
    ...
    internal class OperatingSystem : System.ComponentModel.Component
    {
        ...
        {
            this.InitializeObject(null, new System.Management.ManagementPath(OperatingSystem.ConstructPath(keyName)), null);
        }

        public OperatingSystem(System.Management.ManagementScope mgmtScope, string keyName)
        {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(OperatingSystem.ConstructPath(keyName)), null);
        }
...
Values: TRUE or FALSE, A value of TRUE indicates the debugging version of User.exe is installed.")]
        ...
        public QuantumLengthValues QuantumLength
        {
            get
            {
                if ((curObj["QuantumLength"] == null))
                {
                    return ((QuantumLengthValues)(System.Convert.ToInt32(3)));
                }
                return ((QuantumLengthValues)(System.Convert.ToInt32(curObj["QuantumLength"])));
            }
            set
            {
                if ((QuantumLengthValues.NULL_ENUM_VALUE == value))
                {
...
2 = Variable - Quantum length is variable.")]
        ...
        public QuantumTypeValues QuantumType
        {
            get
            {
                if ((curObj["QuantumType"] == null))
                {
                    return ((QuantumTypeValues)(System.Convert.ToInt32(3)));
                }
                return ((QuantumTypeValues)(System.Convert.ToInt32(curObj["QuantumType"])));
            }
            set
            {
                if ((QuantumTypeValues.NULL_ENUM_VALUE == value))
                {
...
10 - Windows Server 2003, Web Edition")]
        ...
        {
            if ((this.IsQuantumLengthNull == false))
            {
                return true;
            }
            return false;
        ...
        {
            if ((this.IsQuantumTypeNull == false))
            {
                return true;
            }
            return false;
        ...
        public static OperatingSystem0Collection GetInstances()
        {
            return GetInstances(null, null, null);
        }

        public static OperatingSystem0Collection GetInstances(string condition)
        {
            return GetInstances(null, condition, null);
        }

        public static OperatingSystem0Collection GetInstances(System.String[] selectedProperties)
        {
            return GetInstances(null, null, selectedProperties);
        }

        public static OperatingSystem0Collection GetInstances(string condition, System.String[] selectedProperties)
        {
            return GetInstances(null, condition, selectedProperties);
        }

        public static OperatingSystem0Collection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions)
        {
            if ((mgmtScope == null))
            {
            ...
            return new OperatingSystem0Collection(clsObject.GetInstances(enumOptions));
        }

        public static OperatingSystem0Collection GetInstances(System.Management.ManagementScope mgmtScope, string condition)
        {
            return GetInstances(mgmtScope, condition, null);
        }

        public static OperatingSystem0Collection GetInstances(System.Management.ManagementScope mgmtScope, System.String[] selectedProperties)
        {
            return GetInstances(mgmtScope, null, selectedProperties);
        }

        public static OperatingSystem0Collection GetInstances(System.Management.ManagementScope mgmtScope, string condition, System.String[] selectedProperties)
        {
            if ((mgmtScope == null))
            {
                if ((statMgmtScope == null))
            ...
            using (System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_OperatingSystem", condition, selectedProperties)))
            {
                System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
                enumOptions.EnsureLocatable = true;
                ObjectSearcher.Options = enumOptions;
                return new OperatingSystem0Collection(ObjectSearcher.Get());
            }
        }
        ...
        public static OperatingSystem CreateInstance()
        {
            ...
            return new OperatingSystem(tmpMgmtClass.CreateInstance());
        }
        ...
        public uint Win32Shutdown(int Flags, int Reserved)
        {
            if ((isEmbedded == false))
            {
                ...
                inParams["Flags"] = ((System.Int32)(Flags));
                inParams["Reserved"] = ((System.Int32)(Reserved));
        ...
        public class OperatingSystem0Collection : object, ICollection
        {

            private ManagementObjectCollection privColObj;

            public OperatingSystem0Collection(ManagementObjectCollection objCollection)
            {
            ...
            {
                return new OperatingSystem0Enumerator(privColObj.GetEnumerator());
            }

            public class OperatingSystem0Enumerator : object, System.Collections.IEnumerator
            {

                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;

                public OperatingSystem0Enumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum)
                {
                    privObjEnum = objEnum;
                }
                ...
                public virtual object Current
                {
                    get
                    {
                        return new OperatingSystem(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
