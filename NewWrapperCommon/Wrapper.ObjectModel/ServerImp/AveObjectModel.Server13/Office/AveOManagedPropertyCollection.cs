...
namespace AvePoint.ObjectModel.Server13.Office
{
    class AveOManagedPropertyCollection : AveAbstractCommonCollection, IAveOManagedPropertyCollection
    {
        ...
        private AveOSearchServiceApplication mSearchApplication;
        ...
        public IAveOSearchServiceApplication SearchApplication
        {
            get
            {
                ...
                if (mSearchApplication == null)
                {
                    searchServiceApplication = AveAssemblyUtility.GetPropertyValue(mManagedPropertyCollection, "SearchApplication") as SearchServiceApplication;
