...
namespace AvePoint.GCommon.Contract.AccountManager.Object
{
    ...
    public class ResultMessage
    {
        ...
        //只有Result类型为AccountTypeError才有值
        [DataMember]
    ...
    public enum BelongToGroupType
    {
        ...
        SystemGroup = 8,
        [EnumMember]
        AdministratorsGroup = 9,
        [EnumMember]
        WebApplicationTenantGroup = 16,
        [EnumMember]
        SiteCollectionTenantGroup = 162,
    }
