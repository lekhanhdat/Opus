...
namespace AvePoint.Wrapper.Common
{
    ...
    [Serializable]
    public class AveWrapperException : AveWrapperBaseException
    {
        ...
        public AveWrapperException(AveWrapperErrorCode errorCode, AveInternalResourceKey key, params object[] args)
            : base(key, args)
        {
            this.ErrorCode = errorCode;
        }

        public AveWrapperException(AveInternalResourceKey key,params object[] args)
            :base(key,args)
        { }

        public AveWrapperException(System.Exception innerException, AveInternalResourceKey i18nkey, params object[] args)
