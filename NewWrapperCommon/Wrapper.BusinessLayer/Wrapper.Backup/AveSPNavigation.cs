...
namespace AvePoint.Wrapper.Backup
{
    public class AveSPNavigation
    {
        ...
        public void Export(IAveBackupStream output, bool backupInheritedNavNodes = false, string srcWebAppUrl = "", bool needFullUrl = false)
        {
            using (AvePerformanceScope scope = new AvePerformanceScope("Backup.AveSPWeb.Navigation"))
            {
                ...
                serializer.NeedBackupFullUrl = needFullUrl;  // This argument is used for CM
