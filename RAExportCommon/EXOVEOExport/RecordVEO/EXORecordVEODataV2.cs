...
{
    internal class EXORecordVEODataV2
    {
        ...
        internal EXORecordVEODataV2()
        {
            //YYYY[‘-‘MM[‘-‘DD[Thh’:’mm[‘:ss]Z[xx’:’yy]]]]
            DateTimeString = DateTime.Now.ToString("yyyy'-'MM'-'ddTHH':'mm':'sszzz");
        }

        internal RecordVEOClass.VERSEncapsulatedObject GeneratorVEOData(EXORecordVEOXML EXORecordVEOXML, EXORecordVEOParameters para, IExchangeItem EXOItem, string jobID, string exportPath, string filePath, string disposalClass)
        {
