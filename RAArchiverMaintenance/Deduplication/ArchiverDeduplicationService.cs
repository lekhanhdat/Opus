...
{
    internal class ArchiverDeduplicationService
    {
        ...
        public void DecreaseMediaDataSize(string jobId, long deletedSize)
        {
            ArchiverIndexSubInfoDao.UpdateArchiverIndexSubInfoMediaSizeAsync(jobId, deletedSize);
        }
    }
}
