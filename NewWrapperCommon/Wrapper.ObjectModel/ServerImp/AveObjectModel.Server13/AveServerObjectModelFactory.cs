...
using AvePoint.ObjectModel.Server13.Office;
...
namespace AvePoint.ObjectModel.Server13
{
    ...
    {
        internal const string SOIntegrationAssemblyName = "SP2013StorageOptimizationIntegration";
        internal const string SOIntegrationNameSpace = "AvePoint.StorageOptimization.Integration.";
        internal const string SOConnectorIntegrationAssemblyName = "SP2013ConnectorBusinessLogic";
        ...
        {
            get { return AveContextKind.Server13ObjectModel; }
        }
