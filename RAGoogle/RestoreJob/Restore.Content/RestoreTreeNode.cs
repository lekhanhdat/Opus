...
namespace RAGoogle.Restore.Content
{
    public class RestoreTreeNode
    {
        ...
        public GDriveDataType Type { get; set; }
    ...
    public class Restorer
    {
        ...
        public static GDriveDataType NodeValue2Type(NodeLevel value)
        {
            switch (value)
            {
                case NodeLevel.GoogleMyDrive:
                    return GDriveDataType.MyDrive;
                case NodeLevel.GoogleSharedDrive:
                    return GDriveDataType.SharedDrive;

                case NodeLevel.GoogleFolder:
                    return GDriveDataType.Folder;
                case NodeLevel.GoogleFile:
                    return GDriveDataType.File;
