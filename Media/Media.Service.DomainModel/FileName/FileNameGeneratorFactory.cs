...
namespace AvePoint.Media.Service.DomainModel
{
    ...
    public class FileNameGeneratorFactory : IFileNameGeneratorFactory
    {
        ...
        public IFileNameGenerator GetFileNameGenerator(ProductModule module = default(ProductModule), DataVersion dataVersion = DataVersion.Data6000)
        {
            return new ArchiverFileNameGenerator(); ;
        }
    }
}