...
namespace AvePoint.GCommon.Contract.Media.Object
{
    ...
    public class DataManagementBrowseInfo
    {
        public DataManagerTreeNodeDto Node { get; set; }
        ...
        public Dictionary<string, List<LogicalDeviceDto>> StorageDeviceMap { get; set; }

        public Boolean IsToLeafNode { get; set; }
        ...
        public override String ToString()
        {
            ...
            stringBuilder.AppendFormat("DataManager Browse Info: ");
