...
namespace AvePoint.RA.Web.Common.WIF
{
    ...
    //public class SignatureAuthorizeAttribute : Attribute, IAsyncAuthorizationFilter
    //{
    //    private RALogger logger = RALogger.GetInstance(typeof(SignatureAuthorizeAttribute));
    ...
    //        if (isAllowAnonymous)
    //        {
    //            logger.Info($"Anonymous request: {filterContext.HttpContext.Request?.GetUrl()?.LocalPath}");
    //        }
    //        else
    //        {
    //            await OnAuthorizationInternalAsync(filterContext);
    //        }
    //    }

    //    private async Task<bool> OnAuthorizationInternalAsync(AuthorizationFilterContext filterContext)
    //    {
    //        var request = filterContext.HttpContext.Request;
    //        if (filterContext.ActionDescriptor.EndpointMetadata.Any(a => a is SignatureAuthorizeAttribute))
    //        {
    ...
    //                catch (Exception)
    //                {
    //                    HandleUnauthorizedRequest(filterContext, HttpStatusCode.Unauthorized, "Access token is invalid.");
    ...
    //                {
    //                    HandleUnauthorizedRequest(filterContext, HttpStatusCode.Unauthorized, "Access token signature is invalid.");
    ...
    //                        HandleUnauthorizedRequest(filterContext, HttpStatusCode.Unauthorized, "Access token signature is expired.");
    ...
    //                    else
    //                    {
    //                        HandleUnauthorizedRequest(filterContext, HttpStatusCode.Unauthorized, "There is no user info.");
    ...
    //    {
    //        filterContext.Result = new ObjectResult(GetAuthorizedErrorMessage(message)) { StatusCode = (int)httpStatus };
    //    }

    //    private JObject GetAuthorizedErrorMessage(string message)
    //    {
    //        return new JObject
    //        {
