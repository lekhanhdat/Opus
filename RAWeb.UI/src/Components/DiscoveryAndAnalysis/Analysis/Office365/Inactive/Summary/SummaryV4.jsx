...
const InactiveSummaryV4 = ({ o365TenantId, jobInfo }) => {
    ...
    const queryNodeDataInfo = async (queryParameter) => {
        const res = await InactiveDataRequester.querySummaryNodesDataV3(
            queryParameter
        );
    ...
    const queryNodeTotalAggregateInfo = async (queryParameter) => {
        const res =
            await InactiveDataRequester.querySummaryNodeTotalAggregateInfoV3(
                queryParameter
            );
...
export default InactiveSummaryV4;
