...
{
    public class RMO365TenantSubJobControlConstants
    {
        public static readonly ImmutableHashSet<JobType> CONTROLLED_JOBS = new HashSet<JobType>
        {
