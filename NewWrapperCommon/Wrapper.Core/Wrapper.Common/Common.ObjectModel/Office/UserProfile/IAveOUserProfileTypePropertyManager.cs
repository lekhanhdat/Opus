...
{
    public interface IAveOUserProfileTypePropertyManager
    {
        IAveOUserProfileTypeProperty Create(IAveOUserProfileCoreProperty coreProperty);
        /// <summary>
        ...
        IAveOUserProfileTypeProperty GetTypePropertyByName(String name);
        /// <summary>
        ...
        /// <returns>IAveOUserProfileTypeProperty接口变量或对象</returns>
        IAveOUserProfileTypeProperty GetSectionPropertyByName(String name);
        /// <summary>
        ...
        void Add(IAveOUserProfileTypeProperty typeProperty);
    }
}
