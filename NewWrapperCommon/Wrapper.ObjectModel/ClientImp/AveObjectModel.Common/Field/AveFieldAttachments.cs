...
{
    class AveFieldAttachments : AveField, IAveFieldAttachments
    {
        ...
        public AveFieldAttachments(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, Dictionary<string, object> contentTypeProp, Dictionary<string, object> prop)
