...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldLinkCollection : AveAbstractCommonCollection<IAveFieldLink>, IAveFieldLinkCollection
    {
        ...
        public AveFieldLinkCollection(IAveRequest request, AveContentType contentType, Dictionary<string, object> fieldLinkColProperties)
        {
            mRequest = request;
        ...
        {
            List<Dictionary<string, object>> fieldLinkList = base.DataCache.GetProperty<List<Dictionary<string, object>>>(AveObjectModelConstant.ChildrenProperties);
            mListData = new List<IAveFieldLink>();
            foreach(Dictionary<string,object> fieldLinkProperties in fieldLinkList )
            {
