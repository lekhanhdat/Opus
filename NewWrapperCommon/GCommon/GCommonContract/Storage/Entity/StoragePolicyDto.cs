...
namespace AvePoint.GCommon.Contract.Storage.Entity
{
    ...
    public class StoragePolicyDto
    {
        ...
        private List<TimeBasedPolicy> timeBasedPolicys = new List<TimeBasedPolicy>();
        private List<EventBasedPolicy> eventBasedPolicys = new List<EventBasedPolicy>();
        private List<CycleBasedPolicy> cycleBasedPolicys = new List<CycleBasedPolicy>();
        #endregion
        ...
        [DataMember]
        public List<ServiceDto> MediaServiceDtos { set; get; }
        [DataMember]
        ...
        /// </summary>
        [DataMember]
        public List<MediaOrderInfo> MediaOrderInfos { get; set; }
    ...
    public class PRCyclePara
    {
        ...
        public override String ToString()
        {
            return String.Format("Cycle id:{0}, Job id:{1}", this.CycleId, this.JobId);
        }
    }
    ...
    public enum StoragePolicyType : int
    {
        ...
        ArchiveType = 2,
        [EnumMember]
        Both = 3, //据冠勋说明，这个只是为了考虑以后radio button 可能变成check box，留代扩展，实际现在应该不会出现这个值。
        [EnumMember]
        FSArchiveType = 4,
    }
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class MediaOrderInfo : IComparable<MediaOrderInfo>
    {
        /// <summary>
        /// Media排序序号从0开始
        /// </summary>
        ...
        public int CompareTo(MediaOrderInfo other)
        {
