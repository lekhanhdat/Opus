...
namespace AvePoint.GCommon.Transfer.MQ
{
    ...
    public class AveMQClient
    {
        ...
        public AveMQClient(string sessionId, string identifier, bool enableSsl)
        ...
        {
            return SendMessage(host, port, relatedBaseUri, jobId, identifier, DataTransferGlobalConfig.DataTransferConfiguration.MqConfig.MaxReconnectionTimeOut, msg);
        }
        #endregion
