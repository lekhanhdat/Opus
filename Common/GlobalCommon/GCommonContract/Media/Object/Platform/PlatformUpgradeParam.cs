...
namespace AvePoint.GCommon.Contract.Media.Object
{
    ...
    public class PlatformUpgradeParam
    {
        [DataMember]
        public List<EITreeNodeDto> TreeNodes { get; set; }
        ...
        [DataMember]
        public Int64 JobStartTime { get; set; }
        ...
        {
            return String.Format("Farm Name: {0}, Job Id: {1}, Job Type: {2}",
                this.FarmName,
                this.JobId,
                this.JobType);
        }
