...
namespace AvePoint.Wrapper.Common
{
    public interface IAveUtility
    {
        ...
        IAvePrincipalInfo ResolvePrincipal(IAveWeb web, string input, AvePrincipalType scopes, AvePrincipalSource sources, IAveUserCollection usersContainer, bool inputIsEmailOnly, bool ignoreDomainDiff = true);
        Dictionary<string, IAvePrincipalInfo> ResolvePrincipals(IAveWeb web, List<string> searchNames, AvePrincipalType scopes, AvePrincipalSource sources, IAveUserCollection usersContainer, bool inputIsEmailOnly, bool ignoreDomainDiff = true);
        ...
        void ShareObject(IAveWeb web, string url, string peoplePickerInput, string roleValue, int groupId, bool propagateAcl, bool sendEmail, bool includeAnonymousLinkInEmail, string emailSubject, string emailBody, bool useSimplifiedRoles);
        string CreateAnonymousLinkWithExpiration(IAveWeb web, string fileFullPath, bool isEditLink, long expirationTicks = default(long));
        string CreateOrganizationSharingLink(IAveWeb web, string fileFullPath, bool isEditLink);
    }
}
