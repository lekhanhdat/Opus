...
namespace AvePoint.GCommon
{
    public static class PerformanceMonitor
    {
        ...
        {
            mLog.Debug("---Performance---Module:{0},time(s):{1:F6}.", !string.IsNullOrEmpty(timer.DisplayName) ? timer.DisplayName : timer.Name, timer.GetTimerSecond());
        }
    ...
    public class AgentPerformanceScope : IDisposable
    {
        ...
        public AgentPerformanceScope(string moduleName, string detailInfo = "", bool addToStatistics = false)
        {
