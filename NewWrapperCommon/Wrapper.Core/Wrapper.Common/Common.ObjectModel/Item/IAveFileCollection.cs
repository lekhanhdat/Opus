...
namespace AvePoint.Wrapper.Common
{
    public interface IAveFileCollection : ICollection, IEnumerable<IAveFile>, IEnumerable
    {
        ...
        IAveFile Add(string urlOfFile, byte[] file, Hashtable properties, IAveUser createdBy, IAveUser modifiedBy, DateTime timeCreated, DateTime timeLastModified, bool overwrite);
