...
namespace AvePoint.Wrapper.Common
{
    public interface IAveUserCollection : ICollection, IEnumerable<IAveUser>, IEnumerable
    {
        ...
        IAveUser AddUser(IAveUser user);
        ...
        /// <summary>
        /// remove several users once
        /// </summary>
        /// <param name="ids"></param>
        void RemoveByIDs(List<int> ids);
        void AddOrRemoveUserInCache(IAveUser user, bool add);
        IAveUser GetDomainGroupByName(string title);
        IAveUser GetByEmail(string email);
        IAveUser GetByUPNName(string upn);
    }
