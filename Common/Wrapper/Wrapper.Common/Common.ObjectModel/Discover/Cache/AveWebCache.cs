...
namespace AvePoint.Wrapper.Common
{
    public class AveWebCache : AveDiscoverCache, IDisposable
    {
        ...
        public Dictionary<Guid, AveWebObject> GetSubWebs()
        {
            return Query.GetSubWebs(this.SiteId, this.WebId);
        }

        public Dictionary<Guid, AveListObject> GetLists(bool throwException = false)
        {
            return Query.QueryWebListForFB(this.SiteId, this.WebId, throwException);
        }
        ...
        {
            return Query.QueryWebContentTypeForIB(this.SiteId, this.WebId);
        }

        public List<AveProjectObject> GetProjects()
        {
            return Query.QueryProjects();
        }
