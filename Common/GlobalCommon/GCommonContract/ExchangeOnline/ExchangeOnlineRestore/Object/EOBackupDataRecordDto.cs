...
namespace AvePoint.GCommon.Contract.ExchangeOnline.ExchangeOnlineRestore.Object
{
    ...
    public class EOBackupDataRecordDto
    {
        [DataMember]
        ...
        [DataMember]
        public ServiceGroupDto BackupSrcAgentGroup { get; set; }
    }

    [DataContract(Namespace = ContractConstants.Namespace)]
    public class EOBackupDataCollectionDto
    {
        [DataMember]
        public List<EOBackupDataRecordDto> Jobs { get; set; }

        [DataMember]
        public List<SimpleDataDto> Plans { get; set; }
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public enum EOTimeStampType : int
    {
        [EnumMember]
        None = 0,
        [EnumMember]
