...
namespace AvePoint.GCommon.Contract.Media.Object
{
    ...
    using ExchangeOnline.ExchangeOnlineMailbox.Object;
    using Server.ControlPanel.Cryptography.Wrapper;

    #endregion using directives

    [DataContract(Namespace = ContractConstants.Namespace)]
    public class ExchangeRestoreBrowseParam
    {
        [DataMember]
        ...
        {
            return string.Format("ExchangeBrowseParam : Path: {0}, Level: {1}, Backup Job ID: {2}", Path, Level, BackupJobId);
        }
    }
}