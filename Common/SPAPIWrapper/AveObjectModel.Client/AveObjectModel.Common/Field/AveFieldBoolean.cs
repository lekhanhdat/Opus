...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldBoolean : AveField, IAveFieldBoolean
    {
        ...
        public AveFieldBoolean(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
