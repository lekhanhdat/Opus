...
namespace AvePoint.GCommon.Contract.Server.Common.Monitor.Object.Detail
{
    ...
    public class CentralAdminJobDetailDto : JobDetailDto
    {
        ...
        [DataMember]
        public string DeadAccountStatus { get; set; }
        ...
        [DataMember]
        public string CheckBrokenLinkEmailAddressFrom { get; set; }
        [DataMember]
        public string CheckBrokenLinkEmailAddress { get; set; }
        ...
        [DataMember]
        public string DeleteObjectsLevel { get; set; }

        [DataMember]
        public string DeleteObjectsURL { get; set; }

        [DataMember]
        public string DeleteObjectsTitle { get; set; }

        [DataMember]
        public string DeleteObjectsStatus { get; set; }

        [DataMember]
        public string DeleteObjectsComments { get; set; }

        #endregion

        #region
        [DataMember]
        public string FixProfileScope { get; set; }
        [DataMember]
        public string FixProfileUrl { get; set; }
        [DataMember]
        public string FixProfileName { get; set; }
        [DataMember]
        public string FixProfileLevel { get; set; }
        [DataMember]
        public string FixProfileProfileName { get; set; }
        [DataMember]
        public string FixProfileRuleName { get; set; }
        [DataMember]
        public string FixProfileCustomAction { get; set; }
        [DataMember]
        public string FixProfileStatus { get; set; }
        [DataMember]
        public string FixProfileComment { get; set; }
        #endregion
    }
}
