...
namespace AvePoint.GCommon.Contract.Replicator.Object
{
    ...
    public sealed class ReplicatorPlan : PlanDto
    {
        [DataMember]
        public List<ReplicatorMappingBase> Mappings { get; set; }

        [DataMember]
        public FarmDto DestFarm { get; set; }

        [DataMember]
        public List<ReplicatorSchedule> ReplicatorSchedules { get; set; }
