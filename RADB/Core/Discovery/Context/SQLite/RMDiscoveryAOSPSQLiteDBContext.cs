...
{
    public class RMDiscoveryAOSPSQLiteDBContext : IDisposable
    {
        public int Timeout { get; set; } = 60 * 10;

        private readonly SQLiteConnection _connection;

        public RMDiscoveryAOSPSQLiteDBContext(string connectionString)
        {
        ...
        {
            return ExecuteInsertAsync(items, RMDiscoveryAOSPSQLiteDBManager.GetSchemaName(o365TenantId));
        }
