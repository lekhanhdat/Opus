...
namespace AvePoint.ObjectModel.Server13
{
    class AveList : AveSecurableObject, IAveList, IDisposable
    {
        ...
        {
            get { return mList.ImageUrl; }
            set { mList.ImageUrl = value; }
        }
        ...
        public IAveListItem AddItem(AveItemCreationInformation itemCreationInfo)
        {
            ...
            return new AveListItem(this.Items as AveListItemCollection, mList.AddItem(rootFolderUrl, file, leafName));
        }
        ...
        {
            SPQuery query = new SPQuery();
            SPWeb tempWeb = mList.ParentWeb;
            {
                query.Folder = tempWeb.GetFolder(camlQuery.FolderServerRelativeUrl);
            }
        ...
        {
            return new AveListItem(this.Items as AveListItemCollection, mList.AddItem(folderUrl, (SPFileSystemObjectType)underlyingObjectType, leafName));
        }
        ...
        public void RestoreListRatingSetting(AveListSettingInfo info)
        {
            ...
            //{
            //    Type type = AveAssemblyUtility.GetType("Microsoft.SharePoint.Portal, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c", "Microsoft.SharePoint.Portal.ReputationHelper");
                ...
                try
                {
                    ...
                    else
                    {
                        if (sourceEnable)
                        {
                            ...
                            Guid ratings = (AveEnv.IsSharePoint2013 || AveEnv.IsSharePoint2010 || AveEnv.IsSharePoint2007) ? publishing.Ratings : Guid.Empty;
                            Guid ratingsCount = (AveEnv.IsSharePoint2013 || AveEnv.IsSharePoint2010 || AveEnv.IsSharePoint2007) ? publishing.RatingsCount : Guid.Empty;
                            Guid likesCount = (AveEnv.IsSharePoint2013 || AveEnv.IsSharePoint2010 || AveEnv.IsSharePoint2007) ? publishing.LikesCount : Guid.Empty;

                            Guid averageRatings = (AveEnv.IsSharePoint2013 || AveEnv.IsSharePoint2010 || AveEnv.IsSharePoint2007) ? publishing.AverageRatings : Guid.Empty;
                            Guid likedBy = (AveEnv.IsSharePoint2013 || AveEnv.IsSharePoint2010 || AveEnv.IsSharePoint2007) ? publishing.LikedBy : Guid.Empty;
                            Guid ratedBy = (AveEnv.IsSharePoint2013 || AveEnv.IsSharePoint2010 || AveEnv.IsSharePoint2007) ? publishing.RatedBy : Guid.Empty;
        ...
        public bool EnableManagedIndexes { get; set; }
        ...
        /// <summary>
        /// O365支持该Property on-premise不支持，返回 Default value
        /// </summary>
        public AveListExperience ListExperienceOptions
        {
            get
            {
                return AveListExperience.Auto;
            }
