...
{
    internal class RMHoldManagerNotificationEmailCompiler : IRMEmailCompiler
    {
        public RMEmailTemplateType TemplateType => RMEmailTemplateType.HoldManagerNotification;
        ...
        public string CompileBody(string body, RMEmailTemplateParameters parameters)
        {
            ...
            var jobNotificationParameters = parameters as RMHoldManagerEmailTemplateParameters;
