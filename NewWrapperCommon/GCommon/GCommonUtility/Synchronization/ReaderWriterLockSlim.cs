...
namespace AvePoint.GCommon.Utility.Synchronization
{
    ...
    [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "ReaderWriterLockSlim is unmodifiable as the cause of being referenced.")]
