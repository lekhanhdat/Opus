...
namespace AvePoint.GCommon.Contract.Server.Login
{
    ...
    public class BuildinAccountCredential : BaseCredential
    {
        #region ICredential Members
        public override AveAuthenticationTypes LogonType
        {
            get
            {
                return AveAuthenticationTypes.LocalSystem;
            }
        ...
        [DataMember]
        public byte[] LoginCredential { get; set; }
        [DataMember]
