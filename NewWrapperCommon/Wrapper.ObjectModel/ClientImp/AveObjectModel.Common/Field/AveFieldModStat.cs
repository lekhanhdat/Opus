...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldModStat:AveFieldChoice,IAveFieldModStat
    {
        ...
        public AveFieldModStat(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, Dictionary<string, object> contentTypeProp, Dictionary<string, object> prop)
