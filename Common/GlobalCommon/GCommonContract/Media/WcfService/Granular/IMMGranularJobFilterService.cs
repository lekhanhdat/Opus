...
namespace AvePoint.GCommon.Contract.Media.WcfService
{
    ...
    public interface IMMGranularJobFilterService
    {
        List<BackupDataRecordDto> GranularBackupJobFilter(BackupDataFilterDto param, List<SiteMasterIndexDto> indexDtos);
    }
}