...
{
    public interface IRMSiteDeletedSizeInfoDao : IBaseDao<RMSiteDeletedSizeInfo>
    {
        public Task<List<RMSiteDeletedSizeInfo>> GetSiteDeleteSizeInfoBySiteUrlAsync(string siteUrl);
        public Task CreateInfo(RMSiteDeletedSizeInfo info);
        public Task DeleteInfoBySiteUrl(string siteUrl);
