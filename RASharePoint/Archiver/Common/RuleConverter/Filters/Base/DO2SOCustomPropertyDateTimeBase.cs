...
{
    internal class DO2SOCustomPropertyDateTimeBase<T> : DO2SOFilterConverterBase
        where T : PolicyRuleBase, new()
    {
        ...
        public DO2SOCustomPropertyDateTimeBase(string value1, int startSequenceNo, DateTimeConditionType condition, string extraValue, PolicyValueUnit unit)
        {
            this.mValue1 = value1;
