...
namespace AvePoint.ObjectModel.Server13
{
    class AveBestBet : IAveBestBet
    {
        ...
        {
            mBestBet.AttachContext((cx as ObjectModel.Server13.Search.AveContext).Context);
        }

        public void DetachContext(Wrapper.Common.Search.IAveContext cx)
        {
            mBestBet.DetachContext((cx as ObjectModel.Server13.Search.AveContext).Context);
        }
