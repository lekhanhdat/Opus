...
namespace OpenNLP.Tools.Util
{
	...
	public class Sequence : IComparable
	{
		...
		/// </returns>
		public virtual IReadOnlyList<string> Outcomes
		{
			get
			{
		...
		private IReadOnlyList<double> Probabilities
		{
			get
			{
				return _probabilities.AsReadOnly();
			}
		}
		...
		public override bool Equals (object o)
		{
			...
			return double.Equals(_score, sequence.Score);
		}  
		...
		public static bool operator == (Sequence firstSequence, Sequence secondSequence)
		{
			...
			return double.Equals(firstSequence.Score, secondSequence.Score);
		}  
