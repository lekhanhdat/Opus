...
{
    public class RuleIdNotContainsQueryBuilder : BaseArrayNotContainFilterBuilder
    {       
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && filterOption.ExceptRuleIds != null && filterOption.ExceptRuleIds.Count > 0;
        }
        ...
        {
            return filterOption.ExceptRuleIds;
        }
    }
}
