...
namespace AvePoint.Wrapper.Common
{
    ...
    public enum AveDateTimeFieldFriendlyFormatType
    {
        Unspecified = 0,
        Disabled = 1,
        Relative = 2,
    ...
    public enum AveOpenBinaryOptions
    {
        ...
        ForceAVScanIfPreviouslyUnscanned = 0x400000,
        GetAsZipStreamBundleFriendly = 0x800000,
        SkipDisallowInfectedFileDownloadCheck = 0x2000000
    }
    ...
    public enum AveUserSharingCapabilities
    {
        None = 0,
    ...
    public enum AveSkipType
    {
        Unknown = 0,
        WorkFlowHistoryList = 1,
        RootWebOnlyList = 2,
        SpecialTemplateList = 3,
        WorkflowRelatedList,
    }

    public enum AvePersonalSiteCapabilities
    {
        None = 0,
        Profile = 1,
        Social = 2,
    ...
    public enum AvePersonalSiteInstantiationState
    {
        Uninitialized,
        Enqueued,
        Created,
    ...
    [System.Flags]
    public enum AveWebSettingTypes
    {
        All = -1,
        None = 0,
        SiteRegionalSettings = 1,
        SiteAccessSettings = 2,
        SiteSharePointDesignerSettings = 4,
        SiteLanguageSettings = 8,
        SiteAuditSettings = 16,
        SiteOtherSettings = 32,
        SiteTitleAndDescription = 64,
        SiteLookAndFeel = 128,
        SubAll = 235
    }
    public enum AveThemeGalleryState 
    {
        None = 0,
        NeedBakup = 1,
        AlreadyBackupBySite = 2,
        AlreadyBackupBySC = 3
        
    }
    public enum AveSharingLinkKind
    {
        Uninitialized,
        Direct,
        OrganizationView,
    ...
    public enum AveSharingPermissionType
    {
        None = 0,
        View = 1,
        Edit = 2,
    ...
    public enum AveSharingLinkType
    {
        None = 0,
        Direct = 1,
        Internal = 2,
    ...
    public enum AveHeaderLayoutType
    {
        None = 0,
        Standard = 1,
        Compact = 2,
    ...
    public enum AveSPVariantThemeType
    {
        None = 0,
        Neutral = 1,
        Soft = 2,
