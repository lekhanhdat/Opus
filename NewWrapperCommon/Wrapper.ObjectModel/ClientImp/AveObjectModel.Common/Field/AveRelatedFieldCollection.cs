...
namespace AvePoint.ObjectModel.Common
{
    class AveRelatedFieldCollection : AveAbstractCommonCollection<IAveRelatedField>, IAveRelatedFieldCollection
    {
        ...
        {
            List<Dictionary<string, object>> relatedFieldsProperties = base.DataCache.GetProperty<List<Dictionary<string, object>>>(AveObjectModelConstant.ChildrenProperties);
            foreach (Dictionary<string, object> relatedFieldProperties in relatedFieldsProperties)
            {
