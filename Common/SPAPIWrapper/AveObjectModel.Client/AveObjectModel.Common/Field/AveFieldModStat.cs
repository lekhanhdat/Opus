...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldModStat:AveFieldChoice,IAveFieldModStat
    {
        ...
        public AveFieldModStat(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
