...
{
    public static class RMDiscoveryFSWithoutInDateQueryParameterExtension
    {
        public static bool TryGetSqlDefinition(this RMDiscoveryFSWithoutInDateQueryParameter parameter, string dataTableAlias, out RMDiscoverySqlDefinition sqlDefinition)
        {
            sqlDefinition = null;
