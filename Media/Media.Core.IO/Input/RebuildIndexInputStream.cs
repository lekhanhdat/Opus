    ...
    public class RebuildIndexInputStream : IRebuildIndexInputStream
    {
        ...
        private void GetNextMetaStream()
        {
            string metaDataFileName = this.files.Find(fileName =>
                ...
                fileName.LastIndexOf(".", StringComparison.OrdinalIgnoreCase) - fileName.LastIndexOf("_", StringComparison.OrdinalIgnoreCase) - 1).EqualsIgnoreCase((this.metaBlockNum + 1).ToString()));
