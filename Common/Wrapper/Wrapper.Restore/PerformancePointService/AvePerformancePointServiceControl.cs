...
namespace AvePoint.Wrapper.Restore
{
    public class AvePerformancePointServiceControl : IDisposable
    {
        ...
        {
#if PerformanceLog
            using (AvePerformanceScope pc = new AvePerformanceScope("Restore.AvePerformancePointSerciveControl.ProcessItemByWeb"))
            {
#endif
                try
                {
        ...
        {
#if PerformanceLog
            using (AvePerformanceScope pc = new AvePerformanceScope("Restore.AvePerformancePointSerciveControl.ProcessByItemId"))
            {
#endif
