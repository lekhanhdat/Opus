...
namespace AvePoint.RA.DB.Dao
{
    public interface ISecurityProfileDao
    {
        ...
        int Update(RADataEncryptionProfile profile);
        int UpdateProfileStatus4TimeoutJobs();
        int UpdateJobStatus(int id, RMSwitchSecurityProfileJobStatus status);
        Dictionary<string, int> GetSwitchProfileTenants();
    }
}
