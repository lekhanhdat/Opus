...
namespace AvePoint.Wrapper.Common
{
    class AveInternalRestoreStream : Stream
    {
        ...
        protected virtual void SafeRead(byte[] buffer, int offset, int length)
        {
            if (inputStream.ReadMetadata(buffer, offset, length) == 0) throw new EndOfStreamException("Unexpected end of stream.");
        }
