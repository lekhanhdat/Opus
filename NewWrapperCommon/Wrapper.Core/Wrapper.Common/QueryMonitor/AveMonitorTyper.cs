...
namespace AvePoint.Wrapper.Common
{
    ...
    public class AveMonitorTyper
    {
        ...
        private static string monitorLogPath;
        private static int defaultLogFileCount = 5;
        ...
        static AveMonitorTyper()
        {
            ...
            {
                mLog.Log(AveLogLevel.WARN, WrapperQueryServiceResource.InstantiatedError, ex);
        ...
        public static void WriteToFile(string processName, string logContent)
        {
            lock (locker)
            {
                if (!string.IsNullOrEmpty(monitorLogPath))
                {
                    ...
                    {
                        mLog.Log(AveLogLevel.WARN, WrapperQueryServiceResource.WriteToFileError, ex);
                    }
                }
            }
        }
