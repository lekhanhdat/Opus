...
{
    class Ave2019PageFileRestore : Ave2019BaseDocumentRestore
    {

        public Ave2019PageFileRestore(AveClientContext context, AveClientOM2019Request request, object authentication, AveDocumentInfo docInfo, Stream fileStream)
