...
namespace AvePoint.Wrapper.Common
{
    ...
    public class AveSearchInfo
    {
        ...
        public AveNavigationInfoList SearchNav = new AveNavigationInfoList();

        #region SP13
        public string SearchQueryConfigurationSettingString;
        public string SchemaConfigurationString;

        #region Add in DocAve6.6
        public Dictionary<Guid, bool> BuildInQueryRuleSetting = new Dictionary<Guid, bool>();
        public Dictionary<string, bool> SSAQueryRuleSetting = new Dictionary<string, bool>(StringComparer.OrdinalIgnoreCase);
        #endregion
        #endregion
    }
