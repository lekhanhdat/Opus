...
namespace AvePoint.Wrapper.Mapping
{
    ...
    public class AveCustomUserAndDomainMapping : IAveCustomUserAndDomainMapping
    {
        ...
        public Dictionary<string, string> customUserMappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
        ...
        public void SetUserAndDomainMappings(Dictionary<string, string> userMappings, Dictionary<string, string> domainMappings)
        {
            ...
            {
                foreach (KeyValuePair<string, string> user in userMappings)
                {
