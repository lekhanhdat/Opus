...
namespace AvePoint.GCommon.Contract.Storage.Entity
{
    ...
    public class SystemProfileDto : IProfileContent
    {
        ...
        [DataMember]
        [XmlAttribute("filerName")]
        public string FilerName { get; set; }

        [DataMember]
        [XmlAttribute("IsASUPLogEnabled")]
        public Boolean IsASUPLogEnabled { get; set; }

        [DataMember]
        [XmlAttribute("systemProfileType")]
        public SystemProfileType SystemProfileType { get; set; }

        [DataMember]
        public List<FolderTarget> FolderTargetList { get; set; }
        ...
        [OnDeserializing]
        public void SetValuesOnDeserializing(StreamingContext context)
        {
            IsASUPLogEnabled = true;
        }

        public String EnableASUPLog { get; set; }
    }
    ...
    public class OntapItemInfo
    {
        ...
        [DataMember]
        [XmlAttribute("FCInitiatorWWPN")]
        public string FCInitiatorWWPN { get; set; }
    }
    ...
    public class ErrorMessageKey
    {
        ...
        public const string FOLDER_TARGET = "FolderTarget";
    }
    ...
    public class SystemProfileDetailDto
    {
        ...
        [DataMember]
        public long FreeSpace { get; set; }    //剩余���间
    }
