...
namespace AvePoint.Wrapper.Common
{
    public sealed class AveCommunitiesConstants
    {
        ...
        public static readonly string CommunityBuildinDiscussionListName = "Discussions List";
        public static readonly string CommunityBuildinCategoriesList = "Categories";
        public static readonly string CommunityBuildinMemberList = "Community Members";
        ...
        public static readonly Guid CommunityDiscussion_BestAnswerId_FieldId = new Guid("{a8b93fba-7396-443d-9884-ee332caa4560}");
