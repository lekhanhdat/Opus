...
namespace RASPAppWeb
{
    ...
    {
        private static RALogger logger = RALogger.GetInstance(typeof(TokenHelper));
        ...
        public static SharePointContextToken ReadAndValidateContextToken(string contextTokenString, string appHostName = null)
        {
            ...
            logger.Info($"context token is null {string.IsNullOrEmpty(contextTokenString)} security  keys count{securityKeys.Count}");
            ...
            {
                logger.Warn($"Validate token by context e{e} ");
        ...
        private static readonly string IssuerId = string.IsNullOrEmpty(ConfigurationManager.AppSettings.Get("IssuerId")) ? ClientId : ConfigurationManager.AppSettings.Get("IssuerId");
    ...
    [Serializable]
    internal class AudienceUriValidationFailedException: Exception
    {
        public AudienceUriValidationFailedException(string msg) : base(msg)
        {
