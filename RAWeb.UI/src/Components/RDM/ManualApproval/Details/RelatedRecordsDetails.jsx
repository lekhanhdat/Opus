...
const BuildRelatedRecordsDetails = (record) =>{
    ...
    if(record.fileExtension === RMResx.RM_RDM_RecordDetails_DataType_SPItem && record.sourceFlag != 5){
        linkType = "itemLink";
    }
    ...
    return [
        ...
        {key : 4, column : StringUtil.trimEndColon(RMResx.RM_JS_BCM_Explorer_Datagrid_FileType) ,value : fileExtension ,type:""},
        {key : 5, column : RMResx.RM_JS_MA_Grid_ApprovalStatus ,value : approvalStatus ,type:""},
        {key : 6, column : RMResx.RM_JS_MA_Grid_Rule ,value : record.ruleName ,type:""},
        {key : 7, column : RMResx.RM_JS_Rule_DisposalClass_Title ,value : record.ruleDisposalClass ,type:""},
        {key : 8, column : RMResx.RM_JS_MA_Grid_RelatedRecords ,value : record.relatedRecords, type: "related"},
        {key : 9, column : RMResx.RM_JS_MA_Grid_RelatedRecordsAction , value : disposalAction , type : ""},
        {key : 10, column : RMResx.RM_MA_Grid_EscalateOrReassignFrom ,value : record.escalateFromDisplayName ,type:""},        
        {key : 11, column : RMResx.RM_JS_MA_Grid_RecordOwner ,value : record.reviewerDisplayNames.join("; ") ,type:""},
        {key : 12, column : RMResx.RM_JS_MA_Grid_Reassigned_Comment ,value : record.escalatedComment ,type:""},
        {key : 13, column : RMResx.RM_JS_MA_Grid_ModifiedBy ,value : record.modifiedBy ,type:""},
        {key : 14, column : RMResx.RM_JS_MA_Grid_ModifiedTime ,value : record.modifiedTime ,type:""},
        {key : 15, column : RMResx.RM_JS_MA_Grid_CreatedBy ,value : record.createdBy ,type:""},
        {key : 16, column : RMResx.RM_JS_MA_Grid_CreatedTime ,value : record.collectionTime ,type:""},
    ];
};


const RelatedRecordsDetails = forwardRef ((props, ref) =>{
    ...
    useImperativeHandle(ref, () => ({
        onShow: (record) => {
            setIsShow(true);
            setRecord(record);
            setColumns(BuildRelatedRecordsDetails(record));
        }
    }));
...
RelatedRecordsDetails.displayName = "RelatedRecordsDetails";

export default RelatedRecordsDetails;