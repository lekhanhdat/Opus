...
namespace AvePoint.Api.Web.ApiControllers
{
    ...
    public class ProvisionController : RAWebApiBase
    {
        ...
        [APIScopeFilter(ContractConstants.HybridInernalScope)]
        public Task<bool> ProvisionSPSite([FromBody]ProvisionSPSiteInfo siteInfo)
        {
            return SaveProvisioningContainerAsync(siteInfo.TenantID, siteInfo.WebUrl, null);
        }

        [HttpPost]
        //[TypeFilter(typeof(APIRateLimitFilter))]
        [APIScopeFilter(ContractConstants.HybridInernalScope)]
        public Task<bool> ProvisionSPList([FromBody]ProvisionSPListInfo listInfo)
        {
