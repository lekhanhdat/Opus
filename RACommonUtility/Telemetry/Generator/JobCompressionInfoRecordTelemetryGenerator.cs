...
{
    public class JobCompressionInfoRecordTelemetryGenerator : TelemetryGenerator
    {
        public override TelemetryModule Module => TelemetryModule.JobCompressionInfoRecord;
        ...
        {
            return args[0] as CloudRecordsCompressionRecord;
        }
    }
}
