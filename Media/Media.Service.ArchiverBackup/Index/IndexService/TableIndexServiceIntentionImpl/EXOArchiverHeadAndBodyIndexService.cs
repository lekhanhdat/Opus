...
{
    public class EXOArchiverHeadAndBodyIndexService : EXOArchiverTableIndexServiceBase
        , IEXOArchiverHeadAndBodyIndexService
    {
        public void InsertArchiveIndexes(List<ExchangeBasicIndex> indexes)
        {
