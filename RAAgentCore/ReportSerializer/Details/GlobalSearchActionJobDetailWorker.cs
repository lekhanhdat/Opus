...
{
    public class GlobalSearchActionJobDetailWorker : AbstractDetailWorker
    {
        public override List<List<ReportCell>> ConvertReportData(IEnumerable<JMJobDetails> details)
        {
            ...
            {
                if (detail is JMGlobalSearchActionJobDetails)
                {
                    List<ReportCell> reports = new List<ReportCell>();
                    JMGlobalSearchActionJobDetails reportnfo = detail as JMGlobalSearchActionJobDetails;
        ...
        public override void InitCreateTableSQLString()
        {
            ...
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_Explorer_GlobalSearchAction, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_Explorer_GlobalSearchAction, TABLE_NAME);
        }
    }
}
