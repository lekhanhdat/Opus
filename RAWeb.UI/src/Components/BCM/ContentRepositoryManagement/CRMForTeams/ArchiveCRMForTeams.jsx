...
import TeamsGeneralSetting from "../ArchiveGeneralSetting/Context/TeamsGeneralSetting";
...
import TeamsArchiveSetting from "../ArchiveSetting/Context/TeamsArchiveSetting";
import ArchiveTeamsScheduleSetting from "../ScheduleSetting/Context/ArchiveTeamsScheduleSetting";
...
export default class ArchiveCRMForTeams extends R.Component {
    idAttr = true;
    constructor(props) {
        super(props);
        ...
        this.runSOJobButtons = {
            isGroup: true, id: "raCrmRunSOJobBtnGroup", name: RMResx.RM_AR_SPS_RunNow, buttons: [
                { id: "raCrmRunRuleActionBtn", name: RMResx.RM_AR_SPS_Teams_RunJobBtn, onClick: this.runJobMessageBox.bind(this, RunJobButtonType.ArchiverJobBtn) },
                { id: "raCrmRunImportSCBtn", name: RMResx.RM_AR_SPS_Teams_ImportSC, onClick: this.showImportSCClick.bind(this) },
            ]
        };
    ...
    loadRules = async (reload) => {
        if (this.state.needLoadRules || reload) {
            ...
            try {
                ...
                const result = await fetchUtility({ url: '/api/TeamsSettingApi/LoadArchiverRules', method: 'post', data: groupNode.Id });
                if (result) {
    ...
    loadNodeSettings(reload) {
        ...
        $$.loading(true);
        let option = {
            url: "/api/TeamsSettingApi/LoadArchiverNodeSettings",
            method: "Post",
            data: nodeItem
        };
        fetchUtility(option).then((result) => {
            ...
            if (result) {
                ...
                if (settingNode.Level === NodeLevel.WebApplication || settingNode.Level === NodeLevel.Office365GroupEntire || settingNode.Level === NodeLevel.SiteCollection) {
                ...
                if (checkPermission(RouterUrls.CP_Index, RM.UserResources) && (CRMCommonUtil.isGroup(this.settingNode) || CRMCommonUtil.isTeams(settingNode) || CRMCommonUtil.isSiteCollection(this.settingNode))) {
    ...
    inheritParentDoAction() {
        $$.messagedialog(false);
        let option = {
            url: "/api/TeamsSettingApi/InheritParentArchiverSettings",
            method: "Post",
    ...
    inheritSubnodeDoAction() {
        $$.messagedialog(false);
        let option = {
            url: "/api/TeamsSettingApi/InheritSubNodeToCurrentSettings",
            method: "Post",
            data: this.settingNode
        };
        fetchUtility(option).then((result) => {
    ...
    runJobDoAction(buttonType) {
        ...
        let option = {
            url: buttonType === RunJobButtonType.ArchiverJobBtn ? "/api/TeamsSettingApi/RunArchiverJob" : "/api/TeamsSettingApi/RunSOPreScanJob",
            method: "Post",
            data: this.settingNode
        };
    ...
    onExportArchiveSPSetting = () => {
        const option = {
            url: "/api/BCMAdminTeamsSettingApi/ExportTeamsSOSetting",
            method: "POST",
    ...
    renderImportSCPanel() {
        return <R.Panel
            header={RMResx.RM_AR_SPS_Teams_ImportSC}
            size={670}
    ...
    render() {
        return <div id="rmCRM">
            <section className="crm-header">
                ...
                <CheckRemoteNodeMessageBar treeSource={SourceFlags.Teams} />
                <TopButtonsComponent
                        ...
                        <div className="ra-splitter-right">
                            ...
                            {this.settingNode && this.state.showRightSetting && <div>
                                <GeneralSettingComponent
                                    ...
                                    context={TeamsGeneralSetting.getContext()}
                            ...
                            {this.state.showRightSetting && this.state.enableClassification == EnableRecordManagementSetting.Enable && <div>
                                <ArchiveSettingComponent
                                    ...
                                    context={TeamsArchiveSetting.getContext()}
                                    refreshNodeSettings={this.refreshNodeSettings}
                                ...
                                <ScheduleSettingComponent
                                    ...
                                    context={ArchiveTeamsScheduleSetting.getContext()}
                                    refreshNodeSettings={this.refreshNodeSettings}
                                ></ScheduleSettingComponent>
                            </div>}
                        </div>
