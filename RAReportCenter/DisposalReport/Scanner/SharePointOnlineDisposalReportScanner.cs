...
{
    //public class SharePointOnlineDisposalReportScanner : DisposalReportScanner<SharePointOnlineNeedReportNode>
    //{

    //    private readonly SharePointOnlineTreeQuerier querier = new SharePointOnlineTreeQuerier();

    //    public SharePointOnlineDisposalReportScanner(DisposalReportModel reportInfo) : base(reportInfo) { }
