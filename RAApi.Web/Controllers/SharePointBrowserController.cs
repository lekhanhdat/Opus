...
{
    [Route("api/sharepointbrowser/[action]")]
    [APIScopeFilter(AvePoint.RA.Contract.Common.ContractConstants.HybridInernalScope)]
    public class SharePointBrowserController: RAWebApiBase
    {

        private static readonly RALogger s_logger = RALogger.GetInstance(typeof(SharePointBrowserController));
