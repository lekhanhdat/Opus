...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldCurrency : AveFieldNumber, IAveFieldCurrency
    {
        ...
        public AveFieldCurrency(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
