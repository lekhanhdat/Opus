...
{
    class AveContentTypeUserResource : AveUserResource
    {
        ...
        protected virtual string ContentTypeId { get; }
        protected virtual string ResourceName { get; }

        public AveContentTypeUserResource(IAveRequest request, string webServerRelativeUrl, IAveList aveList, string contentTypeSource, string resourceName,string contentTypeId, AveClientObjectData dataCache)
        {
            // TODO: Complete member initialization
            this.mRequest = request;
            this.mWebServerRelativeUrl = webServerRelativeUrl;
            this.mFieldSource = contentTypeSource;
        ...
        {
            return mRequest.GetContentTypeUserResource(mWebServerRelativeUrl, mListId, mListTitle, mFieldSource, ResourceName, ContentTypeId, cultureName);
        }

        protected override void InternalUpdate(Dictionary<string, string> changedTitle)
        {
            this.mDataCache.AddChangedProperty(ResourceName, changedTitle);
        }
    }
}
