...
{
    public interface IAveOUserProfileCorePropertyManager
    {

        IAveOUserProfileCoreProperty Create(bool isSection);
        /// <summary>
        ...
        IAveOUserProfileCoreProperty GetCorePropertyByName(String name);
        /// <summary>
        ...
        /// <returns>IAveOUserProfileCoreProperty接口变量或对象</returns>
        IAveOUserProfileCoreProperty GetSectionPropertyByName(String name);
        /// <summary>
        ...
        void Add(IAveOUserProfileCoreProperty coreProperty);
