...
{
    public class OnPremSPLeaveStubFileReceiver : IFileReceiver, IDisposable
    {
        #region - Params -
        ...
        public OnPremSPLeaveStubFileReceiver()
        {
        }

        public OnPremSPLeaveStubFileReceiver(string fileName)
        {
