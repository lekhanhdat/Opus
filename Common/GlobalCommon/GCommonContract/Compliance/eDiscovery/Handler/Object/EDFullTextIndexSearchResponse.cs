...
namespace AvePoint.GCommon.Contract.Compliance.eDiscovery.Handler.Object
{
    ...
    public class EDFullTextIndexSearchResponse : EDiscoveryResponse
    {

        public EDFullTextIndexSearchResponse()
        {
            FallarProfile = new Dictionary<string, string>();
            HeldFiles = new List<HeldFileDto>();
        }
