...
{
    public class AveOneDriveDocumentRestore : BaseDocumentRestore
    {
        public AveOneDriveDocumentRestore(AveClientContext context, AveClientOM2013Request request, object authentication, AveDocumentInfo docInfo, Stream fileStream)
        ...
        private void AddNewFile()
        {
            ...
            File = ParentWeb.GetFolderByServerRelativeUrl(DocInfo.ParentFolderRelativeUrl).Files.Add(new FileCreationInformation { ContentStream = FileStream, Url = FileServerRelativeUrl, Overwrite = true });
            if (!LoadFileInfo(File))
            {
                    ...
                    ContainsVideoContentType())
                {
                    ...
                    File = ParentWeb.GetFileByServerRelativeUrl(FileServerRelativeUrl);
                    LoadFileInfo(File);
                }
            }
