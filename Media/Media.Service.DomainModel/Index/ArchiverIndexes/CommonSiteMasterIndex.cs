...
{
    [Table(IndexConstants.TableNameCommonSiteMaster)]
    public class CommonSiteMasterIndex : IndexBase
    {
        [Column("COL_ID")]
        ...
        public override String ToString()
        {
            ...
            sb.Append("CommonSiteMasterIndex: JobId:");
        ...
        public override Dictionary<String, Object> GenerateInsertDatabaseParameters()
        {
            ...
            dic.Add("@COL_TEAMS_ID", this.TeamsId);
            ...
            dic.Add("@COL_DATATYPE", this.DataType);
