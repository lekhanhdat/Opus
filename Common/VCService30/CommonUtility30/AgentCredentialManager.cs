...
namespace AvePoint.Common
{
    ...
    public class AgentCredentialManager
    {
        ...
        public static Tuple<string, string, string> GetAgentCredential()
        {
            ...
            {
                logger.Warn("An error occurred while retrieving agent account from manager. Exception details: {0}", ex.ToString());

                Tuple<string, string, string> credential = AgentCacheManager.GetCachedAgentCredential();
