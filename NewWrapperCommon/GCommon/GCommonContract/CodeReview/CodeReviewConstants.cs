...
namespace AvePoint.GCommon.Contract.CodeReview
{
    ...
    public class CodeReviewConstants
    {
        //Accessibility
        ///<summary>
        ///​针对页面上的纯图片(不能点击, 不能focus), 需要添加Alt Text.
        /// </summary>
        public const string CHECK_LIST_ID_A11Y_1 = "A11Y-1";

        ///<summary>
        ///​针对可获取焦点的图片(可以点击，类似于Button), 需要添加Alt Text.
        /// </summary>
        public const string CHECK_LIST_ID_A11Y_2 = "A11Y-2";

        ///<summary>
        ///针对输入框TextBox, PasswordBox, 需要添加LabelBy.
        /// </summary>
        public const string CHECK_LIST_ID_A11Y_3 = "A11Y-3";

        ///<summary>
        ///​页面上焦点顺序正确, 不能丢失焦点.
        /// </summary>
        public const string CHECK_LIST_ID_A11Y_4 = "A11Y-4";

        ///<summary>
        ///​自定义控件需要支持正确读音.
        /// </summary>
        public const string CHECK_LIST_ID_A11Y_5 = "A11Y-5";
        ...
        ///<summary>
        ///​当查询的表带索引时, 注意查询条件要尽可能的向索引靠拢, 避免全表扫描.
        /// </summary>
        public const string CHECK_LIST_ID_DB_6 = "DB-6";
