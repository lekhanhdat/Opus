...
{
    public class RetentionJobTelemetryGenerator : TelemetryGenerator
    {
        public override TelemetryModule Module => TelemetryModule.RetentionJob;
        ...
        {
            return args[0] as CloudRecordsRetentionTelemetryRecord;
        }
