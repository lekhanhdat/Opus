...
{
    [Table("RMOptimizationSettingsInfo")]
    public class RMDiscoveryOffice365OptimizationSettingsInfo : RMDiscoveryDBTable
    {
        [Key]
    ...
    public class RMDiscoverOptimizationJobInfo
    {
        public RMDiscoveryOffice365TenantInfo o365Info { get; set; }
        public RMDiscoveryOffice365OptimizationSettingsInfo settingInfo { get; set; }
    }
