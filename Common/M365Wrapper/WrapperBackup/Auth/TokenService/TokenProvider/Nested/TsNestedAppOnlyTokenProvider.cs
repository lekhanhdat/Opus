...
class TsNestedAppOnlyTokenProvider : TsNestedTokenProviderBase
{
    public override NestedTokenProviderType TokenFactoryType
    {
        get
        {
            return NestedTokenProviderType.ApplicationBear;
        }
    }
    ...
    public TsNestedAppOnlyTokenProvider(IModernTokenService tokenService, string customerId, string tenantId, IdentityProviderType appType, string appId)
