...
namespace  AvePoint.Hybrid.Utility.Util
{
    ...
    {
        public static void ThrowIfNull(object arg, string msg)
        {
            if (arg == null)
            {
        ...
        public static void ThrowIfNullOrEmpty(object arg, string msg)
        {
        ...
        public static Exception NotSupportedException(string msg)
        {
