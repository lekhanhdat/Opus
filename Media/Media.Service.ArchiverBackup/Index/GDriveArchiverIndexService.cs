...
{
    public class GDriveArchiverIndexService:IIndexService<GDriveIndexServiceOpenParameter>
    {
        private RALogger logger = RALogger.GetInstance(typeof(ArchiverIndexService));
        GDriveIndexServiceOpenParameter indexServiceOpenParam;
        public ArchiverIndexService _IndexService { get; set; }
        public IIndexProcessor<GDriveArchiverIndexProcessorParameter> IndexProcessor = new IndexProcessor<GDriveArchiverIndexProcessorParameter>();
        ...
        public void Open(GDriveIndexServiceOpenParameter openParam)
        {
        ...
        public void DeleteFileForJob(GDriveIndexServiceOpenParameter openParam)
        {
            this.indexServiceOpenParam = openParam;
            openParam.IndexDatabaseName = this.GenerateArchiverIndexName(openParam);
        ...
        private String GenerateArchiverIndexName(GDriveIndexServiceOpenParameter openParam)
        {
        ...
        private GDriveArchiverIndexProcessorParameter GetIndexProcessorParameter(GDriveIndexServiceOpenParameter openParam)
        {
            ...
            GDriveArchiverIndexProcessorParameter indexProcessorParameter = new GDriveArchiverIndexProcessorParameter(IdentityManager.IdentityContent);
        ...
        public void DeleteFile(GDriveIndexServiceOpenParameter openParam)
        {
            var dbInfo = new IndexDatabaseInfo(openParam);
