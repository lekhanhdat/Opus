...
namespace AvePoint.Common.FilterEngine
{
    ...
    /// List级别信息对象类
    /// </summary>
    public class ListInfo : CommonInfoBase
    {
        ...
        public bool EnableVersioning { get => GetPropertyValue(field); set => SetPropertyValue(ref field, value); }
        ...
        public bool RequireCheckout { get => GetPropertyValue(field); set => SetPropertyValue(ref field, value); }
