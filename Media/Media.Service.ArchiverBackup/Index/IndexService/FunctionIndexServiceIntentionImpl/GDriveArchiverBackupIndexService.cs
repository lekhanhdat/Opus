...
{
    public class GDriveArchiverBackupIndexService
                : GDriveArchiverIndexServiceBase
        , IGDriveArchiverBackupIndexService
    {
        ...
        public void InsertSiteMaster(GDriveMasterIndex siteMasterIndex)
        {
            this.SiteMasterService.InsertSiteMasterIndex(siteMasterIndex);
        }

        public void UpdateJobInfoIndex(string jobId, string key, string value)
        {
            this.SiteMasterService.UpdateJobInfoIndex(jobId, key, value);
        }
    }
}
