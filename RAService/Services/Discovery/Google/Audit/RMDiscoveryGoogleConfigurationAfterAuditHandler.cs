...
{
    public class RMDiscoveryGoogleConfigurationAfterAuditHandler : IAsyncAuditAfterHandler
    {
        ...
        public static async Task CollectScopeConfig(RMAuditInfo auditInfo, RMDiscoveryGoogleScopeInfo beforeScopeInfo)
        {
        ...
        public static void CollectROTConfig(RMAuditInfo auditInfo, RMDiscoveryOffice365RotDefinition beforeRotDefinition, List<RMDiscoveryGoogleRuleInfo> beforeRotRules)
        {
