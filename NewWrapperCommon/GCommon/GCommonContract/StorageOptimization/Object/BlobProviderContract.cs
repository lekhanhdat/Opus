...
namespace AvePoint.GCommon.Contract.StorageOptimization.Object
{
    ...
    public class BlobProviderContract : SONodeContract<BlobProviderContract>
    {
        ...
        public bool Equals(BlobProviderContract cloned)
        {
            if (cloned == null || GetType() != cloned.GetType())
            {
                return false;
            }
            if (this.Children != null && cloned.Children != null)
            {
                for (int i = 0; i < this.Children.Count; i++)
                {
                    if (!this.Children[i].Equals(cloned.Children[i]))
                        return false;
                }
            }
            //if (this.StubDatabase != null && !this.StubDatabase.Equals(cloned.StubDatabase))
            //    return false;
            if (this.EBSStatus != cloned.EBSStatus)
                return false;
            if (this.RBSStatus != cloned.RBSStatus)
                return false;
            if (this.IncludeNewStatus != cloned.IncludeNewStatus)
                return false;
            if (this.Schedule != null)
            {
                ...
                if (this.Schedule.StartTime != cloned.Schedule.StartTime)
                {
                    return false;
                }
                //if (!this.Schedule.TimeZoneId.Equals(cloned.Schedule.TimeZoneId))
                //{
                //    return false;
                //}
                if (this.Schedule.IntervalType != cloned.Schedule.IntervalType)
                {
                    return false;
                }
                if (this.Schedule.Interval != cloned.Schedule.Interval)
                {
                    return false;
                }
            }
            ...
            if (this.RBSRunNow != cloned.RBSRunNow)
                return false;
            return true;
        }
    ...
    public class StubDatabaseInfo
    {
        ...
        //public bool Equals(StubDatabaseInfo cloned)
        //{
        //    if (cloned == null || GetType() != cloned.GetType())
        //        return false;
        //    if (this.ID != null && !this.ID.Equals(cloned.ID))
        //        return false;
        //    if (this.DataBaseServer != null && !this.DataBaseServer.Equals(cloned.DataBaseServer))
        //        return false;
        //    if (this.DataBaseName != null && !this.DataBaseName.Equals(cloned.DataBaseName))
        //        return false;
        //    if (this.Authentication != cloned.Authentication)
        //        return false;
        //    if (this.Domain != null && !this.Domain.Equals(cloned.Domain))
        //        return false;
        //    if (this.UserName != null && !this.UserName.Equals(cloned.UserName))
        //        return false;
        //    if (this.Password != null && !this.Password.Equals(cloned.Password))
        //        return false;
        //    if (this.FailoverDatabase != null && !this.FailoverDatabase.Equals(cloned.FailoverDatabase))
        //        return false;
        //    return true;
        //}
