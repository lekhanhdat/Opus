...
namespace AvePoint.GCommon.Contract.DeploymentManager
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IADesignManagerService
    {
        /// <summary>
        ...
        [OperationContract]
        ReturnResult HandleMessageFromServer(DMMessage message);

        [OperationContract]
        void HandleMessage(JobQueueMessage message);
        ...
        [OperationContract]
        ReturnResult HandleMessageFromPrimaryAgent(DMMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult HandleMessageFromServerForMonitorJob(DMMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult HandleMessageFromAgentForMonitorJob(DMMessage message);
    }
}
