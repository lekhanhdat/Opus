...
namespace AvePoint.RA.SharePoint.Archiver
{
    internal class DeletionNode
    {
        ...
        private readonly ManifestDocumentSnapshot snapshot;
        ...
        public ManifestDocumentSnapshot Snapshot { get { return snapshot; } }
        ...
        public DeletionNode(string header)
        {
            ...
            else
            {
                ...
                if (headerInfo.HasAttribute("ManifestDocumentSnapshot"))
                {
                    this.snapshot = SerializerHelper.DeserializeByJsonSerializer<ManifestDocumentSnapshot>(headerInfo.Attributes["ManifestDocumentSnapshot"].Value);
                }
