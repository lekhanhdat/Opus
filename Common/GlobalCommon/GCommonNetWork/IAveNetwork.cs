...
namespace AvePoint.GCommon.Network
{
    ...
    {
        int ReconnectTimeout { set; }
        int ReconnectRetryInterval { set; }
        int Available { get; }
        ...
        int ReceiveBinary(byte[] data, int nIndex, int nLength);
        void ReceiveDataBlock(AveDataBlock dataBlock);
        string ReceiveMessage();
        void SendBinary(byte[] data, int nIndex, int nLength);
