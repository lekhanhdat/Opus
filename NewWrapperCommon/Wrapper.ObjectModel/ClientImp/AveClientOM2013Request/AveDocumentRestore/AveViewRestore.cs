...
{
    public class AveViewRestore : BaseDocumentRestore
    {
        public AveViewRestore(AveClientContext context, AveClientOM2013Request request, object authentication, AveDocumentInfo docInfo, Stream fileStream)
        ...
        private ClientFile HandleViewFile(View view)
        {
            try
            {
                ClientFile file = ParentWeb.GetFileByServerRelativeUrl(view.ServerRelativeUrl);
                LoadFileInfo(file);
