...
{
    public class RMDiscoveryOffice365DuplicateCalculatorV4
    {
        ...
        public RMDiscoveryOffice365DuplicateCalculatorV4(RMDiscoveryOffice365MainJob jobInfo)
        {
        ...
        public async Task CalculateAsync()
        {
            try
            {
                _logger.Info($"Start calculate duplciate data(V4)");
