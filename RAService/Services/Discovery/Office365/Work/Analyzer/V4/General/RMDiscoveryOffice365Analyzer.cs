...
using AvePoint.RA.Service.Services.Discovery.Office365.Work.Analyzer.V4.General.Inactive;
using AvePoint.RA.Service.Services.Discovery.Office365.Work.Analyzer.V4.General.Rot;
    ...
    public class RMDiscoveryOffice365Analyzer
    {
            ...
            try
            {
                ...
                foreach (var tenantDiscoveryJobs in tenantGroupedDiscoveryJobs)
                {
                    ...
                    foreach (var contentSourceDiscoveryJobs in contentSourceGroupedDiscoveryJobs)
                    {
                        ...
                        var aggregateTotalDataAnalyer = new RMDiscoveryOffice365AggregateTotalDataAnalyzer(o365TenantId, _mainJob.Type, contentSource);
        ...
        private async Task CleanupDeletedSiteDataAsync(Guid o365TenantId, Guid siteId)
        {
            try
            {
                ...
                // Cleanup from SQL Server (Discovery DB) - includes SiteInoes
