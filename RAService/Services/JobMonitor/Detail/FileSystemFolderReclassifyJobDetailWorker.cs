...
{
    public class FileSystemFolderReclassifyJobDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_FileSystem_FolderReclassify, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_FileSystem_FolderReclassify, TABLE_NAME);
        }
    }
}
