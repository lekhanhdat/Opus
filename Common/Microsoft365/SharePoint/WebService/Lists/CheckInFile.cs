...
namespace Microsoft365.SharePoint.WebService.Lists
{
    ...
    public class CheckInFile : ISoapHttpRequest
    {
        ...
        [XmlElement(ElementName = "checkinType")]
        public string CheckinType { get; set; }

        [XmlIgnore]
        public string SoapAction => "http://schemas.microsoft.com/sharepoint/soap/CheckInFile";
