...
namespace AvePoint.GCommon.Contract.Server.Common.Monitor.Object
{
    ...
    public class BaseMonitorModule
    {
        ...
        /// <summary>
        /// 执行Action之后的Message信息，支持同时显示多个MessageBar
        /// </summary>
        [DataMember]
        public List<FeedBackMessage> FeedBackMessage { get; set; }

        /// <summary>
        /// 执行Action后的Alert Message,比较直观的给出具体提示
        /// </summary>
        [DataMember]
        public AlertMessageModule AlertMessage { get; set; }
    }
    [DataContract]
