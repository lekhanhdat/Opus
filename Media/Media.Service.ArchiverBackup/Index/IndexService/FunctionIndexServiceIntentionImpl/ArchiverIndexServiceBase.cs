...
namespace AvePoint.Media.Service.ArchiverBackup
{
    ...
    public abstract class ArchiverIndexServiceBase
    {
        ...
        public IArchiverHeadAndBodyIndexService HeadAndBodyService { get; set; }
        public IArchiverSiteMasterIndexService SiteMasterService { get; set; }
        ...
        public ICommonSiteMasterIndexService CommonSiteMasterService { get; set; }
    }
}