...
{
    public class RMDiscoveryFSRotFileExtensionsQuerier : RMDiscoveryFSRotDataQuerier<List<RMDiscoveryFileExtensionDataInfo>>
    {
        public RMDiscoveryFSRotFileExtensionsQuerier(RMDiscoveryFSQueryParameter queryParameter) : base(queryParameter)
        {
        }
        ...
        public override async Task<List<RMDiscoveryFileExtensionDataInfo>> QueryAsync()
        {
            ...
            var sql =
                ...
                JOIN [{_schemaName}].[RMFSFileExtensions] AS fileType ON data.FileExtension = fileType.Id ";
