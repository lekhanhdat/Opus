...
namespace AvePoint.GCommon.Utility.I18N
{
    public abstract class AveEventMessage
    {
        ...
        private string GetValue(string prefix)
        {
            ...
            temp = temp.Substring(temp.IndexOf("EventIds") + "EventIds".Length);
            temp = temp.Replace("+", "_");
            temp = prefix + temp;
        ...
        {
            this.Contexts.Add(ContextKeys.Common.MoreInformation, "http://www.DocAve.com/EventID.aspx?id=" + EventId);
        }
    ...
    public class EventIds
    {
        ...
        public class Database
        {
            public class AddDatabaseSuccessfullyEventMessage : AveEventMessage
            {
                ...
                {
                    Contexts.Add(ContextKeys.Database.DatabaseName, databaseName);
                    Contexts.Add(ContextKeys.Database.DatabaseType, ContextValues.GetContextValue(databaseType));
                }
            }
        ...
        public class Driver
        {
            public class OperateDriverFailedEventMessage : AveEventMessage
            {
                ...
                {
                    Contexts.Add(ContextKeys.Common.OperationType, ContextValues.GetContextValue(operationType));
                    Contexts.Add(ContextKeys.Driver.DriverName, driverName);
                }
                public override AveLogLevel LogLevel { get { return AveLogLevel.ERROR; } }
            }
