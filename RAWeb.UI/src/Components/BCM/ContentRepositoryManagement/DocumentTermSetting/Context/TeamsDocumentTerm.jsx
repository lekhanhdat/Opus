...
export default {
    ...
    saveTermSettings(that, callback) {
        ...
        let sendUrl = CRMCommonUtil.isGroup(currNode) ? "/api/TeamsSettingApi/SaveGroupLevelSetting" : "/api/TeamsSettingApi/SaveDocumentLevelSetting";
        let option = {
            url: sendUrl,
            method: "Post",
            data: currNode
    ...
    getSavedTerm(that) {
        ...
        let option = {
            url: "/api/TeamsSettingApi/GetSavedTree",
            method: "Post",
            data: paramObj
        };
