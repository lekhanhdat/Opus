...
namespace AvePoint.Wrapper.Common
{
    ...
    {
        private static AveLogger mLog = AveLogger.GetInstance(typeof(AzureNativeMethods));
        // Fields
        ...
        {
            string dir = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Office365\\x64");
        ...
        [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "AzureNativeMethods class fields.")]
