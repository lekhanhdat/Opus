...
const BuildUnderReviewDetails = (record) =>{
    ...
    return [
        ...
        {key : 11, column : RMResx.RM_MA_Grid_EscalateOrReassignFrom ,value : record.escalateFromDisplayName ,type:""},        
        {key : 12, column : RMResx.RM_JS_MA_Grid_RecordOwner ,value : record.reviewerDisplayNames.join("; ") ,type:""},
        {key : 13, column : RMResx.RM_JS_MA_Grid_Reassigned_Comment ,value : record.escalatedComment ,type:""},
        {key : 14, column : RMResx.RM_MA_JS_LastReviewedBy ,value : record.manualLastReviewedBy ,type:""},
        {key : 15, column : RMResx.RM_MA_JS_LastReviewTime ,value : record.manualLastReviewTime ,type:""},
        {key : 16, column : RMResx.RM_JS_MA_Grid_ModifiedBy ,value : record.modifiedBy ,type:""},
        {key : 17, column : RMResx.RM_JS_MA_Grid_ModifiedTime ,value : record.modifiedTime ,type:""},
        {key : 18, column : RMResx.RM_JS_MA_Grid_CreatedBy ,value : record.createdBy ,type:""},
        {key : 19, column : RMResx.RM_JS_MA_Grid_CreatedTime ,value : record.collectionTime ,type:""},

    ];
};


const UnderReviewDetails = forwardRef ((props, ref) =>{
    ...
    useImperativeHandle(ref, () => ({
        onShow: (record) => {
            setIsShow(true);
            setRecord(record);
            setColumns(BuildUnderReviewDetails(record));
        }
    }));
...
UnderReviewDetails.displayName = "UnderReviewDetails";

export default UnderReviewDetails;