...
{
    public class WorkspaceHoldImportDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_WORKSPACE_HOLD_IMPORT, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_WORKSPACE_HOLD_IMPORT, TABLE_NAME);
        }
    }
}
