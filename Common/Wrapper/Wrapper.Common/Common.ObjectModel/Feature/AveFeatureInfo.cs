...
namespace AvePoint.Wrapper.Common
{
    ...
    public class AveFeatureInfoComparer : IEqualityComparer<AveFeatureInfo>
    {
        public bool Equals(AveFeatureInfo x, AveFeatureInfo y)
        {
            return x.Id == y.Id;
        }

        public int GetHashCode(AveFeatureInfo obj)
        {
