...
namespace AvePoint.Media.Service.DomainModel
{
    ...
    public class ArchiverStorageInfoMetaDataBuilder
        : StorageInfoMetaDataBuilderBase<ArchiverBackupJob>
    {
        protected override Dictionary<String, String> BuildMetaData(ArchiverBackupJob backupJob)
        {
            ...
            metaDataDictionary[this.MetaDataKeyNameArchiverSiteCollectionName] = backupJob.SiteUrl;
