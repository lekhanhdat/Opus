...
namespace AvePoint.RA.Common.Cryptography
{
    public class AESEncriptionHelper
    {
        ...
        /// <summary>
        /// If FIPS is enabled on the machine, it doesn't work.
        /// it is used to compatible with old data.
        /// </summary>
        /// <param name="toEncryptArray"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        //public static byte[] DecryptWithFIPSDisabled(byte[] toEncryptArray, string key)
        //{
        //    var rm = GetAlgorithm(key);
        ...
        ///* Fortify Issue Type:Weak Encryption: Insecure Mode of Operation
        /// <summary>
        /// If FIPS is enabled on the machine, this algorithm doesn't work
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
