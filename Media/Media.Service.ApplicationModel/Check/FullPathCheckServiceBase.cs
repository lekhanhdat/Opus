...
namespace AvePoint.Media.Service.Check
{
    ...
    public abstract class FullPathCheckServiceBase<TParameter, TResult>
        :IFullPathCheckService
        where TParameter : class, ICheckInfo, new()
        where TResult : class, ICheckResult, new()
    {
