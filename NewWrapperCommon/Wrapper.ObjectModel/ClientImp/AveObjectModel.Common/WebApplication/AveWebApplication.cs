...
namespace AvePoint.ObjectModel.Common
{
    ...
    class AveWebApplication : AveClientObject, IAveWebApplication
    {
        ...
        public Dictionary<AveUrlZone, IAveIisSettings> IisSettings
        {
            get 
            {
                if (base.DataCache.IsPropertyNotLoaded("IisSettings"))
                {
                    ...
                    base.DataCache.PropertiesCache["IisSettings"] = iisSettings;
                    return iisSettings;
                }
        ...
        public IAveServiceApplicationProxyGroup ServiceApplicationProxyGroup
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("ServiceApplicationProxyGroup"))
                {
                    ...
                    base.DataCache.PropertiesCache["ServiceApplicationProxyGroup"] = serviceAppProxyGroup;
        ...
        private bool m_SelfServiceCreateIndividualSite = false;
        public bool SelfServiceCreateIndividualSite
        {
            get { return m_SelfServiceCreateIndividualSite; }
            set { m_SelfServiceCreateIndividualSite = value; }
        }

        private string m_SelfServiceCreationParentSiteUrl = string.Empty;
        public string SelfServiceCreationParentSiteUrl
        {
            get { return m_SelfServiceCreationParentSiteUrl; }
            set { m_SelfServiceCreationParentSiteUrl = value; }
        }

        private string m_SelfServiceCreationQuotaTemplate = string.Empty;
        public string SelfServiceCreationQuotaTemplate
        {
            get { return m_SelfServiceCreationQuotaTemplate; }
            set { m_SelfServiceCreationQuotaTemplate = value; }
        }

        private string m_SelfServiceSiteCustomFormUrl = string.Empty;
        public string SelfServiceSiteCustomFormUrl
        {
            get { return m_SelfServiceSiteCustomFormUrl; }
            set { m_SelfServiceSiteCustomFormUrl = value; }
        }

        private bool m_ShowStartASiteMenuItem = false;
        public bool ShowStartASiteMenuItem
        {
            get { return m_ShowStartASiteMenuItem; }
            set { m_ShowStartASiteMenuItem = value; }
        }
        ...
        bool mAllowAnalyticsCookieForAnonymousUsers = false;
        public bool AllowAnalyticsCookieForAnonymousUsers
        {
            get
            {
                return mAllowAnalyticsCookieForAnonymousUsers;
            }
            set
            { }
        }
