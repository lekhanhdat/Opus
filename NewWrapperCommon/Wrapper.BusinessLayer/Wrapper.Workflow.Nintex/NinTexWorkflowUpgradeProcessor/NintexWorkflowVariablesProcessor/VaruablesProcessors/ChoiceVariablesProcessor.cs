...
{
    class ChoiceVariablesProcessor : VariablesProcessorBase
    {
        public ChoiceVariablesProcessor(NWWorkflowVariable currentVar)
            : base(currentVar)
        {
        }
        protected override VariableConfiguration GetVariableConfiguration()
        {
            ...
            currentVar.Choice.All(choice =>
            {
                choices.AppendLine(choice);
                return true;
            });
