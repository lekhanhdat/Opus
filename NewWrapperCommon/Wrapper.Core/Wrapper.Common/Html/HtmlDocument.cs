...
namespace AvePoint.Wrapper.Common
{
    ...
    public class HtmlDocument : IXPathNavigable
    {
        ...
        public HtmlNode GetElementbyId(string id)
        {
            ...
            return _nodesid[id.ToLower(System.Globalization.CultureInfo.InvariantCulture)] as HtmlNode;
        }
        ...
        internal void SetIdForNode(HtmlNode node, string id)
        {
            ...
            if (node == null)
            {
                _nodesid.Remove(id.ToLower(System.Globalization.CultureInfo.InvariantCulture));
            }
            else
            {
                _nodesid[id.ToLower(System.Globalization.CultureInfo.InvariantCulture)] = node;
            }
        }
            ...
            if (prev == null)
            {
                ...
                else
                {
                    ...
                    if (HtmlNode.CanOverlapElement(_currentnode.Name))
                    {
                        ...
                        ((HtmlTextNode)closenode).Text = ((HtmlTextNode)closenode).Text.ToLower(System.Globalization.CultureInfo.InvariantCulture);
                        if (_lastparentnode != null)
                        {
        ...
        [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "The wrong names are html node name.")]
        [SuppressMessage("Microsoft.Globalization", "CA1309:UseOrdinalStringComparison", MessageId = "System.String.Compare(System.String,System.String,System.StringComparison)", Justification = "")]
