...
namespace AvePoint.ObjectModel.ClientOM
{
    ...
    abstract class ClientSideWebPartCommonWorker
    {
        ...
        protected virtual bool ReplacePropertyByType(IAveSite site, JProperty property, ClientSideWebpartPropertyTypes propertyType, ClientSideWebpartPropertyScopes scope, out JToken result)
        {
            ...
            switch (propertyType)
            {
                ...
                case ClientSideWebpartPropertyTypes.UserLoginName:
                    ...
                    string mappedLogin = this.getUseMethod(originalLogin.Trim(true, false, UserLoginPrefix));
        ...
        protected Func<string, string> getUseMethod;
        public void SetMappingAndSourceInfo(AveSiteMappingManager mapping, AveSiteInfo sourceSitInfo , AveClientContext context, Func<string, string> GetUserFromMapping)
        {
