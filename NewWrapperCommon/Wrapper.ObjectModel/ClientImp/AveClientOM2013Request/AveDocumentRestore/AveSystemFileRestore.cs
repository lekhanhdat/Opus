...
{
    public class AveSystemFileRestore : BaseDocumentRestore
    {
        public AveSystemFileRestore(AveClientContext context, AveClientOM2013Request request, object authentication, AveDocumentInfo docInfo, Stream fileStream) :
        ...
        public override Dictionary<string, object> Restore()
        {
            ...
            ClientFile file = ParentWeb.GetFileByServerRelativeUrl(FileServerRelativeUrl);
