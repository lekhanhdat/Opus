...
namespace AvePoint.GCommon.Utility
{
    ...
    {
        private static readonly IEventHandlerConverter eventHandlerConverter = new EventHandlerConverter();
        ...
        public static void Register<T>(T target, EventHandler eventHandler)
        {
