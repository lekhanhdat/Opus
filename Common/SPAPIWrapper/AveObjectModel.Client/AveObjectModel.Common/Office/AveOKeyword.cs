    ...
    class AveOKeyword : AveClientObject, IAveOKeyword
    {
        ...
        public IAveOBestBetCollection BestBets
        {
            get
            {
                ...
                {
                    var bestBetsProp = base.DataCache.GetPropertyWithoutChange<List<Dictionary<string, object>>>("BestBets" + AveObjectModelConstant.ObjectPropertySuffix);
                    IAveOBestBetCollection bestBetCollection = new AveOBestBetCollection(mRequest, this, mKeys, bestBetsProp);
                    base.DataCache.AddProperty("BestBets",bestBetCollection);
                }
        ...
        public IAveOSynonymCollection Synonyms
        {
            get
            {
                ...
                {
                    string synonyms = base.DataCache.GetPropertyWithoutChange("Synonyms" + AveObjectModelConstant.ObjectPropertySuffix).ToString();
                    IAveOSynonymCollection synonymCollection = new AveOSynonymCollection(mRequest, this, mKeys, synonyms);
                    base.DataCache.AddProperty("Synonyms",synonymCollection);
                }
