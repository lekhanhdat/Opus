...
namespace AvePoint.GCommon.Contract.StorageOptimization.Connector.Object
{
    ...
    public class ConnectorJobReport
    {
        ...
        public List<Guid> WebIDs { get; set; }
        public List<Guid> ListIDs { get; set; }
        public List<Guid> FailedSiteIDs { get; set; }
        public List<Guid> FailedWebIDs { get; set; }
        public List<Guid> FailedListIDs { get; set; }
