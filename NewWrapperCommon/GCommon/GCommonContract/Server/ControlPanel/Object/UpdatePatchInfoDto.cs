...
namespace AvePoint.GCommon.Contract.Server.ControlPanel.Object
{
    ...
    public class UpdatePatchInfoDto
    {
        ...
        //GovernanceAutomation Patch的Version
        [XmlElement("VersionForGovernanceAutomation")]
        [DataMember]
        public string VersionForGovernanceAutomation { get; set; }
        ...
        //GovernanceAutomation Patch的Display Version
        [XmlElement("DisplayVersionForGovernanceAutomation")]
        [DataMember]
        public string DisplayVersionForGovernanceAutomation { get; set; }
        ...
        [XmlElement("FilesForResetIIS")]
        [DataMember]
        public string FilesForResetIIS { get; set; }

        [XmlElement("GAVersion")]
        [DataMember]
        public string GAVersion { get; set; }

        [XmlElement("DependGAVersion")]
        [DataMember]
        public string DependGAVersion { get; set; }
        ...
        [Obsolete("该属性已经不在使用和维护，建议使用PatchZipInfo")]
        [DataMember]
        public bool IsIncludeShell { get; set; }

        [DataMember]
        public PatchZipInfo PatchZipInfo { get; set; }
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class PatchZipInfo
    {
        [DataMember]
        public bool IsIncludeAgentPatch { get; set; }

        [DataMember]
        public bool IsIncludeControlPatch { get; set; }

        [DataMember]
        public bool IsIncludeMediaPatch { get; set; }

        [DataMember]
        public bool IsIncludeReportPatch { get; set; }
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class InstallExtendInfo
    {
        [DataMember]
    ...
    #region region Enforce DocAve and GA installation order [ADO-134177]
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class GAIntallationOrder
    {
        /// <summary>
        /// 是否出现了安装顺序的错误
        /// </summary>
        ...
        /// <summary>
        /// 0 : No Error
        /// 1 : GA+ hotfix version排序时出现问题(可能是解析版本出错，version内容出错)
        /// 2 : 版本不匹配，说明某个control service的版本低于要升级的GA+ 版本
        /// 3 : hotfix 和 control Service比较时出错了
        /// 4 : 没有客用的Control Service
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// 出现安装顺序错误的GA+ patch 信息
        /// </summary>
        [DataMember]
        public List<UpdatePatchInfoDto> NeedInstallPatchs;

        /// <summary>
        /// 不满足安装条件的Service(当前只判断了Active 的Control Service)
        /// </summary>
        [DataMember]
