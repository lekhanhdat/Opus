...
namespace AvePoint.GCommon.Contract.SharePointBrowser
{
    ...
    public class SharePointBrowserContract : BrowserContractBase
    {
        ...
        /// </summary>
        [DataMember]
        public List<PRTreeNodeDto> PRParentNodes { get; set; }
        /// <summary>
        /// Agent端返回的获取到的子节点集合
        /// </summary>
        [DataMember]
        public List<PRTreeNodeDto> PRChildenNodes { get; set; }
        [DataMember]
        ...
        public SharePointBrowserContract()
        {
            ...
            PRParentNodes = new List<PRTreeNodeDto>();
            PRChildenNodes = new List<PRTreeNodeDto>();
        }
    }
