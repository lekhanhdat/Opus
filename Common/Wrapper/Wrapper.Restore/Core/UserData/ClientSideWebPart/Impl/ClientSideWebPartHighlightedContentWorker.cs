...
namespace AvePoint.Wrapper.Restore.Core
{
    ...
    class ClientSideWebPartHighlightedContentWorker : ClientSideWebPartCommonWorker, IClientSideWebPartWorker
    {
        public const string Id = "daf0b71c-6de8-4ef7-b511-faae7c388708";

        protected override AveLogger logger { get { return AveLogger.GetInstance(typeof(ClientSideWebPartHighlightedContentWorker)); } }
