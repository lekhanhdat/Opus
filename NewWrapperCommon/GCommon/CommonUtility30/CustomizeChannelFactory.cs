...
namespace AvePoint.Common
{
    ...
    public class CustomizeChannelFactory<T>
    {
        ...
        public static Tuple<T, IDefaultCommunicationTimeouts> CreateChannelInDetails(
           String endpointConfigurationName,
           String schema,
           String host,
           Int32 port,
           String jobId)
        {
            ...
            return new Tuple<T, IDefaultCommunicationTimeouts>(channelFactory.CreateChannel(), channelFactory.Endpoint.Binding);
        }
