...
{
    public class RMDiscoveryFSRotAggregateStatisticQuerier : RMDiscoveryFSRotDataQuerier<RMDiscoveryFSAggregateStatisticDataInfo>
    {
        public RMDiscoveryFSRotAggregateStatisticQuerier(RMDiscoveryFSQueryParameter queryParameter) : base(queryParameter)
        {
        }

        public override async Task<RMDiscoveryFSAggregateStatisticDataInfo> QueryAsync()
        {
            ...
            return await _queryDao.GetDataAsync<RMDiscoveryFSAggregateStatisticDataInfo>(sql, sqlParams.ToArray());
        }
        ...
        private string GetTableName()
        {
            ...
            {
                return "RMFSContainerRuleLevelRotData";
            }

            if (selectedRuleIds.Count > 0)
            {
                return "RMFSBasicRuleLevelRotData";
            }

            if (containerIds.Count > 0)
            {
                return "RMFSContainerRootLevelRotData";
            }
