...
namespace AvePoint.GCommon.Contract.CommonFilter
{
    ...
    public class ArchiverRestoreFilter
    {
        ...
        [JsonProperty]
        [DataMember]
        public string FilterMetadataInfo;
        [JsonProperty]
        [DataMember]
        public List<string> ItemId;
        [JsonProperty]
        [DataMember]
        public string ParentPathMd5;
        [JsonProperty]
        [DataMember]
        ...
        public int ExtraQuerySize;
        public bool SkipDocVersion; // for restore doc
        public List<string> FullPathMD5List;
        [JsonProperty]
        [DataMember]
    ...
    public class ArchiverRestoreOrderBy
    {
        public string ColName;
        public Order Order;
        public ArchiverRestoreOrderBy Next;
    }
