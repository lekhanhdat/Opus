...
using AvePoint.RA.Service.Services.Discovery.Office365.Work.Analyzer.V2;
...
{
    public class RMDiscoveryOffice365AnalysisV2JobRunner : RMDiscoveryOffice365Worker
    {
        ...
        public RMDiscoveryOffice365AnalysisV2JobRunner(string jobId) : base()
        {
            ReportMangerFactory.Instance.Init(jobId, JobType.DiscoveryJobV2);
        ...
        public async Task RunAsync()
        {
            try
            {
                ...
                var analyzer = new RMDiscoveryOffice365Analyzer(
                        ...
                        dateRangeIds,
                        rules,
                        enableExpandQueryTest
                    );
                await analyzer.AnalysisAsync();

                var duplicateCalculator = new RMDiscoveryOffice365DuplicateCalculatorV2(mainJob);
