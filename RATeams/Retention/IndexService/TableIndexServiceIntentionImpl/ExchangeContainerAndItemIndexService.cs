...
namespace Office365GroupRetention
{
        ...
        , IExchangeContainerAndItemIndexService
    {
        ...
        public void UpdateRetentionStatus(string storagePolicyId, string jobid)
        {
            UpdateAsSoftDelete(storagePolicyId, jobid);
        }
        ...
        public void UpdateAsSoftDelete(String storagePolicyId, String jobId)
        {
            ...
            parameters["@jobId"] = jobId;
            var itemTable = "update " + IndexConstants.TableNameExchangeItem + " set COL_RETENTION_STATUS = 1 where COL_STORAGEPOLICYID = @storagePolicyId and COL_JOB_ID = @jobId";
            var plannerTable = "update " + IndexConstants.TableNameExchangePlanner + " set COL_RETENTION_STATUS = 1 where COL_STORAGEPOLICYID = @storagePolicyId and COL_JOB_ID = @jobId";
            this.IndexProcessor.Execute(itemTable, parameters);
            this.IndexProcessor.Execute(plannerTable, parameters);
        }
        ...
        public List<ArchiverBasicIndex> GetDeletingDataFromMainIndex(String storagePolicyId, String jobId)
        {
            ...
            string sql = $"select * from {IndexConstants.TableNameExchangeItem} where COL_STORAGEPOLICYID = @storagePolicyId and COL_JOBID = @jobId LIMIT @offset, @length";
        ...
        public void DeleteContainerAndItemIndexByStorageAndJobId(String storagePolicyId, String jobId)
        {
            ...
            parameters["@storagePolicyId"] = storagePolicyId;
            parameters["@jobId"] = jobId;
            var deleteContainerTable = "delete from " + IndexConstants.TableNameExchangeItem + " where COL_STORAGEPOLICYID = @storagePolicyId and COL_JOB_ID = @jobId";
            var deleteItemTable = "delete from " + IndexConstants.TableNameExchangeContainer + " where COL_STORAGEPOLICYID = @storagePolicyId and COL_JOB_ID = @jobId";
            var deletePlannerTable = "delete from " + IndexConstants.TableNameExchangePlanner + " where COL_STORAGEPOLICYID = @storagePolicyId and COL_JOB_ID = @jobId";
