...
namespace AvePoint.GCommon.Contract.Compliance.eDiscovery.Handler.Object
{
    ...
    public class CrawlSettingsRequest : EDiscoveryRequest
    {
        [DataMember]
        public CrawlSettingsAction CrawlSettingsAction { get; set; }
        [DataMember]
        public List<SSADto> SSAList { get; set; }
        [DataMember]
        public SSADto SSA { get; set; }
    }


    [DataContract(Namespace = ContractConstants.Namespace)]
    public enum CrawlSettingsAction : uint
    {
        [EnumMember]
        LoadSSA = 1,
        [EnumMember]
