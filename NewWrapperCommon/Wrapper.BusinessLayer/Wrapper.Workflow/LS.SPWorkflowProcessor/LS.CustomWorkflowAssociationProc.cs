    ...
    public class CustomWorkflowAssociationProc
    {
        ...
        public void FireBackupCustomWorkflowDataEvent(SPWFAssociationUnit parentAsso)
        {
            ...
            catch (Exception e)
            {
                ...
                logger.Warn("An exception occurred while backup association custom data. exception:{0}", e.ToString());
        ...
        public void FireRestoreCustomWorkflowDataEvent(SPWFAssociationUnit parentAsso)
        {
            ...
            catch (Exception e)
            {
                ...
                logger.Warn("An exception occurred while restore association custom data. exception:{0}", e.ToString());
