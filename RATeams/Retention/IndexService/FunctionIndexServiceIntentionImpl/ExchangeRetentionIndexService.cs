...
namespace Office365GroupRetention
{
        ...
        , IExchangeRetentionIndexService
    {
        ...
        {
            this.ContainerItemIndexService.UpdateRetentionStatus(storagePolicyId, jobid);
        }
        ...
        {
            return this.ContainerItemIndexService.GetDeletingDataFromMainIndex(storagePolicyId, jobId);
        }
