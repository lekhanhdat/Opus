...
{
    public class MigrationEXOArchiverBackupJobSummaryService : MigrationBaseJobSummaryService
    {
        ...
        //public override List<RMJobSummaryRow> GetStatisticsRows(BaseJobDto jobDto)
        //{
        //    JobReportDetailEntityType[] entityTypes = new JobReportDetailEntityType[] { JobReportDetailEntityType.NormalInfo };
        //    List<JobSummary> jobSummaries = JobSummaryWork.GetJobSummary(jobDto, entityTypes);
        //    int[] jobStates = new int[] { (int)JobState.Failed, (int)JobState.FinishedException };
        //    var inCorrectSubJobs = AbstractJobDao.GetSubJobsByJobStates(jobDto.Id, jobStates);
        //    return GetStatisticsRows(jobDto, entityTypes, jobSummaries, inCorrectSubJobs);
        //}
