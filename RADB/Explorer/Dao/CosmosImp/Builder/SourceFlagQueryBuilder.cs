...
{
    public class SourceFlagQueryBuilder : BaseArrayFilterBuilder, IObjectArrayFilterBuilder<SourceFlag>
    {
        ...
        public Query Filter(Query query, SourceFlag[] values)
        {
        ...
        {
            return Contract.TemplateManagement.QueryCloumnIds.SourceFlag;
        }
        ...
        protected override ExplorerFilterOptionV2 Convert2SearchOptionV2(ExplorerQueryColumn column, string objJson, ExplorerSearchColumnOperationLogic columnOperationLogic, ExplorerSearchKeyOperationLogic keyOperationLogic)
        {
            ...
            {
                SourceFlags = JsonConvert.DeserializeObject<List<SourceFlag>>(objJson)
            };
        }
        #endregion
