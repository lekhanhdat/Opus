...
namespace AvePoint.GCommon.Contract.DeploymentManager.Object
{
    ...
    public class FrontEndQueueTemplate : QueueTemplate
    {
        [DataMember]
        public WFEQueueContent WFEContent { get; set; }
    }


    [DataContract(Namespace = ContractConstants.Namespace)]
    public class WFEQueueContent
    {
        /// <summary>
        ...
        [DataMember]
        public string WebConfigs { get; set; }
        ...
        [DataMember]
        public string FilterPolicyName { get; set; }
