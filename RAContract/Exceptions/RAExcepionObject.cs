...
namespace AvePoint.RA.Contract.Exceptions
{
    ...
    [Serializable]
    public class ClassificationInvalidException : Exception
    {
        public ClassificationInvalidException() : base() { }
        public ClassificationInvalidException(string message) : base(message) { }
    }

    [Serializable]
    public class CSDConfigMissException : Exception
    {
        public CSDConfigExceptionType ConfigType;
        public CSDConfigMissException(CSDConfigExceptionType type, string message) : base(message)
        {
            ConfigType = type;
        }
        ...
        {
            return $"[{ConfigType.ToString()}] {base.ToString()}";
        }
    }

    [Serializable]
    public class FailedCheckRuleException : Exception
    {
        public FailedCheckRuleException() : base() { }
        public FailedCheckRuleException(string message) : base(message) { }
    }

    [Serializable]
    public class EnableDataCollectionStatusException : Exception
    {
        public EnableDataCollectionStatusException() : base() { }
        public EnableDataCollectionStatusException(string message) : base(message) { }
    }

    public enum CSDConfigExceptionType
    {
        ExcludedFileTypesClassID = 1,
        SpecialClassCannotBeDefaultClass
    }
}
