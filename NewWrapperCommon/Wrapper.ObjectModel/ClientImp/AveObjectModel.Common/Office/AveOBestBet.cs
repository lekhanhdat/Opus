...
{
    class AveOBestBet : AveClientObject, IAveOBestBet
    {
        private IAveRequest mRequest;

        public AveOBestBet(IAveRequest request, Dictionary<string, object> bestBetProp)
        {
            this.mRequest = request;
            base.DataCache.AddPropertyies(bestBetProp);
        }
        ...
        public Uri Url
        {
            get
            {
                return new Uri(base.DataCache.GetProperty<string>("Url"));
            }
            set
            {
