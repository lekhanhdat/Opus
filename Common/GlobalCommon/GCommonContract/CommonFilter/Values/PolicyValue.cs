...
using AvePoint.GCommon.Contract.Server.Common.AdminSearch.Object;
    ...
    public class PolicyValue
    {
        ...
        private PolicyValueUnit value3Unit;
        ...
        {
            get { return value3Unit; }
            set { value3Unit = value; }
        }
        ...
        public PolicyValue(string value1, PolicyValueUnit unit1, string value2, PolicyValueUnit unit2, string value3, PolicyValueUnit unit3)
        {
            this.value1 = value1;
            this.value1Unit = unit1;
            this.value2 = value2;
