...
{
    public class BaseConnectorApiResponse
    {
        public CustomizeConnectorApiResponseStatusCode statusCode { get; set; }

        public string message { get; set; }

        public static BaseConnectorApiResponse OK()
        {
            return new BaseConnectorApiResponse
            {
                statusCode = CustomizeConnectorApiResponseStatusCode.OK
            };
        }

        public static BaseConnectorApiResponse BadRequest(string message)
        {
            return new BaseConnectorApiResponse
            {
        ...
        public static BaseConnectorApiResponse InternalServerError(string message)
        {
            return new BaseConnectorApiResponse
            {
