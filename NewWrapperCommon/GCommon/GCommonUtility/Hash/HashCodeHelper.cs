...
namespace AvePoint.GCommon.Utility
{
    ...
    public static class HashCodeHelper
    {
        ...
        {
            var isLocalSystemEnableFipsSupport = IsUseFIPS140CompliantCryptographicAlgorithms();
            if (isLocalSystemEnableFipsSupport)
            {
        ...
        [SuppressMessage("FxCopCustomRules", "C100007:SpellCheckStringValues", Justification = "IsUseFIPS140CompliantCryptographicAlgorithms is unmodifiable as the cause of being referenced.")]
