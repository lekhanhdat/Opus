...
namespace LS.SPWorkflowProcessor
{
    ...
    public class SPPermissionUnit
    {
        ...
        public static byte[] Save(SPPermissionUnit permUnit)
        {
            try
            {
                ...
                return LSGZipJsonSerializer.Serialize(SerializableData);
            }
            catch (Exception e)
            {
        ...
        public static byte[] SaveBinaryFunction(SPPermissionUnit permUnit)
        {
            try
            {
                if (permUnit == null)
        ...
        public static SPPermissionUnit Load(byte[] serializedMetadata)
        {
            try
            {
                SPPermissionSerializableData SerializableData = LSGZipJsonSerializer.Deserialize<SPPermissionSerializableData>(serializedMetadata);
    ...
    public class SPPermissionProcessor : IDisposable
    {
        ...
        {
            string key = principalUnit.mName.ToLower();
        ...
        private IAveRoleDefinition GetMappingPermissionLevel(SPPermissionLevelUnit plUnit)
        {
            ...
            string key = plUnit.SerializableData.mName.ToLower();
        ...
        public static string GetUserLoginNameFromId(IAveWeb parentWeb, int id)
        {
            string loginName = string.Empty;
            try
            {
                loginName = parentWeb.SiteUsers.GetByID(id).LoginName;
            }
            catch (Exception e)//need not log
            {
                log.Log(AveLogLevel.DEBUG, WrapperWorkflowResource.GetLoginNameByIdError, e.ToString());
            }
            return loginName;
        }
