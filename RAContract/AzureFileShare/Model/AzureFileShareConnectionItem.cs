...
{
    [DataContract]
    public class AzureFileShareConnectionItem
    {
        [DataMember]
        [JsonProperty("id")]
        ...
        [DataMember]
        [JsonProperty("isRelatedConnectionGroup")]
        public bool IsRelatedConnectionGroup => ConnectionGroupId != Guid.Empty;
        [DataMember]
        [JsonProperty("connectionGroup")]
        public AzureFileShareConnectionGroupItem ConnectionGroup { get; set; }
    }
}
