...
namespace AvePoint.GCommon.Transfer.Data.Interface
{
    ...
    public interface ITransferChannel : IDisposable
    {
        ...
        /// <summary>
        /// 主要用于检查缓冲区是否可用，并且初始化缓冲区,设置缓冲区的Timeout。
        /// </summary>
        /// <param name="sessionId"></param>
        /// <param name="identifier"></param>
        /// <param name="isInited">是初始化还是等待,receiver初始化，sender等待</param>
        /// <param name="timeout">设置Timeout的时间</param>
        /// <returns></returns>
        SessionStatus InitSession(string sessionId, string identifier, bool isInited, int timeout);
        /// <summary>
        /// 设置Timeout
        /// </summary>
        /// <param name="timeout"></param>
        [Obsolete("integrated with InitSession Method, useless")]
        ...
        /// <summary>
        /// 获取Buffer是否可用，检查的对象是谁，
        /// is sender是true，就是检查远端，is sender是false是检查目的端是否还在使用
        /// </summary>
        /// <param name="isSender"></param>
        /// <returns></returns>
        bool BufferSessionInUse(bool isSender);

        /// <summary>
        /// Keep Alive Timeout，
        /// 比如HTTP需要两分钟一次keep alive
        /// </summary>
