...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldUser : AveFieldLookup, IAveFieldUser
    {
        ...
        public AveFieldUser(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, Dictionary<string, object> contentTypeProp, Dictionary<string, object> prop)
