...
{
    [Table("RMFSConnectionInfoes")]
    public class RMDiscoveryFSConnectionInfo : RMDiscoveryDBTable
    {
        [Key]
        ...
        [Index]
        [Column(TypeName = "int")]
        [DefaultValue(RMDiscoveryFSSourceType.FileSystem)]
        public RMDiscoveryFSSourceType SourceType { get; set; }
