...
namespace AvePoint.GCommon.Contract.CentralAdmin.Object.SharedServices.SearchService
{
    ...
    public class CASearchServiceServerNameMappingsOperation : CAOperation
    {
        [DataMember]
        public string ServiceApplicationId { get; set; }

        [DataMember]
        public List<ServerNameMapping> ServerNameMappings { get; set; }
    }

    [DataContract(Namespace = ContractConstants.Namespace)]
    public class ServerNameMapping
    {
        [DataMember]
