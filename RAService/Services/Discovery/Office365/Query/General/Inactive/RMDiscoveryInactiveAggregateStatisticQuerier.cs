...
{
    public class RMDiscoveryInactiveAggregateStatisticQuerier : RMDiscoveryInactiveDataQuerier<RMDiscoveryOffice365AggregateStatisticDataInfo>
    {
        public RMDiscoveryInactiveAggregateStatisticQuerier(RMDiscoveryOffice365QueryParameter queryParameter) : base(queryParameter)
        {
        }
