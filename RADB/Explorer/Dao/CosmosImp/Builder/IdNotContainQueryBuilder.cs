...
{
    public class IdNotContainQueryBuilder: BaseArrayNotContainFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && filterOption.ExceptIds != null && filterOption.ExceptIds.Count > 0;
        }

        protected override string GetFilterColumnName()
        {
            return CosmosConst.C_Id;
        }

        protected override object GetFilterValue(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption.ExceptIds;
        }
    }
}
