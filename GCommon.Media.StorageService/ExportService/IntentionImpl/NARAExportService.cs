...
{
    internal class NARAExportService : ExportServiceBase
    {
        ...
        protected override ExportDataFileResult ExportDataFile(DataReadAction read, ExportInfo exportInfo)
        {
            ...
            using (var exportDataFileStream = this.ExportDevice.OpenStream(exportDataFileStorageInfo, FileMode.OpenOrCreate))
            {
                ...
                result.HashValue = HashCodeHelper.ToHashCode(exportDataFileStream, "SHA256");
           ...
           ExportInfo exportInfo)
        {
            ...
            var hashValue = HashCodeHelper.ToHashCode(this.metaDataStream, "SHA256");
            var result = new ExportMetaDataFileResult { MetaData = metaData, MetaDataStream = this.metaDataStream, HashValue = hashValue, FileSize = this.metaDataStream.Length };
            return result;
        }
