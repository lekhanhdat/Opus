...
public class GControlApprovalStatus : IFilter
{
    
    public ManualApprovalFilterOptions FilterOption => ManualApprovalFilterOptions.GControlApprovalStatus;
    public async Task<Expression<Func<ManualApprovalRecord, bool>>> GetCosmosDBFilterExpressionAsync(string value)
    {
        ...
        return (root) => filterApprovalStatus.Contains(root.GControlManualApprovedStatus);
    }
}