    ...
    return (
        <>
            <div className="reco-mutable-data">
                ...
                <div className="reco-storage-style" tabIndex="0" data-tooltip="ifneed">
                    <$g.I18NProvider msg={RMResx.RM_FA_ROT_StorageMsg}>
                        <span className="reco-storage-text">
                            {getSizeRate()}
                        </span>
                        <span className="reco-storage-text">{NumberUtil.internaltionalCounting(progressFileTotalSize)}</span>
                    </$g.I18NProvider>
                </div>
            </div>
        </>
