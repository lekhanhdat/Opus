...
namespace AvePoint.Common.FilterEngine
{
    ...
    public class FolderInfo : CommonInfoBase
    {
        ...
        public Hashtable TermInfosOfDisplayName { get => GetPropertyValue(field); set => SetPropertyValue(ref field, value); } //add for RevIM folder rule
        public bool IsOrphanedFolder { get => GetPropertyValue(field); set => SetPropertyValue(ref field, value); }
    }
}
