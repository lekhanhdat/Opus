...
namespace AvePoint.ObjectModel.Common
{
    class AvePropertyBag : AveClientObject, IAvePropertyBag
    {
        ...
        public AvePropertyBag(IAveWeb web,IAveRequest request, Dictionary<string, object> Properties)
        {
            mWeb = web;
            mRequest = request;
        ...
        public AvePropertyBag(IAveAlert alert, IAveRequest request, Dictionary<string, object> Properties)
        {
            mAlert = alert;
            mRequest = request;
        ...
        public int Count
        {
            get
            {
                return base.DataCache.PropertiesCache.Count;
            }
        }
        ...
        public string this[string key]
        {
            ...
            set
            {
                ...
                base.DataCache.PropertiesCache[key] = value;
        ...
        public void Clear()
        {
            ...
            base.DataCache.ChangedProperties["ClearProperties"] = true;
        }
