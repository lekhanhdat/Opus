...
namespace AvePoint.GCommon.Network
{
    ...
    /// <summary>
    /// 从socket读数据返回零字节并且没抛异常的情况，抛出这个异常
    /// </summary>
    public class ReadEmptyDataFromSocketException : CommonNetworkException
    {
    ...
    /// <summary>
    ///在发送和接收端做一次数据同步时，同步不上抛出此异常
    /// </summary>
    public class SyncDataException : CommonNetworkException
    {
    ...
    ///进行数据加密处理的时候抛出异常
    /// </summary>
    public class DataEncryptException : CommonNetworkException
    {
