...
{
    public class ConnectorApiQueryResponse : BaseConnectorApiResponse
    {
        public string startIndex { get; set; }
        public List<ExpandoObject> queriedItems { get; set; } = new List<ExpandoObject>();
        public static ConnectorApiQueryResponse QueryResult(List<ExpandoObject> queriedItems, string pageIndex)
        {
            return new ConnectorApiQueryResponse
            {
