...
{
    [DataContract]
    public class CreateAndDestryoedReportModel
    {
        [DataMember]
        ...
        [DataMember]
        [JsonProperty(PropertyName = "dateFrameType")]
        public DateFrameType DateFrameType { get; set; }
        [DataMember]
        [JsonProperty(PropertyName = "customStartDate")]
        public string CustomStartDate { get; set; }
        [DataMember]
        [JsonProperty(PropertyName = "customEndDate")]
