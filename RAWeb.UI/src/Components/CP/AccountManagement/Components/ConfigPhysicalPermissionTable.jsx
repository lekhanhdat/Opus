import { PermissionManageModule } from "../../../../Constants/Constants";

export default class ConfigPhysicalPermissionTable extends R.Component {
    idAttr = true;
    componentCreate() {
        this.state = {
            disabled: false,
    ...
    render(Row, Cell) {
        ...
        return (
            <Row>
                <Cell>
                    <R.Checkbox
                        id={"raCpAmPhyPermissionScopeTableChk" + index}
