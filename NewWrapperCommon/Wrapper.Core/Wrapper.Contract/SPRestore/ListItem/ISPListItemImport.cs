...
namespace AvePoint.Wrapper.Core.SPRestore
{
    ...
    /// Restore File
    /// </summary>
    public interface ISPListItemImport : ISPItemImport
    {
        /// <summary>
        ...
        /// <returns></returns>
        SPFileRestoreReport Restore(IAveRestoreStream restoreStream, SPListItemRestoreOption spListItemRestoreOption);
    }
}
