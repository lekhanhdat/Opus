    ...
    static class ServiceResponseExceptionExtension
    {
        ...
        internal static void ThrowIfWellknownError(this ServiceResponseException srEx, FormattedMessageException.Context context)
        {
            ...
            switch (errorCode)
            {
                ...
                case ServiceError.ErrorFolderNotFound:
                    throw new ObjectNotFoundException(srEx.Message, srEx);
                case ServiceError.ErrorSearchFolderNotInitialized:
                    throw new ExchangeSkipException(srEx.Message, srEx);
                default:
                    break;
            }
        }
        ...
        internal class ServiceResponseErrorDetails
        {
            ...
            private ServiceResponseException exception;
            ...
            internal void ThrowIfWellknownError()
            {
                switch (this.InnerErrorResponseCode)
                {
                    case ErrorCannotAccessDeletedPublicFolder:
                        throw new CannotAccessDeletedPFException(this.InnerErrorMessageText, this.exception);
                    default:
                        break;
                }
            }
