...
namespace AvePoint.Media.Service.ArchiverBackup
{
    ...
    public class GDriveArchiverRetentionIndexService
        : GDriveArchiverIndexServiceBase
        , IGDriveArchiverRetentionIndexService
    {
        ...
        {
            return this.HeadAndBodyService.GetDeleteDataFromMainIndex(storagePolicyId, jobId, driveId, dateTime);
        }
        ...
        public List<GoogleBasicIndex> GetDeletingIndexesByModifiedTime(string storagePolicyId, string jobId, long time,bool filterSoftDeleteDatas)
        {
