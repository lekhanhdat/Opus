...
namespace Microsoft365.Authentication.ADAL
{
	...
	{
		public static IWebUIFactory WebUIFactory
		{
			get;
			set;
		}

		public static IHttpWebRequestFactory HttpWebRequestFactory
		{
			get;
			set;
		}

		public static IRequestCreationHelper RequestCreationHelper
		{
			get;
			set;
		}
