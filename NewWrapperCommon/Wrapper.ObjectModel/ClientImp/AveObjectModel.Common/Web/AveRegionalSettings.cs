...
namespace AvePoint.ObjectModel.Common
{
    class AveRegionalSettings : AveClientObject, IAveRegionalSettings
    {
        ...
        {
            mWeb = web;
            base.DataCache.AddPropertyies((mWeb.RegionalSettings as AveRegionalSettings).DataCache.PropertiesCache);
            mIsNewCreated = true;
        }
        
        internal IAveWeb Web
        {
            get { return mWeb; }
        }
        ...
        public IAveTimeZone TimeZone
        {
            get 
            {
                if (base.DataCache.IsPropertyNotLoaded("TimeZone"))
                {
                    ...
                    base.DataCache.PropertiesCache["TimeZone"] = timeZone;
                    return timeZone;
                }
        ...
        {
            if (mDefaultRegionalSettings == null || mDefaultRegionalSettings.ContainsKey("LocaleId") && (int)mDefaultRegionalSettings["LocaleId"] != (int)lcid)
            {
        ...
        {
            if (mDefaultRegionalSettings == null || mDefaultRegionalSettings.ContainsKey("LocaleId") && (int)mDefaultRegionalSettings["LocaleId"] != localeId)
            {
        ...
        {
            if (mDefaultRegionalSettings == null || mDefaultRegionalSettings.ContainsKey("LocaleId") && (int)mDefaultRegionalSettings["LocaleId"] != lcid)
            {
