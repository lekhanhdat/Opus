...
namespace AvePoint.ObjectModel.Server16
{
    class AveServerAssemblyInit
    {
        ...
        private const string mAveTypeNamePro = "AvePoint.ObjectModel.Server16.Ave";
        private const string mAveOffcieTypeNamePro = "AvePoint.ObjectModel.Server16.Office.Ave";
