...
namespace AvePoint.ObjectModel.Server19
{
    ...
    {
        private SPWorkflowAssociationCollection workflowAssociationCollection;
            ...
            : base(workflowAssociationCollection)
        {
            ...
            this.workflowAssociationCollection = workflowAssociationCollection;
        }
        ...
        public IAveWorkflowAssociation this[Guid workflowAssociationId]
        {
            get
            {
                SPWorkflowAssociation workflowAssociation = workflowAssociationCollection[workflowAssociationId];
        ...
        {
            workflowAssociationCollection.Update((workflowAssociation as AveWorkflowAssociation).WorkflowAssociation);
        }

        public void Remove(IAveWorkflowAssociation association)
        {
            workflowAssociationCollection.Remove((association as AveWorkflowAssociation).WorkflowAssociation);
        }
        ...
        {
            object workFlowAssociation = AveAssemblyUtility.InvokeMethod(workflowAssociationCollection, "GetAssociationByBaseID", new object[] { baseTemplateId, ignoreStartSettings });
            if (workFlowAssociation != null)
            {
        ...
        public override IAveWorkflowAssociation this[int index]
        {
            get
            {
                return new AveWorkflowAssociation(this,workflowAssociationCollection[index]);
            }
        }

        public override int Count
        {
            get { return workflowAssociationCollection.Count; }
        }

        public IAveWorkflowAssociation Add(IAveWorkflowAssociation workflowAssociation)
        {
            SPWorkflowAssociation workFlowAssociation = workflowAssociationCollection.Add((workflowAssociation as AveWorkflowAssociation).WorkflowAssociation);
            if (workFlowAssociation == null)
            {
                return null;
            }
        ...
        {
            SPWorkflowAssociation workflowAssociation = workflowAssociationCollection.GetAssociationByName(name, cultureInfo);
            if (workflowAssociation == null)
            {
                return null;
            }
        ...
        {
            return workflowAssociationCollection.UpdateAssociationsToLatestVersion();
        }
        ...
        public void RemoveAll()
        {
            ...
            {
                int count = workflowAssociationCollection.Count;
                for (int index = count - 1; index >= 0; index--)
                {
                    workflowAssociationCollection.Remove(workflowAssociationCollection[index]);
                }
            }
        }
