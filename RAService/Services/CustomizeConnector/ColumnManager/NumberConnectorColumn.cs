...
{
    public class NumberConnectorColumn : IConnectorColumn
    {
        public Contract.TemplateManagement.ColumnType Type => Contract.TemplateManagement.ColumnType.Number;
        ...
        public async Task<(bool, CustomColumn)> TryConvertToCustomColumnAsync(CustomizeConnectorColumnInfo columnInfo, object valueJson)
        {
            ...
            if(!double.TryParse(valueJson?.ToString(), out var number))
            {
            ...
            customColumn = new CustomColumn
            {
                ...
                Number = number,
                Value_Array = number.ToString().ExplorerAnalyzeBuiltInColumn()
            };
        ...
        public async Task<CustomizeConnectorDataValidateResult> ValueValidateAsync(CustomizeConnectorColumnInfo columnInfo, object valueJson)
        {
            ...
            if(!double.TryParse(valueJson.ToString(), out _))
            {
