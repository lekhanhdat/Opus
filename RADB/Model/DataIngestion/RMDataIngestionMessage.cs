...
{
    public class RMDataIngestionMessage : BaseModel
    {
        [Key]
        ...
        [Column(TypeName = "int")]
        public RMDataIngestionOperationType OperationType { get; set; }
        ...
        [Index]
        [Column(TypeName = "int")]
        public RMDataIngestionMessageStatus Status { get; set; }
