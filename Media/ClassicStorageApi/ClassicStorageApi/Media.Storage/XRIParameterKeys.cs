...
namespace AvePoint.Media.ClassicStorage
{
    ...
    public class XRIParameterKeys //same as PhysicalDeviceParameterKeys class
    {
        ...
        /// <summary>
        /// 用于表示当前的device system是不是用来做Cache用的.
        /// </summary>
        public static readonly string CACHE_KEY = "cache";
        ...
        /// </summary>
        public static readonly string AppendConnectionStringKey = "AppendConnestionStringKey".ToLower(CultureInfo.InvariantCulture);
        ...
        public static readonly string IsValidate = "isValidate".ToLower(CultureInfo.InvariantCulture);
        ...
        /**************************For Box*********************************/
        public static readonly string Box_Client_ID = "boxClientId".ToLower();
        public static readonly string Box_Client_Secret = "boxRefreshSecret".ToLower();
        public static readonly string Box_Refresh_Token = "BoxRefreshTokenSecret".ToLower();
        public static readonly string Box_Root_Folder_Name = "boxRootFolderName".ToLower();
        ...
        public static readonly string Cloud_PASSWORD_KEY_WITHOUT_ENCRYPT = "secretwithoutencrypt";
        public static readonly string AccessPoinyKey = "ACCESSPOINT".ToLower(CultureInfo.InvariantCulture);
        public static readonly string ContainerKey = "containerName".ToLower(CultureInfo.InvariantCulture);
        public static readonly string EnableSSL = "EnableSSL".ToLower(CultureInfo.InvariantCulture);
        /**************************For Cloud Common*********************************/
        ...
        public static readonly string SUB_FOLDER_NAME = "folderName".ToLower(CultureInfo.InvariantCulture);
        ...
        /**************************For Cloud Dropbox*********************************/        /**************************For Cloud Dropbox*********************************/
