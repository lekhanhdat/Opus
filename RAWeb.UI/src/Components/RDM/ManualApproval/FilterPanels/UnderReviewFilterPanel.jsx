...
import { AvaiableOptions, FilterI18Ns, FilterOptions, ManualTab, Source } from "../Constants/index";
...
import DisposalDueDateFilter from "../Filters/DisposalDueDateFilter";

const UnderReviewFilterPanel = ({ show, onFilter, onHide, defaultFilterDefinitions, filterAvailableOptions,SpecialEnableReviewDefinitions,approvalCommentQuickReasons,SpeciallEnableReviewOnlyOneLocationDefinitions, customColumns}) => {
...
export default UnderReviewFilterPanel;