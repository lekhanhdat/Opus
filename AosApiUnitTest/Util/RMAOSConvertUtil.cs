...
namespace AvePoint.RA.Common.Aos.Util
{
    public class RMAOSConvertUtil
    {
        ...
        public static AccountDto Convert2RMAccount(CloudAos.UserInfo dto, bool isOwner = false)
        {
            ...
            {
                UserId = dto.InviteType == CloudAos.InviteType.Group ? dto.ObjectId : dto.Id,
        ...
        public static AccountDto Convert2RMAccount(UserInfo dto)
        {
            if (dto == null) return null;
            return new AccountDto()
            {
        ...
        public static RMAosUserInfo Convert2RMAosUserInfo(CloudAos.UserInfo dto)
        {
            if (dto == null) return null;
            return new RMAosUserInfo()
            {
                Name = dto.Name,
                Id = dto.Id,
                Email = dto.Email,
                FirstName = dto.FirstName,
                InviteType = (RMAosInviteType)dto.InviteType,
                LastModifiedTime = dto.LastModifiedTime.Ticks,
                LastName = dto.LastName,
                LegalPerson = dto.LegalPerson,
                ObjectId = dto.ObjectId,
                Status = (int)dto.Status,
                UserType = (int)dto.Role.Type
            };
        }
