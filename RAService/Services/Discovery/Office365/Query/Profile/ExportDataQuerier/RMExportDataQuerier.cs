...
namespace AvePoint.RA.Service.Services.Discovery.Office365.Query.Profile.ExportInactiveDataQuerier
{
    public abstract class RMExportDataQuerier<T>
    {
        ...
        protected readonly ExportDiscoveryProfileParam _queryParameter;

        protected readonly string _o365TenantSchemaName;

        protected readonly string _profileSchemaName;

        public RMExportDataQuerier(ExportDiscoveryProfileParam queryParameter)
        {
            ...
            _profileSchemaName = RMDiscoveryDBManager.GetOffice365SchemaName(queryParameter.O365TenantId, new Guid (queryParameter.ProfileId));
            SecurityUtils.SanitizeSQLSchemaName(_profileSchemaName);
            SecurityUtils.SanitizeSQLSchemaName(_o365TenantSchemaName);
        }

        public abstract Task<T> QueryExportDataAsync(List<string> needSumColumns);
    }
}
