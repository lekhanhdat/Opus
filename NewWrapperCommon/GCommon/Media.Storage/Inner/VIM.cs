...
namespace AvePoint.Media.Storage.Inner
{
    ...
    public interface IVIM
    {
        ...
        /// <returns></returns>
        IXSystem CreateSystem(string xri, AbstractXSystem parentSystem);
    ...
    {
        public abstract IXSystem CreateSystem(string xri, AbstractXSystem parentSystem);

        public abstract List<string> GetFeatureXML(int type);

        public abstract List<StorageFeature> GetFeatureObj(int type);
    ...
    {
        public const string Egnyte = "egnyte_vim";
        ...
        public const string ObjectAtmos = "objectatmos_vim";
        public const string NFS = "nfs_vim";
        public const string NETAPP_NFS = "netapp_nfs_vim";
        public const string IBMStorwizeFamily = "ibm_vim";
        public const string OpenStack = "openstack_vim";
        public const string IBMElasticStorage = "ibmeco_vim";
        public const string SFTP = "sftp_vim";
        public const string Cleversafe = "cleversafe_vim";
