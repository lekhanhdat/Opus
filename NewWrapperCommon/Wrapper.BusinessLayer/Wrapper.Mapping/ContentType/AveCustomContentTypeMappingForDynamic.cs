...
{
    public class AveCustomContentTypeMappingForDynamic : IAveCustomContentTypeMappingFactory
    {
        private IAveCustomContentTypeMapping customMapping = null;
        ...
        public AveCustomContentTypeMappingForDynamic(byte[] assembly)
        ...
        public AveCustomContentTypeMappingForDynamic(byte[] assembly, string fullTypeName)
        {
            ...
            if (!string.IsNullOrEmpty(fullTypeName))
            {
                ...
                Type baseIntr = t.GetInterface(typeof(IAveCustomContentTypeMapping).ToString());
                if (baseIntr == null)
                {
            ...
            customMapping = ci == null ? null : ci.Invoke(null) as IAveCustomContentTypeMapping;
        }
