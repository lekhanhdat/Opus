...
{
    public class RMDiscoveryInactiveSizeRangeQuerier : RMDiscoveryInactiveDataQuerier<List<RMDiscoverySizeRangeDataInfo>>
    {
        public RMDiscoveryInactiveSizeRangeQuerier(RMDiscoveryOffice365QueryParameter queryParameter) : base(queryParameter)
        {
        }
