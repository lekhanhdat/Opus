...
namespace AvePoint.ObjectModel.ClientOM
{
    public partial class AveClientOMOffice365Request
    {
        ...
        public override string ReadServerTimeLine()
        {
            return mPSIRequest.ReadServerTimeLine();
        }
        public override void UpdateTimeLineByPSI(string tlViewData)
        {
            mPSIRequest.UpdateTimeLine(tlViewData);
        }

        public override List<AveProjectDetailPageInfo> GetDetailPages(Guid eptId)
        {
            return mPSIRequest.ReadEnterpriseTypePDPs(eptId);
        }

        public override void UpdateEnterpriseTypeByPSI(Guid projId, AveProjectEnterpriseProjectTypeInfo eptInfo)
        {
        ...
        public override List<Dictionary<string, object>> QueryProjects(bool includeDetails)
        {
            using (var context = CreateProjectContext())
            {
                if (includeDetails)
        ...
        public override List<Dictionary<string, object>> QueryProjectTasks(Guid projectId, bool isPublished)
        {
            using (var context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> QueryDraftProject(Guid projectId)
        {
            using (var context = CreateProjectContext())
            {
                var project = context.Projects.GetByGuid(projectId);
        ...
        public override List<Dictionary<string, object>> QueryProjectCalendars()
        {
        ...
        public override List<Dictionary<string, object>> QueryProjectCustomFields()
        {
            var result = new List<Dictionary<string, object>>();
        ...
        public override List<Dictionary<string, object>> QueryProjectLookupTables()
        {
            var result = new List<Dictionary<string, object>>();
        ...
        public override List<Dictionary<string, object>> QueryProjectEnterpriseProjectTypes()
        {
            var result = new List<Dictionary<string, object>>();
        ...
        public override List<Dictionary<string, object>> QueryProjectEnterpriseResources()
        {
            var result = new List<Dictionary<string, object>>();
        ...
        public override List<Dictionary<string, object>> QueryProjectPhases()
        {
            var result = new List<Dictionary<string, object>>();
        ...
        public override List<Dictionary<string, object>> QueryProjectStages()
        {
            var result = new List<Dictionary<string, object>>();
        ...
        public override List<Dictionary<string, object>> QueryProjectDetailPages()
        {
            using (var context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> GetProjectById(Guid id)
        {
            using (var context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> AddLookupTable(AveProjectLookupTableInfo tableInfo)
        {
        ...
        public override Dictionary<string, object> AddCustomField(AveProjectCustomFieldInfo customFieldInfo)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> AddEnterpriseType(AveProjectEnterpriseProjectTypeInfo eptInfo)
        {
            using (ProjectContext context = CreateProjectContext())
            {
                try
        ...
        public override Dictionary<string, object> AddEnterpriseResource(AveProjectEnterpriseResourceInfo resourceInfo)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> AddPhase(AveProjectPhaseInfo info)
        {
        ...
        public override Dictionary<string, object> AddStage(AveProjectStageInfo info)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override void DeleteProject(Guid id, string siteUrl)
        {
            using (var context = CreateProjectContext())
            {
                QueueJob job;
        ...
        public override Dictionary<string, object> UpdateLookupTable(Guid id, Dictionary<string, object> updateProp)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> UpdateCustomField(Guid id, Dictionary<string, object> updateProp)
        {
            using (var context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> UpdateEnterpriseProjectType(Guid id, Dictionary<string, object> updateProp)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> UpdateEnterpriseResource(Guid id, Dictionary<string, object> updateProp)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> UpdateStage(Guid id, Dictionary<string, object> updateProp)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override Dictionary<string, object> UpdatePhase(Guid id, Dictionary<string, object> updateProp)
        {
            using (ProjectContext context = CreateProjectContext())
            {
                Dictionary<string, object> phaseProp = new Dictionary<string, object>();
        ...
        public override void RestoreCalendar(List<AveProjectCalendarInfo> calendarInfo)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override void RestoreLookupTable(List<AveProjectLookupTableInfo> lookupTableInfos)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override void RestoreCustomFields(List<AveProjectCustomFieldInfo> customFieldInfos)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override void RestoreEnterpriseResource(List<AveProjectEnterpriseResourceInfo> resourceInfos)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override void RestorePhase(List<AveProjectPhaseInfo> phaseInfos)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override void RestoreStage(List<AveProjectStageInfo> stageInfos)
        {
            using (ProjectContext context = CreateProjectContext())
            {
        ...
        public override void RestoreEnterpriseProjectTypes(List<AveProjectEnterpriseProjectTypeInfo> eptInfos)
        {
            using (ProjectContext context = CreateProjectContext())
            {
                if (eptInfos.Count <= 0)
        ...
        private CustomField GetCustomFieldByName(string name, ProjectContext context)
        {
            return context.CustomFields.FirstOrDefault(f => string.Equals(f.Name, name, StringComparison.OrdinalIgnoreCase));
        }
        ...
        private ProjectContext CreateProjectContext()
        {
            ...
            context.SetTokenProvider(tokenProviders.MainTokenProvider);
            return context;
        }

        private bool WaitForJob(QueueJob job, ProjectContext context)
        {
            var jobState = context.WaitForQueue(job, WrapperConfiguration.BPOS_S.HttpWebRequestTimeout);
        ...
        public override Dictionary<string, object> RestoreProject(AveProjectInfo info, AveProjectReader projectDetails, AveProjectConfig config, AveRestoreMode option)
        {
            var manager = new AveProjectManager(mPSIRequest, this.mWebUrl, this.mUserAccountInfo, tokenProviders.MainTokenProvider, config);
