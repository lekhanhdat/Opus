...
{
    [ServiceContract]
    public interface IADesignManagerCompareService
    {
        /// <summary>
        ...
        [OperationContract]
        ReturnResult HandleMessageFromServer(DMCompareMessage message);
        ...
        [OperationContract]
        ReturnResult HandleMessageFromPrimaryAgent(DMCompareMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult HandleMessageFromServerForMonitorJob(DMCompareMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult HandleMessageFromAgentForMonitorJob(DMCompareMessage message);
    }
}
