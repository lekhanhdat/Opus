...
{
    public class RMDiscoveryAOSPBasicInactiveDataAnalyzer
    {
        private readonly RALogger _logger = RALogger.GetInstance(typeof(RMDiscoveryAOSPBasicInactiveDataAnalyzer));
        ...
        private readonly List<RMDiscoveryAOSPBasicInactiveData> _dataList;

        public RMDiscoveryAOSPBasicInactiveDataAnalyzer(
        ...
        public void Increse(List<RMDiscoveryAOSPSiteInactiveData> siteDataList)
        {
            ...
            foreach (var siteData in siteDataList)
            {
                ...
                if (data == null)
                {
                    data = new RMDiscoveryAOSPBasicInactiveData
                    {
        ...
        private async Task<bool> AppendAndSaveAsync()
        {
            try
            {
                ...
                foreach (var data in _dataList)
                {
                    ...
                    {
                        existsBaicData = new RMDiscoveryAOSPBasicInactiveData
                        {
