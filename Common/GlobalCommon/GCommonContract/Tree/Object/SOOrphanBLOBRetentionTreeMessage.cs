...
{
    [DataContract]
    public class SOOrphanBLOBRetentionTreeMessage : AveTreeMessage
    {
        [DataMember]
        public List<SOOrphanBLOBRetentionTreeNodeDto> NodeList { get; set; }

        [DataMember]
        public SOOrphanBLOBRetentionTreeNodeDto Node { get; set; }
