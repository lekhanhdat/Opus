...
namespace AvePoint.GCommon.Contract.Compliance.eDiscovery.FilterPolicy
{
    ...
    /// </summary>
    [DataContract]
    public enum EDDateTimeRangeType
    {
        [EnumMember]
        Day,
        [EnumMember]
    ...
    /// </summary>
    [DataContract]
    public enum EDRuleMetaDataType
    {
        [EnumMember]
        Number = 0,
        [EnumMember]
