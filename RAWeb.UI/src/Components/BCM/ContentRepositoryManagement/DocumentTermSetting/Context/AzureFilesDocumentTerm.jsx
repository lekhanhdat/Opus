...
export default {
    ...
    saveTermSettings(that, callback) {
        ...
        let sendUrl = "/api/AzureFileSettingApi/SaveSettings";
        let option = {
            url: sendUrl,
            method: "Post",
            data: currNode
    ...
    getSavedTerm(that) {
        ...
        let isGroup = CRMCommonUtil.isAzureFileGroup(currTreeNode);
        ...
        let option = {
            url: "/api/AzureFileSettingApi/GetAzureFileSavedTerm",
            method: "Post",
            data: paramObj
        };
    ...
    isGroupNode(documentTermSetting) {
        return CRMCommonUtil.isAzureFileGroup(documentTermSetting.SelectedNode);
    },

    getGroupNodeId(node) {
        return CRMCommonUtil.getAzureFileGroupNode(node.SelectedNode).id;
    }
};