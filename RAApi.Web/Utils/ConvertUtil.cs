...
namespace AvePoint.RA.Web.Common.Utils
{
    public class ConvertUtil
    {
        ...
        public static TermNodeInfo ToApiTermInfo(RMTermInfo dto)
        {
            return new TermNodeInfo()
            {
                Id = dto.Id,
        ...
        public static TermNodeInfo ToApiTermInfo(Contract.RMReport.TermTreeNode treeNode)
        {
            TermNodeInfo termInfo = new TermNodeInfo();
        ...
        private static List<TermNodeInfo> ToApiTermInfoList(List<Contract.RMReport.TermTreeNode> treeNodeList)
        {
            List<TermNodeInfo> terms = new List<TermNodeInfo>();
