...
namespace RAManualApproval
{
    public class ManualApprovalRuleInfoManager
    {
        ...
        public static async Task<(bool, ManualApprovalRuleModel)> TryGetAsync(SourceFlag flag, string ruleId)
        {
        ...
        private static async Task<Dictionary<SourceFlag, ManualApprovalRuleModel>> LoadRuleInfoAsync(string ruleId)
        {
