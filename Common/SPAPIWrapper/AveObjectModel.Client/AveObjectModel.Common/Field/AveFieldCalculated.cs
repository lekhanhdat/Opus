...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldCalculated : AveField, IAveFieldCalculated
    {
        ...
        public AveFieldCalculated(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
