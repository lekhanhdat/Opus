...
{
    class NWDiscardCheckOutItemActionProcessor : NWLibariesAndListsActionProcessor
    {
        public NWDiscardCheckOutItemActionProcessor(NintexWFActionProcessor workflowActionProcessor)
