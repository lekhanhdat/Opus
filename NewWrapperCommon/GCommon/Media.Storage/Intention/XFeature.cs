...
namespace AvePoint.Media.Storage
{
    ...
    public class FeatureUnit : IConvertible
    {
        ...
        [DataMember]
        public bool NoLable { get { return noLable; } set { this.noLable = value; } }
    ...
    public class SpecificEvent
    {
        ...
        public static readonly SpecificEvent SelectedNFSExport = new SpecificEvent("Selected NFS Export");
        public static readonly SpecificEvent LoadNFSSysteProfiles = new SpecificEvent("Load NFS Profiles");
        public static readonly SpecificEvent CheckUserMapping = new SpecificEvent("Check User Mapping");
        public override string ToString()
        {
