...
namespace AvePoint.Wrapper.Mapping
{
    ...
    public class AveContentTypeMapping : AveRestoredContentTypeMapping, IAveContentTypeMapping
    {
        ...
        public void SetContentTypeNameMappingFromGui(Dictionary<string, string> customMappings)
        {
            (customMapping as AveCustomContentTypeMapping).SetContentTypeNameMappingFromGui(customMappings);
        }
