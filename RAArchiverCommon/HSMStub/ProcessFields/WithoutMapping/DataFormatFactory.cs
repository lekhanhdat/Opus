...
namespace AvePoint.Wrapper.Restore
{
    class DataFormatFactory
    {
        ...
        public static IDataFormat CreateInstance(AveXmlField xmlField, IAveField destField, AveSPItem mItem, int originalVersion, int originalRowId, Dictionary<string, object> userData)
        {
            ...
            switch (xmlField.Type)
            {
                ...
                case AveFieldType.User:
                    return new UserFieldDataFormat(xmlField, destField, mItem);
                ...
                case AveFieldType.Lookup:
                    return new HSARLookupDataFormat(xmlField, destField, mItem, originalVersion);
