...
namespace AvePoint.GCommon
{
    ...
    {
        AveLogger logger = AveLogger.GetInstance(typeof(CustomX509CertificateValidator));
        ...
        public override void Validate(X509Certificate2 certificate)
        {
            ...
            ValidateCertificateRelationship(certificate, GCommonRoleConfiguration.WCF_Certificate);
        }
