...
namespace LS.BinarySerialization
{
    ...
    internal sealed class SerializationHeaderRecord
    {
        ...
        private void DumpInternal()
        {
            ...
            Console.WriteLine("BINARY", "*****SerializationHeaderRecord*****");
            Console.WriteLine("binaryHeaderEnum (Byte){0}", ((Enum)binaryHeaderEnum).ToString());
            Console.WriteLine("topId (Int32){0}", topId);
            Console.WriteLine("headerId (Int32){0}", headerId);
            Console.WriteLine("majorVersion (Int32){0}", majorVersion);
            Console.WriteLine("minorVersion (Int32){0}", minorVersion);
