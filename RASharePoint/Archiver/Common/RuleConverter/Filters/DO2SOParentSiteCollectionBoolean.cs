...
{
    internal class DO2SOParentSiteCollectionBoolean : DO2SOFilterConverterBase
    {
        ...
        public DO2SOParentSiteCollectionBoolean(string value1, int startSequenceNo, BooleanConditionType condition, string extraValue)
        {
            this.mValue1 = value1;
        ...
        public override List<SOFilterPolicy> Convert()
        {
            ...
            ParentSiteCollectionBooleanRule rule = new ParentSiteCollectionBooleanRule { Value1 = this.mFilterName };
