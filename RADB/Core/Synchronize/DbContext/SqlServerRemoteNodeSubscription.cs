...
public class SqlServerRemoteNodeSubscription : IRemoteNodeSubscription
{
    private readonly IRemoteNodeEvent _remoteNodeEvent;

    public IRemoteNodeSynchronizeDao RemoteNodeSynchronizeDao => new SqlServerRemoteNodeSynchronizeDao();

    public SqlServerRemoteNodeSubscription(IRemoteNodeEvent remoteNodeEvent)
    {
