...
namespace AvePoint.ObjectModel.Server16
{
    ...
    {
        internal const string SOIntegrationAssemblyName = "SP2016StorageOptimizationIntegration"; 
        internal const string SOIntegrationNameSpace = "AvePoint.StorageOptimization.Integration.";
        internal const string SOConnectorIntegrationAssemblyName = "SP2016ConnectorBusinessLogic";
        ...
        {
            get { return AveContextKind.Server16ObjectModel; }
        }
        ...
        {
            logger.Debug("Start 16 server object model factory");
