...
namespace AvePoint.Media.Storage.Cloud.Cleversafe
{
    ...
    using System.Text;
    #endregion
    class CleversafeMultipartUploadStream : HttpUploadStream
    {
        ...
        public CleversafeMultipartUploadStream(CleversafeClient client, String fullURL, Dictionary<String, String> headers)
            : base(null)
        {
            this.client = client;
