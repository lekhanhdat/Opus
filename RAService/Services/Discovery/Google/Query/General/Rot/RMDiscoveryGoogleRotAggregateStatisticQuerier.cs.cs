...
{
    public class RMDiscoveryGoogleRotAggregateStatisticQuerier : RMDiscoveryGoogleRotDataQuerier<RMDiscoveryGoogleAggregateStatisticDataInfo>
    {
        public RMDiscoveryGoogleRotAggregateStatisticQuerier(RMDiscoveryGoogleQueryParameter queryParameter) : base(queryParameter)
        {
        }
...
FROM [{_schemaName}].[{tableName}] AS data ";
            ...
            return await _queryDao.GetDataAsync<RMDiscoveryGoogleAggregateStatisticDataInfo>(sql, sqlParams.ToArray());
        }
