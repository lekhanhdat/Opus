...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldChoice:AveFieldMultiChoice,IAveFieldChoice
    {
        ...
        public AveFieldChoice(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
