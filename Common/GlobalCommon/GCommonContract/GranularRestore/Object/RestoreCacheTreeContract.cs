...
namespace AvePoint.GCommon.Contract.GranularRestore.Object
{
    ...
    public class RestoreCacheTreeContract
    {
        [DataMember]
        public List<RestoreCacheTreeDto> CacheTrees { get; set; }
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class RestoreCacheTreeDto
    {
        [DataMember]
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class BackupJobsMappingDto
    {
        /// <summary>
    ...
    {
        public RestoreCacheTreeDto CacheTreeDto { get; set; }
    ...
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class RestoreCacheTreeSearchParams
    {
        [DataMember]
