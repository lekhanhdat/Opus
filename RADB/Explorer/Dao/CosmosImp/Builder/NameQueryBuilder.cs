...
{
    public class NameQueryBuilder : BaseArraySearchBuilder
    {
        private static List<string> builtInOrDefaultColumnIds = new List<string> { DefaultColumnIDs.NameOrTitle};
        ...
        {
            return CosmosConst.C_LeafNameArray;
        }

        protected override string GetSearchColumnName()
        {
            return CosmosConst.C_LeafName;
        }
