...
{
    [DataContract]
    public class RMDiscoveryAOSPNodeQueryParameter
    {
        [DataMember]
        [JsonProperty("viewMode")]
        public RMDiscoveryAOSPNodeViewMode ViewMode { get; set; }
        [DataMember]
        ...
        [DataMember]
        [JsonProperty("siteUniqueIds")]
        public List<string> SiteUniqueIds { get; set; } = new();
    ...
    [DataContract]
    public enum RMDiscoveryAOSPNodeViewMode
    {
        [EnumMember]
        None = 0,
        [EnumMember]
