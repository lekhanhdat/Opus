...
{
    public class SharePointOnPremFarmBrowser : IBrowser
    {
        public HybridBrowserType BrowserType => HybridBrowserType.SharePointOnPremFarm;
        ...
        public string Browse(string message)
        {
            ...
            return factory?.CreateFarm()?.Local?.ID.ToString();
        }
    }
}
