...
namespace AvePoint.Media.Core.IO.Input
{
    ...
    public class FormatedInputStream : IMediaGeneralInputStream, IXConverter
    {
        ...
        public FormatedInputStream(OpenInputStreamParameter openParam)
        {
            ...
            if (this.dataListener == null) throw new NullReferenceException("FormatedInputStream Formated InputStream Exception");
        }
        ...
        public String NextItem(IndexBase itemIndex)
        {
            ...
            this.currentBackupJobIdForMetaData = itemIndex.BackupJobId;
        ...
        public void BeginRead(FileType fileType)
        {
            switch (fileType)
            {
                ...
                case FileType.Content:
                    ...
                    break;
                default:
                    throw new Exception($"FormatedInputStreamBeginReadException:{fileType}");
            }
        }
        ...
        private void ChangeMetaDataFile()
        {
            ...
            bool isRealChange = this.currentMetaDataFileNumber != this.lastMetaDataFileNumber || this.currentMetaDataFilePrefixNumber != lastMetaDataFilePrefixNumber
                || !this.currentBackupJobIdForMetaData.Equals(this.lastBackupJobIdForMetaData,StringComparison.OrdinalIgnoreCase);
            if (isRealChange)
            {
        ...
        private void ChangeContentDataFile()
        {
            ...
            bool isRealChange = this.currentContentDataFileNumber != this.lastContentDataFileNumber || this.currentContentDataFilePrefixNumber != lastContentDataFilePrefixNumber
                || !this.currentBackupJobIdForContentData.Equals(this.lastBackupJobIdForContentData,StringComparison.OrdinalIgnoreCase);
            if (isRealChange)
            {
        ...
        {
            return this.currentItemIndex.CurrentItemContentDataTotalLength - this.totalReadedContentData;
        }
        ...
        public StorageInfo FormNames(FileType fileType, String highName, String lowName)
        {
            ...
            switch (fileType)
            {
                ...
                case FileType.MetaData:
                    ...
                    break;
                default:
                    throw new Exception(String.Format($"FormatedInputStreamBeginReadException:{fileType}"));
            }
        ...
        {
            if (IsOpenModeSet(StreamOpenType.NoContent))
                throw new Exception("Formated InputStream SetContentData Offset And Length Exception");
            if (isFirstBlock)
            {
            ...
            if (isSupportAutoChangeDataBlock)
            {
                contentDataBeginReadLength = currentItemIndex.CurrentItemContentDataTotalLength;
            }
            else
            {
                contentDataBeginReadLength = Math.Min(currentItemIndex.CurrentItemContentDataTotalLength - totalReadedContentData, blocksize - contentDataBeginReadOffset);
            }
        }
