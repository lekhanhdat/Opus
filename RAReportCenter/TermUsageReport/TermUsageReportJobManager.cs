...
{
    public class TermUsageReportJobManager
    {
        ...
        {
            ReportMangerFactory.Instance.Init(jobId, AvePoint.RA.Contract.JobMonitor.JobType.TermUsageReport, true);
        ...
        public static void SendTermUsageDetails(List<RMTerm> terms)
        {
            var details = terms.ConvertAll(item => new JMTermSelection
            {
                Term = item.Name,
                TermFullPath = item.FullPath
            });
        ...
        public static void AddJobReport(BCSTermUsageReport report)
        {
