...
namespace AvePoint.RA.Contract.TemplateManagement
{
    ...
    {
        public static List<TemplateType> GetSubTemplatesType(this TemplateType type)
        {
            switch (type)
            {
                case TemplateType.Custom:
                    return new List<TemplateType>() { TemplateType.Custom, TemplateType.Box, TemplateType.Folder };
            ...
            return new List<TemplateType>() { type };
        }
    }
}
