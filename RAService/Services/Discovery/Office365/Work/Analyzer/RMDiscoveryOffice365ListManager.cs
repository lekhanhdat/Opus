...
{
    public class RMDiscoveryOffice365ListManager
    {
        private readonly RALogger _logger = RALogger.GetInstance(typeof(RMDiscoveryOffice365ListManager));
        ...
        public RMDiscoveryOffice365ListManager(Guid o365TenantId, Guid siteId)
        {
