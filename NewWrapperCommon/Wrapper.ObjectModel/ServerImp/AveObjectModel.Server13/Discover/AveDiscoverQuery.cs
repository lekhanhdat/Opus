...
namespace AvePoint.ObjectModel.Server13
{
    public class AveDiscoverQuery : IAveDiscoveryQuery
    {
        ...
        {
            using (var pc = new AvePerformanceScope("Server.AveDiscoverQuery.QuerySystemListItemForIB"))
            {
        ...
        public void QueryListItemForIB(AveFolderCache folderCache, AveItemObject folderObject, AveListObject listObject, List<AveDiscoverExtraItemBaseInfo> extraItems)
        {
            ...
            using (var pc = new AvePerformanceScope("Server.AveDiscoverQuery.QueryListItemForIB"))
            {
        ...
        {
            using (var pc = new AvePerformanceScope("Server.AveDiscoverQuery.QueryChangedListItemFromExtraItemList"))
            {
