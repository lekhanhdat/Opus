            ...
            if (listIdToken != null)
            {
                ...
                if (listId != Guid.Empty)
                {
                    ...
                    try
                    {
                        ...
                        {
                            list = document.ParentFolder.ParentWeb.Lists.GetList(listId, false);
                        }
                        else
                        {
                    ...
                    {
                        foreach (IAveList templist in document.ParentFolder.ParentWeb.Lists)
                        {
                            if (templist.BaseTemplate == AveListTemplateType.Events)
                            {
                                list = templist;
