        ...
        public void Write(AveDataBlock dataBlock)
        {
            switch (dataBlock.Type)
            {
                ...
                case AveDataBlockType.TAIL_TYPE:
                    ...
                    break;
                default:
                    throw new System.NotSupportedException($"FormatedOutputStreamWriteException:{dataBlock.Type}");
            }
        }
        ...
        public StorageResult Close()
        {
            ...
            try
            {
                if (contentDataStream != null)
                {
                    ...
                    {
                        //if (!(this.maxBlockSize < ServiceConstants.MemoryStreamLimit * IOConstants.MB))
                        //{
