...
namespace AvePoint.Media.Service.ArchiverBackup
{
    ...
    public interface IGDriveArchiverRetentionIndexService
    {
        ...
        List<GoogleBasicIndex> GetDeletingIndexesByModifiedTime(String storagePolicyId, String jobId,long time,bool filterSoftDeleteDatas);
        #endregion
    }
}