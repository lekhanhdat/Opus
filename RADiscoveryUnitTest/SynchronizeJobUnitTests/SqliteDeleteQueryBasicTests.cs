...
[TestClass]
public class SqliteDeleteQueryBasicTests : SynchronizeJobInitializeTest
{
    private string DeleteQuery()
    {
        ...
        return
            $"DELETE FROM {SecurityUtils.SanitizeSQLSchemaName(schemaName)}${SecurityUtils.SanitizeSQLSchemaName(tableInfo.Name)}";
    }
    [TestMethod]
    public void  DeleteQueryWithMultipleFilters_ShouldBeSuccessful()
    {
