...
namespace AvePoint.Media.Service.DomainModel
{
    ...
    public interface IControlStubService
    {
        IAJobDetailService JobDetailService { get; set; }
        IMArchiverJobManagementService ArchiverBackupService { get; set; }
        IMArchiverService ArchiverUpgradeServiceSiteMasterIndexService { get; set; }
        IMArchiverSiteMasterIndexService ArchiverGeneralServiceSiteMasterIndexService { get; set; }
        //IMAcceptMediaData ControlStorageService { get; set; }
        IMediaDataDao ControlStorageService => PlatformWindsorManager.GetService<IMediaDataDao>();
        IMServManageService ControlManageService { get; set; }
    }
}