...
using AvePoint.Media.ClassicStorage.Cloud.Azure;
...
{
    public class AzureSystemWrapper : AbstractCloudSystemWrapper
    {
        ...
        public AzureSystemWrapper(AzureSystem azureSystem, AbstractRESTOprationExecutor client)
            : base(azureSystem, client)
        {
