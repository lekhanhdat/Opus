...
using AvePoint.RA.Service.Services.Discovery.Office365.Work.Analyzer.V3.General;
...
{
    public class RMDiscoveryOffice365AnalysisV3JobRunner : RMDiscoveryOffice365Worker
    {
        ...
        public RMDiscoveryOffice365AnalysisV3JobRunner(string jobId) : base()
        {
