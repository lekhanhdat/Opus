...
const ViewModeI18ns = new Map([
    ...
    [DiscoveryNodeViewMode.Site, RMResx.RM_FA_ViewMode_DriveCollection],
]);
...
const GoogleDiscoveryDataView = ({
    ...
    const onViewModeChange = (args) => {
        ...
        clonedQueryParameter.nodeQueryParameter.driveIds = [];
        clonedQueryParameter.nodeQueryParameter.checkedNodeIds = [];
...
export default forwardRef(GoogleDiscoveryDataView);
