...
namespace AvePoint.ObjectModel.Common
{
    class AveAppInstance : AveClientObject, IAveAppInstance
    {
        ...
        public AveAppInstance(AveSite site, IDictionary<string, object> appProperties)
        {
            mSite = site;
        ...
        public IAveApp App
        {
            get 
            {
                if (mApp == null && base.DataCache.IsPropertyAvailable("App"))
                {
        ...
        {
            get { return base.DataCache.GetProperty<Uri>("StartPage"); }
        }
