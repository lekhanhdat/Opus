...
{
    public class CreateAndDestryoedReportJobManager
    {
        ...
        {
            ReportMangerFactory.Instance.Init(jobId, AvePoint.RA.Contract.JobMonitor.JobType.CreateAndDestroyedReport, true);
        ...
        public static void AddSucceedJobDetail(SourceNeedReportNode nodeInfo, string typeI18nKey)
        {
            ...
            {
                ObjectLevel = typeI18nKey,
                Title = nodeInfo.LeafName,
        ...
        public static void AddJobReport(CreateAndDestroyedFileReport report)
        {
