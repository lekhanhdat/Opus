...
{
    public class NewEXORecordVEODataV3
    {
        ...
        private IExchangeItem EXOItem = null;
        ...
        NewEXOVEOV3CustomizeProperty EXOVEOV3CustomizeProperty;

        #region VEO CONTENT
        public NewEXORecordVEODataV3(EXOVEOContentXML xml)
        {
            EXOVEOV3CustomizeProperty = new NewEXOVEOV3CustomizeProperty();
            EXOVEOContentXML = xml;
        }

        public void BuildVEOContentData(ref VEOContent vers, IExchangeItem EXOItem, string jobID, string contentExportPath, string mailFullPath, string msgFilePath, string disposalClass)
        {
            try
            {
        ...
        public NewEXORecordVEODataV3(EXOVEOHistoryXML xml)
        {
    ...
    internal class NewEXOVEOV3CustomizeProperty
    {
        public string? GetEXOItemPropertyValue(bool ExchangeMetadataAsSource, string defaultValue, string columnName, IExchangeItem EXOItem, string jobID, string exportPath, string filePath, string disposalClass)
        {
