...
namespace AvePoint.Wrapper.Common
{
    public sealed class AveBuiltInContentTypeId
    {
        ...
        public const string CommonIndicator = "0x00A7470EADF4194E2E9ED1031B61DA0884";
        public const string SiteMembership = "0x010027FC2137D8DE4B00A40E14346D070D52";
            ...
            if (s_dict == null)
            {
                lock (s_lock)
                {
                    if (s_dict == null)
                    {
                        ...
                        s_dict[CommonIndicator] = true;
                        s_dict[SiteMembership] = true;
                    }
                }
            }
            bool flag = false;
            s_dict.TryGetValue(contentTypeId.ToUpper(), out flag);
            return flag;
        }
    ...
    {            
        ...
        private readonly static object splsiLock = new object();
        private readonly static object dsLock = new object();
    ...
    public class AvePublishingBuiltInContentType
    {
        public static string MasterPage
        {
            get
            {
                return "0x0101000F1C8B9E0EB4BE489F09807B2C53288F0054AD6EF48B9F7B45A142F8173F171BD1";
            }
        }
        ...
        public static string PageLayout
        {
            get
            {
                return "0x01010007FF3E057FA8AB4AA42FCB67B453FFC100E214EEE741181F4E9F7ACC43278EE811";
            }
        }
    }
}
