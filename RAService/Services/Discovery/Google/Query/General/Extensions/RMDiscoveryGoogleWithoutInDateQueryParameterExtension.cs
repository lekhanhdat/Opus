...
{
    public static class RMDiscoveryGoogleWithoutInDateQueryParameterExtension
    {
        public static bool TryGetSqlDefinition(this RMDiscoveryGoogleWithoutInDateQueryParameter parameter, string dataTableAlias, out RMDiscoverySqlDefinition sqlDefinition)
        {
            sqlDefinition = null;
