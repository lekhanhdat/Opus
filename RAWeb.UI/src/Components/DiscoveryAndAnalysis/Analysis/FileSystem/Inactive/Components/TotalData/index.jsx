...
import { FileSystemTotalMutableData } from "../index";
...
function TotalData({ queryParameter }) {
    ...
    useEffect(() => {
        const handler = async () => {
            const res =
                await FileSystemInactiveDataRequester.queryAggregateInfo(
                    queryParameter
                );
    ...
    const handleActivePieChart = () => {
        ...
        if (progressFileTotalSize === 0) {
            ...
            Number.parseInt(
                (totalDataInfo.fileTotalSize / progressFileTotalSize / 1.0)
                    .toFixed(2)
                    .replace(".", "")
            ) === 0 &&
        ...
        <>
            ...
            <div className="reco-percentage-chart">
                <PieChartWithProgress
                    ...
                    name={
                        RMResx.RM_FA_GoogleDrive_Inactive_SummaryTab_PieChartTitle
                    }
