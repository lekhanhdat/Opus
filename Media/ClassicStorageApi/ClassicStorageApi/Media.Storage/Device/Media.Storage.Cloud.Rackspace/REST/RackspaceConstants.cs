...
namespace AvePoint.Media.ClassicStorage.Cloud.Rackspace.REST
{
    ...
    public static class RackspaceConstants
    {
        public const string authenticationURL = "https://api.mosso.com/auth";
        /** HTTP Header token that identifies the username to Cloud Files **/
        public const string X_STORAGE_USER = "x-auth-user";
        /** HTTP header token that identifies the auth key to Cloud Files **/
