...
{
    internal class DO2SOParentSiteCollectionNumber : DO2SOFilterConverterBase
    {
        ...
        public DO2SOParentSiteCollectionNumber(string value1, int startSequenceNo, NumberConditionType condition, string extraValue)
        {
            this.mValue1 = value1;
        ...
        public override List<SOFilterPolicy> Convert()
        {
            ...
            ParentSiteCollectionNumberRule rule = new ParentSiteCollectionNumberRule { Value1 = this.mFilterName };
