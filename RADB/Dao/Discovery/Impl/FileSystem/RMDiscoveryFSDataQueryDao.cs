...
{
    public class RMDiscoveryFSDataQueryDao : IRMDiscoveryFSDataQueryDao
    {
        ...
        public async Task<List<RMDiscoveryFSAggregateTotalData>> GetAggregateTotalDataListAsync()
        {
            using var efContext = await RMDiscoveryDBManager.GetFileSystemEFContextAsync();
            return await efContext.FSAggregateTotalDataList.ToListAsync();
        }
    }
}
