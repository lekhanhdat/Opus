...
namespace AvePoint.ObjectModel.ServerSE
{
    class AveAlertCollection : AveAbstractCommonCollection<IAveAlert>, IAveAlertCollection
    {
        ...
        {
            var alertId = mWeb.Web.Alerts.Add(alertTitle, guidKey, uintKey, eventType, alertFrequency, alertTime, status, recipient, bstrItemDocUrl,
                AlertTypeAndScopeBits, strAlertTemplateName, filter, bstrProperties, bSendMail, deliveryChannels, Guid.Empty);
