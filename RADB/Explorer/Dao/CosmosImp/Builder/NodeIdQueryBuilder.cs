...
namespace AvePoint.RA.DB.Explorer.Dao.CosmosImp.Builder
{
    ...
    /// FS node id filter
    /// </summary>
    public class NodeIdQueryBuilder : BaseFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && !string.IsNullOrEmpty(filterOption.NodeId);
        }
