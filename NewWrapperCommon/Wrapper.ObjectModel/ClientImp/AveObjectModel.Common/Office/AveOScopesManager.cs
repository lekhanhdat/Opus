...
{
    abstract class AveOScopesManager : AveClientObject, IAveOScopesManager
    {
        private AveServiceContext m_ServiceContext;
        internal AveOScopeDisplayGroupCollection m_DisplayGroups;

        public AveOScopesManager()
        {
        }

        public AveOScopesManager(AveServiceContext context)
        {
            m_ServiceContext = context;
        }

        public abstract IAveOScopeDisplayGroupCollection AllDisplayGroups
        {
            get;
        }

        public abstract IAveOScopeCollection AllScopes
        {
            get;
        }
