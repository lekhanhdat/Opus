...
{
    public class RMDiscoveryAOSPInactiveSizeRangeQuerier : RMDiscoveryAOSPInactiveDataQuerier<List<RMDiscoverySizeRangeDataInfo>>
    {
        public RMDiscoveryAOSPInactiveSizeRangeQuerier(RMDiscoveryAOSPQueryParameter queryParameter) : base(queryParameter)
        {
        }
...
JOIN [dbo].[RMAOSPSizeRange] AS sizeRange ON data.SizeRange = sizeRange.Id ";
