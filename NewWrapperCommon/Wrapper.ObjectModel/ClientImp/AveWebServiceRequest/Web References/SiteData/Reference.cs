...
namespace AvePoint.ObjectModel.WebService.SiteData {
    using System;
    ...
    public partial class SiteData : AveSoapHttpClientProtocol
    {
        ...
        /// <remarks/>
        public SiteData() {
            this.Url = global::AvePoint.ObjectModel.WebService.Properties.Settings.Default.AveWebServiceRequest_SiteData_SiteData;
        ...
        public string GetChanges(ObjectType objectType, string contentDatabaseId, ref string startChangeId, ref string endChangeId, int Timeout, out bool moreChanges) {
            object[] results = this.Invoke("GetChanges", new object[] {
                        ...
                        endChangeId,
                        Timeout});
            startChangeId = ((string)(results[1]));
            endChangeId = ((string)(results[2]));
            moreChanges = ((bool)(results[3]));
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void GetChangesAsync(ObjectType objectType, string contentDatabaseId, string startChangeId, string endChangeId, int Timeout) {
            this.GetChangesAsync(objectType, contentDatabaseId, startChangeId, endChangeId, Timeout, null);
        }
        
        /// <remarks/>
        public void GetChangesAsync(ObjectType objectType, string contentDatabaseId, string startChangeId, string endChangeId, int Timeout, object userState) {
