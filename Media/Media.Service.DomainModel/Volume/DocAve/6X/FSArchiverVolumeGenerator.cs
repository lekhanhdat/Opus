...
namespace Media.Service.DomainModel.Volume.DocAve._6X
{
    internal class FSArchiverVolumeGenerator : ArchiverVolumeGeneratorBase
    {
        ...
        public override string GenerateIndexVolume(VolumeParameter param)
        {
            ...
            return SecurityUtils.SafeCombinePath(SecurityUtils.SafeCombinePath(SecurityUtils.SafeCombinePath(SecurityUtils.SafeCombinePath(ServiceConstants.FSArchiverPath, "IndexVolume")), param.SiteCollectionUrl), param.SiteCollectionUrl);
        }
