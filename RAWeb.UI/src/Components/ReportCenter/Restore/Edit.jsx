...
const getViewRequestOption = (id) => ({
    url: "/api/RestoreReport/Get",
    data: id
});

const getEditRequestOption = (reportInfo) => ({
    url: "/api/RestoreReport/Edit",
    data: reportInfo
});
...
const Edit = ({ history }) => {
    ...
    const onCancel = () => {
        history.push({
            pathname: RouterUrls.RC_RestoreReportManagement,
        });
    };
    ...
    return (
        <div className="reco-disposal-edit-wrapper">
            <section className="reco-disposal-header">
                ...
                />
                <$g.SiteMap
                    data={[SiteMapLinks.RC_RestoreReportManagement, {text: RMResx.RM_JS_Common_Edit}]} />
            </section>
