...
namespace AvePoint.GCommon.MicroKernel
{
    ...
    {
        readonly TIocContainer iocContainer;
        readonly Object thumbprint;
        ...
        public IocServiceHost(TIocContainer container, Type serviceType)
            : this(container, serviceType, null, null) { }
