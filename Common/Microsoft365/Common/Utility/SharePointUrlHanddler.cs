...
{
    public class SharePointUrlHanddler
    {
        ...
        {
            if (Uri.TryCreate(siteUrl,UriKind.Absolute,out Uri result))
            {
            ...
            throw new ArgumentException($"{siteUrl} is not a valid Uri string.");
        }
    }
}