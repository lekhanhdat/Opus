...
{
    class DateTimeDataFormatForHSMConnector : BaseDataFormatForHSMConnector
    {
        private static AveLogger log = AveLogger.GetInstance(typeof(DateTimeDataFormatForHSMConnector));

        public DateTimeDataFormatForHSMConnector(AveXmlField xmlField, IAveField destField, IAveListItem mItem) :
