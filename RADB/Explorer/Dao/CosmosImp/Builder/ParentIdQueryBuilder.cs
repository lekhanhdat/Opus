...
{
    public class ParentIdQueryBuilder : BaseArrayFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && filterOption.ParentIds != null && filterOption.ParentIds.Count > 0;
        }
