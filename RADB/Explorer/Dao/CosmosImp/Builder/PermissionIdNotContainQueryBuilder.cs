...
{
    public class PermissionIdNotContainQueryBuilder : BaseArrayNotContainFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && filterOption.ExcludePersmissionScopes != null && filterOption.ExcludePersmissionScopes.Count > 0;
        }
        ...
        {
            return filterOption.ExcludePersmissionScopes;
        }
    }
}
