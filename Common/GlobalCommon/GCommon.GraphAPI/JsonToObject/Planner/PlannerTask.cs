...
namespace AvePoint.GCommon.GraphAPI
{
    ...
    public class GraphPlannerTask : EntityBase
    {
        ...
        public GPCompletedBy CompletedBy { get; set; }
        ...
        public GPCreatedBy CreatedBy { get; set; }

        [JsonProperty("appliedCategories")]
        public Dictionary<string, bool> AppliedCategories { get; set; }

        [JsonProperty("assignments")]
        public Dictionary<string, GPTAssignmentValue> Assignments { get; set; }

        [JsonProperty("bucketTaskBoardFormat")]
        public BucketTaskBoardFormat BucketTaskBoardFormat { get; set; }
    ...
    #region Sub-Object
    public class GPTAssignmentValue : EntityBase
    {
        ...
        public GPTAssignedBy AssignedBy { get; set; }
    }
    public class GPTAssignedBy : EntityBase
    {
    ...
    public class GPTAppliedCategories : EntityBase
    {
    ...
    public class BucketTaskBoardFormat : EntityBase
    {
