...
public class RMDiscoverySalesforceJobManagementApiController : BaseApiController
{
    private readonly IRMDiscoverySalesforceJobManagementService _jobManagementService = new RMDiscoverySalesforceJobManagementService();
    [HttpGet]
