...
{
    public class RMMyhubCountryCodeFilter : IRMMyhubFilter
    {
        public string Name => "CountryCode";

        public RMMyhubSQLInfo GetSQL(string valueJson)
        {
            var value = Newtonsoft.Json.JsonConvert.DeserializeObject<RMMyhubDriveCountryCodeFilterValue>(valueJson);
            ...
            return BuildCountryCodeSqlInfo(validOptions);
        }

        private static RMMyhubSQLInfo BuildCountryCodeSqlInfo(string[] options)
        {
            ...
            {
                string parameterName = $"@countryCode{i}";
                conditions.Add($"c.countryCode = {parameterName}");
        ...
        public class RMMyhubDriveCountryCodeFilterValue
        {
