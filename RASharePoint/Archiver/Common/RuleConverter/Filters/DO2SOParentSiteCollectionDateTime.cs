...
{
    public class DO2SOParentSiteCollectionDateTime : DO2SOFilterConverterBase
    {
        ...
        public DO2SOParentSiteCollectionDateTime(string value1, int startSequenceNo, DateTimeConditionType condition, string extraValue, PolicyValueUnit unit)
        {
            this.mValue1 = value1;
        ...
        public override List<SOFilterPolicy> Convert()
        {
            ...
            ParentSiteCollectionDateTimeRule rule = new ParentSiteCollectionDateTimeRule { Value1 = this.mFilterName };
