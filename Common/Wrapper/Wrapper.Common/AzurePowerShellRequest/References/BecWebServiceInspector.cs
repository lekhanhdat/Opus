...
namespace AvePoint.Wrapper.Common
{
    ...
    class BecWebServiceInspectorV1 : IClientMessageInspector
    {
        private IAPSTokenManager tokenManager;

        public BecWebServiceInspectorV1(IAPSTokenManager tokenManager)
        {
        ...
        public object BeforeSendRequest(ref Message request, IClientChannel channel)
        {
            ...
            if (tokenManager.TokenType == APSTokenType.Bearer)
            {
                header.BearerToken = tokenManager.Token;
            }
            else
            {
                header.LiveToken = tokenManager.Token;
            }
