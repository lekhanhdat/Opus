...
namespace AvePoint.Wrapper.Common
{
    public interface IAveConnectorQueryService : IAveQueryService
    {
        ...
        void UpdateDBContent(AveBaseItemInfo info, System.IO.Stream fs, bool isRbs);
        ...
        string GetRecycleFileDiskname(AveBaseItemInfo info, string columnName);
        ...
        string GetRecycleItemContentTypeId(AveBaseItemInfo info);
        string GetRecycleItemProperties(AveBaseItemInfo itemInfo);
        bool UpdateRecycleItemProperty(AveBaseItemInfo itemInfo, byte[] metaInfoBytes);
        ...
        int GetItemRecycleStatus(AveBaseItemInfo info);

        void UpdateStreamSchema(AveBaseItemInfo info, byte streamSchema);
        void UpdateVersionStreamSchema(AveBaseItemInfo info, byte streamSchema);

        /// <summary>
        /// 获取激活某个Feature的所有SiteCollection信息
        /// </summary>
        /// <param name="featureId"></param>
        /// <returns></returns>
        List<Guid> GetConnectorSiteCollectionIDs(string featureId);
    }
}
