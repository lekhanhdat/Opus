...
namespace AvePoint.Wrapper.Common
{
    public class Ave2010SiteFlags
    {
        ...
        public static bool httpsHostHeaderSiteUrlScheme(uint flags)
        {
            return (((AveBitField)flags & AveBitField.httpsHostHeaderSiteUrlScheme) > ((AveBitField)0));
        }
    ...
    public enum AveBitField:uint
    {
        ...
        shareByEmailEnabled = 0x80000000,
        shareByLinkEnabled = 0x4000000,
