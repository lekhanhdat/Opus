            ...
            using (AvePerformanceScope pc = new AvePerformanceScope("Restore.AveSPWebApplication.FindWebApplication"))
            {
                ...
                try
                {
                    if (useWebAppUrl)
                    {
                        ...
                        if (app == null)
                        {
                            throw new Exception("Cannot find the WebApplication to restore the site:" + webAppUrl);
                        }
                    }
                    else
                    {
                        ...
                        if (app == null)
                        {
                            ...
                            if (app == null)
                            {
                                throw new Exception("Cannot find the WebApplication to restore the site:" + url);
                            }
                        }
                    }
                }
