...
namespace AvePoint.ObjectModel.Server19
{
    class AveSearchSetting : IAveSearchSetting
    {
        ...
        {
            mSearchSetting.AttachContext((cx as ObjectModel.Server19.Search.AveContext).Context);
        }

        public void DetachContext(Wrapper.Common.Search.IAveContext cx)
        {
            mSearchSetting.DetachContext((cx as ObjectModel.Server19.Search.AveContext).Context);
        }
