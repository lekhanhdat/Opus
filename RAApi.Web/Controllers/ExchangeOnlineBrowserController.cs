...
{
    [Route("api/exchangeonlinebrowser/[action]")]
    [APIScopeFilter(AvePoint.RA.Contract.Common.ContractConstants.HybridInernalScope)]
    public class ExchangeOnlineBrowserController : RAWebApiBase
    {
        ...
        [HttpPost]
        public string Browser([FromBody] RABrowserContract contract)
        {
            var res = RABrowserUtil.Instance.Browse<ExchangeOnlineTreeMessage>(contract);
