...
namespace AvePoint.Wrapper.Common
{
    ...
    public class AveWebPartCache
    {
        ...
        public bool IsSitePostRestore { get; set; }
    ...
    public interface IAveLimitedWebPartManager : IDisposable
    {
        ...
        IAveWebPart ImportWebPart(XmlReader reader, out string errorMessage);
        IAveWebPart ImportWebPart(XmlReader reader,bool isShared, out string errorMessage);
        void ExportWebPart(IAveWebPart webPart, XmlWriter writer);

        List<AveWebPartBaseInfo> GetWebParts(AveBaseItemInfo info);
        void RestoreWebParts(IList webParts, bool clearAll);
        void RestoreWebParts(List<AveWebPartBaseInfo> webparts, bool clearAll);
