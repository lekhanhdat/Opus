...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldDateTime : AveField, IAveFieldDateTime
    {
        ...
        public AveFieldDateTime(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
        ...
        public AveCalendarType CalendarType
        {
            get
            {
                return base.DataCache.GetProperty<AveCalendarType>("DateTimeCalendarType");
            }
            set
            {
                base.DataCache.AddChangedProperty("DateTimeCalendarType", (int)value);
            }
        }
        ...
        public AveDateTimeFieldFriendlyFormatType FriendlyDisplayFormat
        {
            get
            {
                return base.DataCache.GetProperty<AveDateTimeFieldFriendlyFormatType>("FriendlyDisplayFormat");
            }
            set
            {
                base.DataCache.AddChangedProperty("FriendlyDisplayFormat", (int)value);
            }
        }
    }
}
