...
namespace AvePoint.RA.Web.Common.RMTaxonomy
{
    public class RMTaxonomy
    {
        ...
        public List<RMTermSet> GetTermSets()
        {
            List<RMTermSet> termSets = TermSetDao.FindAll();
            return termSets;
        }

        //public List<RMTerm> GetTermByTermSetId(int termSetId)
        //{
            
           
        //    //List<RMTerm> terms = TermDao.FindList()
        //}
    }
}