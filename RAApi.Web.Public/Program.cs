        ...
        builder => builder.SetIsOriginAllowed((originUrl) =>
                          {
                              ...
                              logger.Info($"CORS check originUrl: {originUrl}, aosTenantId: {aosTenantId}");
...
{
    config.Title = "Opus Web Public API";
    config.Description = "OpenAPI document for Opus Web Public API";
});
