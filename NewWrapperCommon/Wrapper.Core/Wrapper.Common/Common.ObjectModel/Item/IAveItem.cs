...
namespace AvePoint.Wrapper.Common
{
    public interface IAveItem
    {
        ...
        Dictionary<string, object> GetListItemInfo(AveBaseItemInfo baseItemInfo, Dictionary<string, object> currentVersionDocData);
        ...
        List<AveTermStoreInfo> GetRelatedMetadataInfo(List<AveTaxFieldInfo> infos, AveBackupOption backupColumnOption);
        List<AveTermStoreInfo> GetTermPropertyWebPartMetadataInfo(List<string> termPropertyWebPartInfos, AveBackupOption backupColumnOption);
        ...
        bool SetTaxCatchAllValue(IAveListItem item, IAveFieldCollection fields);
