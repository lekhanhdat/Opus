...
namespace AvePoint.ObjectModel.Server19
{
    ...
    {
        internal const string SOIntegrationAssemblyName = "SP2019StorageOptimizationIntegration"; 
        internal const string SOIntegrationNameSpace = "AvePoint.StorageOptimization.Integration.";
        internal const string SOConnectorIntegrationAssemblyName = "SP2019ConnectorBusinessLogic";
        ...
        {
            get { return AveContextKind.Server19ObjectModel; }
        }
        ...
        {
            logger.Debug("Start 19 server object model factory");
