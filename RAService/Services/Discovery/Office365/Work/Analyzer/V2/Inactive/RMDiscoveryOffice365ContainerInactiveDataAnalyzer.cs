    ...
    public class RMDiscoveryOffice365ContainerInactiveDataAnalyzer
    {
        ...
        public async Task<bool> SaveAsync()
        {
            try
            {
                ...
                {
                    await _dataDao.AddOrUpdateContainerInactiveDataAsync(_o365TenantId, _containerId, _dataList.ToArray());
                }
        ...
        private async Task<bool> RecalculateAndSaveAsync()
        {
            try
            {
                ...
                var enumerableDataList = _dataDao.GetSiteInactiveDataListByContainerAsync(_o365TenantId, _containerId, inactiveColumns);
