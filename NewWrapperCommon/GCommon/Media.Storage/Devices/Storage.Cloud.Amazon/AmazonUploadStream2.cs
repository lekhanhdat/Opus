...
{
    class AmazonUploadStream2 : HttpUploadStream
    {
        public StorageLogger Logger { get { return StorageLogger.GetInstance(typeof(AmazonUploadStream)); } }
        ...
        public AmazonUploadStream2(HttpWebRequest request, AmazonOpenParameter openParameter)
        {
