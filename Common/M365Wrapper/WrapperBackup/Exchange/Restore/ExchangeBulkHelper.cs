...
//    {
//        protected ExchangeFolder parentFolder;
...
//        public static Dictionary<string, string> ItemIdChangeKeyDic { get; set; } = new Dictionary<string, string>();
...
//        public ExchangeBulkHelper(ExchangeGraphFolder graphFolder) : base(graphFolder.GetGraphService())
//        {
//            parentFolder = graphFolder;
//        }
...
//            return ImportItems(importItemsDic, (uploadItems, ids) =>
//            {
//                uploadItems.ForEach(itemArg => itemArg.DataStream.Seek(0, SeekOrigin.Begin));
//                return ImportItemsInternal(service, uploadItems, ids);
//            });
//        }



//        protected Dictionary<string, ExportAndImportItemResult> ImportItems<T>(Dictionary<string, T> importItemsDic, Func<List<T>, List<string>, (Dictionary<string, ExportAndImportItemResult>, Dictionary<string, ExportAndImportItemResult>)> realImportFunc)
//        {
//            var retry = 0;
...
//                    (var successfulItems, failedItems) = realImportFunc(uploadItems.ToList(), remainItemDic.Keys.ToList());
...
//        public virtual void DeleteItemSimple(List<string> deleteItemUniqueIds)
//        {
//            try
//            {
...
//        {
//            var graphFolder = parentFolder as ExchangeGraphFolder;
//            var useGraph = graphFolder != null;
//            ExchangeService service = null;
//            itemIdsDic.Clear();
//            ExchangeIdsDic.Clear();
//            ItemIdChangeKeyDic.Clear();

//            if (!useGraph)
//            {
//                service = CloneExchangeService(parentFolder.Service);
//            }

//            Dictionary<string, string> itemsDicByExtendedProperty = new Dictionary<string, string>();
//            List<string> itemIdsByFolderId = new List<string>();
//            if (useGraph)
//            {
//                var idInfo = graphFolder.GetItemIdsInfo();
//                itemsDicByExtendedProperty = idInfo.OldNewIdDic;
//                itemIdsByFolderId = idInfo.ItemIdChangeKeyDic.Keys.ToList();
//                ItemIdChangeKeyDic = idInfo.ItemIdChangeKeyDic;
//            }
//            else
//            {
//                //#1.获取所有有扩展属性（我们还原回去的）的Item的ID的字典，格式<OldId,NewId>
//                itemsDicByExtendedProperty = GetAllItemsByExtendedProperty(service, folderId);
//                //#2.获取所有Folder下所有ItemId（NewId）
//                itemIdsByFolderId = GetAllItemsByFolderId(service, folderId).Select(item => item.Id.UniqueId).ToList();
//            }
