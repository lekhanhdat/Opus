...
{
    public class RMDiscoveryAOSPInactiveAggregateStatisticQuerier : RMDiscoveryAOSPInactiveDataQuerier<RMDiscoveryAOSPAggregateStatisticDataInfo>
    {
        public RMDiscoveryAOSPInactiveAggregateStatisticQuerier(RMDiscoveryAOSPQueryParameter queryParameter) : base(queryParameter)
        {
        }
...
FROM [{_schemaName}].[{dataTable}] AS data ";
            ...
            return await _queryDao.GetDataAsync<RMDiscoveryAOSPAggregateStatisticDataInfo>(sql, sqlParams);
        }
    }
}
