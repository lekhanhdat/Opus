...
namespace AvePoint.Wrapper.Restore
{
    ...
    public class AveSPWebAppPropertyManager : AvePoint.Wrapper.Restore.IAveSPWebAppPropertyManager
    {
    ...
    public class AveSPWebAppPathManager : AvePoint.Wrapper.Restore.IAveSPWebAppPathManager
    {
        private AveSPWebApp mAveSPWebApp;
    ...
    public class AveSPWebAppPolicyRoleManager : AvePoint.Wrapper.Restore.IAveSPWebAppPolicyRoleManager
    {
        private AveSPWebApp mAveSPWebApp;
        private static AveLogger mLog = AveLogger.GetInstance(MethodBase.GetCurrentMethod().DeclaringType);
    ...
    public class AveSPWebAppPolicyManager : AvePoint.Wrapper.Restore.IAveSPWebAppPolicyManager
    {
