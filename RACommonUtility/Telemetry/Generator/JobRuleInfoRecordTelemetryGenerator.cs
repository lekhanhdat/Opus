...
{
    internal class JobRuleInfoRecordTelemetryGenerator : TelemetryGenerator
    {
        public override TelemetryModule Module => TelemetryModule.JobRuleInfoRecord;
        ...
        {
            return args[0] as CloudRecordsJobRuleInfoRecord;
        }
