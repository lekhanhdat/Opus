...
namespace AvePoint.GCommon.Contract.Server.SyncData
{
    [DataContract(Namespace = ContractConstants.Namespace)]
    public class SyncDataJobDto : BaseJobDto
    {
        [DataMember]
        [ColumnMapAttribute(DBColumn = ContractConstants.INT_1)]
        public SyncDataActionType SyncActionType { get; set; }

        [DataMember]
        [ColumnMapAttribute(DBColumn = ContractConstants.INT_2)]
        public PlanCategory SyncModule { get; set; }
        ...
        [DataMember]
        public List<string> BackupJobId { get; set; }
    }
}
