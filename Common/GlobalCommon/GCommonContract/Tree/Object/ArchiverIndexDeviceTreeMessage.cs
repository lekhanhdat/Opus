...
{
    [DataContract]
    public class ArchiverIndexDeviceTreeMessage : AveTreeMessage
    {
        [DataMember]
        public List<ArchiverIndexDeviceTreeNodeDto> NodeList { get; set; }

        [DataMember]
        public ArchiverIndexDeviceTreeNodeDto Node { get; set; }
