...
namespace Office365GroupRestore
{
    ...
    public class ExchangeIndexInfo
    {
        ...
        public long MonthStartTime { get; set; }

        public long MonthEndTime { get; set; }
        ...
        public ExchangeIndexInfo(String path, Int64 endTime, String backupJobId, long monthStartTime, long monthEndTime, Boolean onlyOneJob = false)
        {
            this.BackupJobId = backupJobId;
            this.OnlyOneJob = onlyOneJob;
            this.Path = path;
        ...
        public ExchangeIndexInfo(String path, Int64 endTime, String backupJobId, String sortId, Boolean onlyOneJob = false)
        {
            this.BackupJobId = backupJobId;
            this.OnlyOneJob = onlyOneJob;
            this.Path = path;
        ...
        public ExchangeIndexInfo(String path, Int64 endTime, String backupJobId, long monthStartTime, String sortId, Boolean onlyOneJob = false)
        {
            this.BackupJobId = backupJobId;
            this.OnlyOneJob = onlyOneJob;
            this.Path = path;
