...
namespace AvePoint.RA.SharePoint.Common
{
    public class JobContext
    {
        ...
        public string Scope { private set; get; } = string.Empty;
        public string O365TenantId { private set; get; } = string.Empty;
        ...
        protected ITenantInfoDao TenantInfoDao
        {
            get
            {
                ...
                {
                    mTenantInfoDao = RA.Common.PlatformWindsorManager.GetService(typeof(ITenantInfoDao)) as ITenantInfoDao;
                }
        ...
        private JobContext(string jobId, JobType jobType)
        {
            ...
            if (AvePoint.RA.Common.JobService.JobServiceUtility.IsSubJob(jobId))
            {
                ...
                O365TenantId = subJobWithContext.O365TenantId;
                Scope = subJobWithContext.String1;
