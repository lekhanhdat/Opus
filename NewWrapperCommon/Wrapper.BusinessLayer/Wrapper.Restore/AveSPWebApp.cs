...
{
    public class AveSPWebApp : AvePoint.Wrapper.Restore.IAveSPWebApp
    {
        private string mUrl;
        private IAveWebApplication mWebApp;
        public Dictionary<Guid, Guid> mapPolicyRole = new Dictionary<Guid, Guid>();
        public AveSPWebApp(string url)
        {
            mUrl = url;
