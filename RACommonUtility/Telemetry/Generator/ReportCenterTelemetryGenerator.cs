...
{
    public class ReportCenterTelemetryGenerator : TelemetryGenerator
    {
        ...
        public override TelemetryModule Module => TelemetryModule.ReportCenter;
        ...
        protected override Dictionary<TelemetryEventType, Func<IList<object>, CloudRecordsCommonRecord>> EventTypeGenerateMapping =>
            new Dictionary<TelemetryEventType, Func<IList<object>, CloudRecordsCommonRecord>>
            {
                ...
                { TelemetryEventType.CreateCreationAndDestructionProfile, RecordRequest },
                { TelemetryEventType.CreateContentDueProfile, RecordRequest },
                { TelemetryEventType.ViewAuditReport, RecordRequest }
            };

        public CloudRecordsCommonRecord RecordRequest(IList<object> args)
        {
            return new CloudRecordsReportCenterRecord();
        }
