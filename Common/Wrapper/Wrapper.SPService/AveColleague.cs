        ...
        public void CreateColleague(AveColleagueInfo colleagueInfo)
        {
            ...
            try
            {
                ...
                if (!profileManager.UserExists(profileName))
                {
                    ...
                    {
                        mColleagues[profileName] = new List<AveColleagueInfo>();
                    }
                    mColleagues[profileName].Add(colleagueInfo);
                }
                else
                {
                    ...
                    {
                        //mLog.Log(AveLogLevel.WARN, "WP10RTMySite0440", colleague.Title, e);
            ...
            {
                //mLog.Log(AveLogLevel.WARN, "WP10RTMySite0447", e);
