...
{
    public class DueTimeFrameReportWorker : AbstractReportWorker
    {
        public DueTimeFrameReportWorker()
        {
        ...
        public override void SaveReportJobDatas(IEnumerable<BaseReport> jobDetails, BaseJobDto jobInfo)
        {
            ...
            using (SqliteLockManager.AcquireLock(jobInfo.Id))
            {
        ...
        public void InitCreateTableSQLString()
        {
            ...
            CREATE_TABLE_SQL = string.Format(ReportConstants.CREATE_TABLE_DUE_TIMEFRAME_REPORT, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(ReportConstants.INSERT_DATA_DUE_TIMEFRAME_REPORT, TABLE_NAME);
        }
