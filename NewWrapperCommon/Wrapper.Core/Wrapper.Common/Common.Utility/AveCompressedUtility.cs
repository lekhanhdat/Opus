    ...
    public class AveCompressedUtility
    {
        ...
        public static Dictionary<string, string> GetMetaInfoDictionary(string metaInfoString)
        {
            ...
            try
            {
                ...
                dic = metaInfoHandler.ToStringDictionary();
            }
            catch (Exception e)
            {
        ...
        public static Dictionary<string, string> GetMetaInfoDictionary(byte[] metaInfoString)
        {
            Dictionary<string, string> dic = new Dictionary<string, string>();
            try
            {
        ...
        public static Hashtable GetMetaInfoHashtable(String metaInfoString)
        {
            ...
            {
                log.Log(AveLogLevel.DEBUG, WrapperCommonResource.AWCGetMetadataInfoDicError, e);
            }
            return hash;
        }
