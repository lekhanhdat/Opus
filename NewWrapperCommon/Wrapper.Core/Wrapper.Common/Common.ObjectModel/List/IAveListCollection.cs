...
namespace AvePoint.Wrapper.Common
{
    ...
    {
        Guid Add(string title, string description, IAveListTemplate template);
        ...
        Guid Add(string strTitle, string strDescription, AveListTemplateType templateType);
        ...
        Guid Add(string title, string description, string url, string featureId, int templateType, string docTemplateType, string listSchema, AveQuickLaunchOptions quickLaunchOptions);
