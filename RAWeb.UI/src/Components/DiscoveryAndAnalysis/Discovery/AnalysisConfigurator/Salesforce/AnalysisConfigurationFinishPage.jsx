...
import { SalesforceAnalysisConfigurationPanelComponent } from "./Components";
        ...
        <div>
            ...
            <div className="reco-success-configurator">
                <div className="reco-success-content">
                    {jobInfo.status === DiscoveryJobStatus.Finished && (
                        <div>
                            ...
                            <div className="reco-success-des" tabIndex="0">
                                <$g.I18NProvider
                                    msg={
                                        RMResx.RM_FA_SF_Discovery_SuccessPage_Des
                                    }
                                >
                                    <a
                                        className="ra-link-a"
                                        href={`/Root/FileAnalysis/InactiveOptimization?dataSource=${DiscoveryDataSource.Salesforce}`}
                                    >
                    ...
                    <SalesforceAnalysisConfigurationPanelComponent ref={panelRef} />
                </div>
            </div>
            <section style={{ display: "none" }}>
                <form
                    ref={formRef}
                    action="/api/RMDiscoverySalesforceConfigurationApi/DownloadDiscoveryJobReport"
                    method="post"
                >
                    <input
