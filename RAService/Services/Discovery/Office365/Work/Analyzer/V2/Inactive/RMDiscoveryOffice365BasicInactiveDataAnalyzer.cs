    ...
    public class RMDiscoveryOffice365BasicInactiveDataAnalyzer
    {
        ...
        public async Task<bool> SaveAsync()
        {
            try
            {
                ...
                await _dataDao.AddOrUpdateBasicInactiveDataAsync(_o365TenantId, _contentSource, _dataList.ToArray());
        ...
        private async Task<bool> AppendAndSaveAsync()
        {
            try
            {
                ...
                await _dataDao.AddOrUpdateBasicInactiveDataAsync(_o365TenantId, _contentSource, existsDataList.ToArray());
        ...
        private async Task<bool> RecalculateAndSaveAsync()
        {
            try
            {
                ...
                var containerDataList = await _dataDao.GetContainerInactiveDataListAsync(_o365TenantId, customColumns).ToListAsync();
