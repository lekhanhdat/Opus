...
namespace AvePoint.Wrapper.Common
{
    ...
    public class AveSitePolicyInfo
    {
        public void LoadFromXml(string schema)
        {
            ...
            Description = contentTypeNode.Attributes["Description"] != null ? contentTypeNode.Attributes["Description"].Value : string.Empty;
            ...
            if (policyNode == null)
            {
                throw new Exception("policy schema doesn't contain policy information");
            }
