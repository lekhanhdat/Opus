...
namespace Microsoft365.SharePoint.WebService.Lists
{
    ...
    public class UpdateListItems : ISoapHttpRequest
    {
        [XmlElement(ElementName = "listName")]
        public string ListName { get; set; }

        [XmlElement(ElementName = "updates")]
        public XmlNode Updates { get; set; }

        [XmlIgnore]
        public string SoapAction => "http://schemas.microsoft.com/sharepoint/soap/UpdateListItems";
