...
namespace AvePoint.ObjectModel.Server13
{
    class AveExtenderDiscoverReaderImp : AveExtenderDiscoverReader
    {
        ...
        public override string GetAttachmentsQueryString()
        {
            ...
            return AveQueryString13.Sp13AllAttachmentsForExternder;
        }

        public override string GetSingleItemAttachmentsQueryString()
        {
            return AveQueryString13.Sp13SingleAttachmentForExternder;
        }

        public override string GetAttachmentsWithRecycleBinQueryString()
        {
            return AveQueryString13.Sp13AllAttachmentsForExternderWithRecycleBin;
        }
        
        public override string GetAllItemsInAllDocQueryString()
        {
            return AveQueryString13.Sp13AllItemsInDocsForExtender;
        }

        public override string GetAllVersionsQueryString(bool includeRecyclebin = false)
        {
            return includeRecyclebin ? AveQueryString13.Sp13AllItemsAndVersionsForExtenderWithRecycleBin : AveQueryString13.Sp13AllItemsAndVersionsForExtender;
        }

        public override string GetAllItemAndVersionsStubInfoQueryString()
        {
            return AveQueryString13.Sp13AllItemAndVersionsStubInfo;
        }

        public override string GetAllAttachmentsStubInfoQueryString()
        {
            return AveQueryString13.Sp13AllAttachmentsStubInfoForExtender;
        }

        public override string GetDocInfoForIBQueryString()
        {
            return AveQueryString13.Sp13AllDocValueForEventCache_Extender;
        }
