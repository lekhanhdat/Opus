...
{
    public interface ISharePointScanner4JPMC: IDisposable
    {
    ...
    public interface IScanDataReader4JPMC : IDisposable
    {
        ...
        List<ArchiveApproveReport4JPMGroupBy> GetArchiveApproveReportsGroupByColumns(string ruleId, string listId);
        List<ArchiveApproveReport4JPMTotalSize> GetArchiveApproveReportsTotalSize(string ruleId, string listId = "");
    }
}
