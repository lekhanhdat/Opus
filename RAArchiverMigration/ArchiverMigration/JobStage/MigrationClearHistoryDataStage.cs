...
{
    internal class MigrationClearHistoryDataStage : AbstractArchiverMigrationStage
    {

        public override string StageType => "Clear History Data Stage";
        ...
        */
        public override int JobProgressWeight => new Random().Next(4, 6);
