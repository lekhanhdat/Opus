...
namespace AvePoint.Media.Service.DomainModel
{
    ...
    public class IndexServiceOpenParameter
    {
        ...
        private IndexServiceOpenParameter(IndexServiceOpenParameter param)
        {
            ...
            IsNeedCheckIntegrity = param.IsNeedCheckIntegrity;
            IsNeedCreateNewIndex = param.IsNeedCreateNewIndex;
            DataMode = param.DataMode;
            IndexDatabaseName = param.IndexDatabaseName;
            NeedDownLoad = param.NeedDownLoad;
            //ThrowExceptionWhenError = param.ThrowExceptionWhenError;
        }

        public virtual IndexServiceOpenParameter DeepClone()
        {
            return new IndexServiceOpenParameter(this);
        }
