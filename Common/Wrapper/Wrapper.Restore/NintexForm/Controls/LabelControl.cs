...
namespace AvePoint.Wrapper.Restore.NintexForm.Online
{
    ...
    {
        public LabelControl(AveSPWeb web, IAveList list, string contentTypeId, XmlNode controlNode, XmlNamespaceManager nsManager)
        ...
        public override void ProcessControl(bool isPost)
        {
            ...
            var textNode = mControlNode.SelectSingleNode("d2p1:Text", nsManager);
