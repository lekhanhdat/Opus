...
namespace AvePoint.GCommon
{
    public class SelfSignedCertificate
    {
        ...
        public static byte[] CreateSelfSignCertificatePfxForAppProfile(
            string x500,
            DateTime startTime,
            DateTime endTime)
        {
            byte[] pfxData = CreateSelfSignCertificatePfxForAppProfile(
                x500,
                startTime,
                endTime,
                (SecureString)null);
        ...
        public static byte[] CreateSelfSignCertificatePfxSHA2(
            string x500,
            DateTime startTime,
            DateTime endTime,
            string insecurePassword)
        {
            ...
            try
            {
                ...
                pfxData = CreateSelfSignCertificatePfxSHA2(
                    x500,
                    startTime,
                    endTime,
                    password);
            ...
            SecureString password)
        {
            ...
            try
            {
                ...
                CRYPT_ALGORITHM_IDENTIFIER algorithm = new CRYPT_ALGORITHM_IDENTIFIER();
                algorithm.pszObjId = "1.2.840.113549.1.1.11";//SHA256
                algorithm.Parameters = new CRYPTOAPI_BLOB();
                var algorithmPointer = Marshal.AllocHGlobal(Marshal.SizeOf(algorithm));
            ...
            SecureString password)
        {
            ...
            try
            {
                ...
                Check(NativeMethods.CryptGenKey(
                    providerContext,
                    1, // AT_KEYEXCHANGE
                    0x08000001, // CRYPT_EXPORTABLE 2048Bit
                                // CRYPT_EXPORTABLE
                    out cryptKey));
                ...
                certContext = NativeMethods.CertCreateSelfSignCertificate(
                    ...
                    0,
                    ref kpi,
                    algorithmPointer, // default = SHA1RSA
                    ref startSystemTime,
                    ref endSystemTime,
                    IntPtr.Zero);
                Check(certContext != IntPtr.Zero);
