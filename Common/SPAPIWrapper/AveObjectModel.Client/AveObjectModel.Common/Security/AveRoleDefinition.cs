...
namespace AvePoint.ObjectModel.Common
{
    class AveRoleDefinition : AveClientObject, IAveRoleDefinition
    {
        ...
        public AveRoleDefinition(IAveRequest request, AveRoleDefinitionCollection roleDefinitionCollection, IDictionary<string, object> roleDefinitionProperties)
        {
            mRequest = request;
            mRoleDefinitionCollection = roleDefinitionCollection;
        ...
        public AveRoleDefinition(IAveRequest request, AveRoleDefinitionBindingCollection roleDefinitionBindingCollection, IDictionary<string, object> roleDefinitionProperties)
        {
            mRequest = request;
        ...
        public AveRoleDefinition(IAveRequest request, AveRoleDefinitionCollection roleDefinitionCollection, IAveWeb parentWeb, IDictionary<string, object> roleDefinitionProperties)
        {
            mRequest = request;
            if (parentWeb != null)
            {
        ...
        public AveRoleDefinition(IAveRequest request, AveRoleDefinitionBindingCollection roleDefinitionBindingCollection, IAveWeb parentWeb, IDictionary<string, object> roleDefinitionProperties)
        {
            mRequest = request;
            if (parentWeb != null)
            {
        ...
        {            
            base.DataCache.AddChangedProperties(roleDefinition.DataCache.GetPropertyCache());
        }
        ...
        internal AveWeb Web
        {
            set
            {
                ...
                base.DataCache.AddProperty(AveObjectModelConstant.WebServerRelativeUrl,mWeb.ServerRelativeUrl);
            }
        }
