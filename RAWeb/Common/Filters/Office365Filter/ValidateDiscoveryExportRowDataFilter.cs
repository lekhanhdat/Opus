...
internal class ValidateDiscoveryExportRowDataFilter : BaseAuthorizeAttribute
{
    protected override async Task<bool> IsAuthorizedAsync(AuthorizationFilterContext filterContext, RMIdentity Identity)
    {
        return await RMDiscoveryOffice365LicenseHelper.IsAllowedToExportRowDataAsync();
    }
}