...
class DetailRow extends React.Component {
    ...
    render() {
        return <React.Fragment>
            <div className="ra-crm-row">
                {this.renderChildren(this)}
            </div>
            <div className="ra-crm-row">
                <div className="ra-crm-row-split"></div>
            </div>
        </React.Fragment>;
    }
}
...
class DetailCell extends React.Component {
    ...
    renderValue() {
        if (this.props.children) {
            return <span tabIndex="0" style={{ whiteSpace: 'pre-wrap' }}>{this.props.children}</span>;
        } else {
    ...
    render() {
        ...
        return <React.Fragment>
            <div className="ra-crm-label" {...labelProps}>
                <span tabIndex="0" className="ra-crm-span">{label}</span>
            </div>
            <div className="ra-crm-value">
                {this.renderValue()}
            </div>
        </React.Fragment>;
    }
