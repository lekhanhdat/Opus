...
namespace AvePoint.Wrapper.Common
{
    public class SafeExecutor
    {
        ...
        private Task mAction;
        private Task mPostAction;              

        public SafeExecutor(Task action)
            : this(action, null)
        {
        }

        public SafeExecutor(Task action, Task postAction)
        {
            mAction = action;
        ...
        public static WaitCallback GetExecutor(Task action)
        {
            return new SafeExecutor(action).Execute;
        }

        public static WaitCallback GetExecutor(Task action, Task postAction)
        {
