...
namespace AvePoint.Wrapper.Restore
{
    ...
    class LookupDataFormatForHSMConnector : BaseDataFormatForHSMConnector
    {
        private int originalVesrion;
        private AveObjectModelFactory mAveObjectModelFactory;

        public LookupDataFormatForHSMConnector(AveObjectModelFactory aveObjectModelFactory, AveXmlField xmlField, IAveField destField, IAveListItem mItem, int originalVesrion) :
        ...
        {
            IAveFieldLookupValueCollection lookupValues = mAveObjectModelFactory.CreateFieldLookupValueCollection();
            foreach (var value in lookupItemVaues)
            {
                lookupValues.Add(mAveObjectModelFactory.CreateFieldLookupValue(value.ItemRowId, value.lookupValue));
            }
            return lookupValues;
        }
        ...
        /*private void CacheLookupColumnValue(ArrayList lookupFieldValue, IAveFieldLookup destLookupField, AveLookupObject obj)
        {
            ...
            {
                LookupListID = obj != null ? obj.ListId : new Guid(destLookupField.LookupList),
