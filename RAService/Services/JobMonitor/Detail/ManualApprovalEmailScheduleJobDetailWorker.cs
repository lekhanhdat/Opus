...
{
    public class ManualApprovalEmailScheduleJobDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_ManualApprovalEmailSchedule, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_ManualApprovalEmailSchedule, TABLE_NAME);
        }
    }
}
