...
{
    public interface ISharePointScanner: IDisposable
    {
        public Task RunAsync();

        public IScanDataReader GetScanDataReader();

        public List<string> LoadBreakInheritNodeUrls(string scopeUrl, string siteObjectId = "");
    }
    public interface IScanDataReader : IDisposable
    {
