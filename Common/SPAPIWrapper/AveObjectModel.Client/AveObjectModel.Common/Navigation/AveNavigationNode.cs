...
namespace AvePoint.ObjectModel.Common
{
    class AveNavigationNode : AveClientObject, IAveNavigationNode
    {
        ...
        public AveNavigationNode(AveWeb web, IAveNavigationNode parentNavigationNode, AveNavigationNodeCollection navigationNodeCol, IAveRequest request, IDictionary<string, object> navigationNodeProperties)
        {
        ...
        public AveNavigationNode(string title, string url, bool isExternal, int nodeType,AveNavigationNodeCollection navigationNodeCol)
        {
            ...
            base.DataCache.AddPropertyies(node.DataCache.GetPropertyCache());
        }
        ...
        internal Dictionary<string, object> Location
        {
            get
            {
                if (mLocation == null && base.DataCache.IsPropertyAvailable("Id" + AveObjectModelConstant.ObjectPropertySuffix))
                {
                    ...
                    mLocation.Add("Id" + AveObjectModelConstant.ObjectPropertySuffix, DataCache.GetPropertyWithoutChange("Id" + AveObjectModelConstant.ObjectPropertySuffix));
                    if (base.DataCache.IsPropertyAvailable("ClientContext"))
                    {
                        mLocation.Add("ClientContext", DataCache.GetPropertyWithoutChange("ClientContext"));
                    }
                }
        ...
        public IAveNavigationNodeCollection Children
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("Children"))
                {
                    ...
                    base.DataCache.AddProperty("Children",children);
                }
        ...
        public Hashtable Properties
        {
            get
            {
                ...
                foreach (var property in DataCache.GetPropertyCache())
                {
                    table.Add(property.Key, property.Value);
                }
                return table;//base.DataCache.GetProperty<Hashtable>("Properties");
            }
        }
        ...
        public bool IsVisible
        {
            get
            {
                return base.DataCache.GetProperty<bool>("IsVisible");
            }
        }
        ...
        public void Update()
        {
            if (base.DataCache.ChangedProperties.Count > 0)
            {
                ...
                nodeSource["Id" + AveObjectModelConstant.ObjectPropertySuffix] = base.DataCache.GetPropertyWithoutChange("Id" + AveObjectModelConstant.ObjectPropertySuffix);
                if (base.DataCache.IsPropertyAvailable("ClientContext"))
                {
                    nodeSource["ClientContext"] = base.DataCache.GetPropertyWithoutChange("ClientContext");
                }
        ...
        public void Move(IAveNavigationNodeCollection collection, IAveNavigationNode previousSibling)
        {
            ...
            previousNodeProperties["Id" + AveObjectModelConstant.ObjectPropertySuffix] = (previousSibling as AveNavigationNode).DataCache.GetPropertyWithoutChange("Id" + AveObjectModelConstant.ObjectPropertySuffix);
            Dictionary<string, object> nodeSource = new Dictionary<string, object>();
            nodeSource["Id" + AveObjectModelConstant.ObjectPropertySuffix] = base.DataCache.GetPropertyWithoutChange("Id" + AveObjectModelConstant.ObjectPropertySuffix);
        ...
        private void MoveNodeInCollection(IAveNavigationNodeCollection collection, MoveType type, int position)
        {
            ...
            int parentId = collection.Parent.ID;
            if (Parent != null)
            {
            ...
            while (parentNode != null)
            {
                if (parentNode.Title != null && parentNode.Title.Equals("Quick launch"))
                {
                    source = "QuickLaunch";
                    break;
                }
                else if (parentNode.Title != null && parentNode.Title.Equals("SharePoint Top Navigation Bar"))
                {
                    source = "TopNavigationBar";
                    break;
                }
        ...
        public void Delete()
        {
            ...
            if (mParentNavigationNode != null && mParentNavigationNode.DataCache.IsPropertyAvailable("Id" + AveObjectModelConstant.ObjectPropertySuffix))
            {
                previousNodeProperties = new Dictionary<string, object>();
                previousNodeProperties["Id" + AveObjectModelConstant.ObjectPropertySuffix] = mParentNavigationNode.DataCache.GetPropertyWithoutChange("Id" + AveObjectModelConstant.ObjectPropertySuffix);
                if (mParentNavigationNode.DataCache.IsPropertyAvailable("ClientContext"))
                {
                    previousNodeProperties["ClientContext"] = mParentNavigationNode.DataCache.GetPropertyWithoutChange("ClientContext");
                }
            }
            this.mRequest.DeleteNavigationNode(this.mWeb.ServerRelativeUrl, previousNodeProperties, this.DataCache.GetPropertyCache());
