...
namespace AvePoint.GCommon.Contract.Media.Object
{
    ...
    public class PlatformUpdateCatalogParam
    {
        [DataMember]
        ...
        [DataMember]
        public Boolean IsNeedRunJob { get; set; }
        ...
        [DataMember]
        public List<PRJobRetentionInfo> RetentionInfos { get; set; }

        public override String ToString()
        {
            return String.Format("Backup Job Id: {0}, Retention Job Id: {1}, Logical Device: {2}",
                this.BackupJobId,
                this.RetentionJobId,
                this.LogicalDevice);
        }
