...
namespace AvePoint.GCommon.Contract.StorageOptimization.Object
{
    ...
    {
        [EnumMember]
        DataBlock = 0,//Data Block
        [EnumMember]
        File = 1,//Archiver File Level
        [EnumMember]
        RecordsFile = 2,//Records File Level
    }
    ...
    public enum DeDuplicateStatus
    {
        ...
        None = 0,
        [EnumMember]
        WaitingDeDuplicate = 1,
        [EnumMember]
        FinishDeDuplicate = 2,
        [EnumMember]
        FailedDeDuplicate = 3,
        [EnumMember]
        FinishedWithExceptionDeDuplicate = 4,
    }

    // use to mark file in tb_body_index
    [DataContract(Namespace = ContractConstants.Namespace)]
    public enum IndexDeduplicateFileStatus
    {
        [EnumMember]
        None = 0,
        [EnumMember]
    ...
    // Dedup Index DB: use to mark file in tb_body_index
    [DataContract(Namespace = ContractConstants.Namespace)]
    public enum IndexDedupFileDeleteStatus
    {
        [EnumMember]
        WaitToDelete = 0,   // wait to delete
        [EnumMember]
        Deleted = 1,  // already deleted
        [EnumMember]
        NotNeedDelete = 2, // not need deleted
    }

    // Dedup Extension Info
    [DataContract(Namespace = ContractConstants.Namespace)]
    [Serializable]
    public class DedupExtensionInfo
    {
        [DataMember]
        public string DedupJobId { get; set; }
        [DataMember]
        public string SourceFileStoragePolicyId { get; set; }
        [DataMember]
        public long SourceFileContentLength { get; set; }
        [DataMember]
        public string DedupSourceFileJobId { get; set; }
        [DataMember]
        public string DuplicateFileStorageInfo { get; set; }
        [DataMember]
