...
namespace AvePoint.RA.Service.Services.Discovery.AOSP.Work.Extensions
{
    public static class RMDiscoveryAOSPIEJobExtension
    {

        private static readonly RALogger _logger = RALogger.GetInstance(typeof(RMDiscoveryAOSPIEJobExtension));
