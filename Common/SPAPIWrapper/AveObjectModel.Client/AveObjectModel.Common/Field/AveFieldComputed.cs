...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldComputed : AveField, IAveFieldComputed
    {
        ...
        public AveFieldComputed(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
        ...
        public bool EnableLookup 
        {
            get
            {
                return base.DataCache.GetProperty<bool>("EnableLookup");
            }
            set
            {
                base.DataCache.AddChangedProperty("EnableLookup",value);
            }
        }
    }
}
