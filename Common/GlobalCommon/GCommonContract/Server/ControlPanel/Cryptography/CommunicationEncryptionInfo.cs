...
namespace AvePoint.GCommon.Contract.Server.ControlPanel.Cryptography
{
    ...
    public class CommunicationEncryptionInfo : ISystemSettingContent
    {
        [DataMember]
        public AvePasswordDto CommunicationEncryptionKey { get; set; }

        [DataMember]
        public string CommunicationEncryptionKeyStr { get; set; }
