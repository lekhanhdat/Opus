...
{
    public class ArchiverSiteMasterIndex : BaseModel
    {
        [Key]
        ...
        [Index(name: "IX_ArchiverSiteMasterIndex_JobId")]
        public string JobId { get; set; }

        [Column(TypeName = "nvarchar")]//400
        [Index(name: "IX_ArchiverSiteMasterIndex_SiteURL")]
        ...
        [Column(TypeName = "int")]
        [Index(name: "IX_ArchiverSiteMasterIndex_MergeIndexState_DuplicateStatus", Order = 1)]
        ...
        [Column(TypeName = "int")]
        [Index(name: "IX_ArchiverSiteMasterIndex_MergeIndexState_DuplicateStatus", Order = 2)]
        public int DuplicateStatus { get; set; }
        [Column(TypeName = "nvarchar")]//400
        [Index(name: "IX_ArchiverSiteMasterIndex_GroupMailboxAddress", Order = 3)]
