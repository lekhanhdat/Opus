...
namespace AvePoint.ObjectModel.Common
{
    class AveModerationInformation : AveClientObject, IAveModerationInformation
    {
        ...
        public AveModerationInformation( IAveRequest request, AveListItem item ) 
        {
            mRequest = request;
            mItem = item;
            base.DataCache.PropertiesCache["Comment"] = item["_ModerationComments"] == null ? "" : item["_ModerationComments"] as string;
            base.DataCache.PropertiesCache["Status"] = item["_ModerationStatus"] == null ? 0 : Convert.ToInt32(item["_ModerationStatus"]);
