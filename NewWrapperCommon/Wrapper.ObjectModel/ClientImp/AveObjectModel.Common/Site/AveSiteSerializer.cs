...
namespace AvePoint.ObjectModel.Common
{
    ...
    internal class AveSiteSerializer : IAveSiteSerializer
    {
        ...
        /// <summary>
        /// backup site info without all web templates
        /// </summary>
        /// <returns></returns>
        ...
        public AveSiteInfo GetObjectData()
        {
            ...
            siteInfo.IsOnline = m_Site.IsOnlineSite;
            ...
            siteInfo.TimeZoneId = m_Site.RootWeb.RegionalSettings.TimeZone.ID;
            //365获取不到WebApplication，urlReplace需求，暂时将Prefixes写成固定的几个，以后再想办法实现
            siteInfo.Prefixes = new List<string>() { "", "sites", "teams", "personal" };
