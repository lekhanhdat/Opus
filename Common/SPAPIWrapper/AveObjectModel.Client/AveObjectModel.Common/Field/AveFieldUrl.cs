...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldUrl : AveField, IAveFieldUrl
    {
        ...
        public AveFieldUrl(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
