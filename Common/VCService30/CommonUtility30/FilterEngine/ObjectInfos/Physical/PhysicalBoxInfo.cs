...
namespace AvePoint.Common.FilterEngine
{
    ...
    /// Document级别信息对象类
    /// </summary>
    public class PhysicalBoxInfo : CommonInfoBase
    {

        public long Size { get => GetPropertyValue(field); set => SetPropertyValue(ref field, value); }
        public DateTime LastestFolderDisposalDueDate { get => GetPropertyValue(field); set => SetPropertyValue(ref field, value); }
