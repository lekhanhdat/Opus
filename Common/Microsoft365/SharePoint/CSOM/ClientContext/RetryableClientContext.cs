...
namespace Microsoft365.SharePoint.CSOM
{
    ...
    /// <summary>
    /// This is a readonly context,may have issue if execute update or add operation with retry.
    /// </summary>
    public class RetryableClientContext : ClientContext
    {
        ...
        public RetryableClientContext(string webFullUrl,int retryCount,int retryInterval,bool useHttpClient=true)
            : base(webFullUrl)
        {
            if (useHttpClient)
            {
