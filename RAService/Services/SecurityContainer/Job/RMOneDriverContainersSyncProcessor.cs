...
{
    internal class RMOneDriverContainersSyncProcessor : RMSPOOneDriverContainersSyncProcessor
    {
        public RMOneDriverContainersSyncProcessor(IRMReportManager reportManger, ISPSettingTreeService spSettingTreeService, 
            ...
            : base(reportManger, spSettingTreeService, rmSecurityContainerService, scopeRoleAssignmentDao, securityContainerDao, explorerDao, containerInGroups, SourceFlag.OneDrive)
        {
        }
