...
namespace AvePoint.Wrapper.Backup
{
    public abstract class AveSPEventReceiver
    {
            ...
            foreach (IAveEventReceiverDefinition receiverDefinition in receiverDefinitions)
            {
                try
                {
                    ...
                    AveEventReceiverInfo receiverInfo = new AveEventReceiverInfo()
                    {
                        ...
                        SequenceNumber = receiverDefinition.SequenceNumber,
                        Synchronization = contextKind == AveContextKind.Server07ObjectModel ? 0 : receiverDefinition.Synchronization
                    };
        ...
        public abstract AveContextKind GetContextKind();
    }
    ...
    public class AveSPWebEventReceiver : AveSPEventReceiver
    {
        ...
        public override AveContextKind GetContextKind()
        {
            return this.mAveSPWeb.ParentSite.SPContextKind;
        }
    }
    ...
    public class AveSPListEventReceiver : AveSPEventReceiver
    {
        ...
        public override AveContextKind GetContextKind()
        {
            return this.mAveSPList.ParentSite.SPContextKind;
        }
    }
}