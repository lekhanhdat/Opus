...
{
    internal class DO2SOParentLibraryBoolean : DO2SOFilterConverterBase
    {
        ...
        public DO2SOParentLibraryBoolean(string value1, int startSequenceNo, BooleanConditionType condition, string extraValue)
        {
            this.mValue1 = value1;
        ...
        public override List<SOFilterPolicy> Convert()
        {
            ...
            ParentLibraryBooleanRule rule = new ParentLibraryBooleanRule { Value1 = this.mFilterName };
