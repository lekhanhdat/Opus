...
{
    public class FolderBrowserButton : IButton
    {
        public FolderBrowserButton(FolderBrowserCommand _command)
        {
            Command = _command;
        }

        public string Content { get; set; } = " " + COMMONRESX.COMMON_BTN_BROWSE;
