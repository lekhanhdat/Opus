...
namespace AvePoint.GCommon.Contract.Server.Common.TimeZone
{
    ...
    public struct TransitionTime
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                var compare = (TransitionTime)obj;
                return
                    compare.TimeOfDay == this.TimeOfDay &&
                    compare.Month == this.Month &&
                    compare.Week == this.Week &&
                    compare.Day == this.Day &&
                    compare.DayOfWeek == this.DayOfWeek &&
                    compare.IsFixedDateRule == this.IsFixedDateRule;
