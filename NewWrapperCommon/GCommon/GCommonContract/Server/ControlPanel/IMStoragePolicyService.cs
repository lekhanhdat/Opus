...
namespace AvePoint.GCommon.Contract.Server.ControlPanel
{
    ...
    public interface IMStoragePolicyService
    {
        ...
        [OperationContract]
        List<string> ValidateStoragePolicyOnGroup(StoragePolicyDto dto, EntityObjectPermissionType permission);
        ...
        /// <returns></returns>
        [OperationContract]
        List<StoragePolicyDto> GetStoragePolicyByModule(int type, int isOldRecord);

        [OperationContract]
        List<StoragePolicyDto> GetStoragePolicyByModuleAndRetentionType(int type, int isOldRecord, StoragePolicyType retentionType);
    }
}
