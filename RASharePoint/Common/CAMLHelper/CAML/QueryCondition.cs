...
namespace AvePoint.RA.SharePoint.Common.CAMLHelper.CAML
{
    ...
    public class QueryCondition
    {
        ...
        public QueryCondition(Types.JoinTypes joinType, Types.FieldRefTypes fieldRefType, string field, Types.FieldTypes fieldType, Types.QueryTypes queryType, string[] values)
            : this(joinType)
        {
            _query = new Query(field, fieldRefType, fieldType, queryType, values);
        }
