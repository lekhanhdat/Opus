...
namespace Microsoft365.Authentication
{
    ...
    class GeneralSPOTokenProvider : ITokenProvider
    {
        private readonly SPOCredentials onlineCredentials;

        public GeneralSPOTokenProvider(string username, string password, AveAzureEnvironment environment)
            : this(username, password.ToSecureString(), environment)
        { }

        public GeneralSPOTokenProvider(string username, SecureString password, AveAzureEnvironment environment)
        {
