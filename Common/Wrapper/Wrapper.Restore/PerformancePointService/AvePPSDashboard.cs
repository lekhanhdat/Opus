...
namespace AvePoint.Wrapper.Restore
{
    public class AveSPPPSDashboard : AvePPSBase
    {
        ...
        {
            foreach (XmlElement dashboardElement in pagesElement)
            {
        ...
        {
            foreach (XmlElement dashboardElementChild in dashboardElement)
            {
                if(string.Equals(dashboardElementChild.Name,"DashboardElements",StringComparison.OrdinalIgnoreCase))
                {
                    foreach (XmlElement innerDashboardElement in dashboardElementChild)
                    {
