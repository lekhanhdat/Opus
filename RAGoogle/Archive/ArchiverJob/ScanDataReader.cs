...
namespace RAGoogle.Archive.ArchiverJob;

public class ScanDataReader : IScanDataReader
{
    private ApprovalReportService mScanDB = null;
    public ScanDataReader(GoogleConfiguration config)
    {
