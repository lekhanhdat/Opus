...
namespace AvePoint.Media.Service.DomainModel
{
    ...
    public class GDriveIndexServiceOpenParameter : IndexServiceOpenParameter
    {
        ...
        public GDriveIndexServiceOpenParameter()
        {
        }
        public GDriveIndexServiceOpenParameter(string subSubJobId, IXSystem indexLogicalDevice, IXSystem indexCacheDevice, String indexVolume)
        {
        ...
        private GDriveIndexServiceOpenParameter(GDriveIndexServiceOpenParameter param)
        {
        ...
        public GDriveIndexServiceOpenParameter(GDriveBrowseInfo browserInfo, IXSystem cacheSystem, IXSystem indexDevice)
        {
        ...
        public GDriveIndexServiceOpenParameter(GDriveBackupJob backupJob, string currentUserAddress, IXSystem cacheSystem, IXSystem indexDevice, bool isNeedBackupIndex = false, bool isNeedCheckIntegrity = false)
        {
            IndexCacheDeviceSystem = cacheSystem;
        ...
        public GDriveIndexServiceOpenParameter(GDriveBackupJob backupJob, IXSystem cacheSystem, IXSystem indexDevice)
        {
            IndexVolume = backupJob.IndexVolume;
            IndexCacheDeviceSystem = cacheSystem;
            CacheSetting = backupJob.CacheSetting;
        ...
        /// 支持 Exchagne module
        /// </summary>
        public GDriveIndexServiceOpenParameter(GDriveBackupJob backupJob, string currentUserAddress, string currentObjectId, IXSystem cacheSystem, IXSystem indexDevice, bool supportObjectId) : this(backupJob, currentUserAddress, cacheSystem, indexDevice)
        {
        ...
        /// 支持 Exchagne module
        /// </summary>
        public GDriveIndexServiceOpenParameter(GDriveRestoreJob restoreJob, IXSystem cacheSystem, IXSystem indexDevice, string currentUserAddress, MailboxType currentMailboxType, string currentObjectId, bool supportObjectId) : this(restoreJob, cacheSystem, indexDevice, currentUserAddress, currentMailboxType)
        {
            ObjectId = currentObjectId;
            SupportObjectId = supportObjectId;
            Timestamp = restoreJob.BackupTime;
        }
        public GDriveIndexServiceOpenParameter(GDriveRestoreJob restoreJob, IXSystem cacheSystem, IXSystem indexDevice, string currentUserAddress, MailboxType currentMailboxType)
        {
            IndexCacheDeviceSystem = cacheSystem;
        ...
        public override GDriveIndexServiceOpenParameter DeepClone()
        {
            return new GDriveIndexServiceOpenParameter(this);
        }
    }
}