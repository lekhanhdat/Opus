...
namespace AvePoint.Wrapper.Restore.Core
{
    ...
    class ClientSideWebPartImageWorker : ClientSideWebPartCommonWorker, IClientSideWebPartWorker
    {
        public const string Id = "d1d91016-032f-456d-98a4-721247c305e8";

        protected override AveLogger logger { get { return AveLogger.GetInstance(typeof(ClientSideWebPartImageWorker)); } }
