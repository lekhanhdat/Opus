...
namespace AvePoint.Common.FilterEngine.Engines.Box
{
    internal class BoxFilterEngine : FilterEngineBase
    {
        public BoxFilterEngine(List<FilterPolicy> policyLists, Dictionary<PolicyLevel, string> filterConditionExpressionLists, FilterEngine engine)
        ...
        {
            var fileInfo = objectInfo as BoxItemInfo;
