...
namespace SqlKata
{
    public abstract partial class BaseQuery<Q>
    {
        ...
        public Q WhereNot(string column, string op, object value, bool forJoin = false)
        {
        ...
        public Q AndWhere(Func<Q, Q> callback)
        {
            return And().Where(callback);
        }
        ...
        public Q WhereRegex(string column, object value, bool caseSensitive = false, string escapeCharacter = null)
        {
            return AddComponent("where", new BasicStringCondition
            {
                Operator = "regex",
        ...
        public Q OrWhereRegex(string column, object value, bool caseSensitive = false, string escapeCharacter = null)
        {
            return Or().WhereRegex(column, value, caseSensitive, escapeCharacter);
        }
        public Q WhereStringEquals(string column, object value, bool caseSensitive = false, string escapeCharacter = null)
        {
            return AddComponent("where", new BasicStringCondition
            {
        ...
        public Q WhereNotStringEquals(string column, object value, bool caseSensitive = false, string escapeCharacter = null)
        {
            return Not().WhereStringEquals(column, value, caseSensitive, escapeCharacter);
        }

        public Q OrWhereStringEquals(string column, object value, bool caseSensitive = false, string escapeCharacter = null)
        {
            return Or().WhereStringEquals(column, value, caseSensitive, escapeCharacter);
        }

        public Q OrWhereNotStringEquals(string column, object value, bool caseSensitive = false, string escapeCharacter = null)
        {
            return Or().Not().WhereStringEquals(column, value, caseSensitive, escapeCharacter);
        }

        public Q AndWhereNotStringEquals(string column, object value, bool caseSensitive = false, string escapeCharacter = null)
        {
            return And().Not().WhereStringEquals(column, value, caseSensitive, escapeCharacter);
        }

        public Q WhereArrayContain(string column, object value, bool partialMatch = false)
        {
            return AddComponent("where", new BasicStringCondition
            {
        ...
        public Q WhereNotArrayContain(string column, object value, bool partialMatch = false)
        {
            return Not().WhereArrayContain(column, value, partialMatch);
        }

        public Q OrWhereArrayContain(string column, object value, bool partialMatch = false)
        {
            return Or().WhereArrayContain(column, value, partialMatch);
        }

        public Q OrWhereNotArrayContain(string column, object value, bool partialMatch = false)
        {
            return Or().Not().WhereArrayContain(column, value, partialMatch);
        }

        public Q WhereArrayContainV2(object array, string column, bool partialMatch = false)
        {
            return AddComponent("where", new BasicStringCondition
            {
                Operator = "arrayContainV2",
                Column = column,
                Value = array,
                CaseSensitive = partialMatch,
                EscapeCharacter = null,
        ...
        public Q WhereArrayContainV3(object array, string column, string fuction,bool partialMatch = false)
        {
            return AddComponent("where", new BasicStringCondition
            {
                Operator = "arrayContainV3",
                Column = column,
                Value = array,
                CaseSensitive = partialMatch,
                EscapeCharacter = null,
        ...
        public Q WhereNotArrayContainV2(object array, string column, bool partialMatch = false)
        {
            return Not().WhereArrayContainV2(array, column, partialMatch);
        }

        public Q OrWhereArrayContainV2(object array, string column, bool partialMatch = false)
        {
            return Or().WhereArrayContainV2(array, column, partialMatch);
        }

        public Q OrWhereNotArrayContainV2(object array, string column, bool partialMatch = false)
        {
            return Or().Not().WhereArrayContainV2(array, column, partialMatch);
        }
        ...
        public Q WhereDefined(string column)
        {
            return AddComponent("where", new BasicStringCondition
            {
                Operator = "IS_DEFINED",
        ...
        public Q WhereNotDefined(string column)
        {
            return Not().WhereDefined(column);
        }

        public Q OrWhereDefined(string column)
        {
            return Or().WhereDefined(column);
        }

        public Q OrWhereNotDefined(string column)
        {
            return Or().Not().WhereDefined(column);
        }
