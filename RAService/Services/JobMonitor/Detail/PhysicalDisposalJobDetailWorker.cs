...
{
    public class PhysicalDisposalJobDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_PHYSICAL_Disposal, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_PHYSICAL_Disposal, TABLE_NAME);
        }
    }
}
