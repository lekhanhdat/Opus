...
{
    public static class RMDiscoveryGoogleFileExtensionQueryParameterExtension
    {
        public static bool TryGetSqlDefinition(this RMDiscoveryGoogleFileExtensionQueryParameter parameter, string dataTableAlias, out RMDiscoverySqlDefinition sqlDefinition)
        {
            sqlDefinition = null;
