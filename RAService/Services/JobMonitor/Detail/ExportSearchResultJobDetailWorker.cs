...
{
    public class ExportSearchResultJobDetailWorker: AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_Explorer_ExportSearchResult, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_Explorer_ExportSearchResult, TABLE_NAME);
        }
    }
}
