...
{
    public class TermConnectorBuildInColumn : IConnectorBuildInColumn
    {

        private ITermDao TermDao => PlatformWindsorManager.GetService<ITermDao>();

        public Guid ColumnId => CustomizeConnectorBuildColumnIds.Term;
        ...
        public void ApplyRecordValue(Record record, Dictionary<string, CustomColumn> customColumnDic)
        {
            ...
            {
                record.TermId = new Guid(value.Id);
                record.TermName = value.Name;
        ...
        public async Task<CustomizeConnectorNameValue<string>> ConvertToNameValueAsync(CustomizeConnectorColumnInfo columnInfo, Record record, bool forDisplay = true)
        {
            ...
            {
                Name = I18NEntity.GetString("RM_PRM_PRE_Column_DisposalClass"),
                Value = TermDao.GetTermNamesPathByTermId(record.TermId)
            };
        }
    }
}
