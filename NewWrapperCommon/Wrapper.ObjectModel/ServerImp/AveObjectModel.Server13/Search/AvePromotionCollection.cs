...
namespace AvePoint.ObjectModel.Server13
{
    class AvePromotionCollection : AveAbstractCommonCollection<IAvePromotion>, IAvePromotionCollection
    {
        ...
        {
            Promotion promotion = mPromotionCollection.AddPromotion(name, (context as ObjectModel.Server13.Search.AveContext).Context);
            if (promotion == null)
            {
                return null;
            }
        ...
        {
            Promotion promotion = mPromotionCollection.AddPromotion(name, description, boostValue, start, end, (context as ObjectModel.Server13.Search.AveContext).Context);
            if (promotion == null)
            {
                return null;
            }
