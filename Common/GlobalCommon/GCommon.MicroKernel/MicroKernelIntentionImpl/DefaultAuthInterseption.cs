        ...
        public void PreInvoke(InterseptionContext context)
        {
                ...
                || !context.CoreMessage.AuthorizationKey.Equals(AuthorizationToken))
            {
                throw new UnauthorizedAccessException(
                  @"Unauthorized access to microkernel server, this is often because the communication authorization key is null or invalid to access the microkernel server");
            }
        }
