...
{
    public class EXONAAExportPathGenerator : EXOExportPathGeneratorBase
    {
        ...
        public EXONAAExportPathGenerator(String ConvertIllegalCharacterTo, String physicalDeviceDtoPath, string ColumnName)
        {
