...
namespace AvePoint.ObjectModel.Server13
{
    class AveSearchSetting : IAveSearchSetting
    {
        ...
        {
            mSearchSetting.AttachContext((cx as ObjectModel.Server13.Search.AveContext).Context);
        }

        public void DetachContext(Wrapper.Common.Search.IAveContext cx)
        {
            mSearchSetting.DetachContext((cx as ObjectModel.Server13.Search.AveContext).Context);
        }
