...
{
    [DataContract]
    public class RMDiscoveryGoogleProfileDataInfo
    {
        [DataMember]
        [JsonProperty("id")]
        ...
        [DataMember]
        [JsonProperty("availableRuleCategories")]
        public List<RMDiscoveryRuleCategory> AvailableRuleCategories { get; set; } = [];
        [DataMember]
        ...
        [DataMember]
        [JsonProperty("ruleInfoLabel")]
        public string RuleInfoLabel { get; set; }
    }
}
