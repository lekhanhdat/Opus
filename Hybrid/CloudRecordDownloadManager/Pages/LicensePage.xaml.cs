...
namespace CloudRecordDownloadManager.Pages {
    ...
    public partial class LicensePage : BasePage {
        ...
        public LicensePage() {
            ...
            NextButton.IsEnabled = RuntimeCache.LicenseAgreed;
            AgreeButton.IsChecked = RuntimeCache.LicenseAgreed;
        }
        ...
        private void AgreeAction(object sender, RoutedEventArgs e) {
            RuntimeCache.LicenseAgreed = AgreeButton.IsChecked ?? false;
            NextButton.IsEnabled = RuntimeCache.LicenseAgreed;
        }
