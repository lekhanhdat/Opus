...
{
    internal class XX509ClientCertificateAuthentication
    {
        ...
        internal static X509CertificateValidator DefaultCertificateValidator
        {
            get
            {
                ...
                {
                    defaultCertificateValidator = (X509CertificateValidator)Invoker.GetStaticProperty(typeof(X509ClientCertificateAuthentication), "DefaultCertificateValidator");
                }
