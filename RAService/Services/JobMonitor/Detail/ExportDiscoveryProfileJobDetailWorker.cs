...
{
    public class ExportDiscoveryProfileJobDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_DISCOVERY_EXPORT, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_DISCOVERY_EXPORT, TABLE_NAME);
        }
    }
}
