...
namespace AvePoint.GCommon.Contract.Server.ControlPanel.SuperUserConfiguration.Object
{
    ...
    public class SuperUserConfigurationDto : IProfileContent
    {
        [DataMember]
    ...
    [DataContract]
    public class SuperUserResult: CommonSettingResultForPage
    {
        [DataMember]
        public List<SuperUserConfigurationDto> SuperUserConfigurationDtoList { get; set; }
    }
