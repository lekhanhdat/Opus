...
namespace AvePoint.ObjectModel.Common
{
    class AveProfileLoader:IAveProfileLoader
    {
        ...
        public AveProfileLoader (string adminUrl,AveBPOSAccountInfo userAccountInfo) //for create operation
        {
            ...
            mRequest = request.Proxy as IAveRequest;
        }
        public IAveUserProfile GetUserProfile()
        {
        ...
        public static IAveProfileLoader GetProfileLoader(IAveRequest request)
        {
            throw new NotImplementedException();
        }

        public static IAveUserProfile GetOwnerUserProfile(IAveRequest request)
        {
            throw new NotImplementedException();
        }
    }
