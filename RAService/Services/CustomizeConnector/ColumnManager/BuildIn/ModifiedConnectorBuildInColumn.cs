...
{
    public class ModifiedConnectorBuildInColumn : IConnectorBuildInColumn
    {

        private readonly IGeneralSettingService GeneralSettingService = PlatformWindsorManager.GetService<IGeneralSettingService>();

        public Guid ColumnId => CustomizeConnectorBuildColumnIds.Modified;
        ...
        public void ApplyRecordValue(Record record, Dictionary<string, CustomColumn> customColumnDic)
        {
            ...
            record.TimeModified = date.Ticks;
        ...
        public async Task<CustomizeConnectorNameValue<string>> ConvertToNameValueAsync(CustomizeConnectorColumnInfo columnInfo, Record record, bool forDisplay = true)
        {
            ...
            var dateTimeFormat = forDisplay ? GeneralSettingService.ConvertTiksToDateTime(gls, record.TimeModified, true).SimplifyFormatTime :
            GeneralSettingService.ConvertTiksToUTCDateTime(gls, record.TimeModified).SimplifyFormatTime;
