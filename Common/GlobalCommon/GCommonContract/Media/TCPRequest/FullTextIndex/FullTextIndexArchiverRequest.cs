...
namespace AvePoint.GCommon.Contract.Media.TCPRequest.FullTextIndex
{
    ...
    public class FullTextIndexArchiverRequest : ArchiverRestoreRequest
    {
        [DataMember]
        ...
        {
            return String.Format("Full Text Index Archiver Request: File Size Limit: {0}, " +
                "Scope Type: {1}, Full Text Index Job Id: {2}",
                this.FileSizeLimit,
                this.ScopeType,
                this.FullTextIndexJobId);
        }
    }
}
