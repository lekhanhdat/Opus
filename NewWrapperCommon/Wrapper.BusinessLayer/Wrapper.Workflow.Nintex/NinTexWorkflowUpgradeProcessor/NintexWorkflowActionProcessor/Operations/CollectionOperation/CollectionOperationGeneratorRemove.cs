...
{
    internal class CollectionOperationGeneratorRemove : CollectionOperationGenerator
    {
        public CollectionOperationGeneratorRemove(CollectionAvailableOperation availableOperation) : base(availableOperation)
        {
            ClassName = "#CollectionOperationItemRemove";
            InputCollectionDescription = "The collection variable to remove an item from.";
            InputIndexDescription = "Index of the item to remove.";
            OutputCollectionDescription = "Collection variable to store the collection with the item removed.";
            ActionName = "Remove Item from Collection";
        }
