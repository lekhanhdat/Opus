...
export default {
    getContext() {
        return {
            ...
            downloadRelatedAppUrl: "/api/SPOnPremSettingApi/DownloadRelatedApp",
        };
    },
    saveTermSettings(that, callback) {
        ...
        let sendUrl = CRMCommonUtil.isGroup(currNode) ? "/api/SPOnPremSettingApi/SaveGroupLevelSetting" : "/api/SPOnPremSettingApi/SaveDocumentLevelSetting";
        let option = {
            url: sendUrl,
            method: "Post",
            data: currNode
    ...
    getSavedTerm(that) {
        ...
        let option = {
            url: "/api/SPOnPremSettingApi/GetSavedTree",
            method: "Post",
            data: paramObj
        };
