...
{
    public static class RMDiscoveryFSRotRuleQueryParameterExtension
    {
        public static bool TryGetSqlDefinition(this RMDiscoveryFSROTRuleQueryParameter parameter, string dbSchemaName, string dataTableAlias, out RMDiscoverySqlDefinition sqlDefinition)
        {
            sqlDefinition = new();
            ...
            var ruleTableName = "RMFSRuleInfo";
