...
const FilterOption = FilterOptions.ModifiedTime;

const ModifiedTimeFilter = ({ onFilterChange, onRemoveFilterChange, filterDefinitions }) => {
...
export default ModifiedTimeFilter;
