...
{
    public interface IAveOUserProfileTypeProperty
    {
        Boolean IsEventLog { get; set; }
        Boolean IsReplicable { get; set; }
        Boolean IsSection { get; }
        Boolean IsSystem { get; }
        Boolean IsUpgrade { get; set; }
        Boolean IsUpgradePrivate { get; set; }
        Boolean IsVisibleOnEditor { get; set; }
        Boolean IsVisibleOnVeiwer { get; }
        Int32 MaximumShown { get; }
        String Name { get; set; }
