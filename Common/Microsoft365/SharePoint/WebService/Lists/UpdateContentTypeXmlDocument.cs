...
namespace Microsoft365.SharePoint.WebService.Lists
{
    ...
    public class UpdateContentTypeXmlDocument : ISoapHttpRequest
    {
        ...
        [XmlElement(ElementName = "newDocument")]
        public XmlNode NewDocument { get; set; }

        [XmlIgnore]
        public string SoapAction => "http://schemas.microsoft.com/sharepoint/soap/UpdateContentTypeXmlDocument";
