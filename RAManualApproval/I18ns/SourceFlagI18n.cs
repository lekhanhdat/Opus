...
namespace RAManualApproval.I18ns
{
    public static class SourceFlagI18n
    {
        public static  Dictionary<SourceFlag, string> SourceFlagI18ns = new Dictionary<SourceFlag, string>
        {
            ...
            { SourceFlag.LifecycleRetention, "RM_JM_DeletionStatus_Retention" },
            { SourceFlag.Connector, "RM_CP_Connector" },
        };
    }
}
