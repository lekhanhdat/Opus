...
using AvePoint.GCommon.Contract.Server.Common;
    ...
    public interface IMSystemProfileService
    {
        ...
        [OperationContract]
        string CreateSystemProfileOnGroup(SystemProfileDto dto, EntityObjectPermissionType permissionType);
        [OperationContract]
        ...
        [OperationContract]
        List<SystemProfileDto> GetSystemProfileListByIds(List<string> ids);
        [OperationContract]
