...
namespace AvePoint.GCommon.Contract.ExchangeOnline.ExchangeOnlineBackup.Object
{
    ...
    [XmlRootAttribute(ElementName = "EOSiteMasterIndexExtension")]
    public class EOSiteMasterIndexExtension
    {
        /// <summary>
        ...
        [DataMember]
        [XmlAttribute]
        public String RealFBJobId { get; set; }
        ...
        {
            return String.Format("Custom Action File Path: {0}",
    ...
    public class EODataVersionContentDto
    {
        [DataMember]
