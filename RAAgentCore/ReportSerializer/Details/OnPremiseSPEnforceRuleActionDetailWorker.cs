...
{
    public class OnPremiseSPEnforceRuleActionDetailWorker : AbstractDetailWorker
    {
        public override List<List<ReportCell>> ConvertReportData(IEnumerable<JMJobDetails> details)
        {
            ...
            {
                if (detail is JMOnPremiseSPEnforceRuleActionJobDetails)
                {
                    List<ReportCell> reports = new List<ReportCell>();
                    JMOnPremiseSPEnforceRuleActionJobDetails reportnfo = detail as JMOnPremiseSPEnforceRuleActionJobDetails;
        ...
        public override void InitCreateTableSQLString()
        {
            ...
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_OnpremiseSP_EnforceRuleAction, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA_OnpremiseSP_EnforceRuleAction, TABLE_NAME);
        }
    }
}
