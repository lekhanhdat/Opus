...
namespace AvePoint.RA.Web.Controllers.Discovery.Office365
{
    ...
    public class RMDiscoveryOffice365JobManagementApiController : BaseApiController
    {

        private readonly IRMDiscoveryOffice365JobManagentService _jobManagementService = new RMDiscoveryOffice365JobManagentService();
