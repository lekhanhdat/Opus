...
{
    public class AuditCommonService : RMServiceBase, IAuditCommonService
    {
        public IAuditDao AuditDao { get; set; }

        public async System.Threading.Tasks.Task Add(RMAuditInfo auditInfo)
        {
            await AuditDao.Add(RMSecurityUtil.ConvertToDBAudit(auditInfo));
        }
