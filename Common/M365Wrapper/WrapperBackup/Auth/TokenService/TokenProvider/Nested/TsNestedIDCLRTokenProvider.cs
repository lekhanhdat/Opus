...
class TsNestedIDCLRTokenProvider : TsNestedTokenProviderBase
{
    ...
    public TsNestedIDCLRTokenProvider(IModernTokenService tokenService, string customerId, string tenantId, string userName)
    ...
    public override async ValueTask<AccessTokenResult> GetAccessTokenAsync(string resource, TokenResourceType resourceType, CancellationToken cancellationToken)
    {
        ...
        {
            return await TokenService.GetSharePointTokenAsync(UserName, resource, SharePointTokenType.IDCRL);
