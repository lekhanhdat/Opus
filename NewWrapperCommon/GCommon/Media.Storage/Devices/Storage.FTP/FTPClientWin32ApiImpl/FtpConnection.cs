...
namespace AvePoint.Media.Storage.FTP
{
    ...
    /// </summary>
    class FtpConnection : IDisposable
    {
        ...
        public FtpConnection(string host)
            : this(host, NativeMethods.InternetDefaultFtpPort, string.Empty, string.Empty)
        {
            this.ftpHost = host;
        }
        ...
        public FtpConnection(string host, string userName, string password)
            : this(host, NativeMethods.InternetDefaultFtpPort, userName, password)
        {
        }
        ...
        #region IDisposable
        /// <summary>
        /// The overrided Dispose method , This dispose pattern need to change in future, using the FTPClient style
        /// </summary>
        public void Dispose()
        {
            this.Dispose(true);
