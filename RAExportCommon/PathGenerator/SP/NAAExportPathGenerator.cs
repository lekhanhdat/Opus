...
{
    public class NAAExportPathGenerator : ExportpathGeneratorBase
    {
        ...
        private const string EXPORTMETADATAFORMAT = "{0}_NAA.CSV";//e.g. itemId_Version.Extension.idx
        ...
        public NAAExportPathGenerator(String ConvertIllegalCharacterTo, String physicalDeviceDtoPath, string ColumnName, string teamsAddress)
        {
