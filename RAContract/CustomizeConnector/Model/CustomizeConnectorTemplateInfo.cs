...
{
    public class CustomizeConnectorTemplateInfo
    {
        [JsonProperty("id")]
        ...
        [JsonProperty("columnInfoes")]
        public IEnumerable<CustomizeConnectorColumnInfo> ColumnInfoes { get; set; } = new List<CustomizeConnectorColumnInfo>();
    }
}
