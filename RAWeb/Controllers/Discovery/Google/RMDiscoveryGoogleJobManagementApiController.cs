...
namespace AvePoint.RA.Web.Controllers.Discovery.Google
{
    ...
    public class RMDiscoveryGoogleJobManagementApiController : BaseApiController
    {
        private readonly IRMDiscoveryGoogleJobManagementService _jobManagementService = new RMDiscoveryGoogleJobManagementService();
