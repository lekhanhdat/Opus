...
namespace AvePoint.ObjectModel.ClientOM
{
    internal class AveClientObjectsCache : IDisposable
    {
        ...
        public AveDictionary<int, Dictionary<string, object>> Folders;
        ...
        /// </summary>
        public AveDictionary<int, Dictionary<string, object>> Items;
        /// <summary>
        ...
        public ConcurrentDictionary<string, Dictionary<string, long>> FoldersToSubItemLastAccessTime;
        ...
        public static AveClientObjectsCache NewCache
        {
            get
            {
                ...
                //value.List = null;
                value.dirty = false;
                value.Items = new AveDictionary<int, Dictionary<string, object>>();
                value.Files = new Dictionary<string, Dictionary<string, object>>(StringComparer.OrdinalIgnoreCase);
                value.Folders = new AveDictionary<int, Dictionary<string, object>>();
                ...
                value.FoldersToSubItemLastAccessTime = new ConcurrentDictionary<string, Dictionary<string, long>>();
                return value;
            }
        }
