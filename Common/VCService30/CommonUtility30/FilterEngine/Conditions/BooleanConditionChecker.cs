        ...
        public static bool IsQualified(PolicyCondition policyCondition, bool objectValue, PolicyValue policyValue)
        {
            switch (policyCondition)
            {
                ...
                case PolicyCondition.Exactly:
                    bool yes = string.Equals("yes", policyValue.Value1.ToLower(), StringComparison.OrdinalIgnoreCase) || string.Equals("true", policyValue.Value1.ToLower(), StringComparison.OrdinalIgnoreCase);
