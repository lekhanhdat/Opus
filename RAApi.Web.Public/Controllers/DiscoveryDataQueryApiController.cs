...
namespace AvePoint.RA.Api.Web.Public.Controllers
{
    ...
    [ApiController]
    public class DiscoveryDataQueryApiController : RAWebApiBase
    {
        ...
        [HttpPost]
        public Task<RMDiscoveryRotCategoryDataInfo> GetRotCategoryData([FromBody] Dictionary<string, Guid> parameters)
        {
            return s_discoveryDataQueryService.QueryRotV3CategoryDataAsync(parameters["o365TenantId"]);
        }
    }
}
