...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldText : AveField, IAveFieldText
    {
        ...
        public AveFieldText(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, IDictionary<string, object> contentTypeProp, IDictionary<string, object> prop)
