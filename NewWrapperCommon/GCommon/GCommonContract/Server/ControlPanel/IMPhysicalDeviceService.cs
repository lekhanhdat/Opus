...
namespace AvePoint.GCommon.Contract.Server.ControlPanel
{
    ...
    public interface IMPhysicalDeviceService
    {
        ...
        [OperationContract]
        List<PhysicalDeviceDto> GetPhysicalDevicesByIds(List<string> ids);
        ...
        /// <returns></returns>
        [OperationContract]
        List<PhysicalDeviceDto> GetPysicalDevicesByModule(int type, int isOldRecord);

        [OperationContract]
        List<PhysicalDeviceDto> GetPhysicalDevicesByAccountProfielId(string accountProfileId, int isOldRecord);
    }
}
