...
namespace AvePoint.GCommon.Contract.ExchangeOnline.ExchangeOnlineBackup.Object
{
    ...
    public class ExchangeOnlineBackupResponse
    {
        [DataMember]
        ...
        [DataMember]
        public ExchangeOnlineBackupPlanDto QuickBackupDefaultSettings { get; set; }
    ...
    public enum ExchangeOnlineBackupRequsetType
    {
        [EnumMember]
        StoragePolicy = 1,
