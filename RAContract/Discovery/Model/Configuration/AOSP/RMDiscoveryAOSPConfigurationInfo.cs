...
{
    [DataContract]
    public class RMDiscoveryAOSPConfigurationInfo
    {
        [DataMember]
        [JsonProperty("scopeInfo")]
        public RMDiscoveryAOSPScopeInfo ScopeInfo { get; set; } = new();

        [DataMember]
        [JsonProperty("o365TenantIds")]
        public List<string> O365TenantIds { get; set; } = [];
        ...
        public RMDiscoveryAOSPInactiveDefinition InactiveDefinition { get; set; } = new();

        [DataMember]
        [JsonProperty("rotDefinition")]
        public RMDiscoveryAOSPRotDefinition RotDefinition { get; set; } = new();

        [DataMember]
        [JsonProperty("isAllowLockedSites")]
        public bool IsAllowLockedSites { get; set; }
    }
}
