...
namespace AvePoint.ObjectModel.Common
{
    class AveAlert : AveClientObject, IAveAlert
    {
        ...
        public AveAlert(AveWeb web, AveAlertCollection alertCollection, IAveRequest request, Dictionary<string, object> alertProperties)
        {
            mWeb = web;
            mRequest = request;
        ...
        public string AlertTemplateName
        {
            get
            {
                return base.DataCache.GetProperty<string>("AlertTemplateName");
            }
        }
        ...
        public IAveUser User
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("User"))
                {
                    IAveUser user = mWeb.SiteUsers.GetByID(UserId);
                    base.DataCache.PropertiesCache["User"] = user;
                    return user;
                }
            ...
            set
            {
                base.DataCache.PropertiesCache["User"] = value;
                base.DataCache.AddChangedProperty("UserUpdateId", this.User.ID);
            }
        }
        ...
        public IAvePropertyBag Properties
        {
            get
            {
                ...
                return base.DataCache.GetProperty<IAvePropertyBag>("Properties");
            }
        }
        ...
        public string ListUrl
        {
            get
            {
                return base.DataCache.GetProperty<string>("ListUrl");
            }
        }
    }
}
