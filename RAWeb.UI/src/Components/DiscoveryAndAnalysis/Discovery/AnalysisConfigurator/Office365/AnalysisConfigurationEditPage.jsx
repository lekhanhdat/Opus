...
import {AnalysisConfigurationScopeComponent, AnalysisConfigurationInactiveComponent, AnalysisConfigurationRotComponent} from "./Component";

const DEFAULT_DISCOVERY_INFO = {
    scopeInfo: {
        scopeType: DiscoveryM365Scope.DataSource,
        contentSources: [],
        specifyContainerIds: [],
    },
    sizeRangeInfoes: [],
...
const AnalysisConfigurationEditPage = ({ history }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            let values = await Promise.all([containerInfos, configurationInfos, jobStatusInfo]);
            $$.loading(false);

            setJobStatusInfo(values[2]);
            setSteps(steps);
            setContainers(values[0]);
            ...
            clonedConfigurationInfo = {
                ...
                rotDefinition: {
                    ...
                    activeTab: clonedConfigurationInfo.rotDefinition.activeTab = 0,
                }
            }
    ...
    const getJobInfo = (value) => {
        if (value === 3 || value === 4) {
            steps.find(
                (item) => item.step === value
            ).ref.current.onShowDialog(location.state);
        }
    };
    ...
    const runDiscoveryDoAction = async () => {
        ...
        const result = await fetchUtility({
            url: "/api/RMDiscoveryOffice365ConfigurationApi/AddOrUpdateNewlyConfigurationInfo",
            ...
            <div className="reco-fac-panel">
                ...
                <div className="reco-fac-form-panel">
                    <div className="reco-fac-form-content">
                        ...
                        >
                            <AnalysisConfigurationScopeComponent
                        ...
                        >
                            <AnalysisConfigurationInactiveComponent
                        ...
                        >
                            <AnalysisConfigurationRotComponent
