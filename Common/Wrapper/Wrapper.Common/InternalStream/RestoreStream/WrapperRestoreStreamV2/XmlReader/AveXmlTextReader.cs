 ...
 namespace AvePoint.Wrapper.Common
{
    ...
    public class AveXmlTextReader : XmlReader
    {
        ...
        static AveXmlTextReader()
        {
            TempFolder = Path.Combine(AveEnv.AgentTempFolder, Process.GetCurrentProcess().Id.ToString());
        ...
        public AveXmlTextReader(XmlReader reader)
        {
            internalReader = reader;
        }

        public AveXmlTextReader(StreamReader reader,XmlReaderSettings setting)
        {
        ...
        public string ReadXmlToFile(AveMetadataType metadataType)
        {
            ...
            string path = SecurityUtils.SafeCombinePath(TempFolder, metadataType.ToString()+"_"+Guid.NewGuid().ToString());
