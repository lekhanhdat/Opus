...
namespace AvePoint.Media.Storage.FTP.Wrapper
{
    ...
    public delegate void FtpSslValidation(WrapperFtpClient control, FtpSslValidationEventArgs e);
    ...
    /// AvePoint.Media.Storage.FTP.Wrapper gets in return. Please review the Debug example
    /// below for information on how to add TraceListeners for capturing
    /// the convorsation between AvePoint.Media.Storage.FTP.Wrapper and the server.
    /// </summary>
    ...
    /// </example>
	public class WrapperFtpClient : IDisposable {
	    ...
	    protected WrapperFtpClient CloneConnection() {
		    WrapperFtpClient conn = Create();
		    ...
		    conn.ValidateCertificate += new FtpSslValidation(
			    delegate( WrapperFtpClient obj, FtpSslValidationEventArgs e ) {
				    e.Accept = true;
			    } );
	    ...
	    protected virtual WrapperFtpClient Create() {
		    return new WrapperFtpClient();
	    }
        ...
        public static WrapperFtpClient Connect(Uri uri, bool checkcertificate) {
            WrapperFtpClient cl = new WrapperFtpClient();
            ...
            cl.ValidateCertificate += new FtpSslValidation(delegate(WrapperFtpClient control, FtpSslValidationEventArgs e) {
        ...
        /// <param name="uri">The URI to parse</param>
        /// <returns>FtpClient object</returns>
        public static WrapperFtpClient Connect(Uri uri) {
