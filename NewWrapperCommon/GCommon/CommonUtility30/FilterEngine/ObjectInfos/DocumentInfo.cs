...
namespace AvePoint.Common.FilterEngine
{
    ...
    public class DocumentInfo : VersionedObjectInfoBase
    {
        ...
        #region Add for Migration Custom Filter

        public Hashtable IntrNameToDispName { get; set; }

        public Hashtable DispNameToType { get; set; }

        #endregion

        public Hashtable WorkflowStatus { get; set; }

        public Hashtable ParentSiteProperties { get; set; }

        public Hashtable ParentSiteCollectionProperties { get; set; }

        public string ParentFolderName { get; set; }

        internal override FilterLevel Level
        {
            get { return FilterLevel.Document; }
        }
    }
}
