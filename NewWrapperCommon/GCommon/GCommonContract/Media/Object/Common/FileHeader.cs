...
namespace AvePoint.GCommon.Contract.Media.Object
{
    ...
    public class FileHeader
    {
        ...
        /// <summary>
        /// This field is used to identify the current SiteCollection backup successfully
        /// </summary>
        [DataMember]
        ...
        public override String ToString()
        {
            ...
            stringBuilder.AppendFormat("SPMode: {0}, ", this.SPMode);
            ...
            stringBuilder.AppendFormat("SPVersion: {0}", this.SPVersion);
            stringBuilder.AppendFormat("RowID: {0}", this.RowId);
