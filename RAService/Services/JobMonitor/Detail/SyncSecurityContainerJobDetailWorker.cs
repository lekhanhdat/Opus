...
{
    public class SyncSecurityContainerJobDetailWorker : AbstractJobDetailWorker
    {
        ...
        {
            TABLE_NAME = JobMonitorConstants.JOBDETAIL;
            CREATE_TABLE_SQL = string.Format(JobMonitorConstants.CREATE_TABLE_SYNC_SECURITY_CONTAINER_SETTING, TABLE_NAME);
            INSERT_DATA_SQL = string.Format(JobMonitorConstants.INSERT_DATA__SYNC_SECURITY_CONTAINER_SETTING, TABLE_NAME);
        }
    }
}
