...
namespace AvePoint.Wrapper.Common
{
    ...
    public class HtmlNodeCollection : IList<HtmlNode>
    {
        ...
        public HtmlNode this[string nodeName]
        {
            get
            {
                nodeName = nodeName.ToLower(System.Globalization.CultureInfo.InvariantCulture);
        ...
        public static HtmlNode FindFirst(HtmlNodeCollection items, string name)
        {
            ...
            {
                if (node.Name.ToLower(System.Globalization.CultureInfo.InvariantCulture).Contains(name))
                    return node;
