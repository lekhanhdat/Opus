...
namespace AvePoint.GCommon.Contract.Media.WcfService
{
    ...
    public interface IMMDataInfoService
	{
        /// <summary>
        /// 获取若干logical device下每个Plan的数据大小
        /// </summary>
        /// <param name="List<DiskSpaceLogicalDevicePara>"></param>
        /// <returns>DiskSpaceMonitoringCollectorDefinition</returns>
        DiskSpaceMonitoringCollectorDefinition GetLogicalDeviceDataInfo(DiskSpaceMonitoringCollectorDefinition logicalDeviceCollector);
	}
}
