...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldComputed : AveField, IAveFieldComputed
    {
        ...
        public AveFieldComputed(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, Dictionary<string, object> contentTypeProp, Dictionary<string, object> prop)
