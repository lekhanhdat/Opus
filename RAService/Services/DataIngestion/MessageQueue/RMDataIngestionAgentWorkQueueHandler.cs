...
{
    public class RMDataIngestionAgentWorkQueueHandler : RMDataIngestionAzureQueueHandler
    {
        public override RMDataIngestionType IngestionType => RMDataIngestionType.AgentWork;

        public RMDataIngestionAgentWorkQueueHandler()
            : base(RMAgentAzureQueueContext.AgentWorkQueue, typeof(RMDataIngestionAgentWorkQueueHandler))
        {
        }
    }
}
