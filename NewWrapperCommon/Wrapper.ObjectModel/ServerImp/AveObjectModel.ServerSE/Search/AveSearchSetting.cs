...
namespace AvePoint.ObjectModel.ServerSE
{
    class AveSearchSetting : IAveSearchSetting
    {
        ...
        {
            mSearchSetting.AttachContext((cx as ObjectModel.ServerSE.Search.AveContext).Context);
        }

        public void DetachContext(Wrapper.Common.Search.IAveContext cx)
        {
            mSearchSetting.DetachContext((cx as ObjectModel.ServerSE.Search.AveContext).Context);
        }
