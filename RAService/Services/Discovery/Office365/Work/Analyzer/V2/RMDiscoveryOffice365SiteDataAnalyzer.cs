...
namespace AvePoint.RA.Service.Services.Discovery.Office365.Work.Analyzer.V2
{
    public class RMDiscoveryOffice365SiteDataAnalyzer
    {
        ...
        public async Task<(bool succeed, RMDiscoveryOffice365SiteInfo siteInfo)> InitAsync(long fileTotalSize, long fileSumCount, bool hidden)
        {
            try
            {
                ...
                if(_jobType == RMDiscoveryJobType.Retry && siteInfo != null)
                {
                    ...
                    siteInfo.FileTotalSize = fileTotalSize;
                    siteInfo.FileSumCount = fileSumCount;
