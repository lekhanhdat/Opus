...
namespace AvePoint.GCommon.Contract.Media.TCPRequest.Restore
{
    ...
    public class GDriveRestoreRequest : MediaTCPRequest
    {
        [DataMember]
        ...
        [DataMember]
        public GoogleDriveTreeNodeDto TreeRoot { get; set; }
        ...
        public override String ToString()
        {
            ...
            stringBuilder.AppendFormat("Drive Name: {0}, ", this.DriveName);
            stringBuilder.AppendFormat("Drive Id: {0}, ", this.DriveId);
