...
namespace AvePoint.RA.Web.Config
{
    ...
    {
        //RALogger Logger = new RALogger(typeof(GlobalConfig));
        ...
        private static void InitCastle()
        {
            ...
            //windsorContainer.Register(Classes.FromAssembly(Assembly.GetCallingAssembly()).BasedOn<Controller>().LifestyleTransient());
