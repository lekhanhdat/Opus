...
{
    public class AveFolderDto : IAveObjectDto, IComparable<IAveObjectDto>, IComparable<AveFolderDto>
    {
        private Guid mId;
        ...
        {
            AveFolderDto folderDto = other as AveFolderDto;
            if (folderDto == null)
            {
                return mType - other.Type;
            }
            return CompareTo(folderDto);
        }

        public int CompareTo(AveFolderDto other)
        {
