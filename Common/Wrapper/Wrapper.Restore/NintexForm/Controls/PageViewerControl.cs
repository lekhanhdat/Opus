...
namespace AvePoint.Wrapper.Restore.NintexForm.Online
{
    ...
    {
        public PageViewerControl(AveSPWeb web, IAveList list, string contentTypeId, XmlNode controlNode, XmlNamespaceManager nsManager)
        ...
        public override void ProcessControl(bool isPost)
        {
            ...
            var sourceUrlNode = mControlNode.SelectSingleNode("d2p1:Source", nsManager);
