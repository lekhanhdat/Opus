...
namespace AvePoint.GCommon.Contract.ReportCenter.Object
{
    ...
    public class NetworkingCollectorDefinition : BaseCollectorDefinition
    {
        //Type废弃了
        [DataMember]
        ...
        [DataMember]
        public NetworkingType MessageType { set; get; }

        [DataMember]
        public List<string> Adapters { set; get; }

        [DataMember]
        public List<NetworkAdapterDetail> NetworkAdapterDetailList { set; get; }
    }
