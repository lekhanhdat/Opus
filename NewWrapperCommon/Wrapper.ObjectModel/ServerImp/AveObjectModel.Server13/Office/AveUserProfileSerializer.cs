...
namespace AvePoint.ObjectModel.Server13
{
    class AveUserProfileSerializer : IAveUserProfileSerializer,IDisposable
    {
        ...
        public AveUserProfileSerializer(AveSite site, string login, bool needInit, AveSiteInfo sourceSiteInfo, AveServerObjectModelFactory factory)
        {
            new AveUserProfileSerializer(site, login, needInit, sourceSiteInfo, factory, null);
        }
