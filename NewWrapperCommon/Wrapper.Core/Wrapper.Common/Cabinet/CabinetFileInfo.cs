...
namespace AvePoint.Wrapper.Common
{
    ...
    public sealed class CabinetFileInfo : FileSystemInfo
    {
        ...
        public CabinetFileInfo(CabinetInfo cabinetInfo, string filePath)
        {
            if (cabinetInfo == null)
            {
        ...
        public override string FullName
        {
            get
            {
                if (this.Cabinet != null)
                {
                    return System.IO.Path.Combine(this.CabinetName, System.IO.Path.Combine(this.Path, this.Name));
                }
                return null;
            }
        }
