...
namespace AvePoint.Wrapper.Common
{
    ...
    {
        private IClientMessageInspector mRequestInspector;
        public BecWebServiceCustomBehavior(IClientMessageInspector requestInspector)
        {
            mRequestInspector = requestInspector;
        }
        ...
        {
            clientRuntime.MessageInspectors.Add(mRequestInspector);
        }
