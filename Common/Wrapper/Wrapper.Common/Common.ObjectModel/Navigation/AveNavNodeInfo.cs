...
namespace AvePoint.Wrapper.Common
{
    ...
    public class AveNavigationInfoList
    {
        ...
        public bool ShareQuickLunch { set; get; }
    ...
    public class Ave2013NavigationInfo : AveNavigationInfoList
    {
        public bool AddNewPagesToNavigation { get; set; }

        public bool CreateFriendlyUrlsForNewPages { get; set; }

        public AveStandardNavigationSettings CurrentNavigation { get; set; }

        public AveStandardNavigationSettings GlobalNavigation { get; set; }
    }

    public class AveStandardNavigationSettings
    {
        public AveStandardNavigationSource Source { get; set; }
