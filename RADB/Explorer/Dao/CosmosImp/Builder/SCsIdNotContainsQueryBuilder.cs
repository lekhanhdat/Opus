...
{
    public class SCsIdNotContainsQueryBuilder : BaseArrayNotContainFilterBuilder
    {
        protected override bool CanFilter(ExplorerFilterOptionV2 filterOption)
        {
            return filterOption != null && filterOption.ExceptSCIds != null && filterOption.ExceptSCIds.Count > 0;
        }
        ...
        {
            return filterOption.ExceptSCIds;
        }
    }
}
