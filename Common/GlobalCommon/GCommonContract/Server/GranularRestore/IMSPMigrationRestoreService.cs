...
namespace AvePoint.GCommon.Contract.Server.GranularRestore
{
    ...
    public interface IMSPMigrationRestoreService
    {
        ...
        /// <summary> 通过filter 条件search backup data 记录. </summary>
        /// <param name="filterDto"></param>
        /// <returns></returns>
        BackupDataCollectionDto SearchBackupDataRecords(BackupDataFilterDto filterDto);
    }
}
