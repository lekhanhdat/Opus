...
namespace AvePoint.GCommon.Contract.DeploymentManager
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IASCDeployManagerService
    {
        /// <summary>
        ...
        /// <returns></returns>
        [OperationContract]
        ReturnResult ProcessMessage(SCDMMessage message);
        [OperationContract]
        void ProcessSCMessage(JobQueueMessage message);
        ...
        [OperationContract]
        ReturnResult ProcessMessageFromPrimaryAgent(SCDMMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult ProcessMessageForStopJob(SCDMMessage message);
        ...
        /// <returns>操作的结果返回值</returns>
        [OperationContract]
        ReturnResult ProcessMessageFromPrimaryAgentForStopJob(SCDMMessage message);
    }
}
