...
{
    internal class RMDiscoveryFSRotNodeDataQuerier : RMDiscoveryFSRotDataQuerier<RMDiscoveryNodeDataInfo>
    {
        public RMDiscoveryFSRotNodeDataQuerier(RMDiscoveryFSQueryParameter queryParameter) : base(queryParameter)
        {
        }

        public override async Task<RMDiscoveryNodeDataInfo> QueryAsync()
        {
            var tableName = "RMFSContainerRootLevelRotData";
