...
{
    public class ReportJobExecutionRecordTelemetryGenerator : TelemetryGenerator
    {
        public override TelemetryModule Module => TelemetryModule.ReportJobExecutionRecord;
        ...
        {
            return args[0] as CloudRecordsReportJobExecutionRecord;
        }
