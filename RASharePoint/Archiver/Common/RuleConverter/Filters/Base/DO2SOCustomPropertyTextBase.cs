...
{
    internal class DO2SOCustomPropertyTextBase<T> : DO2SOFilterConverterBase
        where T : PolicyRuleBase, new()
    {
        ...
        public DO2SOCustomPropertyTextBase(string value1, int startSequenceNo, TextConditionType condition, string extraValue)
        {
            this.mValue1 = value1;
