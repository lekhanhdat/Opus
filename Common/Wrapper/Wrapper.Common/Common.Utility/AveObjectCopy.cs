...
namespace AvePoint.Wrapper.Common
{
    public class AveObjectCopy
    {
        ...
        public static void UpdateObjectBasicProperties(IDictionary<string, object> propertiesDic, object infoObj, string[] properties)
        {
        ...
        public static void UpdateObjectBasicPropertiesWithEscape(IDictionary<string, object> props, object obj, params string[] escapeProperties)
        {
        ...
        public static void UpdateObjectBasicProperties(IDictionary<string, object> props, object obj)
        {
