...
namespace AvePoint.GCommon.Contract.AccountManager.ViewModel
{
    ...
    public class AddUserViewModel
    {
        ...
        [DataMember]
        public List<GroupDto> AllSuperAdminGroups { get; set; }
        [DataMember]
        public List<GroupDto> AllSecurityTrimmingGroups { get; set; }
        [DataMember]
