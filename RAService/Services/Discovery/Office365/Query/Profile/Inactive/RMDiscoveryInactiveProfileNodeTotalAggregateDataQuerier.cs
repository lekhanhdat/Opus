...
{
    public class RMDiscoveryInactiveProfileNodeTotalAggregateDataQuerier : RMDiscoveryInactiveProfileDataQuerier<Dictionary<string, object>>
    {
        public RMDiscoveryInactiveProfileNodeTotalAggregateDataQuerier(RMDiscoveryOffice365ProfileQueryParameter queryParameter) : base(queryParameter)
        {
        }
