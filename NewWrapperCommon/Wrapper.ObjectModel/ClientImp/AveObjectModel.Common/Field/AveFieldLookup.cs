...
namespace AvePoint.ObjectModel.Common
{
    class AveFieldLookup : AveField, IAveFieldLookup
    {
        ...
        public AveFieldLookup(IAveRequest request, AveList list, AveWeb web, string fieldSource, AveFieldCollection fieldCollection, Dictionary<string, object> contentTypeProp, Dictionary<string, object> prop)
