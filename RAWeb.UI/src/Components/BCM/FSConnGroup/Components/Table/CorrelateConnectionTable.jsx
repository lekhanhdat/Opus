export default class CorrelateConnectionTable extends R.Component {
    idAttr = true;
    componentCreate() {
        this.state = {
            page: 1,
        ...
        return (
            <div>
                <R.Table
                    ...
                    rowTemplate={CorrelateConnectionTableRowTemplate}
...
class CorrelateConnectionTableRowTemplate extends R.TableRow {
    constructor(props) {
        super(props);
        this.state = {};
    }
