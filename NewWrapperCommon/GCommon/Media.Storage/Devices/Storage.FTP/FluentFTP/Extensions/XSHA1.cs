...
namespace AvePoint.Media.Storage.FTP.Wrapper.Extensions
{
    ...
    public static class XSHA1
    {
        ...
        public static string GetXSHA1(this WrapperFtpClient client, string path)
        {
            FtpReply reply;
        ...
        public static IAsyncResult BeginGetXSHA1(this WrapperFtpClient client, string path, AsyncCallback callback, object state)
        {
