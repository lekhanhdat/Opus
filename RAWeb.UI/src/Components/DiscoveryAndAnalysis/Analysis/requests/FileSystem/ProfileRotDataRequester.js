        ...
        return ExceptionHandler.handleAsync(
            async () => {
                const res = await CacheUtil.WindowCacheUtil.tryGetValueAsync(
                    ...
                    async () => {
                        const requestOption = {
                            url: "/api/RMDiscoveryFSProfileDataQueryApi/queryRotOptimizationNodeTotalAggregateInfo",
                            method: "POST",
        ...
        return ExceptionHandler.handleAsync(
            async () => {
                const res = await CacheUtil.WindowCacheUtil.tryGetValueAsync(
                    ...
                    async () => {
                        const requestOption = {
                            url: "/api/RMDiscoveryFSProfileDataQueryApi/queryRotOptimizationNodesData",
                            method: "POST",
                            data: queryParameter,
                        };
                        return await fetchUtility(requestOption);
