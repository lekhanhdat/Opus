...
{
    public class I18NEntity : IValueConverter
    {
        /// <summary>
        ///     用于缓存资源文件管理器，用于国际化不在当前Assembly进行时，如Gui.Common
        /// </summary>
        private static readonly Dictionary<string, ResourceManager> ResourceMgrCache =
        ...
        public static string Get(string module, string english)
        {
            return BaseGet(module, english);
        }

        public static string Get(string module, string english, params object[] args)
        {
            return BaseGet(module, english, args);
        }
        ...
        public object Convert(
            ...
            CultureInfo culture)
        {
            var english = value as string;
            var module = parameter as string;
            return Get(module, english);
        }
