...
namespace AvePoint.ObjectModel.Common
{
    class AveView : AveClientObject, IAveView
    {
        ...
        public AveView(AveList parentList, AveViewCollection container, IAveRequest request, IDictionary<string, object> prop)
        {
            mRequest = request;
        ...
        public IAveContentTypeId ContentTypeId
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("ContentTypeId"))
                {
                    ...
                    base.DataCache.AddProperty("ContentTypeId",Id);
                }
                return base.DataCache.GetProperty<IAveContentTypeId>("ContentTypeId");
            }
            set
            {
                base.DataCache.AddProperty("ContentTypeId",value);
        ...
        public IAveViewFieldCollection ViewFields
        {
            get
            {
                if (base.DataCache.IsPropertyNotLoaded("ViewFields"))
                {
                    ...
                    base.DataCache.AddProperty("ViewFields",viewFields);
                }
        ...
        private void InitHtmlSchemaXml(AveList list, IDictionary<string, object> property)
        {
